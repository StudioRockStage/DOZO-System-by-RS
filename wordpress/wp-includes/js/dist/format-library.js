/******/ (() => {
  // webpackBootstrap
  /******/ "use strict";
  var __webpack_exports__ = {}; // external ["wp","richText"]

  const external_wp_richText_namespaceObject = window["wp"]["richText"]; // external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/format-bold.js
  /**
   * WordPress dependencies
   */

  const formatBold = /*#__PURE__*/ (0,
  ...
  /* harmony default export */ const format_bold = formatBold; // ./node_modules/@wordpress/format-library/build-module/bold/index.js
  ...
  /* harmony default export */ const library_code = code; // ./node_modules/@wordpress/format-library/build-module/code/index.js
  ...
  const external_wp_components_namespaceObject = window["wp"]["components"]; // external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // ./node_modules/@wordpress/format-library/build-module/image/index.js
  /**
   * WordPress dependencies
   */
  ...
  function InlineUI({ value, onChange, activeObjectAttributes, contentRef }) {
    ...
    const [editedWidth, setEditedWidth] = (0,
    external_wp_element_namespaceObject.useState)(width);
    const [editedAlt, setEditedAlt] = (0,
    external_wp_element_namespaceObject.useState)(alt);
  ...
  /* harmony default export */ const format_italic = formatItalic; // ./node_modules/@wordpress/format-library/build-module/italic/index.js
  ...
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // ./node_modules/@wordpress/icons/build-module/library/link.js
  /**
   * WordPress dependencies
   */

  const link_link = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const library_link = link_link; // external ["wp","a11y"]

  const external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/@wordpress/format-library/build-module/link/utils.js
  /**
   * WordPress dependencies
   */
   ...
   */
  function createLinkFormat({ url, type, id, opensInNewWindow, nofollow }) {
    const format = {
      type: "core/link",
      attributes: {
        url,
  ...
  const walkToEnd = partialRight(walkToBoundary, "forwards"); // ./node_modules/@wordpress/format-library/build-module/link/inline.js
  ...
  function InlineLinkUI({
    ...
    function onChangeLink(nextValue) {
      ...
      if (
        ...
        const inserted = (0, external_wp_richText_namespaceObject.insert)(
          value,
          newText,
        );
    ...
    function createButtonText(searchTerm) {
      return (0, external_wp_element_namespaceObject.createInterpolateElement)(
        ...
        {
          mark: /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            "mark",
            {},
          ),
        },
  ...
  /* harmony default export */ const inline = InlineLinkUI; // ./node_modules/@wordpress/format-library/build-module/link/index.js
  ...
  function link_Edit({
    ...
    function addLink(target) {
      ...
      if (
        ...
        !isActive &&
        text &&
        (0, external_wp_url_namespaceObject.isEmail)(text)
      ) {
        onChange(
          (0, external_wp_richText_namespaceObject.applyFormat)(value, {
            type: link_name,
        ...
        !isActive &&
        text &&
        (0, external_wp_url_namespaceObject.isPhoneNumber)(text)
      ) {
        onChange(
          (0, external_wp_richText_namespaceObject.applyFormat)(value, {
            type: link_name,
    ...
    const hasSelection = !(0, external_wp_richText_namespaceObject.isCollapsed)(
      value,
    );
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
      external_ReactJSXRuntime_namespaceObject.Fragment,
        ...
        children: [
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            external_wp_blockEditor_namespaceObject.RichTextToolbarButton,
            {
              ...
              icon: library_link,
              title: isActive
                ? (0, external_wp_i18n_namespaceObject.__)("Link")
                : link_title,
              onClick: (event) => {
  ...
  const build_module_link_link = {
    ...
    __unstablePasteRule(value, { html, plainText }) {
      ...
      if (
        !(0, external_wp_url_namespaceObject.isURL)(pastedText) ||
  ...
  const formatStrikethrough = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const format_strikethrough = formatStrikethrough; // ./node_modules/@wordpress/format-library/build-module/strikethrough/index.js
  ...
  external_wp_element_namespaceObject.forwardRef)(Icon); // ./node_modules/@wordpress/icons/build-module/library/text-color.js

  /**
   * WordPress dependencies
   */

  const textColor = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const text_color = textColor; // ./node_modules/@wordpress/icons/build-module/library/color.js
  ...
  /* harmony default export */ const library_color = color; // external ["wp","privateApis"]

  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/format-library/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
  ...
  function InlineColorUI({
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_components_namespaceObject.Popover,
      {
        ...
        anchor: popoverAnchor,
        children: /*#__PURE__*/ (0,
        external_ReactJSXRuntime_namespaceObject.jsxs)(Tabs, {
          children: [
            /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
              Tabs.TabList,
              {
            ...
            TABS.map((tab) =>
              /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
                Tabs.TabPanel,
                {
                  ...
                  focusable: false,
                  children: /*#__PURE__*/ (0,
                  external_ReactJSXRuntime_namespaceObject.jsx)(ColorPicker, {
                    name: name,
                    property: tab.name,
                    value: value,
                    onChange: onChange,
  ...
  function TextColorEdit({
    ...
    external_wp_blockEditor_namespaceObject.useSettings)(
      "color.custom",
      "color.palette",
    );
  ...
  /* harmony default export */ const library_subscript = subscript; // ./node_modules/@wordpress/format-library/build-module/subscript/index.js
  ...
  /* harmony default export */ const library_superscript = superscript; // ./node_modules/@wordpress/format-library/build-module/superscript/index.js
  ...
  const button_button = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      viewBox: "0 0 24 24",
  ...
  /* harmony default export */ const library_button = button_button; // ./node_modules/@wordpress/format-library/build-module/keyboard/index.js
  ...
  /* harmony default export */ const library_help = help; // ./node_modules/@wordpress/format-library/build-module/unknown/index.js
  ...
  /* harmony default export */ const library_language = language; // ./node_modules/@wordpress/format-library/build-module/language/index.js
  ...
  function language_Edit({ isActive, value, onChange, contentRef }) {
    const [isPopoverVisible, setIsPopoverVisible] = (0,
    external_wp_element_namespaceObject.useState)(false);
    const togglePopover = () => {
  ...
  function InlineLanguageUI({ value, contentRef, onChange, onClose }) {
    ...
    const [dir, setDir] = (0, external_wp_element_namespaceObject.useState)(
      "ltr",
    );
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_components_namespaceObject.Popover,
      {
        ...
        external_ReactJSXRuntime_namespaceObject.jsxs)(
          external_wp_components_namespaceObject.__experimentalVStack,
          {
            ...
            spacing: 4,
            className:
              "block-editor-format-toolbar__language-container-content",
            onSubmit: (event) => {
              event.preventDefault();
              onChange(
                (0, external_wp_richText_namespaceObject.applyFormat)(value, {
  ...
  const non_breaking_space_title = (0, external_wp_i18n_namespaceObject.__)(
    "Non breaking space",
  );
  const nonBreakingSpace = {
    ...
    edit({ value, onChange }) {
      function addNonBreakingSpace() {
        onChange(
          (0, external_wp_richText_namespaceObject.insert)(value, "\u00a0"),
        );
      }
      return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_blockEditor_namespaceObject.RichTextShortcut,
  ...
  /* harmony default export */ const default_formats = [
    bold,
    code_code,
    image_image,
    italic,
  ...
  default_formats.forEach(({ name, ...settings }) =>
