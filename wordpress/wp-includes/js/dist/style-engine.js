...
***************************************************************************** */
  ...
  const VARIABLE_PATH_SEPARATOR_TOKEN_STYLE = "--"; // ./node_modules/@wordpress/style-engine/build-module/styles/utils.js
   ...
   * @return GeneratedCSSRule[]  CSS rules.
   */
  function generateBoxRules(
    style,
    options,
    path,
    ruleKeys,
    individualProperties = ["top", "right", "bottom", "left"],
  ) {
  ...
  /* harmony default export */ const color_background = background; // ./node_modules/@wordpress/style-engine/build-module/styles/color/gradient.js
  ...
  /* harmony default export */ const color_gradient = gradient; // ./node_modules/@wordpress/style-engine/build-module/styles/color/text.js
  ...
  /* harmony default export */ const color_text = text_text; // ./node_modules/@wordpress/style-engine/build-module/styles/color/index.js

  /**
   * Internal dependencies
   */

  /* harmony default export */ const styles_color = [
    color_text,
    color_gradient,
    color_background,
  ...
  /* harmony default export */ const dimensions = [minHeight, aspectRatio]; // ./node_modules/@wordpress/style-engine/build-module/styles/background/index.js
  ...
  /* harmony default export */ const styles_background = [
    backgroundImage,
    backgroundPosition,
    backgroundRepeat,
    backgroundSize,
  ...
  /* harmony default export */ const styles_shadow = [shadow]; // ./node_modules/@wordpress/style-engine/build-module/styles/outline/index.js
  ...
  /* harmony default export */ const spacing_padding = padding; // ./node_modules/@wordpress/style-engine/build-module/styles/spacing/margin.js
  ...
  /* harmony default export */ const spacing_margin = margin; // ./node_modules/@wordpress/style-engine/build-module/styles/spacing/index.js
  ...
  function compileCSS(style, options = {}) {
    ...
    const selectorRules = Object.keys(groupedRules).reduce(
      (acc, subSelector) => {
        acc.push(
          `${subSelector} { ${groupedRules[subSelector].map((rule) => `${paramCase(rule.key)}: ${rule.value};`).join(" ")} }`,
        );
        return acc;
      },
      [],
