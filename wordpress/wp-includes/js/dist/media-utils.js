/******/ (() => {
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/@wordpress/media-utils/build-module/components/media-upload/index.js
  /**
  ...
  /* harmony default export */ const media_upload = MediaUpload; // ./node_modules/@wordpress/media-utils/build-module/components/index.js
  // external ["wp","blob"]

  const external_wp_blob_namespaceObject = window["wp"]["blob"]; // external ["wp","apiFetch"]
  ...
  function transformAttachment(attachment) {
    ...
    return {
      ...
      caption:
        (_attachment$caption$r = attachment.caption?.raw) !== null &&
        _attachment$caption$r !== void 0
          ? _attachment$caption$r
          : "",
   ...
   */
  async function sideloadToServer(
    file,
    attachmentId,
    additionalData = {},
    signal,
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/media-utils/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
