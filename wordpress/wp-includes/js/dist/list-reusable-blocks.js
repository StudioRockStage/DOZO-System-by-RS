/******/ (() => {
  ...
  /******/
  /************************************************************************/
  var __webpack_exports__ = {}; // external ["wp","element"]

  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/tslib/tslib.es6.mjs
  /******************************************************************************
...
***************************************************************************** */
  ...
  const external_wp_blob_namespaceObject = window["wp"]["blob"]; // ./node_modules/@wordpress/list-reusable-blocks/build-module/utils/export.js
  /**
  ...
  async function exportReusableBlock(id) {
    ...
    (0, external_wp_blob_namespaceObject.downloadBlob)(
      fileName,
      fileContent,
      "application/json",
    );
  }
  /* harmony default export */ const utils_export = exportReusableBlock; // external ["wp","compose"]

  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // ./node_modules/@wordpress/list-reusable-blocks/build-module/utils/file.js
  /**
  ...
  async function importReusableBlock(file) {
    ...
    if (
      ...
      (parsedContent.syncStatus && typeof parsedContent.syncStatus !== "string")
    ) {
  ...
  /* harmony default export */ const utils_import = importReusableBlock; // external "ReactJSXRuntime"

  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/list-reusable-blocks/build-module/components/import-form/index.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const import_form = (0,
  external_wp_compose_namespaceObject.withInstanceId)(ImportForm); // ./node_modules/@wordpress/list-reusable-blocks/build-module/components/import-dropdown/index.js
  ...
  /* harmony default export */ const import_dropdown = ImportDropdown; // ./node_modules/@wordpress/list-reusable-blocks/build-module/index.js
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    (0, external_wp_element_namespaceObject.createRoot)(container).render(
      /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
        ...
        {
          children: /*#__PURE__*/ (0,
          external_ReactJSXRuntime_namespaceObject.jsx)(import_dropdown, {
            onUpload: showNotice,
          }),
        },
      ),
