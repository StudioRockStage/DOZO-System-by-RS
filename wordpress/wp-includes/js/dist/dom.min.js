...
(() => {
  ...
  function M(t, e, n, r) {
    ...
    ("static" === a && (r.style.position = "relative"),
  ...
  function K(t) {
    switch (t.nodeType) {
      ...
      case t.ELEMENT_NODE:
        return (
          !t.hasAttributes() &&
          (!t.hasChildNodes() || Array.from(t.childNodes).every(K))
        );
      default:
        return !0;
    }
  ...
  function et(t) {
    ...
    const {
      ...
      ...tt,
      ins: { children: tt.ins.children },
      del: { children: tt.del.children },
    };
    return c;
  }
  function nt(t) {
          ...
          if (s)
            c.length && !t.querySelector(c.join(","))
              ...
              : t.parentNode && "BODY" === t.parentNode.nodeName && nt(t)
                ? (it(t.childNodes, e, n, r),
                  Array.from(t.childNodes).some((t) => !nt(t)) && X(t))
