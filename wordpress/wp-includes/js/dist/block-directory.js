/******/ (() => {
  ...
  const external_wp_plugins_namespaceObject = window["wp"]["plugins"]; // external ["wp","hooks"]
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // external ["wp","blocks"]
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","editor"]
  const external_wp_editor_namespaceObject = window["wp"]["editor"]; // ./node_modules/@wordpress/block-directory/build-module/store/reducer.js
  /**
  ...
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // ./node_modules/@wordpress/block-directory/build-module/store/selectors.js
  /**
   * WordPress dependencies
   */
  ...
  function isRequestingDownloadableBlocks(state, filterValue) {
    ...
    return (_state$downloadableBl =
      state.downloadableBlocks[filterValue]?.isRequesting) !== null &&
  ...
  function getDownloadableBlocks(state, filterValue) {
    ...
    return (_state$downloadableBl2 =
      state.downloadableBlocks[filterValue]?.results) !== null &&
      _state$downloadableBl2 !== void 0
  ...
  external_wp_data_namespaceObject.createRegistrySelector)((select) =>
    (0, external_wp_data_namespaceObject.createSelector)(
      (state) => {
        ...
        const { getBlockName, getClientIdsWithDescendants } = select(
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // external ["wp","apiFetch"]
  const external_wp_apiFetch_namespaceObject = window["wp"]["apiFetch"];
  var external_wp_apiFetch_default = /*#__PURE__*/ __webpack_require__.n(
    external_wp_apiFetch_namespaceObject,
  ); // external ["wp","notices"]
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // external ["wp","url"]
  const external_wp_url_namespaceObject = window["wp"]["url"]; // ./node_modules/@wordpress/block-directory/build-module/store/load-assets.js
  /**
   * WordPress dependencies
   */
...
***************************************************************************** */
  ...
  (0, external_wp_data_namespaceObject.register)(store); // ./node_modules/@wordpress/block-directory/build-module/components/auto-block-uninstaller/index.js
  ...
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // ./node_modules/clsx/dist/clsx.mjs
  function r(e) {
    var t,
      f,
      n = "";
  ...
  /* harmony default export */ const dist_clsx = clsx; // external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // ./node_modules/@wordpress/icons/build-module/icon/index.js
  /**
   * WordPress dependencies
   */
  ...
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/star-filled.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const star_filled = starFilled; // ./node_modules/@wordpress/icons/build-module/library/star-half.js

  /**
   * WordPress dependencies
   */

  const starHalf = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const star_half = starHalf; // ./node_modules/@wordpress/icons/build-module/library/star-empty.js
  ...
  /* harmony default export */ const star_empty = starEmpty; // ./node_modules/@wordpress/block-directory/build-module/components/block-ratings/stars.js
  ...
  /* harmony default export */ const stars = Stars; // ./node_modules/@wordpress/block-directory/build-module/components/block-ratings/index.js

  /**
   * Internal dependencies
   */

  const BlockRatings = ({ rating }) =>
  ...
  /* harmony default export */ const block_ratings = BlockRatings; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-icon/index.js
  ...
  /* harmony default export */ const downloadable_block_icon =
    DownloadableBlockIcon; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-notice/index.js
  ...
  /* harmony default export */ const downloadable_block_notice =
    DownloadableBlockNotice; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-block-list-item/index.js
  ...
  /* harmony default export */ const downloadable_block_list_item =
    DownloadableBlockListItem; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-list/index.js
          ...
          external_ReactJSXRuntime_namespaceObject.jsx)(
            downloadable_block_list_item,
            {
              onClick: () => {
                ...
                if (
                  (0, external_wp_blocks_namespaceObject.getBlockType)(
                    item.name,
                  )
                ) {
                  onSelect(item);
  ...
  /* harmony default export */ const downloadable_blocks_list =
    DownloadableBlocksList; // external ["wp","a11y"]

  const external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/inserter-panel.js
  /**
   * WordPress dependencies
   */
            ...
            "div",
            {
              ...
              children: [
                ...
                external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
                  ...
                  children: [
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)("h2", {
                      className:
  ...
  /* harmony default export */ const inserter_panel =
    DownloadableBlocksInserterPanel; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/no-results.js
              ...
              external_ReactJSXRuntime_namespaceObject.jsxs)(
                external_wp_components_namespaceObject.Tip,
                {
                  children: [
                    ...
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)("br", {}),
                    /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsxs)(
  ...
  /* harmony default export */ const no_results = DownloadableBlocksNoResults; // ./node_modules/@wordpress/block-directory/build-module/components/downloadable-blocks-panel/index.js
    ...
    (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
        ...
        if (hasPermission) {
          ...
          const installableBlocks = downloadableBlocks.filter(({ name }) => {
            ...
            const isPreviouslyInstalled = (0,
            external_wp_blocks_namespaceObject.getBlockType)(name);
  ...
  function InserterMenuDownloadableBlocksPanel() {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      ...
      {
        children: ({ onSelect, onHover, filterValue, hasItems }) => {
  ...
  /* harmony default export */ const inserter_menu_downloadable_blocks_panel =
    InserterMenuDownloadableBlocksPanel; // ./node_modules/@wordpress/block-directory/build-module/components/compact-list/index.js
  ...
  function CompactList({ items }) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      "ul",
      {
        ...
        children: items.map(({ icon, id, title, author }) =>
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
            "li",
            {
      ...
      external_wp_editor_namespaceObject.PluginPrePublishPanel,
      {
        ...
        children: [
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)("p", {
            ...
            children: (0, external_wp_i18n_namespaceObject._n)(
  ...
  /* harmony default export */ const get_install_missing = getInstallMissing; // ./node_modules/@wordpress/block-directory/build-module/plugins/index.js
