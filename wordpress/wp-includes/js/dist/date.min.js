...
(() => {
  var M = {
      ...
      5537: (M, z, b) => {
        (M.exports = b(3849)).tz.load(b(1681));
      },
      6154: (M) => {
        "use strict";
  ...
  ((b.n = (M) => {
    var z = M && M.__esModule ? () => M.default : () => M;
    return (b.d(z, { a: z }), z);
  }),
    (b.d = (M, z) => {
      for (var p in z)
    ...
    (b.o = (M, z) => Object.prototype.hasOwnProperty.call(M, z)),
    (b.r = (M) => {
  ...
  ((() => {
    ...
    function a() {
      const M = z().tz.zone(o.timezone.string);
      M
        ? z().tz.add(
            z().tz.pack({
              name: c,
    ...
    const n = {
      ...
      w: "d",
      z: (M) => (parseInt(M.format("DDD"), 10) - 1).toString(),
      W: "W",
      F: "MMMM",
      m: "MM",
      M: "MMM",
      ...
      r: (M) => M.locale("en").format("ddd, DD MMM YYYY HH:mm:ss ZZ"),
      U: "X",
    };
    function L(M, b = new Date()) {
      let p, O;
      const A = [],
        c = z()(b);
    ...
    function f(M, z = new Date(), b) {
      return L(M, r(z, b));
    }
    function B(M, b = new Date()) {
      return L(M, z()(b).utc());
    }
    function i(M, z = new Date(), b) {
      if (!0 === b) return X(M, z);
      !1 === b && (b = void 0);
      const p = r(z, b);
      return (p.locale(o.l10n.locale), L(M, p));
    }
    function X(M, b = new Date()) {
      const p = z()(b).utc();
      return (p.locale(o.l10n.locale), L(M, p));
    }
    function N(M) {
