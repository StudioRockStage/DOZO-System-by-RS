/******/ (() => {
  ...
  __webpack_require__.d(__webpack_exports__, {
    PluginBlockSettingsMenuItem: () =>
      /* reexport */ PluginBlockSettingsMenuItem,
    ...
    __experimentalFullscreenModeClose: () =>
      /* reexport */ fullscreen_mode_close,
    __experimentalMainDashboardButton: () =>
      /* binding */ __experimentalMainDashboardButton,
    __experimentalPluginPostExcerpt: () =>
      /* reexport */ __experimentalPluginPostExcerpt,
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // external ["wp","blockLibrary"]
  const external_wp_blockLibrary_namespaceObject = window["wp"]["blockLibrary"]; // external ["wp","deprecated"]
  const external_wp_deprecated_namespaceObject = window["wp"]["deprecated"];
  var external_wp_deprecated_default = /*#__PURE__*/ __webpack_require__.n(
    external_wp_deprecated_namespaceObject,
  ); // external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // external ["wp","preferences"]
  const external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // external ["wp","widgets"]
  const external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // external ["wp","editor"]
  const external_wp_editor_namespaceObject = window["wp"]["editor"]; // ./node_modules/clsx/dist/clsx.mjs
  function r(e) {
    var t,
      f,
      n = "";
  ...
  /* harmony default export */ const dist_clsx = clsx; // external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // external ["wp","plugins"]
  const external_wp_plugins_namespaceObject = window["wp"]["plugins"]; // external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/chevron-up.js
  /**
   * WordPress dependencies
   */

  const chevronUp = /*#__PURE__*/ (0,
  ...
  /* harmony default export */ const chevron_up = chevronUp; // ./node_modules/@wordpress/icons/build-module/library/chevron-down.js

  /**
   * WordPress dependencies
   */

  const chevronDown = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      viewBox: "0 0 24 24",
  ...
  /* harmony default export */ const chevron_down = chevronDown; // external ["wp","notices"]

  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // external ["wp","commands"]
  const external_wp_commands_namespaceObject = window["wp"]["commands"]; // external ["wp","coreCommands"]
  const external_wp_coreCommands_namespaceObject = window["wp"]["coreCommands"]; // external ["wp","url"]
  const external_wp_url_namespaceObject = window["wp"]["url"]; // external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // ./node_modules/@wordpress/icons/build-module/library/wordpress.js
  /**
   * WordPress dependencies
   */

  const wordpress = /*#__PURE__*/ (0,
  external_ReactJSXRuntime_namespaceObject.jsx)(
    external_wp_primitives_namespaceObject.SVG,
    {
      xmlns: "http://www.w3.org/2000/svg",
  ...
  /* harmony default export */ const library_wordpress = wordpress; // ./node_modules/@wordpress/edit-post/build-module/components/back-button/fullscreen-mode-close.js
  ...
  function FullscreenModeClose({ showTooltip, icon, href, initialPost }) {
    ...
    const { isRequestingSiteIcon, postType, siteIconUrl } = (0,
    ...
    const buttonLabel =
      (_postType$labels$view = postType?.labels?.view_items) !== null &&
      _postType$labels$view !== void 0
        ? _postType$labels$view
  ...
  /* harmony default export */ const fullscreen_mode_close =
    FullscreenModeClose; // external ["wp","privateApis"]

  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/edit-post/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
  ...
  const { BackButton: BackButtonFill } = unlock(
  ...
  /* harmony default export */ const back_button = BackButton; // ./node_modules/@wordpress/edit-post/build-module/store/constants.js
   ...
   * @type {string}
   */
  const VIEW_AS_PREVIEW_LINK_SELECTOR = "#wp-admin-bar-preview a"; // ./node_modules/@wordpress/edit-post/build-module/components/editor-initialization/listener-hooks.js
  ...
  const external_wp_keyboardShortcuts_namespaceObject =
    window["wp"]["keyboardShortcuts"]; // ./node_modules/@wordpress/edit-post/build-module/store/reducer.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // ./node_modules/@wordpress/edit-post/build-module/utils/meta-boxes.js
  /**
  ...
  const openModal =
    ...
    ({ registry }) => {
      external_wp_deprecated_default()(
        "select( 'core/edit-post' ).openModal( name )",
        {
          since: "6.3",
  ...
  const closeModal =
    ...
    ({ registry }) => {
      external_wp_deprecated_default()(
        "select( 'core/edit-post' ).closeModal()",
        {
          since: "6.3",
   ...
   * @return {Object} Action object.
   */
  const toggleEditorPanelEnabled =
    (panelName) =>
    ({ registry }) => {
      external_wp_deprecated_default()(
  ...
  const switchEditorMode =
    ...
    ({ registry }) => {
      external_wp_deprecated_default()(
        "dispatch( 'core/edit-post' ).switchEditorMode",
        {
          since: "6.6",
  ...
  const showBlockTypes =
    ...
    ({ registry }) => {
      unlock(
        registry.dispatch(external_wp_editor_namespaceObject.store),
  ...
  function setIsEditingTemplate() {
    external_wp_deprecated_default()(
      "dispatch( 'core/edit-post' ).setIsEditingTemplate",
      {
        since: "6.5",
  ...
  function __unstableCreateTemplate() {
    external_wp_deprecated_default()(
      "dispatch( 'core/edit-post' ).__unstableCreateTemplate",
      {
        since: "6.5",
      },
    );
  ...
  const toggleDistractionFree =
    ...
    ({ registry }) => {
      external_wp_deprecated_default()(
        "dispatch( 'core/edit-post' ).toggleDistractionFree",
        {
          since: "6.6",
  ...
  const { interfaceStore: selectors_interfaceStore } = unlock(
    external_wp_editor_namespaceObject.privateApis,
  );
  const EMPTY_ARRAY = [];
  const EMPTY_OBJECT = {};
  ...
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    ...
    ).get("core", "editorMode")) !== null && _select$get !== void 0
      ? _select$get
      : "visual";
  });
  ...
  function convertPanelsToOldFormat(inactivePanels, openPanels) {
    ...
    const panels = openPanels?.reduce(
      (accumulatedPanels, panelName) => {
  ...
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    ...
    return (_select$get2 = select(
      external_wp_preferences_namespaceObject.store,
    ).get("core", "hiddenBlockTypes")) !== null && _select$get2 !== void 0
      ? _select$get2
      : EMPTY_ARRAY;
  });
   ...
   */
  const isPublishSidebarOpened = (0,
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    external_wp_deprecated_default()(
  ...
  external_wp_data_namespaceObject.createRegistrySelector)(
    (select) => (state, panelName) => {
      ...
      return select(
        external_wp_editor_namespaceObject.store,
      ).isEditorPanelRemoved(panelName);
    },
  );
   ...
   */
  const isModalActive = (0,
  external_wp_data_namespaceObject.createRegistrySelector)(
    (select) => (state, modalName) => {
      external_wp_deprecated_default()(
        `select( 'core/edit-post' ).isModalActive`,
        {
          since: "6.3",
   ...
   */
  const getActiveMetaBoxLocations = (0,
   ...
   */
  const isMetaBoxLocationVisible = (0,
  external_wp_data_namespaceObject.createRegistrySelector)(
    (select) => (state, location) => {
      return (
        ...
        getMetaBoxesPerLocation(state, location)?.some(({ id }) => {
          return select(
            external_wp_editor_namespaceObject.store,
          ).isEditorPanelEnabled(`meta-box-${id}`);
        })
      );
    },
  );
   ...
   */
  const __experimentalGetPreviewDeviceType = (0,
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    external_wp_deprecated_default()(
   ...
   */
  const __experimentalGetInsertionPoint = (0,
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    external_wp_deprecated_default()(
   ...
   */
  const isListViewOpened = (0,
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    external_wp_deprecated_default()(
      `select( 'core/edit-post' ).isListViewOpened`,
      {
        since: "6.5",
  ...
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    ...
    return (
      select(external_wp_editor_namespaceObject.store).getCurrentPostType() ===
      "wp_template"
    );
  });
  ...
  external_wp_data_namespaceObject.createRegistrySelector)((select) => () => {
    const { id: postId, type: postType } = select(
      external_wp_editor_namespaceObject.store,
    ).getCurrentPost();
  ...
  (0, external_wp_data_namespaceObject.register)(store); // ./node_modules/@wordpress/edit-post/build-module/components/keyboard-shortcuts/index.js
  ...
  /* harmony default export */ const keyboard_shortcuts = KeyboardShortcuts; // ./node_modules/@wordpress/edit-post/build-module/components/init-pattern-modal/index.js
  ...
  function InitPatternModal() {
    ...
    external_wp_element_namespaceObject.useState)(undefined);
    const [title, setTitle] = (0, external_wp_element_namespaceObject.useState)(
      "",
    );
    const { postType, isNewPost } = (0,
    external_wp_data_namespaceObject.useSelect)((select) => {
      const { getEditedPostAttribute, isCleanNewPost } = select(
        external_wp_editor_namespaceObject.store,
      );
      return {
        ...
        children:
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            external_wp_components_namespaceObject.Modal,
            {
              ...
              children: /*#__PURE__*/ (0,
              external_ReactJSXRuntime_namespaceObject.jsx)("form", {
                onSubmit: (event) => {
                        ...
                        external_wp_components_namespaceObject.__experimentalHStack,
                        {
                          ...
                          external_ReactJSXRuntime_namespaceObject.jsx)(
                            external_wp_components_namespaceObject.Button,
                            {
                              ...
                              children: (0,
                              external_wp_i18n_namespaceObject.__)("Create"),
                            },
                          ),
                        },
                      ),
  ...
  /* harmony default export */ const browser_url = (0,
  ...
  })(BrowserURL); // ./node_modules/@wordpress/edit-post/build-module/components/meta-boxes/meta-boxes-area/index.js
  ...
  /* harmony default export */ const meta_boxes_area = MetaBoxesArea; // ./node_modules/@wordpress/edit-post/build-module/components/meta-boxes/meta-box-visibility.js
  ...
  const external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // ./node_modules/@wordpress/edit-post/build-module/components/more-menu/manage-patterns-menu-item.js
  /**
   * WordPress dependencies
   */
  ...
  function ManagePatternsMenuItem() {
    const url = (0, external_wp_data_namespaceObject.useSelect)((select) => {
      ...
      const defaultUrl = (0, external_wp_url_namespaceObject.addQueryArgs)(
        "edit.php",
        {
          post_type: "wp_block",
        },
      );
      const patternsUrl = (0, external_wp_url_namespaceObject.addQueryArgs)(
        "site-editor.php",
        {
          path: "/patterns",
        },
  ...
  /* harmony default export */ const manage_patterns_menu_item =
    ManagePatternsMenuItem; // ./node_modules/@wordpress/edit-post/build-module/components/more-menu/welcome-guide-menu-item.js
  ...
  const { PreferenceBaseOption } = unlock(
    external_wp_preferences_namespaceObject.privateApis,
  );
  function submitCustomFieldsForm() {
    ...
    customFieldsForm
      ...
      .setAttribute(
        "value",
        (0, external_wp_url_namespaceObject.getPathAndQueryString)(
        ...
        children: [
          ...
          /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            external_wp_components_namespaceObject.Button,
            {
              ...
              children: willEnable
                ? (0, external_wp_i18n_namespaceObject.__)("Show & Reload Page")
                : (0, external_wp_i18n_namespaceObject.__)(
                    "Hide & Reload Page",
                  ),
            },
  ...
  function EnableCustomFieldsOption({ label }) {
    const areCustomFieldsEnabled = (0,
    external_wp_data_namespaceObject.useSelect)((select) => {
      return !!select(
        external_wp_editor_namespaceObject.store,
  ...
  const { PreferenceBaseOption: enable_panel_PreferenceBaseOption } = unlock(
    external_wp_preferences_namespaceObject.privateApis,
  );
  function EnablePanelOption(props) {
    const { toggleEditorPanelEnabled } = (0,
    external_wp_data_namespaceObject.useDispatch)(
      external_wp_editor_namespaceObject.store,
    );
    const { isChecked, isRemoved } = (0,
  ...
  const { PreferencesModalSection } = unlock(
    external_wp_preferences_namespaceObject.privateApis,
  );
  ...
  /* harmony default export */ const meta_boxes_section = (0,
  external_wp_data_namespaceObject.withSelect)((select) => {
  ...
  })(MetaBoxesSection); // ./node_modules/@wordpress/edit-post/build-module/components/preferences-modal/index.js
  ...
  const { PreferenceToggleControl } = unlock(
    external_wp_preferences_namespaceObject.privateApis,
  );
  const { PreferencesModal } = unlock(
    external_wp_editor_namespaceObject.privateApis,
  );
  function EditPostPreferencesModal() {
    const extraSections = {
      general: /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
        meta_boxes_section,
        {
          title: (0, external_wp_i18n_namespaceObject.__)("Advanced"),
        },
      ),
      appearance: /*#__PURE__*/ (0,
      external_ReactJSXRuntime_namespaceObject.jsx)(PreferenceToggleControl, {
        scope: "core/edit-post",
  ...
  const { ToolsMoreMenuGroup, ViewMoreMenuGroup } = unlock(
    external_wp_editor_namespaceObject.privateApis,
  );
  const MoreMenu = () => {
  ...
  /* harmony default export */ const more_menu = MoreMenu; // ./node_modules/@wordpress/edit-post/build-module/components/welcome-guide/image.js
  ...
  function WelcomeGuideDefault() {
    const { toggleFeature } = (0, external_wp_data_namespaceObject.useDispatch)(
      store,
    );
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
  ...
  function WelcomeGuide({ postType }) {
    const { isActive, isEditingTemplate } = (0,
    external_wp_data_namespaceObject.useSelect)(
      (select) => {
  ...
  /* harmony default export */ const library_fullscreen = fullscreen; // ./node_modules/@wordpress/edit-post/build-module/commands/use-commands.js
  ...
  function useCommands() {
    const { isFullscreen } = (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
    ...
    (0, external_wp_commands_namespaceObject.useCommand)({
      ...
      label: isFullscreen
        ? (0, external_wp_i18n_namespaceObject.__)("Exit fullscreen")
        : (0, external_wp_i18n_namespaceObject.__)("Enter fullscreen"),
      ...
      callback: ({ close }) => {
        ...
        createInfoNotice(
          isFullscreen
            ? (0, external_wp_i18n_namespaceObject.__)("Fullscreen off.")
            : (0, external_wp_i18n_namespaceObject.__)("Fullscreen on."),
          {
            id: "core/edit-post/toggle-fullscreen-mode/notice",
            type: "snackbar",
            actions: [
    ...
    const effect = (0, external_wp_compose_namespaceObject.useRefEffect)(
      (node) => {
        function onMouseDown(event) {
          ...
          const { selectBlock, insertDefaultBlock } = registry.dispatch(
            external_wp_blockEditor_namespaceObject.store,
          );
          if (
            lastBlock &&
            (0, external_wp_blocks_namespaceObject.isUnmodifiedDefaultBlock)(
              lastBlock,
            )
          ) {
  ...
  function useShouldIframe() {
    return (0, external_wp_data_namespaceObject.useSelect)((select) => {
      const { getEditorSettings, getCurrentPostType, getDeviceType } = select(
        external_wp_editor_namespaceObject.store,
      );
      return (
  ...
  function useNavigateToEntityRecord(
    ...
    const { getRenderingMode } = (0,
    external_wp_data_namespaceObject.useSelect)(
      external_wp_editor_namespaceObject.store,
    );
    const { setRenderingMode } = (0,
    external_wp_data_namespaceObject.useDispatch)(
      external_wp_editor_namespaceObject.store,
    );
    const onNavigateToEntityRecord = (0,
    ...
    const onNavigateToPreviousEntityRecord = (0,
    external_wp_element_namespaceObject.useCallback)(() => {
      dispatch({
        type: "pop",
      });
  ...
  const useMetaBoxInitialization = (enabled) => {
    const isEnabledAndEditorReady = (0,
    external_wp_data_namespaceObject.useSelect)(
      (select) =>
        enabled &&
        select(
  ...
  const { getLayoutStyles } = unlock(
    external_wp_blockEditor_namespaceObject.privateApis,
  );
  const { useCommands: layout_useCommands } = unlock(
    external_wp_coreCommands_namespaceObject.privateApis,
  );
  const { useCommandContext } = unlock(
    external_wp_commands_namespaceObject.privateApis,
  );
  const { Editor, FullscreenMode, NavigableRegion } = unlock(
    external_wp_editor_namespaceObject.privateApis,
  );
  ...
  function useEditorStyles(...additionalStyles) {
    const { hasThemeStyleSupport, editorSettings } = (0,
    external_wp_data_namespaceObject.useSelect)((select) => {
      return {
    ...
    return (0, external_wp_element_namespaceObject.useMemo)(() => {
      var _editorSettings$style,
        _editorSettings$defau,
        _editorSettings$style2,
        _editorSettings$style3;
      const presetStyles =
        (_editorSettings$style = editorSettings.styles?.filter(
          (style) => style.__unstableType && style.__unstableType !== "theme",
        )) !== null && _editorSettings$style !== void 0
          ? _editorSettings$style
          : [];
      const defaultEditorStyles = [
        ...((_editorSettings$defau = editorSettings?.defaultEditorStyles) !==
          null && _editorSettings$defau !== void 0
          ? _editorSettings$defau
          : []),
        ...presetStyles,
      ];
      ...
      const hasThemeStyles =
        ...
        presetStyles.length !==
          ((_editorSettings$style2 = editorSettings.styles?.length) !== null &&
          _editorSettings$style2 !== void 0
            ? _editorSettings$style2
            : 0);
      ...
      const baseStyles = hasThemeStyles
        ? (_editorSettings$style3 = editorSettings.styles) !== null &&
          _editorSettings$style3 !== void 0
          ? _editorSettings$style3
          : []
        : defaultEditorStyles;
      if (addedStyles) {
  ...
  function MetaBoxesMain({ isLegacy }) {
    const [isOpen, openHeight, hasAnyVisible] = (0,
    external_wp_data_namespaceObject.useSelect)((select) => {
      const { get } = select(external_wp_preferences_namespaceObject.store);
    ...
    const isShort = (0, external_wp_compose_namespaceObject.useMediaQuery)(
      "(max-height: 549px)",
    );
    const [{ min, max }, setHeightConstraints] = (0,
    external_wp_element_namespaceObject.useState)(() => ({}));
    // Keeps the resizable area’s size constraints updated taking into account
    // editor notices. The constraints are also used to derive the value for the
    // aria-valuenow attribute on the separator.
    const effectSizeConstraints = (0,
    external_wp_compose_namespaceObject.useRefEffect)((node) => {
    ...
    const [isUntouched, setIsUntouched] = (0,
    external_wp_element_namespaceObject.useState)(true);
    ...
    if (isShort) {
      ...
      paneProps = /** @type {Parameters<typeof ResizableBox>[0]} */ {
        ...
        handleComponent: {
          top: /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsxs)(
            external_ReactJSXRuntime_namespaceObject.Fragment,
            {
              children: [
                /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
                  external_wp_components_namespaceObject.Tooltip,
                  {
                    ...
                    children: /*#__PURE__*/ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)("button", {
  ...
  function Layout({
    ...
    const {
      ...
      (select) => {
        ...
        const isViewable =
          (_getPostType$viewable = getPostType(currentPostType)?.viewable) !==
            null && _getPostType$viewable !== void 0
        ...
        const isDirectlyEditingPattern =
          currentPostType === "wp_block" && !onNavigateToPreviousEntityRecord;
        ...
        return {
          ...
          showMetaBoxes:
            (isNotDesignPostType && !isZoomOut()) || isDirectlyEditingPattern,
          ...
          case "move-to-trash":
            {
              ...
              external_wp_url_namespaceObject.addQueryArgs)("edit.php", {
                trashed: 1,
    ...
    const backButton =
      (0, external_wp_compose_namespaceObject.useViewportMatch)("medium") &&
      isFullscreenActive
        ? /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
            back_button,
            {
      ...
      external_wp_components_namespaceObject.SlotFillProvider,
      {
        ...
        external_ReactJSXRuntime_namespaceObject.jsxs)(
          external_wp_editor_namespaceObject.ErrorBoundary,
          {
            ...
            children: [
              /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
                external_wp_commands_namespaceObject.CommandMenu,
                {},
              ),
              /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
                WelcomeGuide,
              ...
              /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
                "div",
                {
                  ...
                  children: /*#__PURE__*/ (0,
                  external_ReactJSXRuntime_namespaceObject.jsxs)(Editor, {
                    ...
                    extraSidebarPanels:
                      showMetaBoxes &&
                      /*#__PURE__*/ (0,
                      external_ReactJSXRuntime_namespaceObject.jsx)(MetaBoxes, {
                        location: "side",
                      }),
                    extraContent:
                      !isDistractionFree &&
  ...
  /* harmony default export */ const layout = Layout; // ./node_modules/@wordpress/edit-post/build-module/deprecated.js
  ...
  const { PluginPostExcerpt } = unlock(
    external_wp_editor_namespaceObject.privateApis,
  );
  const isSiteEditor = (0, external_wp_url_namespaceObject.getPath)(
    window.location.href,
  )?.includes("site-editor.php");
  ...
  function PluginBlockSettingsMenuItem(props) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_editor_namespaceObject.PluginBlockSettingsMenuItem,
      {
        ...props,
      },
    );
  ...
  function PluginDocumentSettingPanel(props) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_editor_namespaceObject.PluginDocumentSettingPanel,
      {
        ...props,
      },
    );
  ...
  function PluginPostPublishPanel(props) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_editor_namespaceObject.PluginPostPublishPanel,
      {
        ...props,
      },
    );
  ...
  function PluginPostStatusInfo(props) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_editor_namespaceObject.PluginPostStatusInfo,
      {
        ...props,
      },
    );
  ...
  function PluginSidebar(props) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_editor_namespaceObject.PluginSidebar,
      {
        ...props,
      },
    );
  ...
  function PluginSidebarMoreMenuItem(props) {
    ...
    return /*#__PURE__*/ (0, external_ReactJSXRuntime_namespaceObject.jsx)(
      external_wp_editor_namespaceObject.PluginSidebarMoreMenuItem,
      {
        ...props,
      },
    );
