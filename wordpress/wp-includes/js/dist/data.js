/******/ (() => {
  ...
  var equivalent_key_map_default =
    /*#__PURE__*/ __webpack_require__.n(equivalent_key_map); // external ["wp","reduxRoutine"]
  const external_wp_reduxRoutine_namespaceObject = window["wp"]["reduxRoutine"];
  var external_wp_reduxRoutine_default = /*#__PURE__*/ __webpack_require__.n(
    external_wp_reduxRoutine_namespaceObject,
  ); // external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // ./node_modules/@wordpress/data/build-module/redux-store/combine-reducers.js
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/data/build-module/lock-unlock.js
  /**
  ...
  /* harmony default export */ const promise_middleware = promiseMiddleware; // ./node_modules/@wordpress/data/build-module/resolvers-cache-middleware.js
  ...
  /* harmony default export */ const resolvers_cache_middleware =
    createResolversCacheMiddleware; // ./node_modules/@wordpress/data/build-module/redux-store/thunk-middleware.js
  ...
  const subKeysIsResolved = onSubKey("selectorName")((
    state = new (equivalent_key_map_default())(),
    action,
  ) => {
    switch (action.type) {
  ...
  /* harmony default export */ const metadata_reducer = isResolved; // ./node_modules/rememo/rememo.js
    ...
    (state) => {
      ...
      Object.values(state).forEach((selectorState) =>
        ...
        Array.from(selectorState._map.values()).forEach((resolution) => {
          ...
          const currentStatus =
            (_resolution$1$status = resolution[1]?.status) !== null &&
  ...
  const mapValues = (obj, callback) =>
    Object.fromEntries(
      Object.entries(obj !== null && obj !== void 0 ? obj : {}).map(
  ...
  /* harmony default export */ const store = coreDataStore; // ./node_modules/@wordpress/data/build-module/utils/emitter.js
  ...
  /* harmony default export */ const default_registry = createRegistry(); // ./node_modules/is-plain-object/dist/is-plain-object.mjs
  ...
  var cjs_default = /*#__PURE__*/ __webpack_require__.n(cjs); // ./node_modules/@wordpress/data/build-module/plugins/persistence/storage/object.js
  let objectStorage;
  const storage = {
    getItem(key) {
  ...
  /* harmony default export */ const object = storage; // ./node_modules/@wordpress/data/build-module/plugins/persistence/storage/default.js
  ...
  /* harmony default export */ const storage_default = default_storage; // ./node_modules/@wordpress/data/build-module/plugins/persistence/index.js
  ...
  /* harmony default export */ const persistence = persistencePlugin; // ./node_modules/@wordpress/data/build-module/plugins/index.js
  // external ["wp","priorityQueue"]

  const external_wp_priorityQueue_namespaceObject =
    window["wp"]["priorityQueue"]; // external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","isShallowEqual"]
   ...
   * example.
   */
  /* harmony default export */ const context = Provider; // ./node_modules/@wordpress/data/build-module/components/registry-provider/use-registry.js
  ...
  /* harmony default export */ const async_mode_provider_context =
    context_Provider; // ./node_modules/@wordpress/data/build-module/components/async-mode-provider/use-async-mode.js
  ...
  function Store(registry, suspense) {
    ...
    function getStoreState(name) {
      ...
      return (_registry$stores$name =
        registry.stores[name]?.store?.getState?.()) !== null &&
        _registry$stores$name !== void 0
      ...
      function updateValue() {
        ...
        if (true) {
          if (!didWarnUnstableReference) {
            ...
            if (
              !external_wp_isShallowEqual_default()(mapResult, secondMapResult)
            ) {
  ...
  function useSelect(mapSelect, deps) {
    ...
    const staticSelectModeRef = (0, external_wp_element_namespaceObject.useRef)(
      staticSelectMode,
    );
  ...
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/data/build-module/components/with-select/index.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const with_select = withSelect; // ./node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch-with-map.js
  ...
  const useDispatchWithMap = (dispatchMap, deps) => {
    ...
    return (0, external_wp_element_namespaceObject.useMemo)(() => {
      ...
      return Object.fromEntries(
        Object.entries(currentDispatchProps).map(([propName, dispatcher]) => {
  ...
  /* harmony default export */ const use_dispatch_with_map = useDispatchWithMap; // ./node_modules/@wordpress/data/build-module/components/with-dispatch/index.js
  ...
  /* harmony default export */ const with_dispatch = withDispatch; // ./node_modules/@wordpress/data/build-module/components/with-registry/index.js
  ...
  /* harmony default export */ const with_registry = withRegistry; // ./node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch.js
  ...
  /* harmony default export */ const use_dispatch = useDispatch; // ./node_modules/@wordpress/data/build-module/dispatch.js
