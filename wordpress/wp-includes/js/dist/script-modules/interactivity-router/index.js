...
const interactivity_namespaceObject = x({
  ["getConfig"]: () =>
    __WEBPACK_EXTERNAL_MODULE__wordpress_interactivity_8e89b257__.getConfig,
  ["privateApis"]: () =>
    __WEBPACK_EXTERNAL_MODULE__wordpress_interactivity_8e89b257__.privateApis,
  ["store"]: () =>
...
const navigationMode =
  (_getConfig$navigation = (0, interactivity_namespaceObject.getConfig)(
    "core/router",
  ).navigationMode) !== null && _getConfig$navigation !== void 0
    ? _getConfig$navigation
    : "regionBased";
  ...
  "core/router",
  {
    ...
    actions: {
      ...
      *navigate(href, options = {}) {
        const { clientNavigationDisabled } = (0,
        interactivity_namespaceObject.getConfig)();
        ...
        if (
          page &&
          !page.initialData?.config?.["core/router"]?.clientNavigationDisabled
        ) {
...
function a11ySpeak(messageKey) {
  ...
  Promise.resolve(/* import() */)
    .then(__webpack_require__.bind(__webpack_require__, 317))
    .then(
      ({ speak }) => speak(message),
...
export {
  ...
  __webpack_exports__state as state,
};
