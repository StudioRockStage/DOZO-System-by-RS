/******/ var __webpack_modules__ = {
  /***/ 380: /***/ (
    ...
    var preact_module = __webpack_require__(622); // ./node_modules/preact/hooks/dist/hooks.module.js
    var hooks_module_t,
      r,
      hooks_module_u,
      i,
      hooks_module_o = 0,
      hooks_module_f = [],
      hooks_module_c = preact_module /* options */.fF,
      e = hooks_module_c.__b,
      a = hooks_module_c.__r,
      v = hooks_module_c.diffed,
      l = hooks_module_c.__c,
      m = hooks_module_c.unmount,
      s = hooks_module_c.__;
    function p(n, t) {
      (hooks_module_c.__h && hooks_module_c.__h(r, n, hooks_module_o || t),
        (hooks_module_o = 0));
    ...
    function y(n, u) {
      ...
      !hooks_module_c.__s &&
        C(i.__H, u) &&
        ((i.__ = n), (i.u = u), r.__H.__h.push(i));
    }
    function _(n, u) {
      var i = p(hooks_module_t++, 4);
      !hooks_module_c.__s &&
        C(i.__H, u) &&
        ((i.__ = n), (i.u = u), r.__h.push(i));
    }
    function A(n) {
      return (
        (hooks_module_o = 5),
    ...
    function P(n, t) {
      hooks_module_c.useDebugValue &&
        hooks_module_c.useDebugValue(t ? t(n) : n);
    }
    function b(n) {
    ...
    function j() {
      for (var n; (n = hooks_module_f.shift()); )
        if (n.__P && n.__H)
          try {
    ...
    ((hooks_module_c.__b = function (n) {
      ...
      (hooks_module_c.diffed = function (n) {
        ...
        (t &&
          t.__H &&
          (t.__H.__h.length &&
            ((1 !== hooks_module_f.push(t) &&
              i === hooks_module_c.requestAnimationFrame) ||
              ((i = hooks_module_c.requestAnimationFrame) || w)(j)),
          t.__H.__.forEach(function (n) {
            (n.u && (n.__H = n.u), (n.u = void 0));
          })),
          (hooks_module_u = r = null));
      }),
    ...
    var signals_core_module_i = Symbol.for("preact-signals");
    function signals_core_module_t() {
      if (!(signals_core_module_s > 1)) {
        var i,
          t = !1;
        while (void 0 !== signals_core_module_h) {
          var r = signals_core_module_h;
          signals_core_module_h = void 0;
          signals_core_module_f++;
          while (void 0 !== r) {
            var o = r.o;
            r.o = void 0;
            r.f &= -3;
            if (!(8 & r.f) && signals_core_module_c(r))
              try {
                r.c();
              } catch (r) {
                if (!t) {
    ...
    function signals_core_module_r(i) {
    ...
    var signals_core_module_h = void 0,
    ...
    signals_core_module_u.prototype.brand = signals_core_module_i;
    signals_core_module_u.prototype.h = function () {
      return !0;
    };
    signals_core_module_u.prototype.S = function (i) {
    ...
    signals_core_module_u.prototype.U = function (i) {
      if (void 0 !== this.t) {
        var t = i.e,
          r = i.x;
        if (void 0 !== t) {
    ...
    signals_core_module_u.prototype.subscribe = function (i) {
      var t = this;
      return E(function () {
        var r = t.value,
          n = signals_core_module_o;
        signals_core_module_o = void 0;
        try {
          i(r);
        } finally {
    ...
    signals_core_module_u.prototype.valueOf = function () {
      return this.value;
    };
    signals_core_module_u.prototype.toString = function () {
      return this.value + "";
    };
    signals_core_module_u.prototype.toJSON = function () {
      return this.value;
    };
    signals_core_module_u.prototype.peek = function () {
    ...
    Object.defineProperty(signals_core_module_u.prototype, "value", {
      get: function () {
        var i = signals_core_module_e(this);
        if (void 0 !== i) i.i = this.i;
        return this.v;
      },
      set: function (i) {
        if (i !== this.v) {
          if (signals_core_module_f > 100) throw new Error("Cycle detected");
          this.v = i;
          this.i++;
    ...
    function signals_core_module_d(i) {
      return new signals_core_module_u(i);
    }
    ...
    function signals_core_module_y(i) {
      signals_core_module_u.call(this, void 0);
      this.x = i;
      this.s = void 0;
      this.g = signals_core_module_v - 1;
      this.f = 4;
    }
    (signals_core_module_y.prototype = new signals_core_module_u()).h =
      function () {
        this.f &= -3;
        if (1 & this.f) return !1;
        if (32 == (36 & this.f)) return !0;
        this.f &= -5;
        if (this.g === signals_core_module_v) return !0;
        this.g = signals_core_module_v;
        this.f |= 1;
        ...
        signals_core_module_o = i;
        signals_core_module_l(this);
        this.f &= -2;
        return !0;
      };
    signals_core_module_y.prototype.S = function (i) {
      if (void 0 === this.t) {
        this.f |= 36;
        for (var t = this.s; void 0 !== t; t = t.n) t.S.S(t);
      }
      signals_core_module_u.prototype.S.call(this, i);
    };
    signals_core_module_y.prototype.U = function (i) {
      if (void 0 !== this.t) {
        signals_core_module_u.prototype.U.call(this, i);
        if (void 0 === this.t) {
          this.f &= -33;
    ...
    signals_core_module_y.prototype.N = function () {
      if (!(2 & this.f)) {
        this.f |= 6;
        for (var i = this.t; void 0 !== i; i = i.x) i.t.N();
      }
    };
    Object.defineProperty(signals_core_module_y.prototype, "value", {
      get: function () {
    ...
    function signals_core_module_w(i) {
      return new signals_core_module_y(i);
    }
    ...
    function signals_core_module_p(i) {
      if (signals_core_module_o !== this)
        throw new Error("Out-of-order effect");
      signals_core_module_l(this);
      signals_core_module_o = i;
      this.f &= -2;
      if (8 & this.f) signals_core_module_g(this);
      signals_core_module_t();
    }
    ...
    signals_core_module_b.prototype.S = function () {
      ...
      this.f |= 1;
      this.f &= -9;
      signals_core_module_(this);
      signals_core_module_a(this);
      signals_core_module_s++;
      var i = signals_core_module_o;
      signals_core_module_o = this;
      return signals_core_module_p.bind(this, i);
    };
    signals_core_module_b.prototype.N = function () {
      if (!(2 & this.f)) {
        this.f |= 2;
        this.o = signals_core_module_h;
        signals_core_module_h = this;
      }
    };
    signals_core_module_b.prototype.d = function () {
      this.f |= 8;
      if (!(1 & this.f)) signals_core_module_g(this);
    };
    function E(i) {
    ...
    function signals_module_l(i, n) {
      preact_module /* options */.fF[i] = n.bind(
        null,
        preact_module /* options */.fF[i] || function () {},
      );
    }
    function signals_module_d(i) {
      if (signals_module_s) signals_module_s();
      signals_module_s = i && i.S();
    }
    function signals_module_h(i) {
      var r = this,
        f = i.data,
        o = useSignal(f);
      o.value = f;
      var e = T(function () {
        ...
        r.__$u.c = function () {
          ...
          t();
          if (
            (0, preact_module /* isValidElement */.zO)(f) ||
            3 !== (null == (i = r.base) ? void 0 : i.nodeType)
          ) {
            r.__$f |= 1;
            r.setState({});
          } else r.base.data = f;
    ...
    signals_module_h.displayName = "_st";
    Object.defineProperties(signals_core_module_u.prototype, {
      constructor: { configurable: !0, value: void 0 },
      type: { configurable: !0, value: signals_module_h },
      props: {
        configurable: !0,
        get: function () {
          return { data: this };
    ...
    signals_module_l("__b", function (i, r) {
      if ("string" == typeof r.type) {
        ...
        for (var f in t)
          if ("children" !== f) {
            var o = t[f];
            if (o instanceof signals_core_module_u) {
              if (!n) r.__np = n = {};
              n[f] = o;
              t[f] = o.peek();
            }
    ...
    signals_module_l("__r", function (i, r) {
      signals_module_d();
      var n,
        t = r.__c;
      if (t) {
    ...
    signals_module_l("__e", function (i, r, n, t) {
      signals_module_d();
      signals_module_v = void 0;
      i(r, n, t);
    });
    signals_module_l("diffed", function (i, r) {
      signals_module_d();
      signals_module_v = void 0;
      var n;
    ...
    function signals_module_p(i, r, n, t) {
      var f = r in i && void 0 === i.ownerSVGElement,
        o = signals_core_module_d(n);
      return {
        o: function (i, r) {
          o.value = i;
          t = r;
    ...
    signals_module_l("unmount", function (i, r) {
      if ("string" == typeof r.type) {
        var n = r.__e;
        if (n) {
          var t = n.U;
    ...
    signals_module_l("__h", function (i, r, n, t) {
      if (t < 3 || 9 === t) r.__$f |= 2;
      i(r, n, t);
    });
    preact_module /* Component */.uA.prototype.shouldComponentUpdate =
      function (i, r) {
        ...
        for (var o in i)
          if ("__source" !== o && i[o] !== this.props[o]) return !0;
        for (var e in this.props) if (!(e in i)) return !0;
        return !1;
      };
    function useSignal(i) {
      return T(function () {
        return signals_core_module_d(i);
      }, []);
    }
     ...
     */
    const getObjectFromProxy = (proxy) => proxyToObj.get(proxy); // ./node_modules/@wordpress/interactivity/build-module/proxies/signals.js
    ...
    const deepMergeRecursive = (target, source, override = true) => {
      ...
      for (const key in source) {
        ...
        const propSignal =
          !!proxy && hasPropSignal(proxy, key) && getPropSignal(proxy, key);
    ...
    function store(
      ...
      if (!stores.has(namespace)) {
        ...
        if (lock !== universalUnlock && !storeLocks.has(namespace)) {
          ...
          const isLockValid =
            lock === universalUnlock || (lock !== true && lock === storeLock);
          if (!isLockValid) {
            if (!storeLock) {
    ...
    const parseServerData = (dom = document) => {
      ...
      const jsonDataScriptTag = // Preferred Script Module data passing form
        (_dom$getElementById = dom.getElementById(
          "wp-script-module-data-@wordpress/interactivity",
        )) !== null && _dom$getElementById !== void 0
          ? _dom$getElementById
          : // Legacy form
    ...
    populateServerData(data); // ./node_modules/@wordpress/interactivity/build-module/hooks.js
    ...
    function deepClone(source) {
      if (isPlainObject(source)) {
        return Object.fromEntries(
          Object.entries(source).map(([key, value]) => [key, deepClone(value)]),
        );
      }
    ...
    const directivePrefix = "wp"; // ./node_modules/@wordpress/interactivity/build-module/vdom.js
    ...
    const currentNamespace = () => {
      var _namespaces;
      return (_namespaces = namespaces[namespaces.length - 1]) !== null &&
        _namespaces !== void 0
        ? _namespaces
        : null;
    };
    ...
    function toVdom(root) {
      ...
      function walk(node) {
        ...
        if (nodeType === 4) {
          ...
          node.replaceWith(
            new window.Text(
              (_nodeValue = node.nodeValue) !== null && _nodeValue !== void 0
                ? _nodeValue
                : "",
            ),
          );
        ...
        for (let i = 0; i < attributes.length; i++) {
          ...
          if (
            ...
            if (attributeName === ignoreAttr) {
              ...
              const namespace =
                (_regexResult$ = regexResult?.[1]) !== null &&
                _regexResult$ !== void 0
                  ? _regexResult$
                  : null;
              let value =
                (_regexResult$2 = regexResult?.[2]) !== null &&
                _regexResult$2 !== void 0
                  ? _regexResult$2
                  : attributeValue;
              try {
        ...
        if (localName === "template") {
          props.content = [...elementNode.content.childNodes].map((childNode) =>
            toVdom(childNode),
          );
        } else {
  ...
  /***/ 622: /***/ (
    ...
    function _(l, t, u) {
      var i,
        ...
        e = {};
      for (o in t)
        "key" == o ? (i = t[o]) : "ref" == o ? (r = t[o]) : (e[o] = t[o]);
      if (
        (arguments.length > 2 &&
    ...
    function $() {
      for (var n, t, u, r, o, f, c, s = 1; i.length; )
        (i.length > s && i.sort(e),
          (n = i.shift()),
          (s = i.length),
          n.__d &&
    ...
    function I(n, l, t, u, i, r, o, e, f, c, s) {
      ...
      for (f = P(t, l, _, f, m), a = 0; a < m; a++)
        null != (y = t.__k[a]) &&
          ...
          y.ref &&
            h.ref != y.ref &&
            (h.ref && q(h.ref, null, y), s.push(y.ref, y.__c || d, y)),
          null == w && null != d && (w = d),
          4 & y.__u || h.__k === y.__k
            ? (f = A(y, f, n))
    ...
    function A(n, l, t) {
      ...
      if ("function" == typeof n.type) {
        for (u = n.__k, i = 0; u && i < u.length; i++)
          u[i] && ((u[i].__ = n), (l = A(u[i], l, t)));
        return l;
      }
      n.__e != l &&
        (l && n.type && !t.contains(l) && (l = S(n)),
    ...
    function O(n, t, u, i, r, o, e, f, c, s) {
      ...
      n: if ("function" == typeof j)
        try {
          if (
            ...
            S &&
              ...
              w(h.__s, j.getDerivedStateFromProps(b, h.__s))),
            (v = h.props),
            (y = h.state),
            (h.__v = t),
            p)
          ...
          ((h.state = h.__s),
            ...
            (f = I(n, d(L) ? L : [L], t, u, i, r, o, e, f, c, s)),
            (h.base = t.__e),
            (t.__u &= -161),
        ...
        null == o && t.__v == u.__v
          ...
          : (f = t.__e = V(u.__e, t, u, i, r, o, e, c, s));
    ...
    function V(t, u, i, r, o, e, f, c, s) {
      ...
      if (null == t) {
        ...
        ((t = document.createElementNS(o, x, k.is && k)),
      ...
      if (null === x) b === k || (c && t.data === k) || (t.data = k);
        ...
        if (
          ((e = e && n.call(t.childNodes)), (b = i.props || p), !c && null != e)
        )
          for (b = {}, a = 0; a < t.attributes.length; a++)
            b[(w = t.attributes[a]).name] = w.value;
        for (a in b)
          if (((w = b[a]), "children" == a));
    ...
    function B(n, t, u) {
      ...
      if (
        ...
        (i = n.ref) && ((i.current && i.current !== n.__e) || q(i, null, t)),
        null != (i = n.__c))
      ) {
      ...
      if ((i = n.__k))
        for (r = 0; r < i.length; r++)
          i[r] && B(i[r], t, u || "function" != typeof n.type);
    ...
    function E(t, u, i) {
      ...
      (u == document && (u = document.documentElement),
        l.__ && l.__(t, u),
        (o = (r = "function" == typeof i) ? null : (i && i.__k) || u.__k),
        (e = []),
        (f = []),
        O(
          u,
          (t = ((!r && i) || u).__k = _(k, null, [t])),
          o || p,
          p,
          u.namespaceURI,
          !r && i ? [i] : o ? null : u.firstChild ? n.call(u.childNodes) : null,
          e,
          !r && i ? i : o ? o.__e : u.firstChild,
          r,
          f,
        ),
        z(e, t, f));
              ...
              try {
                if (
                  ...
                  null != i.componentDidCatch &&
                    (i.componentDidCatch(n, u || {}), (o = i.__d)),
                  o)
                )
                  return (i.__E = i);
              } catch (l) {
...
// EXTERNAL MODULE: ./node_modules/preact/dist/preact.module.js
var debug_preact_module = __webpack_require__(622); // ./node_modules/preact/devtools/dist/devtools.module.js
var debug_i;
function debug_t(o, e) {
  ...
  (debug_i =
    "undefined" != typeof globalThis
      ...
      : "undefined" != typeof window
        ? window
        : void 0) &&
  debug_i.__PREACT_DEVTOOLS__ &&
  debug_i.__PREACT_DEVTOOLS__.attachPreact(
    "10.26.4",
    debug_preact_module /* options */.fF,
    {
      Fragment: debug_preact_module /* Fragment */.FK,
      Component: debug_preact_module /* Component */.uA,
    },
  ); // ./node_modules/preact/debug/dist/debug.module.js

var debug_debug_module_t = {};
function debug_r() {
  debug_debug_module_t = {};
}
function debug_a(e) {
  return e.type === debug_preact_module /* Fragment */.FK
    ? "Fragment"
...
var debug_debug_module_i = [],
  debug_s = [];
function debug_c() {
  return debug_debug_module_i.length > 0
    ? debug_debug_module_i[debug_debug_module_i.length - 1]
    : null;
}
var debug_l = !0;
function debug_u(e) {
  return (
    "function" == typeof e.type &&
    e.type != debug_preact_module /* Fragment */.FK
  );
}
function debug_f(n) {
...
var debug_d = "function" == typeof WeakMap;
function debug_p(n) {
  var e = [];
  return n.__k
    ? (n.__k.forEach(function (n) {
        n && "function" == typeof n.type
          ? e.push.apply(e, debug_p(n))
...
var debug_v = debug_preact_module /* Component */.uA.prototype.setState;
function debug_y(n) {
  return (
    "table" === n ||
    "tfoot" === n ||
...
debug_preact_module /* Component */.uA.prototype.setState = function (n, e) {
  return (
    null == this.__v &&
      null == this.state &&
      console.warn(
...
var debug_m =
  ...
  debug_b = debug_preact_module /* Component */.uA.prototype.forceUpdate;
function debug_w(n) {
  var e = n.props,
    o = debug_a(n),
    t = "";
...
((debug_preact_module /* Component */.uA.prototype.forceUpdate = function (n) {
  return (
    null == this.__v
      ? console.warn(
  ...
  (debug_preact_module /* options */.fF.__m = function (n, e) {
    var o = n.type,
      t = e
        .map(function (n) {
  ...
  (function () {
    !(function () {
      var n = debug_preact_module /* options */.fF.__b,
        o = debug_preact_module /* options */.fF.diffed,
        t = debug_preact_module /* options */.fF.__,
        r = debug_preact_module /* options */.fF.vnode,
        a = debug_preact_module /* options */.fF.__r;
      ((debug_preact_module /* options */.fF.diffed = function (n) {
        (debug_u(n) && debug_s.pop(), debug_debug_module_i.pop(), o && o(n));
      }),
        (debug_preact_module /* options */.fF.__b = function (e) {
          (debug_u(e) && debug_debug_module_i.push(e), n && n(e));
        }),
        (debug_preact_module /* options */.fF.__ = function (n, e) {
          ((debug_s = []), t && t(n, e));
        }),
        (debug_preact_module /* options */.fF.vnode = function (n) {
          ((n.__o = debug_s.length > 0 ? debug_s[debug_s.length - 1] : null),
            r && r(n));
        }),
        (debug_preact_module /* options */.fF.__r = function (n) {
          (debug_u(n) && debug_s.push(n), a && a(n));
        }));
    })();
    var n = !1,
      o = debug_preact_module /* options */.fF.__b,
      r = debug_preact_module /* options */.fF.diffed,
      c = debug_preact_module /* options */.fF.vnode,
      l = debug_preact_module /* options */.fF.__r,
      v = debug_preact_module /* options */.fF.__e,
      b = debug_preact_module /* options */.fF.__,
      g = debug_preact_module /* options */.fF.__h,
      E = debug_d
        ? {
        ...
        : null,
      k = [];
    ((debug_preact_module /* options */.fF.__e = function (n, e, o, t) {
      if (e && e.__c && "function" == typeof n.then) {
        var r = n;
        n = new Error(
          "Missing Suspense. The throwing component was: " + debug_a(e),
        );
          ...
          if (
            ...
            try {
              ...
              (E.lazyPropTypes.set(e.type, !0),
                console.warn(
                  s + "Component wrapped in lazy() is " + debug_a(c),
                ));
            } catch (n) {
              console.warn(
                s +
          ...
          (e.type.__f &&
            ...
            (function (n, e, o, r, a) {
              Object.keys(n).forEach(function (o) {
                ...
                i &&
                  !(i.message in debug_debug_module_t) &&
                  ((debug_debug_module_t[i.message] = !0),
                  console.error(
                    "Failed prop type: " +
                      i.message +
                      ((a && "\n" + a()) || ""),
            ...
            })(e.type.propTypes, l, 0, debug_a(e), function () {
              return debug_f(e);
            }));
        }
        o && o(e);
    ...
    var T,
      _ = 0;
    ((debug_preact_module /* options */.fF.__r = function (e) {
      (l && l(e), (n = !0));
      var o = e.__c;
      if ((o === T ? _++ : (_ = 1), _ >= 25))
        throw new Error(
      ...
      (debug_preact_module /* options */.fF.__h = function (e, o, t) {
        if (!e || !n)
    ...
    ((debug_preact_module /* options */.fF.vnode = function (n) {
      ...
      (debug_preact_module /* options */.fF.diffed = function (e) {
        var o,
          t = e.type,
          i = e.__;
        if (
          ...
          e.__c === T && (_ = 0),
          "string" == typeof t &&
            (debug_y(t) || "p" === t || "a" === t || "button" === t))
        ) {
          var s = debug_h(i);
          if ("" !== s && debug_y(t))
            "table" === t && "td" !== s && debug_y(s)
              ? console.error(
            ...
            var c = debug_p(e).filter(function (n) {
              return debug_m.test(n);
            });
            c.length &&
              console.error(
...
var debug_build_module = __webpack_require__(380); // ./node_modules/@wordpress/interactivity/build-module/debug.js
/**
 * External dependencies
 */
...
export {
  ...
  __webpack_exports__getContext as getContext,
  __webpack_exports__getElement as getElement,
  __webpack_exports__getServerContext as getServerContext,
  __webpack_exports__getServerState as getServerState,
  __webpack_exports__privateApis as privateApis,
  __webpack_exports__splitTask as splitTask,
  __webpack_exports__store as store,
  __webpack_exports__useCallback as useCallback,
  __webpack_exports__useEffect as useEffect,
  __webpack_exports__useInit as useInit,
  ...
  __webpack_exports__useWatch as useWatch,
  __webpack_exports__withScope as withScope,
  __webpack_exports__withSyncEvent as withSyncEvent,
};
