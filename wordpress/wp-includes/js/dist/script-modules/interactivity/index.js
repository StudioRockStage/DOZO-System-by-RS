...
function _(n, u) {
  ...
  !hooks_module_c.__s && C(i.__H, u) && ((i.__ = n), (i.u = u), r.__h.push(i));
}
function A(n) {
  return (
    (hooks_module_o = 5),
...
preact_module /* Component */.uA.prototype.shouldComponentUpdate = function (
  i,
  r,
) {
  var n = this.__$u,
...
const deepMerge = (target, source, override = true) =>
  signals_core_module_r(() =>
    deepMergeRecursive(getObjectFromProxy(target) || target, source, override),
