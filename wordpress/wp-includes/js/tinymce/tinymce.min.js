...
!(function (V) {
  ...
  var ea,
    ...
    Sa = function (e) {
      return (
        Ea(e) && (e = e.parentNode),
        Na(e) && e.hasAttribute("data-mce-caret")
      );
    },
    Ta = function (e) {
          ...
          (r = Ht.reduce(
            ...
            ? Au(r)
              ? (function (e, t) {
                  ...
                  return (
                    Au(e) && t > e.data.length && (t = e.data.length),
                    _u(e, t)
                  );
                })(r, parseInt(o, 10))
  ...
  var ul,
    ...
    gf = function (e, t, n) {
      return (
        mf(!0, t),
        mf(!1, n),
        df(t, n).fold(d(ff, e, t, n), d(lf, e, t, n))
      );
    },
    pf = function (e, t, n, r) {
            ...
            ((r = !1),
              ...
              g.on("AfterSetSelectionRange", function (e) {
                var t,
                  n = e.range;
                (b(n) ||
                  "mcepastebin" === n.startContainer.parentNode.id ||
                  C(),
  ...
  Jw(
    (tN.prototype = {
      ...
      getElement: function () {
        return (
          this.targetElm || (this.targetElm = Gw.get(this.id)),
          this.targetElm
        );
      },
      getWin: function () {
