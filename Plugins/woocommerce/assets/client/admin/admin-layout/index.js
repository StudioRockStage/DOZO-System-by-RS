(() => {
  ...
  const o = window.wp.components,
    ...
    a = ({ children: e, order: t = 1 }) =>
      (0, r.createElement)(o.Fill, { name: l }, (o) =>
        (0, n.createOrderedChildren)(e, t, o),
      );
  a.Slot = ({ fillProps: e }) =>
  ...
  const _ = (0, r.createContext)(void 0),
    ...
    w = ({ children: e, value: t }) =>
      (0, r.createElement)(_.Provider, { value: t }, e),
    p = () => {
