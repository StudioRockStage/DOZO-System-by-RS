  ...
  var e = {
          ...
          for (var y = 1, s = !0; y < r.length; y += 1) {
            ...
            if (
              ...
              if (l && y + 1 >= r.length) {
                var h = l(u, d);
                u =
                  (s = !!h) && "get" in h && !("originalValue" in h.get)
                    ? h.get
                    : u[d];
              } else ((s = S(u, d)), (u = u[d]));
              s && !p && (b[c] = u);
      ...
      83282: (e, t, r) => {
        ...
        e.exports = function e(t, o, n, c) {
          ...
          if (
            (void 0 === n && (n = 0), n >= E && E > 0 && "object" == typeof t)
          )
        ...
        function X(e, t) {
          ...
          if ("function" == typeof E)
            for (var u = 0; u < i.length; u++)
              Y.call(e, i[u]) && o.push("[" + t(i[u]) + "]: " + t(e[i[u]], e));
          return o;
        }
      },
      24294: (e) => {
        ...
        var o = r(50323),
          ...
          u = function (e, t, r, o) {
            if (e) {
              ...
              for (
                var f = 0;
                r.depth > 0 && null !== (c = i.exec(a)) && f < r.depth;
      ...
      61007: (e, t, r) => {
        ...
        var o = r(2435),
          ...
          m = function e(t, r, a, i, c, u, f, y, m, b, g, h, v, w, S, j) {
            ...
            for (
              var Y = i && l(O) && 1 === O.length ? r + "[]" : r, D = 0;
              D < k.length;
              ++D
            ) {
              var I = k[D],
                R = "object" == typeof I && void 0 !== I.value ? I.value : O[I];
              if (!u || null !== R) {
                var T = l(O)
                  ? "function" == typeof a
                    ? a(Y, I)
        ...
        e.exports = {
          ...
          compact: function (e) {
            for (
              ...
              for (
                var n = t[o], i = n.obj[n.prop], c = Object.keys(i), l = 0;
                l < c.length;
                ++l
              ) {
                var u = c[l],
  ...
  ((() => {
    ...
    (r.r(o),
      r.d(o, {
        ...
        getDateFormatsForIntervalPhp: () => Y,
    ...
    const c = "YYYY-MM-DD",
      ...
      u = [
        ...
        {
          value: "quarter",
          label: (0, a.__)("Quarter to date", "woocommerce"),
        },
        {
          value: "last_quarter",
          label: (0, a.__)("Last quarter", "woocommerce"),
        },
      ...
      p = [
        {
          ...
          label: (0, a.__)("Previous period", "woocommerce"),
        },
        {
          value: "previous_year",
          label: (0, a.__)("Previous year", "woocommerce"),
        },
      ],
      f = (e) => t()(e).isValid(),
      y = (e, t) => {
    ...
    function b(e, r) {
      const o = m().startOf(e).subtract(1, e),
        n = o.clone().endOf(e);
      let a, i;
      if ("previous_period" === r)
        if ("year" === e)
          ((a = t()().startOf(e).subtract(2, e)), (i = a.clone().endOf(e)));
        else {
          const e = n.diff(o, "days");
          ((i = o.clone().subtract(1, "days")),
            (a = i.clone().subtract(e, "days")));
        }
      else
        "week" === e
          ? ((a = o.clone().subtract(1, "years")),
            (i = n.clone().subtract(1, "years")))
        ...
        (e, r, o, n, a) => {
          ...
          return (
            "string" != typeof c.period &&
              (console.warn(`Unexpected default period type ${c.period}`),
              (c.period = "")),
            "string" != typeof c.compare &&
              (console.warn(`Unexpected default compare type ${c.compare}`),
              (c.compare = "")),
            {
              period: c.period,
              compare: c.compare,
    ...
    function Y(e, t = 0) {
      ...
      switch (e) {
        ...
        case "week":
          ...
          const e = (0, a.__)("Week of", "woocommerce").replace(
            /(\w)/g,
            "\\$1",
          );
          ((r = `${e} F j, Y`), (o = `${e} F j, Y`));
    ...
    function D(e, t = 0, r = { type: "d3" }) {
      return "php" === r.type ? Y(e, t) : M(e, t);
    }
    function I({ userLocale: e, weekdaysShort: r }) {
      "en" !== t().locale() &&
        t().updateLocale(e, {
          longDateFormat: {
    ...
    const R = {
      ...
      startAfterEnd: (0, a.__)(
        "Start date must be before end date",
        "woocommerce",
      ),
      endBeforeStart: (0, a.__)(
        "Start date must be before end date",
        "woocommerce",
      ),
    };
    ...
    function L(e, t) {
      ...
      if (!isNaN(r) && !isNaN(o))
        for (let e = r; e <= o; e++) if (N(e)) return !0;
      return !1;
    }
  })(),
