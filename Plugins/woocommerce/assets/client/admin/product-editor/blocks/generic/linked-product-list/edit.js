...
const element_1 = require("@wordpress/element"),
  ...
  use_product_entity_prop_1 = __importDefault(
    require("../../../hooks/use-product-entity-prop"),
  ),
...
async function getProductsBySearchValue(e = "", t = []) {
...
function LinkedProductListBlockEdit({
  ...
  const { property: o, emptyState: c } = e,
    s = (0, element_1.useRef)(!1),
    [, n] = (0, element_1.useState)(""),
    [d, i] = (0, element_1.useState)([]),
    [_, u] = (0, element_1.useState)(!1),
    l = (0, block_templates_1.useWooBlockProps)(e),
    [a, p] = (0, element_1.useReducer)(reducer_1.reducer, {
      linkedProducts: [],
    }),
    m = (0, core_data_1.useEntityId)("postType", t),
    k = (0, reducer_1.getLoadLinkedProductsDispatcher)(p),
    g = (0, reducer_1.getSelectSearchedProductDispatcher)(p),
    f = (0, reducer_1.getRemoveLinkedProductDispatcher)(p),
    [E, S] = (0, use_product_entity_prop_1.default)(o, { postType: t });
  function h(e = "", t = []) {
    return (
      n(e),
      u(!0),
      getProductsBySearchValue(e, t)
        .then((e) => {
          i(e);
        })
        .finally(() => {
  ...
  (0, element_1.useEffect)(() => {
    !a.selectedProduct && E && E.length > 0 && k(E);
  }, [E, a.selectedProduct]);
  const P = (0, compose_1.useDebounce)(function (e = "") {
    h(e, [...(E || []), m]);
  }, 300);
  (0, element_1.useEffect)(() => {
    r && !s.current && ((s.current = !0), h("", [...(E || []), m]));
  }, [r, s, E, m]);
  const y = (0, element_1.useCallback)(
      (e) => {
        if ((E || []).includes(e.id)) return;
        const t = g(e, a.linkedProducts);
        (S(t),
          h("", [...(t || []), m]),
  ...
  return (0, element_1.createElement)(
    ...
    a.isLoading && (0, element_1.createElement)(product_list_1.Skeleton, null),
    !a.isLoading &&
      0 === a.linkedProducts.length &&
      (0, element_1.createElement)(
        advice_card_1.AdviceCard,
        {
          tip: c.tip,
          dismissPreferenceId: `woocommerce-product-${o}-advice-card-dismissed`,
        ...
        (0, element_1.createElement)(EmptyStateImage, { ...c }),
      ),
    !a.isLoading &&
      a.linkedProducts.length > 0 &&
      (0, element_1.createElement)(product_list_1.ProductList, {
        products: a.linkedProducts,
        onRemove: function (e) {
          const t = f(e, a.linkedProducts);
          (S(t),
            h("", [...(t || []), m]),
