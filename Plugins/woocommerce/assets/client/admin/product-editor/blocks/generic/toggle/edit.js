...
const element_1 = require("@wordpress/element"),
  ...
  sanitize_1 = require("@woocommerce/sanitize"),
...
function Edit({ attributes: e, context: { postType: t } }) {
  const o = (0, block_templates_1.useWooBlockProps)(e),
    ...
    [a, d] = (0, use_product_entity_prop_1.default)(c, {
      postType: t,
      fallbackValue: !1,
    }),
    p = (0, core_data_1.useEntityId)("postType", t),
    [u] = (0, core_data_1.useEntityProp)("postType", t, "parent_id");
  function m() {
  ...
  return (
    e?.help &&
      (k = (0, element_1.createElement)("div", {
        dangerouslySetInnerHTML: {
          __html: (0, sanitize_1.sanitizeHTML)(e.help),
        },
      })),
    e?.checkedHelp &&
      m() &&
      (k = (0, element_1.createElement)("div", {
        dangerouslySetInnerHTML: {
          __html: (0, sanitize_1.sanitizeHTML)(e.checkedHelp),
        },
      })),
    e?.uncheckedHelp &&
      !m() &&
      (k = (0, element_1.createElement)("div", {
        dangerouslySetInnerHTML: {
          __html: (0, sanitize_1.sanitizeHTML)(e.uncheckedHelp),
        },
      })),
    (0, element_1.createElement)(
      ...
      l &&
        (0, element_1.createElement)("p", {
          ...
          dangerouslySetInnerHTML: { __html: (0, sanitize_1.sanitizeHTML)(s) },
        }),
    )
  );
}
