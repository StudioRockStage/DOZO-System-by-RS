...
async function getTaxonomiesMissingParents(e, t) {
  ...
  return (
    ...
    e.forEach((e) => {
      e.parent > 0 && !s[e.parent] && n.push(e.parent);
    }),
    n.length > 0
...
const PAGINATION_SIZE = 30,
  useTaxonomySearch = (e, t = { fetchParents: !0 }) => {
    const [n, s] = (0, element_1.useState)(!1);
    return {
      searchEntity: async function (n) {
        s(!0);
        let o = [];
        try {
          ((o = await (0, data_1.resolveSelect)("core").getEntityRecords(
            "taxonomy",
            e,
            { per_page: 30, search: (0, components_1.escapeHTML)(n) },
          )),
            t?.fetchParents && (o = await getTaxonomiesMissingParents(o, e)));
        } finally {
          s(!1);
        }
        return o;
