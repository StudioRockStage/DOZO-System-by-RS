...
const i18n_1 = require("@wordpress/i18n"),
  ...
  CreateTaxonomyModal = ({
    ...
    const [s, c] = (0, element_1.useState)(""),
      ...
      { searchEntity: u, isResolving: p } = (0, use_taxonomy_search_1.default)(
        n,
      ),
    ...
    const { saveEntityRecord: x } = (0, data_1.useDispatch)("core"),
      [y, w] = (0, element_1.useState)(!1),
      ...
      (0, element_1.createElement)(
        ...
        (0, element_1.createElement)(
          components_1.BaseControl,
          {
            ...
            help: h || r,
            className: (0, clsx_1.default)({ "has-error": h }),
          },
          (0, element_1.createElement)(components_1.TextControl, {
            id: g,
            value: v,
            onChange: E,
          }),
              ...
              label: (0, element_1.createInterpolateElement)(
                `${l || (0, i18n_1.__)("Parent", "woocommerce")} <optional/>`,
                {
                  optional: (0, element_1.createElement)(
                    ...
                    {
                      className:
                        "woocommerce-create-new-taxonomy-modal__optional",
                    },
        ...
        (0, element_1.createElement)(
          ...
          (0, element_1.createElement)(
            components_1.Button,
            { variant: "tertiary", onClick: e, disabled: y },
