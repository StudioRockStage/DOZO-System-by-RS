...
function Edit({ attributes: e, context: { postType: t } }) {
  const o = (0, block_templates_1.useWooBlockProps)(e),
    ...
    [h, y] = (0, use_product_entity_prop_1.default)(i, {
      postType: t,
      fallbackValue: "",
    }),
    { hasEdit: x } = (0, use_product_edits_1.useProductEdits)(),
    g = (0, element_1.useRef)(null),
    {
      ...
      async function () {
        ...
        return (
          ...
          e.validity.valid ? void 0 : { message: t }
        );
      },
      [f, l, s, a, u, c, _, h],
    );
  return (0, element_1.createElement)(
    ...
    (0, element_1.createElement)(text_control_1.TextControl, {
      ref: (0, compose_1.useMergeRefs)([g, b]),
      type: f?.value ?? "text",
      value: h,
      disabled: p,
      label: r,
      ...
      tooltip: d,
      suffix: (function () {
        if (!v || !h || !g.current) return;
        const e = "url" === g.current.type && !g.current.validity.typeMismatch;
        return !0 === v && e
