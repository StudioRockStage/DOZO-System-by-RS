...
const element_1 = require("@wordpress/element"),
  ...
  VariableProductTour = () => {
    const [e, o] = (0, element_1.useState)(!1),
      ...
      { totalCount: n } = (0, data_2.useSelect)(
        (e) => {
      ...
      { updateUserPreferences: c, variable_product_block_tour_shown: s } = (0,
      ...
      i = {
        ...
        options: {
          ...
          effects: {
            arrowIndicator: !0,
            spotlight: { interactivity: { enabled: !0 } },
          },
          callbacks: {
            onStepViewOnce: () => {
        ...
        closeHandler: () => {
          (c({ variable_product_block_tour_shown: "yes" }),
            o(!1),
            (0, tracks_1.recordEvent)("variable_product_block_tour_dismissed"));
        },
      };
    (0, element_1.useEffect)(() => {
      const t = r.current !== n && n > 0 && 0 === r.current;
      ((r.current = n), t && !e && o(!0));
    }, [n]);
    const { hasShownProductEditorTour: u } = (0, data_2.useSelect)((e) => {
      const { getOption: o } = e(data_1.optionsStore);
      return {
        hasShownProductEditorTour:
          "yes" === o("woocommerce_block_product_tour_shown"),
      };
    }, []);
    return "yes" !== s && e && u
