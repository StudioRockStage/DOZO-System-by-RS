...
function Edit({ attributes: e, clientId: r, context: t }) {
  const o = (0, block_templates_1.useWooBlockProps)(e),
    ...
    [c, u] = (0, core_data_1.useEntityProp)(
      "postType",
      t.postType || "product",
      "regular_price",
    ),
              ...
              if (s)
                return (0, element_1.createElement)("span", {
                  dangerouslySetInnerHTML: {
                    __html: (0, sanitize_1.sanitizeHTML)(s),
                  },
                });
            })(),
          className: (0, clsx_1.default)({ "has-error": f }),
        },
