...
function Edit({ attributes: e }) {
  const t = (0, block_templates_1.useWooBlockProps)(e),
    ...
    ),
    {
      ...
      dismissNotice: a,
      isResolving: l,
    } = (0, use_notice_1.useNotice)(),
    { parentName: _, isParentResolving: d } = (0, data_1.useSelect)(
      (e) => {
        const { getEditedEntityRecord: t, hasFinishedResolution: o } = e(
            core_data_1.store,
          ),
          { name: i } = t("postType", "product", s);
        return {
          parentName: i || "",
          isParentResolving: !o("getEditedEntityRecord", [
            "postType",
            "product",
            s,
          ]),
