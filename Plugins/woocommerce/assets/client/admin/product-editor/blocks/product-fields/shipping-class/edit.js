...
function extractDefaultShippingClassFromProduct(e, t) {
  const s = e?.find(({ slug: e }) => "uncategorized" !== e);
  if (s && !t?.some(({ slug: e }) => e === s.slug))
...
function Edit({ attributes: e, context: { postType: t, isInSelectedTab: s } }) {
  const [o, n] = (0, element_1.useState)(!1),
    ...
    { createProductShippingClass: i } = (0, data_2.useDispatch)(
      data_1.experimentalProductShippingClassesStore,
    ),
    { createErrorNotice: c } = (0, data_2.useDispatch)("core/notices"),
    [r] = (0, core_data_1.useEntityProp)("postType", t, "categories"),
    [l, p] = (0, core_data_1.useEntityProp)("postType", t, "shipping_class"),
    [_] = (0, core_data_1.useEntityProp)("postType", t, "virtual");
  function m(e) {
    let t = (0, i18n_1.__)(
  ...
  const { shippingClasses: u } = (0, data_2.useSelect)(
      (e) => {
        ...
        return { shippingClasses: (s && t(shippingClassRequestQuery)) || [] };
      },
      [s],
    ),
    d = (0, compose_1.useInstanceId)(
  ...
  return (0, element_1.createElement)(
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(
        ...
        (0, element_1.createElement)(components_2.SelectControl, {
          ...
          value: l,
          onChange: (e) => {
            e !== constants_1.ADD_NEW_SHIPPING_CLASS_OPTION_VALUE
              ? p(e)
              : n(!0);
          },
          ...
          options: [
            ...exports.DEFAULT_SHIPPING_CLASS_OPTIONS,
            ...mapShippingClassToSelectOption(u ?? []),
          ],
    ...
    o &&
      (0, element_1.createElement)(components_3.AddNewShippingClassModal, {
        shippingClass: extractDefaultShippingClassFromProduct(r, u),
        onAdd: (e) =>
          i(e, { optimisticQueryUpdate: shippingClassRequestQuery })
            .then(
              (e) => (
                (0, tracks_1.recordEvent)(
