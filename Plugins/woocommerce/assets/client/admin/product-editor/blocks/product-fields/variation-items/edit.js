...
function Edit({ attributes: e, context: { isInSelectedTab: t } }) {
  const r = (0, element_1.useRef)(!1),
    { invalidateResolution: o } = (0, data_2.useDispatch)(
      data_1.experimentalProductVariationsStore,
    ),
    ...
    [n] = (0, core_data_1.useEntityProp)("postType", "product", "has_options"),
    [_] = (0, use_product_entity_prop_1.default)("attributes"),
    c = (0, element_1.useMemo)(
      function () {
        return _?.some((e) => e.variation);
      },
      [_],
    ),
    ...
    { totalCountWithoutPrice: d } = (0, data_2.useSelect)(
      (e) => {
        const { getProductVariationsTotalCount: t } = e(
          data_1.experimentalProductVariationsStore,
        );
        return { totalCountWithoutPrice: n ? t(u) : 0 };
      },
      [n, u],
    ),
    {
      updateUserPreferences: p,
      variable_items_without_price_notice_dismissed: l,
    } = (0, data_1.useUserPreferences)(),
    { ref: m } = (0, validation_context_1.useValidation)(
      "variations",
      async function (e, t) {
        if (d > 0 && !r.current && "publish" !== s && "publish" === t?.status)
          return (
            "yes" !== l &&
              p({
        ...
        (0, element_1.createElement)(variations_table_1.VariationsTable, {
          ...
          noticeActions: [
            {
              ...
              onClick: function (e) {
                (0, tracks_1.recordEvent)(
                  "product_variations_set_prices_select",
          ...
          onVariationTableChange: (e, t) => {
            ("delete" === e ||
              ("update" === e &&
                t &&
                t.find((e) => "regular_price" in e || "sale_price" in e))) &&
              o("getProductVariationsTotalCount", [u]);
          },
        }),
        t &&
          (0, element_1.createElement)(
            variable_product_tour_1.VariableProductTour,
            null,
          ),
      )
