...
function DownloadBlockEdit({ attributes: e, context: { postType: o } }) {
  const n = (0, block_templates_1.useWooBlockProps)(e),
    [t, l] = (0, core_data_1.useEntityProp)("postType", o, "downloads"),
    [a, i] = (0, core_data_1.useEntityProp)("postType", o, "download_limit"),
    [r, c] = (0, core_data_1.useEntityProp)("postType", o, "download_expiry"),
    [d, m] = (0, element_1.useState)(),
  ...
  function f(e) {
    ...
    const o = e.filter((e) => !t.some((o) => o.file === e.url));
    if (
      (o.length !== e.length &&
        p(
          1 === e.length
      ...
      const e = o.map((e) => ({
        ...
        n = t.map(stringifyEntityId);
      (n.push(...e), l(n));
    }
  }
  function E(e) {
    const o = t.reduce(function (o, n) {
      return n.file === e.file ? o : [...o, stringifyEntityId(n)];
    }, []);
    l(o);
  }
  function g(e) {
  ...
  return (0, element_1.createElement)(
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(components_2.MediaUploader, {
        ...
        allowedMediaTypes: _,
        multipleSelect: "add",
        maxUploadFileSize: window.productBlockEditorSettings?.maxUploadFileSize,
        onUpload: f,
        ...
        (0, element_1.createElement)(
          ...
          t.map((e) => {
            const o = getFileName(e.file),
              n = e.file.startsWith("blob");
            return (0, element_1.createElement)(
              components_2.ListItem,
              {
                key: e.file,
                className:
                  "wp-block-woocommerce-product-downloads-field__table-row",
              },
              (0, element_1.createElement)(
                "div",
                {
    ...
    u &&
      (0, element_1.createElement)(
        manage_download_limits_modal_1.ManageDownloadLimitsModal,
        {
          initialValue: { downloadLimit: a, downloadExpiry: r },
          onSubmit: function (e) {
            (i(e.downloadLimit), c(e.downloadExpiry), w(!1));
          },
          onClose: function () {
            w(!1);
          },
