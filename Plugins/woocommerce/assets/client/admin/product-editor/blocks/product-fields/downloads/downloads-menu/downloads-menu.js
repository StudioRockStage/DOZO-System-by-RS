...
const components_1 = require("@wordpress/components"),
  ...
  insert_url_menu_item_1 = require("../insert-url-menu-item"),
  upload_files_menu_item_1 = require("../upload-files-menu-item");
  ...
  return (0, element_1.createElement)(components_1.Dropdown, {
    ...
    renderToggle: ({ isOpen: e, onToggle: n }) =>
      (0, element_1.createElement)(
        ...
        {
          "aria-expanded": e,
          icon: e ? icons_1.chevronUp : icons_1.chevronDown,
          variant: "secondary",
          onClick: n,
        ...
        (0, element_1.createElement)(
          "span",
          null,
          (0, i18n_1.__)("Add new", "woocommerce"),
        ),
      ),
    renderContent: ({ onClose: l }) =>
      (0, element_1.createElement)(
        "div",
        ...
        (0, element_1.createElement)(
          ...
          null,
          (0, element_1.createElement)(
            upload_files_menu_item_1.UploadFilesMenuItem,
            {
              allowedTypes: e,
              maxUploadFileSize: n,
              onUploadSuccess: (e) => {
          ...
          (0, element_1.createElement)(
            insert_url_menu_item_1.InsertUrlMenuItem,
            {
              onLinkSuccess: (e) => {
                (o(e), l());
              },
