...
function AttributesBlockEdit({
  attributes: t,
  context: { isInSelectedTab: e },
}) {
  const [r, o] = (0, core_data_1.useEntityProp)(
      "postType",
      "product",
      "attributes",
    ),
    c = (0, core_data_1.useEntityId)("postType", "product"),
    _ = (0, block_templates_1.useWooBlockProps)(t),
    {
      attributes: a,
      fetchAttributes: i,
      handleChange: d,
  ...
  return (
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(attribute_control_1.AttributeControl, {
        value: a,
        disabledAttributeIds: r.filter((t) => !!t.variation).map((t) => t.id),
        uiStrings: {
          disabledAttributeMessage: (0, i18n_1.__)(
