...
function Edit({ attributes: e, clientId: r, context: t }) {
  const o = (0, block_templates_1.useWooBlockProps)(e),
    { label: s, help: l, tooltip: a, disabled: n } = e,
    [c] = (0, core_data_1.useEntityProp)(
      "postType",
      t.postType || "product",
      "regular_price",
    ),
    [p, i] = (0, core_data_1.useEntityProp)(
      "postType",
      t.postType || "product",
      "sale_price",
    ),
    u = (0, use_currency_input_props_1.useCurrencyInputProps)({
      value: p,
      onChange: i,
    }),
  ...
  return (0, element_1.createElement)(
    ...
    (0, element_1.createElement)(
      components_1.BaseControl,
      {
        id: _,
        help: d || l,
        className: (0, clsx_1.default)({ "has-error": d }),
      },
