...
const element_1 = require("@wordpress/element"),
  ...
  full_editor_toolbar_button_1 = __importDefault(
    require("./full-editor-toolbar-button"),
  ),
  wooBlockwithFullEditorToolbarButton = (0,
  compose_1.createHigherOrderComponent)(
    (e) => (t) =>
      "woocommerce/product-summary-field" !== t?.name ||
      "product-description__content" !== t?.attributes?._templateBlockId
        ...
        : (0, element_1.createElement)(
            ...
            (0, element_1.createElement)(
              ...
              { group: "other" },
              (0, element_1.createElement)(
                full_editor_toolbar_button_1.default,
                null,
              ),
            ),
            (0, element_1.createElement)(e, { ...t }),
