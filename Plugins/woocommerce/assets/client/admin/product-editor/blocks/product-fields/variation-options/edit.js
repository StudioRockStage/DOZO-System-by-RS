...
function Edit({ attributes: e, context: { postType: t, isInSelectedTab: o } }) {
  const r = (0, block_templates_1.useWooBlockProps)(e),
    ...
    {
      updateUserPreferences: a,
      local_attributes_notice_dismissed_ids: n = [],
    } = (0, data_1.useUserPreferences)(),
    [c, s] = (0, core_data_1.useEntityProp)(
      "postType",
      "product",
      "attributes",
    ),
    [_, m] = (0, core_data_1.useEntityProp)(
      "postType",
      "product",
      "default_attributes",
    ),
    l = (0, core_data_1.useEntityId)("postType", t),
    {
      attributes: d,
      fetchAttributes: u,
      handleChange: p,
    } = (0, use_product_attributes_1.useProductAttributes)({
      allAttributes: c,
  ...
  return (
      ...
      (v = (0, element_1.createInterpolateElement)(
        ...
        ),
        {
          attributeNames: (0, element_1.createElement)(
            ...
            null,
            2 === b.length
              ? b.join((0, i18n_1.__)(" and ", "woocommerce"))
              : b.join(", "),
          ),
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(attribute_control_1.AttributeControl, {
        ...
        onNoticeDismiss: () =>
          a({ local_attributes_notice_dismissed_ids: [...n, l] }),
        onAddAnother: () => {
        ...
        renderCustomEmptyState: function ({ addAttribute: e }) {
          return (0, element_1.createElement)(
            ...
            {
              className:
                "wp-block-woocommerce-product-variations-options-field__empty-state",
            },
            (0, element_1.createElement)(
              "div",
              {
        ...
        uiStrings: {
          ...
          newAttributeModalTitle: (0, i18n_1.__)(
          ...
          attributeRemoveLabel: (0, i18n_1.__)(
