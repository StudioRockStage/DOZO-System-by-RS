...
function Edit({ attributes: e }) {
  const t = (0, block_templates_1.useWooBlockProps)(e),
    ...
    [a] = (0, core_data_1.useEntityProp)("postType", "product", "attributes"),
    [s] = (0, core_data_1.useEntityProp)("postType", "product", "type"),
    c = (0, utils_1.hasAttributesUsedForVariations)(a) && "variable" === s;
