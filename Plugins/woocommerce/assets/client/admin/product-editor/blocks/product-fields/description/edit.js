...
function getContentFromFreeform(e) {
  return (
    !(1 !== e.length || "core/freeform" !== e[0].name) &&
    e[0].attributes.content
  );
}
function DescriptionBlockEdit({ attributes: e }) {
  const [t, o] = (0, core_data_1.useEntityProp)(
      "postType",
      "product",
      "description",
    ),
    [r, l] = (0, element_1.useState)([]),
    {
      ...
      (e) => ({
        isModalEditorOpen: e(
          product_editor_ui_1.wooProductEditorUiStore,
        ).isModalEditorOpen(),
        modalEditorBlocks: e(
          product_editor_ui_1.wooProductEditorUiStore,
  ...
  ((0, element_1.useEffect)(() => {
    ...
    (0, element_1.useEffect)(() => {
      if (!n) return;
      const e = (0, blocks_1.serialize)(d);
      o(e);
    }, [d, o, n]));
  const c = (0, block_templates_1.useWooBlockProps)(e, {
      className: (0, clsx_1.default)({ "has-blocks": !!t.length }),
      tabIndex: 0,
    }),
    _ = (0, block_editor_1.useInnerBlocksProps)(
      {},
      {
  ...
  return (0, element_1.createElement)(
    ...
    r?.length
      ...
      : (0, element_1.createElement)("div", { ..._ }),
    i &&
      (0, element_1.createElement)(modal_editor_welcome_guide_1.default, null),
  );
}
