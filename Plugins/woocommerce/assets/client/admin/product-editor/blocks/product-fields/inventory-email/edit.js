...
function Edit({ attributes: e, clientId: t }) {
  const o = (0, block_templates_1.useWooBlockProps)(e),
    ...
    [r, s] = (0, core_data_1.useEntityProp)(
      "postType",
      "product",
      "low_stock_amount",
    ),
    c = (0, compose_1.useInstanceId)(
                ...
                (0, element_1.createInterpolateElement)(
                  ...
                  ),
                  {
                    link: (0, element_1.createElement)(components_1.Link, {
                      href: `${(0, settings_1.getSetting)("adminUrl")}admin.php?page=wc-settings&tab=products&section=inventory`,
                      target: "_blank",
                      type: "external",
                    }),
                  },
                ),
              className: l && "has-error",
            },
            (0, element_1.createElement)(
              components_2.__experimentalInputControl,
              {
                id: c,
                ref: a,
