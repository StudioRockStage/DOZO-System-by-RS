...
function ProductListBlockEdit({ attributes: e, context: { postType: t } }) {
  const { property: o } = e,
    ...
    [m, i] = (0, element_1.useState)(!1),
    [s, _] = (0, element_1.useState)(!1),
  ...
  return (
    ...
    (0, element_1.createElement)(
        ...
        !m &&
          ...
          (0, element_1.createElement)(
            ...
            (0, element_1.createElement)(
              ...
              {
                className:
                  "wp-block-woocommerce-product-list-field__table-header",
              },
              (0, element_1.createElement)(
                "div",
                {
                  className:
                    "wp-block-woocommerce-product-list-field__table-row",
                  role: "rowheader",
                },
                (0, element_1.createElement)(
                  "div",
                  {
                    className:
                      "wp-block-woocommerce-product-list-field__table-header-column",
                    role: "columnheader",
                  },
            ...
            (0, element_1.createElement)(
              ...
              {
                className:
                  "wp-block-woocommerce-product-list-field__table-body",
                role: "rowgroup",
              },
              p.map((e) =>
                (0, element_1.createElement)(
                  ...
                  (0, element_1.createElement)(
                    ...
                    {
                      className:
                        "wp-block-woocommerce-product-list-field__table-cell",
                      role: "cell",
                    },
                    (0, element_1.createElement)("div", {
                      className:
                        "wp-block-woocommerce-product-list-field__product-image",
                    ...
                    (0, element_1.createElement)(
                      ...
                      {
                        className:
                          "wp-block-woocommerce-product-list-field__product-info",
                      },
                      (0, element_1.createElement)(
                        "div",
                        {
                          className:
                            "wp-block-woocommerce-product-list-field__product-name",
                        },
                        (0, element_1.createElement)(
                          components_1.Button,
                          {
                      ...
                      (0, element_1.createElement)(
                        ...
                        {
                          className:
                            "wp-block-woocommerce-product-list-field__product-sku",
                        },
                        e.sku,
                      ),
                    ),
      ...
      a &&
        (0, element_1.createElement)(
          add_products_modal_1.ReorderProductsModal,
          {
            products: p,
            onSubmit: function (e) {
