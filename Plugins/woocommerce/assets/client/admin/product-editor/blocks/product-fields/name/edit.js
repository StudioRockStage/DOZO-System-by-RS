...
function NameBlockEdit({ attributes: e, clientId: t }) {
  const o = (0, block_templates_1.useWooBlockProps)(e),
    { editEntityRecord: r, saveEntityRecord: n } = (0, data_1.useDispatch)(
      "core",
    ),
    ...
    i = (0, data_1.useSelect)(
      (e) =>
        e(core_data_1.store).getEditedEntityRecord("postType", "product", s),
      [s],
    ),
    ...
    g = (0, compose_1.useInstanceId)(components_1.BaseControl, "product_name"),
    { selectBlock: q } = (0, data_1.useDispatch)("core/block-editor");
  (0, element_1.useEffect)(() => {
    e.autoFocus && q(t);
  }, []);
  const [b, h] = (0, use_product_entity_prop_1.default)("featured");
  function x() {
    h(!b);
  }
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(
        components_1.BaseControl,
        {
          ...
          className: (0, clsx_1.default)({ "has-error": E }),
          help: w,
        },
      ...
      l &&
        (0, element_1.createElement)(
          edit_product_link_modal_1.EditProductLinkModal,
          {
            permalinkPrefix: p || "",
            permalinkSuffix: f || "",
            product: i,
            ...
            onSaved: () => c(!1),
            saveHandler: async (e) => {
              const { slug: t, permalink: o } = await n("postType", "product", {
                id: i.id,
                slug: e,
              });
              if (t && o)
                return (
                  r("postType", "product", i.id, { slug: t, permalink: o }),
                  { slug: t, permalink: o }
                );
            },
          },
