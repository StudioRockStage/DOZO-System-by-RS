...
function Edit({ attributes: e }) {
  const { label: o, _templateBlockId: t } = e,
    ...
    r = (0, block_editor_1.useInnerBlocksProps)(
      {
        className:
    ...
    {
      isLoading: s,
      metaboxhiddenProduct: n,
      saveMetaboxhiddenProduct: l,
    } = (0, use_metabox_hidden_product_1.useMetaboxHiddenProduct)(),
    d = (0, element_1.useMemo)(
      () => n && !n.some((e) => e === METABOX_HIDDEN_VALUE),
      [n],
    );
    ...
    (0, element_1.createElement)(
      ...
      (0, element_1.createElement)(components_1.ToggleControl, {
        ...
        onChange: async function (e) {
          const o = e
            ? n.filter((e) => e !== METABOX_HIDDEN_VALUE)
            : [...n, METABOX_HIDDEN_VALUE];
      ...
      s && (0, element_1.createElement)(components_1.Spinner, null),
    ),
    d && (0, element_1.createElement)("div", { ...r }),
  );
}
