  ...
  var e = {
      ...
      40885: (e, t, r) => {
        ...
        e.exports = function (e, t) {
          ...
          var r = (function (e) {
              ...
              var n = [];
              return (
                O(e, x, function (e, t, r, o) {
                  n[n.length] = r ? O(o, k, "$1") : t || e;
                }),
                n
              );
            })(e),
      ...
      83282: (e, t, r) => {
        ...
        e.exports = function e(t, n, o, c) {
          ...
          if (
            (void 0 === o && (o = 0), o >= k && k > 0 && "object" == typeof t)
          )
          ...
          function z(t, r, n) {
            if ((r && (c = P.call(c)).push(r), n)) {
              var i = { depth: l.depth };
              return (
                H(l, "quoteStyle") && (i.quoteStyle = l.quoteStyle),
                e(t, i, o + 1, c)
              );
            }
            return e(t, l, o + 1, c);
          ...
          if (
            ...
            for (
              var ne = "<" + S.call(String(t.nodeName)),
                oe = t.attributes || [],
                ie = 0;
              ie < oe.length;
              ie++
          ...
          if ("object" == typeof t && h) {
            if (T && "function" == typeof t[T] && U)
              return U(t, { depth: k - o });
        ...
        function q(e, t) {
          ...
          return D(
            v.call(v.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, z),
            "single",
            t,
          );
        }
        ...
        var n = r(50323),
          ...
          u = function (e, t, r, n) {
            if (e) {
              ...
              for (
                var f = 0;
                r.depth > 0 && null !== (c = a.exec(i)) && f < r.depth;
      ...
      61007: (e, t, r) => {
        ...
        var n = r(2435),
          ...
          h = function e(t, r, i, a, c, u, f, s, h, g, b, m, v, w, S, j) {
            ...
            if ("comma" === i && l(O))
              (w && f && (O = o.maybeMap(O, f)),
                (F = [{ value: O.length > 0 ? O.join(",") || null : void 0 }]));
            else if (l(s)) F = s;
            else {
              var I = Object.keys(O);
              F = h ? I.sort(h) : I;
            ...
            for (
              var _ = a && l(O) && 1 === O.length ? r + "[]" : r, N = 0;
              N < F.length;
              ++N
            ) {
              var M = F[N],
                U = "object" == typeof M && void 0 !== M.value ? M.value : O[M];
              if (!u || null !== U) {
                var L = l(O)
                  ? "function" == typeof i
                    ? i(_, M)
        ...
        e.exports = {
          ...
          compact: function (e) {
            for (
              ...
              for (
                var o = t[n], a = o.obj[o.prop], c = Object.keys(a), l = 0;
                l < c.length;
                ++l
              ) {
                var u = c[l],
  ...
  ((() => {
    ...
    (r.r(n),
      r.d(n, {
        ...
        flattenFilters: () => m,
        getActiveFiltersFromQuery: () => v,
        getDefaultOptionValue: () => w,
        getHistory: () => g,
        getIdsFromQuery: () => U,
        getNewPath: () => E,
        getPath: () => O,
        getPersistedQuery: () => x,
        getQuery: () => P,
        getQueryExcludedScreens: () => k,
        getQueryExcludedScreensUrlUpdate: () => F,
        getQueryFromActiveFilters: () => S,
        getScreenFromPath: () => R,
        getSearchWords: () => L,
    ...
    function g() {
      if (!h) {
        const e = (function (e) {
          ...
          function j(e, t, r) {
            return (
              !m.length || (m.call({ action: e, location: t, retry: r }), !1)
            );
          }
          function A(e) {
            a = e;
            var t = o();
            ((h = t[0]), (g = t[1]), b.call({ action: a, location: g }));
          }
          function O(e) {
            n.go(e);
          }
          return (
            null == h &&
              ((h = 0), n.replaceState(l({}, n.state, { idx: h }), "")),
            {
              get action() {
                return a;
              },
              ...
              block: function (e) {
                var t = m.push(e);
                return (
                  1 === m.length && r.addEventListener(f, y),
                  function () {
                    (t(), m.length || r.removeEventListener(f, y));
                  }
                );
              },
            }
        ...
        ((h = {
          ...
          e.listen(() => r(h.action, h.location)));
      }
      return h;
    }
    function b(e, t) {
    ...
    function v(e, t) {
      return Object.keys(t).reduce((r, n) => {
        const o = t[n];
        if (o.rules) {
          const t = o.rules.filter((t) => e.hasOwnProperty(b(n, t.value)));
          if (t.length)
            if (o.allowMultiple)
              t.forEach((t) => {
                e[b(n, t.value)].forEach((e) => {
                  r.push({ key: n, rule: t.value, value: e });
                });
              });
            else {
              const o = e[b(n, t[0].value)];
    ...
    function w(e, t) {
      ...
      if (e.input.defaultOption) {
        ...
        return n
          ? n.value
          : void console.warn(
              `invalid defaultOption ${r} supplied to ${e.labels.add}`,
            );
      }
    ...
    function S(e, t, r) {
      return {
        ...v(t, r).reduce((e, t) => ((e[b(t.key, t.rule)] = void 0), e), {}),
        ...e.reduce((e, t) => {
          if (
            "between" === t.rule &&
            (!Array.isArray(t.value) || t.value.some((e) => !e))
          )
            return e;
          if (t.value) {
            const n = b(t.key, t.rule);
    ...
    const j = window.wp.i18n,
          ...
          if (t) {
            ...
            return (
              (i.push = (...t) => {
                const n = i.location,
                  a = W(t[0]);
                "function" != typeof r || r(a, n)
                  ? !1 !== window.confirm(o) && e(...t)
                  : e(...t);
              }),
              () => {
                i.push = e;
      ...
      O = () => g().location.pathname;
    function P() {
      const e = g().location.search;
      return (e.length && (0, o.parse)(e.substring(1))) || {};
    }
    function E(e, r = O(), n = P(), o = "wc-admin") {
      const i = { page: o, ...n, ...e };
    ...
    const x = (e = P()) => {
      ...
      F = () =>
        (0, a.applyFilters)("woocommerce_admin_nav_update_excluded_screens", [
          "extensions",
        ]),
      R = (e = O()) =>
        "/" === e ? "homescreen" : e.replace("/analytics", "").replace("/", "");
    function I(e = "") {
      return new Set(
        e
          .split(",")
    ...
    function _(e, t = O(), r = P(), n = "wc-admin") {
      const o = E(e, t, r, n);
      g().push(o);
    }
    const N = (e) => {
        ...
        return (
          (window.wcNavigation =
            null !== (t = window.wcNavigation) && void 0 !== t ? t : {}),
    ...
    function D(e, t = O(), r = P()) {
      switch (e) {
        case "sort":
          return (e, n) => _({ orderby: e, order: n }, t, r);
        case "compare":
          return (e, n, o) =>
            _({ [n]: `compare-${e}`, [e]: o, search: void 0 }, t, r);
        default:
          return (n) => _({ [e]: n }, t, r);
      }
    }
      ...
      W = (e) =>
        e.startsWith("http")
          ...
          : /^\/?[a-z0-9]+.php/i.test(e)
            ...
            : new URL((0, c.getAdminLink)(E({}, e, {}))),
      B = ({ url: e }) => {
        const t = W(e);
        if (C() && C(String(t)))
          return (
            (window.document.documentElement.scrollTop = 0),
            void g().push(`admin.php${t.search}`)
          );
