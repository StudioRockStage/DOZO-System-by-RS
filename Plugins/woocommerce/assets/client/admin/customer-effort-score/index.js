(() => {
  ...
  var e = {
      ...
      d: (o, t) => {
        for (var s in t)
          e.o(t, s) &&
            !e.o(o, s) &&
            Object.defineProperty(o, s, { enumerable: !0, get: t[s] });
      },
  ...
  (e.r(o),
    e.d(o, {
      ADMIN_INSTALL_TIMESTAMP_OPTION_NAME: () => f,
      ALLOW_TRACKING_OPTION_NAME: () => h,
      CustomerEffortScore: () => m,
      CustomerEffortScoreModalContainer: () => G,
      CustomerEffortScoreTracks: () => Z,
      CustomerEffortScoreTracksContainer: () => oe,
      CustomerFeedbackModal: () => u,
      CustomerFeedbackSimple: () => re,
      FeedbackModal: () => ne,
      QUEUE_OPTION_NAME: () => T,
      SHOWN_FOR_ACTIONS_OPTION_NAME: () => g,
      STORE_KEY: () => O,
      addCustomerEffortScoreExitPageListener: () => Y,
      addExitPage: () => U,
      getExitPageData: () => I,
      getStoreAgeInWeeks: () => z,
      removeCustomerEffortScoreExitPageListener: () => j,
      removeExitPage: () => W,
      triggerExitPageCesSurvey: () => K,
      useCustomerEffortScoreExitPageTracker: () => ie,
  ...
  (e.r(t),
    e.d(t, {
      addCesSurvey: () => y,
      addCesSurveyForAnalytics: () => M,
      addCesSurveyForCustomerSearch: () => k,
      hideCesModal: () => v,
      hideProductMVPFeedbackModal: () => D,
      setCesSurveyQueue: () => b,
      showCesModal: () => C,
      showProductMVPFeedbackModal: () => P,
    }));
  var s = {};
  (e.r(s), e.d(s, { getCesSurveyQueue: () => x }));
  var r = {};
  (e.r(r),
    e.d(r, {
      getCesSurveyQueue: () => Q,
      getVisibleCESModalData: () => A,
      isProductMVPFeedbackModalVisible: () => L,
    }));
  const n = window.wp.element,
    c = window.wp.i18n,
    i = window.wp.data,
    a = window.wp.components,
    l = window.wc.experimental;
  function u({
    recordScoreCallback: e,
    title: o = (0, c.__)("Please share your feedback", "woocommerce"),
    description: t,
    showDescription: s = !0,
    firstQuestion: r,
    secondQuestion: i,
    ...
    onCloseModal: d,
    customOptions: m,
    shouldShowComments: _ = (e, o) => [e, o].some((e) => 1 === e || 2 === e),
    getExtraFieldsToBeShown: w,
    validateExtraFields: p,
  }) {
    const f =
        m && m.length > 0
          ? m
          : [
              {
                label: (0, c.__)("Strongly disagree", "woocommerce"),
                value: "1",
              },
              { label: (0, c.__)("Disagree", "woocommerce"), value: "2" },
              { label: (0, c.__)("Neutral", "woocommerce"), value: "3" },
              { label: (0, c.__)("Agree", "woocommerce"), value: "4" },
              { label: (0, c.__)("Strongly Agree", "woocommerce"), value: "5" },
            ],
      [h, g] = (0, n.useState)(u || NaN),
      [S, E] = (0, n.useState)(u || NaN),
      [b, y] = (0, n.useState)(""),
      [C, v] = (0, n.useState)(!1),
      [M, k] = (0, n.useState)(!0),
      [P, D] = (0, n.useState)({}),
    ...
    return M
      ? (0, n.createElement)(
          ...
          (0, n.createElement)(
            ...
            (0, n.createElement)(a.RadioControl, {
              selected: h.toString(10),
              options: f,
              onChange: (e) => x(e, g),
          ...
          "function" == typeof _ &&
            ...
            (0, n.createElement)(
              ...
              (0, n.createElement)(a.TextareaControl, {
          ...
          "function" == typeof w && w(P, D, O),
          (0, n.createElement)(
            "div",
            { className: "woocommerce-customer-effort-score__buttons" },
            (0, n.createElement)(
              a.Button,
              { isTertiary: !0, onClick: T, name: "cancel" },
            ...
            (0, n.createElement)(
              a.Button,
              {
                isPrimary: !0,
                onClick: () => {
                  const o = !Number.isInteger(h) || (i && !Number.isInteger(S));
                  o && v(!0);
                  const t = "function" == typeof p ? p(P) : {},
                    s = 0 === Object.keys(t).length;
                  !o && s ? (k(!1), e(h, S, b, P)) : N(t);
                },
                name: "send",
              },
              (0, c.__)("Share", "woocommerce"),
            ),
          ),
        )
      : null;
  ...
  function m({
    ...
    firstQuestion: a,
    secondQuestion: l,
    onNoticeShownCallback: m = d,
    onNoticeDismissedCallback: _ = d,
    onModalShownCallback: w = d,
    onModalDismissedCallback: p = d,
    icon: f,
    shouldShowComments: h = (e, o) => [e, o].some((e) => 1 === e || 2 === e),
    getExtraFieldsToBeShown: g,
    validateExtraFields: S,
  }) {
    const [E, b] = (0, n.useState)(!0),
      [y, C] = (0, n.useState)(!1),
      { createNotice: v } = (0, i.useDispatch)("core/notices2");
    return (
      (0, n.useEffect)(() => {
        E &&
          (v("success", r || o, {
            actions: [
              {
                label: (0, c.__)("Give feedback", "woocommerce"),
                onClick: () => {
                  (C(!0), w());
                },
              },
  ...
  const _ = window.wc.data,
    w = window.wc.tracks,
    p = window.wc.navigation,
    f = "woocommerce_admin_install_timestamp",
    h = "woocommerce_allow_tracking",
    g = "woocommerce_ces_shown_for_actions",
    S = window.wp.dataControls,
    E = {
  ...
  function b(e) {
    return { type: E.SET_CES_SURVEY_QUEUE, queue: e };
  }
  function y({
    action: e,
    title: o,
    ...
    secondQuestion: n,
    icon: c,
    pageNow: i = window.pagenow,
    adminPage: a = window.adminpage,
    onsubmitLabel: l,
    props: u = {},
  }) {
    return {
      type: E.ADD_CES_SURVEY,
      action: e,
      title: o,
      description: t,
      noticeLabel: s,
  ...
  function k() {
    return y({
      action: "ces_search",
      title: (0, c.__)("How easy was it to use search?", "woocommerce"),
      firstQuestion: (0, c.__)(
  ...
  function P() {
    return { type: E.SHOW_PRODUCT_MVP_FEEDBACK_MODAL };
  }
  function D() {
    return { type: E.HIDE_PRODUCT_MVP_FEEDBACK_MODAL };
  }
  const O = "wc/customer-effort-score",
    N = "/wc-admin",
    T = "woocommerce_ces_tracks_queue";
  function* x() {
    const e = yield (0, S.apiFetch)({ path: `${N}/options?options=${T}` });
  ...
  const F = {
    ...
    H = (0, i.createReduxStore)(O, {
      ...
      reducer: (e = F, o) => {
        switch (o.type) {
          case E.SET_CES_SURVEY_QUEUE:
            return { ...e, queue: [...e.queue, ...o.queue] };
          case E.HIDE_CES_MODAL:
            return { ...e, showCESModal: !1, cesModalData: void 0 };
          case E.SHOW_CES_MODAL:
            const t = {
              action: o.surveyProps.action,
              description: o.surveyProps.description,
          ...
          case E.ADD_CES_SURVEY:
            ...
            return { ...e, queue: [...e.queue, s] };
          case E.SHOW_PRODUCT_MVP_FEEDBACK_MODAL:
            return { ...e, showProductMVPFeedbackModal: !0 };
          case E.HIDE_PRODUCT_MVP_FEEDBACK_MODAL:
  ...
  (0, i.register)(H);
  const R = H,
    V = "customer-effort-score-exit-page",
    I = () => {
    ...
    B = async () =>
      "yes" === (await (0, i.resolveSelect)(_.optionsStore).getOption(h)),
    U = async (e) => {
      const o = await B();
      if (!window.localStorage || !o) return;
      let t = I();
      (t.find((o) => o === e) || t.push(e),
        (t = t.slice(-10)),
        window.localStorage.setItem(V, JSON.stringify(t)));
    },
    W = (e) => {
      if (!window.localStorage) return;
      let o = I();
      ((o = o.filter((o) => o !== e)),
        (o = o.slice(-10)),
        window.localStorage.setItem(V, JSON.stringify(o)));
    },
    q = {},
    Y = (e, o) => {
      (B(),
        ...
        window.addEventListener("unload", q[e]));
    },
    j = (e) => {
      q[e] && window.removeEventListener("unload", q[e], { capture: !0 });
    };
  function K() {
    const e = I();
    if (e?.length) {
      if (
        !(function (e) {
          const o = {
            import_products: () =>
              "product_importer" !== (0, p.getQuery)().page,
          };
          return !o[e] || o[e]();
        })(e[0])
      )
  ...
  function z(e) {
    ...
    return Math.round(o / _.WEEK);
  }
  const G = () => {
      const { createSuccessNotice: e } = (0, i.useDispatch)("core/notices"),
        { hideCesModal: o } = (0, i.useDispatch)(R),
        {
          storeAgeInWeeks: t,
          resolving: s,
          visibleCESModalData: r,
        } = (0, i.useSelect)((e) => {
          const { getOption: o, hasFinishedResolution: t } = e(_.optionsStore),
            { getVisibleCESModalData: s } = e(R),
            r = o(f) || 0,
            n = null === r || !t("getOption", [f]);
          return {
            storeAgeInWeeks: z(r),
            visibleCESModalData: s(),
            resolving: n,
          };
        }, []);
      return !r || s
        ...
        : (0, n.createElement)(u, {
            ...
            secondQuestion: r.secondQuestion,
            recordScoreCallback: (...s) => {
              (((o, s, n, i = {}) => {
                ((0, w.recordEvent)("ces_feedback", {
                  action: r.action,
                  score: o,
                  score_second_question: null != s ? s : null,
                  score_combined: o + (null != s ? s : 0),
                  comments: n || "",
                  ...i,
                  store_age: t,
                  ...r.tracksProps,
                  ...
                  e(
                    ...
                    r.onSubmitNoticeProps || {},
                  ));
              })(...s),
                o(),
                r.props?.onRecordScore?.());
            },
            onCloseModal: () => {
              (r.props?.onCloseModal?.(), o());
            },
            shouldShowComments: r.props?.shouldShowComments,
            getExtraFieldsToBeShown: r.getExtraFieldsToBeShown,
            validateExtraFields: r.validateExtraFields,
          });
    },
    J = window.wp.compose,
    $ = window.wp.apiFetch;
  ...
  const Z = (0, J.compose)(
      ...
      (0, i.withDispatch)((e) => {
        const { createNotice: o } = e("core/notices");
        return { createNotice: o };
      }),
    )(function ({
      action: e,
      trackProps: o,
      ...
      return p
        ...
        : _
          ? d && -1 !== d.indexOf(e) && !S
            ? null
            : (0, n.createElement)(m, {
                recordScoreCallback: (t, s, r) => {
                  ((0, w.recordEvent)("ces_feedback", {
                    action: e,
                    score: t,
                    score_second_question: s,
                    score_combined: t + s,
                    comments: r || "",
                    store_age: f,
                    ces_location: "inside",
                ...
                onNoticeShownCallback: () => {
                  ((0, w.recordEvent)("ces_snackbar_view", {
                    action: e,
                    store_age: f,
                    ces_location: "inside",
                    ...o,
                ...
                onNoticeDismissedCallback: () => {
                  (0, w.recordEvent)("ces_snackbar_dismiss", {
                    action: e,
                    store_age: f,
                    ces_location: "inside",
                    ...o,
                ...
                onModalDismissedCallback: () => {
                  (0, w.recordEvent)("ces_view_dismiss", {
                    action: e,
                    store_age: f,
                    ces_location: "inside",
                    ...o,
                ...
                icon: (0, n.createElement)(
                  "span",
                  {
                    style: { height: 21, width: 21 },
                    role: "img",
                    "aria-label": (0, c.__)("Pencil icon", "woocommerce"),
                  },
                  l || "✏",
                ),
              })
    ...
    oe = (0, J.compose)(
      (0, i.withSelect)((e) => {
        const { getCesSurveyQueue: o, isResolving: t } = e(O);
        return { queue: o(), resolving: t("getOption", [T]) };
      }),
      (0, i.withDispatch)((e) => {
        const { updateOptions: o } = e(_.optionsStore);
        return {
          clearQueue: () => {
            o({
    ...
    )(function ({ queue: e, resolving: o, clearQueue: t }) {
      const s = e.filter(
        (e) => e.pagenow === window.pagenow && e.adminpage === window.adminpage,
      );
      return (
        (0, ee.useEffect)(() => {
          s.length && t();
  ...
  function te(e) {
    ...
    if ("string" == typeof e || "number" == typeof e) s += e;
      ...
      if (Array.isArray(e)) {
        var r = e.length;
        for (o = 0; o < r; o++)
          e[o] && (t = te(e[o])) && (s && (s += " "), (s += t));
      } else for (t in e) e[t] && (s && (s += " "), (s += t));
    return s;
  }
  const se = function () {
    for (var e, o, t = 0, s = "", r = arguments.length; t < r; t++)
      (e = arguments[t]) && (o = te(e)) && (s && (s += " "), (s += o));
    return s;
  };
  function re({ onSelect: e, label: o, selectedValue: t }) {
    const s = [
      {
        tooltip: (0, c.__)("Very difficult", "woocommerce"),
        value: 1,
        emoji: "😞",
      },
      { tooltip: (0, c.__)("Difficult", "woocommerce"), value: 2, emoji: "🙁" },
      { tooltip: (0, c.__)("Neutral", "woocommerce"), value: 3, emoji: "😑" },
      { tooltip: (0, c.__)("Good", "woocommerce"), value: 4, emoji: "🙂" },
      { tooltip: (0, c.__)("Very good", "woocommerce"), value: 5, emoji: "😍" },
    ];
          ...
          (0, n.createElement)(
            ...
            (0, n.createElement)(
              a.Button,
              {
                ...
                className: se({ "is-selected": t === o.value }),
              },
              o.emoji,
            ),
          ),
  ...
  function ne({
    ...
    onCancel: r,
    children: c,
    isSubmitButtonDisabled: i,
    submitButtonLabel: u,
    cancelButtonLabel: d,
    className: m,
  }) {
    const [_, w] = (0, n.useState)(!0);
    return _
      ? (0, n.createElement)(
          a.Modal,
          {
            className: se("woocommerce-feedback-modal", m),
            title: o,
            onRequestClose: () => {
              (w(!1), s && s());
            },
          ...
          (0, n.createElement)(
            ...
            (0, n.createElement)(
              a.Button,
              { isTertiary: !0, onClick: r, name: "cancel" },
              d,
            ),
            (0, n.createElement)(
              a.Button,
  ...
  const ce = () => {
      const { showCesModal: e, showProductMVPFeedbackModal: o } = (0,
        i.useDispatch)(O),
        { updateOptions: t } = (0, i.useDispatch)(_.optionsStore),
        { wasPreviouslyShown: s, isLoading: r } = (0, i.useSelect)((e) => {
          const { getOption: o, hasFinishedResolution: t } = e(_.optionsStore),
            s = o(g) || [];
          return {
            wasPreviouslyShown: (e) => s.includes(e),
            isLoading: !t("getOption", [g]),
          };
        }, []);
      return {
        wasPreviouslyShown: s,
        isLoading: r,
        showCesModal: (o = {}, s = {}, r = {}, n = {}) => {
          (e(o, s, r, n),
            (async (e) => {
              const { getOption: o } = (0, i.resolveSelect)(_.optionsStore),
                s = (await o(g)) || [];
              t({ [g]: [e, ...s] });
            })(o.action));
        },
  ...
  (window.wc = window.wc || {}).customerEffortScore = o;
})();
