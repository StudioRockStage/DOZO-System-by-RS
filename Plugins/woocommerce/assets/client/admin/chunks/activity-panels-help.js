  ...
  [7956],
  {
    ...
    85810: (e, o, t) => {
      (t.r(o),
        t.d(o, {
          HelpPanel: () => x,
          SETUP_TASK_HELP_ITEMS_FILTER: () => y,
          default: () => S,
        }));
      var c = t(27723),
        m = t(14908),
        ...
        g = t(18886),
        k = t(39793);
      const y = "woocommerce_admin_setup_task_help_items";
      function f(e, o) {
        const { taskName: t } = e;
        o &&
      ...
      const x = ({ taskName: e, recordEvent: o = h.recordEvent, ...t }) => {
          (0, r.useEffect)(() => {
            o("help_panel_open", { task_name: e || "homescreen" });
          }, [e, o]);
          const n = (function (e) {
            const o = (function (e) {
                const { taskName: o } = e;
                    ...
                    return (function (e) {
                      const { countryCode: o, taskLists: t } = e,
                        m = t
                          ...
                          .find((e) => "tax" === e.id);
                      if (!m) return;
                      const { additionalData: n } = m,
                        {
                          woocommerceTaxCountries: r = [],
                          taxJarActivated: i,
                          woocommerceTaxActivated: u,
                          woocommerceShippingActivated: s,
                        } = n,
                        a = !i && r.includes(o) && !u && !s;
                      return [
                        {
                          title: (0, c.__)(
            ...
            o.push(t);
            const n = (0, i.applyFilters)(y, o, e.taskName, e);
            let r = Array.isArray(n)
              ? n.filter((e) => e instanceof Object && e.title && e.link)
              : [];
            r.length || (r = [t]);
            const l = (0, p.partial)(f, e);
            return r.map((e) => {
              var o, t;
              return {
                title: (0, k.jsx)(m.Text, {
                  as: "div",
                  variant: "button",
                  weight: "600",
                  size: "14",
                ...
                before: (0, k.jsx)(u.A, { icon: s.A }),
                after: (0, k.jsx)(u.A, { icon: a.A }),
                linkType:
        ...
        S = (0, _.Zz)(
          (0, n.withSelect)((e) => {
            const { getSettings: o } = e(d.settingsStore),
              { getActivePlugins: t } = e(d.pluginsStore),
              { general: c = {} } = o("general"),
              m = t(),
              n = e(d.onboardingStore)
                .getPaymentGatewaySuggestions()
                .reduce((e, o) => {
                  const { id: t } = o;
                  return ((e[t] = !0), e);
                }, {}),
              r = e(d.onboardingStore).getTaskLists();
            return {
              activePlugins: m,
              countryCode: (0, g.gI)(c.woocommerce_default_country),
    ...
    18886: (e, o, t) => {
      ...
      function m(e, o, t = !1, c) {
        return (function (e, o = !1, t, c) {
          const m = [];
          return c
            ? ((e.product_types || []).forEach((e) => {
                c[e] &&
                  c[e].product &&
                  (o || !t.includes(c[e].slug)) &&
                  m.push(c[e]);
              }),
              m)
            : m;
        })(o, t, c, e).map((e) => e.id || e.product);
      }
      (t.d(o, { Dr: () => m, gI: () => c }), t(18537));
    },
  },
]);
