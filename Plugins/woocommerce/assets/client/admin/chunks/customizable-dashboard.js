  ...
  [3404],
  {
      ...
      class v extends n.Component {
        constructor() {
          (super(),
            ...
            (this.onAdvancedFilterAction =
              this.onAdvancedFilterAction.bind(this)));
        }
        onDateSelect(e) {
          const { report: t, addCesSurveyForAnalytics: o } = this.props;
          (o(),
            (0, h.recordEvent)("datepicker_update", {
              report: t,
              ...(0, s.omitBy)(e, s.isUndefined),
            }));
        }
        onFilterSelect(e) {
          const { report: t, addCesSurveyForAnalytics: o } = this.props,
            n = e.filter || e["filter-variations"];
          [
            "single_product",
            "single_category",
            "single_coupon",
          ...
          ("single_product" === e.filter &&
            (r.filter_variation = e["filter-variations"] || "all"),
            (0, h.recordEvent)("analytics_filter", r));
        }
        onAdvancedFilterAction(e, t) {
          const { report: o, addCesSurveyForAnalytics: n } = this.props;
          switch (e) {
            case "add":
              (0, h.recordEvent)("analytics_filters_add", {
                report: o,
                filter: t.key,
              });
              break;
            case "remove":
              (0, h.recordEvent)("analytics_filters_remove", {
                report: o,
                filter: t.key,
              });
              break;
            case "filter":
              const e = Object.keys(t).reduce(
                (e, o) => ((e[(0, s.snakeCase)(o)] = t[o]), e),
                {},
              );
              (n(),
                (0, h.recordEvent)("analytics_filters_filter", {
                  report: o,
                  ...e,
                }));
              break;
            case "clear_all":
              (0, h.recordEvent)("analytics_filters_clear_all", { report: o });
              break;
            case "match":
              (0, h.recordEvent)("analytics_filters_all_any", {
                report: o,
                value: t.match,
              });
          }
        ...
        render() {
          const {
            ...
            } = this.props,
            {
              ...
              before: l,
              after: h,
            } = (0, d.getDateParamsFromQuery)(n, s),
            { primary: u, secondary: v } = (0, d.getCurrentDates)(n, s),
            f = {
              period: i,
              compare: a,
              before: l,
            ...
            _ = this.context;
          return (0, m.jsx)(c.ReportFilters, {
            query: n,
            siteLocale: p.ne.siteLocale,
            ...
            dateQuery: f,
            isoDateFormat: d.isoDateFormat,
          });
        }
      }
      v.contextType = u.CurrencyContext;
      const f = (0, r.compose)(
        (0, i.withSelect)((e) => {
        ...
        (0, i.withDispatch)((e) => {
          const { addCesSurveyForAnalytics: t } = e(a.STORE_KEY);
    ...
    53847: (e, t, o) => {
      ...
      var n = o(27723),
        ...
        d = o(5573),
        h = o(39793);
      const u = (0, h.jsx)(d.SVG, {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 24 24",
        children: (0, h.jsx)(d.Path, {
      ...
      var x = o(47603);
      const k = (0, r.lazy)(() =>
          Promise.all([o.e(2304), o.e(1133)]).then(o.bind(o, 31861)),
        ),
        j = (0, r.lazy)(() => o.e(823).then(o.bind(o, 39254))),
        C = (0, r.lazy)(() => o.e(6115).then(o.bind(o, 92072))),
        S = "woocommerce_dashboard_default_sections",
        A = (0, c.applyFilters)(S, [
          {
            key: "store-performance",
            component: (e) =>
              (0, h.jsx)(r.Suspense, {
                fallback: (0, h.jsx)(m.Spinner, {}),
                children: (0, h.jsx)(C, { ...e }),
              }),
            title: (0, n.__)("Performance", "woocommerce"),
            isVisible: !0,
            icon: w,
            hiddenBlocks: [
              "coupons/amount",
          ...
          },
          {
            ...
            title: (0, n.__)("Charts", "woocommerce"),
            isVisible: !0,
            icon: b,
            hiddenBlocks: [
          ...
          },
          {
            ...
            component: (e) =>
              (0, h.jsx)(r.Suspense, {
                fallback: (0, h.jsx)(m.Spinner, {}),
                children: (0, h.jsx)(j, { ...e }),
              }),
            title: (0, n.__)("Leaderboards", "woocommerce"),
            isVisible: !0,
            icon: (0, h.jsx)(x.A, {}),
      ...
      class D extends r.Component {
        ...
        render() {
          ...
          return (0, h.jsxs)(r.Fragment, {
            children: [
              (0, h.jsx)("div", {
                className: "woocommerce-ellipsis-menu__item",
                children: (0, h.jsx)(a.TextControl, {
                  label: (0, n.__)("Section title", "woocommerce"),
                  onBlur: s,
                  onChange: i,
                  required: !0,
                  value: c,
                  ...
                  !t &&
                    (0, h.jsxs)(m.MenuItem, {
                      ...
                      children: [
                        (0, h.jsx)(l.A, {
                          icon: (0, h.jsx)(B.A, {}),
                          label: (0, n.__)("Move up", "woocommerce"),
                          size: 20,
                          className: "icon-control",
                        }),
                        (0, n.__)("Move up", "woocommerce"),
                      ],
                    }),
                  !o &&
                    (0, h.jsxs)(m.MenuItem, {
                      ...
                      children: [
                        (0, h.jsx)(l.A, {
                          icon: (0, h.jsx)(F.A, {}),
                          size: 20,
                          label: (0, n.__)("Move down", "woocommerce"),
                          className: "icon-control",
                        }),
                        (0, n.__)("Move down", "woocommerce"),
                      ],
                    }),
                  (0, h.jsxs)(m.MenuItem, {
                    isClickable: !0,
                    ...
                    children: [
                      (0, h.jsx)(l.A, {
                        icon: O.A,
                        size: 20,
                        label: (0, n.__)("Remove block", "woocommerce"),
                        className: "icon-control",
                      }),
                      (0, n.__)("Remove section", "woocommerce"),
                    ],
                  }),
                ],
              }),
      ...
      class T extends r.Component {
        ...
        onTitleBlur() {
          const { onTitleUpdate: e, title: t } = this.props,
            { titleInput: o } = this.state;
          "" === o ? this.setState({ titleInput: t }) : e && e(o);
        }
        onToggleHiddenBlock(e) {
          return () => {
            const t = (0, i.xor)(this.props.hiddenBlocks, [e]);
      ...
      var E = o(88711);
      const V = (0, c.applyFilters)("woocommerce_admin_dashboard_filters", []),
        z = (0, s.compose)(
          (0, p.withSelect)((e) => {
            const { woocommerce_default_date_range: t } = e(
              v.settingsStore,
        ...
        )(({ defaultDateRange: e, path: t, query: o }) => {
          const { updateUserPreferences: s, ...c } = (0,
            v.useUserPreferences)(),
            d = (0, r.useMemo)(
              () =>
                ((e) => {
                  ...
                  if (!Array.isArray(A))
                    throw new Error(
                      `The \`defaultSections\` is not an array, please make sure \`${S}\` filter is used correctly.`,
                    );
                  ...
                  return (
                    n.forEach((t) => {
                      const o = A.find((e) => e.key === t);
                      if (!o) return;
                      const n = e.find((e) => e.key === t);
                      (n && delete n.icon, r.push({ ...o, ...n }));
                    }),
                    r
                  );
                })(c.dashboard_sections),
              [c.dashboard_sections],
            ),
            p = (e) => {
              s({ dashboard_sections: e });
            },
            w = (e, t) => {
              const o = d.map(
                (o) => (delete o.icon, o.key === e ? { ...o, ...t } : o),
              );
              p(o);
            },
            b = (e) => (t) => {
              ((0, g.recordEvent)("dash_section_rename", { key: e }),
                w(e, { title: t }));
            },
            x = (e, t) => () => {
              t && t();
              const o = d.findIndex((t) => e === t.key),
                n = d.splice(o, 1).shift();
              ((n.isVisible = !n.isVisible),
                d.push(n),
                n.isVisible
                  ? (0, g.recordEvent)("dash_section_add", { key: n.key })
                  : (0, g.recordEvent)("dash_section_remove", { key: n.key }),
                p(d));
            },
            k = (e, t) => {
              const o = d.splice(e, 1).shift(),
                n = e + t;
              if (
                d[t < 0 ? n : n - 1].isVisible ||
                0 === e ||
                e === d.length - 1
              ) {
                (d.splice(n, 0, o), p(d));
                const e = { key: o.key, direction: t > 0 ? "down" : "up" };
              ...
              return 0 === e.length
                ...
                : (0, h.jsx)(a.Dropdown, {
                    ...
                    renderToggle: ({ onToggle: e, isOpen: t }) =>
                      (0, h.jsx)(a.Button, {
                        onClick: e,
                        title: (0, n.__)("Add more sections", "woocommerce"),
                        "aria-expanded": t,
                        children: (0, h.jsx)(l.A, { icon: u }),
                      }),
                            ...
                            children: e.map((e) =>
                              (0, h.jsxs)(
                                a.Button,
                                {
                                  ...
                                  title: (0, n.sprintf)(
                                    (0, n.__)("Add %s section", "woocommerce"),
                                    e.title,
                                  ),
                                  children: [
                                    (0, h.jsx)(l.A, {
          ...
          return (0, h.jsx)(y.CurrencyContext.Provider, {
            value: (0, y.getFilteredCurrencyInstance)((0, f.getQuery)()),
            children: (() => {
              const {
                  period: n,
                  compare: r,
                  before: s,
                  after: a,
                } = (0, _.getDateParamsFromQuery)(o, e),
                { primary: c, secondary: l } = (0, _.getCurrentDates)(o, e),
                u = {
                  period: n,
                  compare: r,
                  before: s,
                ...
                p = d.filter((e) => e.isVisible).map((e) => e.key);
                    ...
                    return n.isVisible
                      ? (0, h.jsx)(
                          T,
                          {
                            ...
                            hiddenBlocks: n.hiddenBlocks,
                            onChangeHiddenBlocks:
                              ((s = n.key),
                              (e) => {
                                w(s, { hiddenBlocks: e });
                              }),
                            onTitleUpdate: b(n.key),
                            path: t,
                            defaultDateRange: e,
                            query: o,
                            title: n.title,
                            onMove: (0, i.partial)(k, r),
                            onRemove: x(n.key),
                            isFirst: n.key === p[0],
                            isLast: n.key === p[p.length - 1],
                            filters: V,
                          },
                          n.key,
                        )
    ...
    49649: (e, t, o) => {
      t.A = function (e) {
        var t = e.size,
          ...
          l = ["gridicon", "gridicons-chevron-down", a, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return r.default.createElement(
          "svg",
          i({ className: l, height: o, width: o, onClick: n }, c, {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          }),
      ...
      var n,
        r = (n = o(51609)) && n.__esModule ? n : { default: n },
    ...
    98672: (e, t, o) => {
      t.A = function (e) {
        var t = e.size,
          ...
          l = ["gridicon", "gridicons-chevron-up", a, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return r.default.createElement(
          "svg",
