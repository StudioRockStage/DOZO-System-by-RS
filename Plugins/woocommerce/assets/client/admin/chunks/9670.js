  ...
  [9670],
  {
    ...
    10952: (e, o, t) => {
      ...
      const i = ({ onCancel: e, onImport: o }) =>
        (0, s.jsxs)(c.Modal, {
          ...
          title: (0, r.__)("Load sample products", "woocommerce"),
          onRequestClose: e,
          children: [
            (0, s.jsx)(n.Text, {
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                (0, s.jsx)(c.Button, {
                  isSecondary: !0,
                  onClick: e,
                  children: (0, r.__)("Cancel", "woocommerce"),
                }),
                (0, s.jsx)(c.Button, {
                  isPrimary: !0,
                  onClick: o,
                  children: (0, r.__)("Import sample products", "woocommerce"),
                }),
              ],
            }),
          ],
        ...
        (0, s.jsxs)(c.Modal, {
          ...
          children: [
            ...
            (0, s.jsx)(n.Text, {
              ...
              children: (0, r.__)("Loading sample products", "woocommerce"),
            }),
            (0, s.jsx)(n.Text, {
    ...
    71506: (e, o, t) => {
      ...
      var r = t(27723),
        ...
        l = t(83306),
        d = t(85259);
      const m = ({ redirectUrlAfterSuccess: e }) => {
        const [o, t] = (0, a.useState)(!1),
          { createNotice: c } = (0, i.useDispatch)("core/notices"),
          { recordCompletionTime: m } = (0, d.A)("products");
        return {
          loadSampleProduct: async () => {
            ((0, l.recordEvent)("tasklist_add_product", {
            ...
            try {
              if (
                (await n()({
                  path: `${s.WC_ADMIN_NAMESPACE}/onboarding/tasks/import_sample_products`,
                  method: "POST",
                }),
                e)
              )
    ...
    30288: (e, o, t) => {
      ...
      const p = () =>
        ...
        w = Object.freeze([
          {
            key: "physical",
            title: (0, r.__)("Physical product", "woocommerce"),
            content: (0, r.__)(
              "A tangible item that gets delivered to customers.",
              "woocommerce",
            ),
            before: (0, m.jsx)(c.A, {}),
            after: (0, m.jsx)(i.A, { icon: a.A }),
          },
          {
            key: "digital",
            title: (0, r.__)("Digital product", "woocommerce"),
            content: (0, r.__)(
          ...
          {
            key: "variable",
            title: (0, r.__)("Variable product", "woocommerce"),
            content: (0, r.__)(
          ...
          {
            key: "grouped",
            title: (0, r.__)("Grouped product", "woocommerce"),
            content: (0, r.__)(
          ...
          {
            key: "external",
            title: (0, r.__)("External product", "woocommerce"),
            content: (0, r.__)(
              "Link a product to an external website.",
              "woocommerce",
            ),
            before: (0, m.jsx)(p, {}),
            after: (0, m.jsx)(i.A, { icon: a.A }),
        ...
        _ =
          ((0, r.__)("can’t decide?", "woocommerce"),
          (0, r.__)(
          ...
          a.A,
          {
            key: "printful-advert",
            title: (0, m.jsx)("span", {
              className: "printful-sponsored__text",
              children: (0, r.__)("Print-on-demand products", "woocommerce"),
            }),
            content: (0, r.__)(
        ...
        f = {
          ...
          after: null,
          onClick: () => {
            ((0, l.recordEvent)("tasklist_add_product", { method: "import" }),
        ...
        g = v.physical,
        y = ["physical", "downloads"],
        k = "experimental_woocommerce_tasklist_product_types",
        x = "woocommerce_admin_task_products_after";
    },
    48958: (e, o, t) => {
      t.d(o, { A: () => m });
      var r = t(27723),
      ...
      const m = ({
        items: e,
        onClickLoadSampleProduct: o = () => {},
        showOtherOptions: t = !0,
        isTaskListItemClicked: m = !1,
      }) => {
        const { recordCompletionTime: p } = (0, l.A)("products");
        return (0, d.jsxs)("div", {
          ...
          children: [
            m &&
              (0, d.jsx)("div", {
                ...
                children: (0, d.jsx)(c.Spinner, { className: "list-overlay" }),
              }),
            (0, d.jsx)(c.List, { items: e }),
            t &&
              (0, d.jsx)(n.Text, {
                ...
                children: (0, s.A)({
                  ...
                  components: {
                    sbLink: (0, d.jsx)(c.Link, {
                      onClick: () => (
                        (0, a.recordEvent)("tasklist_add_product", {
                          method: "manually",
                        }),
                        p(),
    ...
    51614: (e, o, t) => {
      ...
      var r = t(86087),
        ...
        d = t(46772),
        m = t(56109);
      const p = (e, o = [], { onClick: t } = {}) => {
        const { createProductByType: p, isRequesting: u } = (() => {
          const { createProductFromTemplate: e } = (0, n.useDispatch)(
              s.itemsStore,
            ),
            [o, t] = (0, r.useState)(!1),
            c = async (o) => {
              try {
                const t = await e(
                  { template_name: o, status: "draft" },
                  { _fields: ["id"] },
                );
                if (t && t.id)
                  return (0, a.getAdminLink)(
                    `post.php?post=${t.id}&action=edit&wc_onboarding_active_task=products&tutorial=true&tutorial_type=${o}`,
                  );
          ...
          return {
            createProductByType: async (e) => {
              if (
                ...
                const o = await c(e),
                  t = (0, m.Qk)("_feature_nonce");
                return void (window.location.href =
                  o + `&product_block_editor=1&_feature_nonce=${t}`);
              }
              const o = await c(e);
              (o && (0, i.navigateTo)({ url: o }), t(!1));
            },
            isRequesting: o,
          };
        })();
    ...
    64321: (e, o, t) => {
      ...
      var r = t(66087),
        ...
        n = t(30288);
      const s = ({ exclude: e } = {}) => {
          const o = (0, c.applyFilters)(n.VF, []);
          let t = [...n.vp, ...o];
          return (
            e && e?.length > 0 && (t = t.filter((o) => !e.includes(o.key))),
            t
          );
        },
        i = (e) => {
          const o = (0, r.intersection)(e, n.We).sort().join(",");
          return n.cT.hasOwnProperty(o) ? n.cT[o] : n.dH;
        };
    },
    85259: (e, o, t) => {
      t.d(o, { A: () => s });
      var r = t(86087),
        ...
        n = t(24060);
      const s = (e, o) => {
        const t = (0, r.useRef)(o || window.performance.now());
        return {
          recordCompletionTime: () => {
            (0, c.recordEvent)("task_completion_time", {
              task_name: e,
              time: (0, n.D8)(window.performance.now() - t.current),
            });
          },
        };
      };
    ...
    86753: (e, o, t) => {
      o.A = function (e) {
        var o = e.size,
          ...
          l = ["gridicon", "gridicons-cloud-outline", i, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return c.default.createElement(
          "svg",
          s({ className: l, height: t, width: t, onClick: r }, a, {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          }),
    ...
    98184: (e, o, t) => {
      o.A = function (e) {
        var o = e.size,
          ...
          l = ["gridicon", "gridicons-product", i, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return c.default.createElement(
          "svg",
          ...
          c.default.createElement(
            ...
            null,
            c.default.createElement("path", {
              d: "M22 3H2v6h1v11a2 2 0 002 2h14a2 2 0 002-2V9h1V3zM4 5h16v2H4V5zm15 15H5V9h14v11zM9 11h6a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
            }),
          ),
        );
      };
    ...
    26742: (e, o, t) => {
      o.A = function (e) {
        var o = e.size,
          ...
          l = ["gridicon", "gridicons-types", i, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return c.default.createElement(
          "svg",
          ...
          c.default.createElement(
            ...
            null,
            c.default.createElement("path", {
              d: "M22 17a5 5 0 11-10.001-.001A5 5 0 0122 17zM6.5 6.5h3.8L7 1 1 11h5.5V6.5zm9.5 4.085V8H8v8h2.585A6.505 6.505 0 0116 10.585z",
            }),
          ),
        );
      };
