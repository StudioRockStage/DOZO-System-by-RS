/*! For license information please see 9568.js.LICENSE.txt */
    ...
    73572: (t, e, n) => {
      ...
      e.A = function (t) {
        ...
        return s.default.createElement(
          "svg",
          i({ className: h, height: n, width: n, onClick: r }, a, {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          }),
      ...
      var r,
        s = (r = n(51609)) && r.__esModule ? r : { default: r },
    ...
    42851: (t, e, n) => {
      ...
      var r,
        ...
        u = (t, e) => {
          ...
          if (l) for (var n of l(e)) h.call(e, n) && c(t, n, e[n]);
          return t;
        },
        d = (t, e) => {
          var n = {};
      ...
      (((t) => {
        const e = class {
          ...
          static encodeText(n, r) {
            const s = t.QrSegment.makeSegments(n);
            return e.encodeSegments(s, r);
          }
          static encodeBinary(n, r) {
            const s = t.QrSegment.makeBytes(n);
            return e.encodeSegments([s], r);
          }
          static encodeSegments(t, n, s = 1, i = 40, a = -1, h = !0) {
            if (
              !(e.MIN_VERSION <= s && s <= i && i <= e.MAX_VERSION) ||
              a < -1 ||
              a > 7
            )
            ...
            let c, u;
            for (c = s; ; c++) {
              const r = 8 * e.getNumDataCodewords(c, n),
                s = l.getTotalBits(t, c);
              if (s <= r) {
                u = s;
                break;
              }
              if (c >= i) throw new RangeError("Data too long");
            }
            for (const t of [e.Ecc.MEDIUM, e.Ecc.QUARTILE, e.Ecc.HIGH])
              h && u <= 8 * e.getNumDataCodewords(c, t) && (n = t);
            let d = [];
            for (const e of t) {
              (r(e.mode.modeBits, 4, d),
                r(e.numChars, e.mode.numCharCountBits(c), d));
              for (const t of e.getData()) d.push(t);
            }
            o(d.length == u);
            const f = 8 * e.getNumDataCodewords(c, n);
            (o(d.length <= f),
            ...
            for (let n = 0; n < e; n++)
              for (let r = 0; r < e; r++)
                (0 == n && 0 == r) ||
                  (0 == n && r == e - 1) ||
                  (n == e - 1 && 0 == r) ||
                  this.drawAlignmentPattern(t[n], t[r]);
            (this.drawFormatBits(0), this.drawVersion());
          }
          drawFormatBits(t) {
            const e = (this.errorCorrectionLevel.formatBits << 3) | t;
            let n = e;
            for (let t = 0; t < 10; t++) n = (n << 1) ^ (1335 * (n >>> 9));
            const r = 21522 ^ ((e << 10) | n);
            o(r >>> 15 == 0);
            for (let t = 0; t <= 5; t++) this.setFunctionModule(8, t, s(r, t));
            (this.setFunctionModule(8, 7, s(r, 6)),
              this.setFunctionModule(8, 8, s(r, 7)),
              this.setFunctionModule(7, 8, s(r, 8)));
            for (let t = 9; t < 15; t++)
              this.setFunctionModule(14 - t, 8, s(r, t));
            for (let t = 0; t < 8; t++)
              this.setFunctionModule(this.size - 1 - t, 8, s(r, t));
            for (let t = 8; t < 15; t++)
              this.setFunctionModule(8, this.size - 15 + t, s(r, t));
          ...
          drawVersion() {
            ...
            for (let t = 0; t < 18; t++) {
              const n = s(e, t),
                r = this.size - 11 + (t % 3),
                o = Math.floor(t / 3);
              (this.setFunctionModule(r, o, n),
                this.setFunctionModule(o, r, n));
            }
          }
          drawFinderPattern(t, e) {
            for (let n = -4; n <= 4; n++)
              for (let r = -4; r <= 4; r++) {
                const s = Math.max(Math.abs(r), Math.abs(n)),
                  o = t + r,
                  i = e + n;
                0 <= o &&
                  o < this.size &&
                  0 <= i &&
                  i < this.size &&
                  this.setFunctionModule(o, i, 2 != s && 4 != s);
              }
          }
          ...
          addEccAndInterleave(t) {
            ...
            const s = e.NUM_ERROR_CORRECTION_BLOCKS[r.ordinal][n],
              ...
              l = Math.floor(e.getNumRawDataModules(n) / 8),
              a = s - (l % s),
              h = Math.floor(l / s);
            let c = [];
            const u = e.reedSolomonComputeDivisor(i);
            for (let n = 0, r = 0; n < s; n++) {
              let s = t.slice(r, r + h - i + (n < a ? 0 : 1));
              r += s.length;
              const o = e.reedSolomonComputeRemainder(s, u);
              (n < a && s.push(0), c.push(s.concat(o)));
            }
            let d = [];
            for (let t = 0; t < c[0].length; t++)
              c.forEach((e, n) => {
                (t != h - i || n >= a) && d.push(e[t]);
              });
            return (o(d.length == l), d);
          }
          drawCodewords(t) {
            if (
            ...
            for (let e = this.size - 1; e >= 1; e -= 2) {
              ...
              for (let r = 0; r < this.size; r++)
                for (let o = 0; o < 2; o++) {
                  const i = e - o,
                    l = (e + 1) & 2 ? r : this.size - 1 - r;
                  !this.isFunction[l][i] &&
                    n < 8 * t.length &&
                    ((this.modules[l][i] = s(t[n >>> 3], 7 - (7 & n))), n++);
                }
            }
            o(n == 8 * t.length);
          }
          applyMask(t) {
            ...
            for (let e = 0; e < this.size; e++)
              for (let n = 0; n < this.size; n++) {
                ...
                !this.isFunction[e][n] &&
                  r &&
                  (this.modules[e][n] = !this.modules[e][n]);
              }
          }
          getPenaltyScore() {
            let t = 0;
            for (let n = 0; n < this.size; n++) {
              ...
              for (let i = 0; i < this.size; i++)
                this.modules[n][i] == r
                  ? (s++, 5 == s ? (t += e.PENALTY_N1) : s > 5 && t++)
                  : (this.finderPenaltyAddHistory(s, o),
                    r ||
                      (t += this.finderPenaltyCountPatterns(o) * e.PENALTY_N3),
                    (r = this.modules[n][i]),
                    (s = 1));
              t += this.finderPenaltyTerminateAndCount(r, s, o) * e.PENALTY_N3;
            }
            for (let n = 0; n < this.size; n++) {
              let r = !1,
                s = 0,
            ...
            for (let n = 0; n < this.size - 1; n++)
              for (let r = 0; r < this.size - 1; r++) {
                const s = this.modules[n][r];
                s == this.modules[n][r + 1] &&
                  s == this.modules[n + 1][r] &&
                  s == this.modules[n + 1][r + 1] &&
                  (t += e.PENALTY_N2);
              }
            let n = 0;
            for (const t of this.modules)
              n = t.reduce((t, e) => t + (e ? 1 : 0), n);
            const r = this.size * this.size,
              s = Math.ceil(Math.abs(20 * n - 10 * r) / r) - 1;
            return (
              o(0 <= s && s <= 9),
              (t += s * e.PENALTY_N4),
              o(0 <= t && t <= 2568888),
          ...
          getAlignmentPatternPositions() {
            if (1 == this.version) return [];
            {
              ...
              let n = [6];
              for (let r = this.size - 7; n.length < t; r -= e)
                n.splice(1, 0, r);
              return n;
            }
          }
          ...
          static reedSolomonComputeDivisor(t) {
            ...
            for (let s = 0; s < t; s++) {
              for (let t = 0; t < n.length; t++)
                ((n[t] = e.reedSolomonMultiply(n[t], r)),
                  t + 1 < n.length && (n[t] ^= n[t + 1]));
          ...
          static reedSolomonComputeRemainder(t, n) {
            ...
            for (const s of t) {
              const t = s ^ r.shift();
              (r.push(0),
                n.forEach((n, s) => (r[s] ^= e.reedSolomonMultiply(n, t))));
            }
            return r;
          }
        ...
        const i = class {
          constructor(t, e, n) {
            if (
              ((this.mode = t), (this.numChars = e), (this.bitData = n), e < 0)
            )
              throw new RangeError("Invalid argument");
          ...
          static makeNumeric(t) {
            ...
            for (let n = 0; n < t.length; ) {
              const s = Math.min(t.length - n, 3);
              (r(parseInt(t.substr(n, s), 10), 3 * s + 1, e), (n += s));
            }
            return new i(i.Mode.NUMERIC, t.length, e);
          }
          static makeAlphanumeric(t) {
            if (!i.isAlphanumeric(t))
            ...
            for (e = 0; e + 2 <= t.length; e += 2) {
              let s = 45 * i.ALPHANUMERIC_CHARSET.indexOf(t.charAt(e));
              ((s += i.ALPHANUMERIC_CHARSET.indexOf(t.charAt(e + 1))),
                r(s, 11, n));
            }
            return (
              e < t.length &&
                r(i.ALPHANUMERIC_CHARSET.indexOf(t.charAt(e)), 6, n),
              new i(i.Mode.ALPHANUMERIC, t.length, n)
            );
          }
          static makeSegments(t) {
            return "" == t
              ...
              : i.isNumeric(t)
                ? [i.makeNumeric(t)]
                : i.isAlphanumeric(t)
                  ? [i.makeAlphanumeric(t)]
                  : [i.makeBytes(i.toUtf8ByteArray(t))];
          }
          static makeEci(t) {
            let e = [];
            if (t < 0)
          ...
          static toUtf8ByteArray(t) {
            ...
            for (let n = 0; n < t.length; n++)
              "%" != t.charAt(n)
                ...
                : (e.push(parseInt(t.substr(n + 1, 2), 16)), (n += 2));
            return e;
          }
        };
        let l = i;
        ...
        ((t) => {
          ...
          ((t) => {
            ...
            let n = e;
            ((n.NUMERIC = new e(1, [10, 12, 14])),
              (n.ALPHANUMERIC = new e(2, [9, 11, 13])),
              (n.BYTE = new e(4, [8, 16, 16])),
              (n.KANJI = new e(8, [8, 10, 12])),
              (n.ECI = new e(7, [0, 0, 0])),
              (t.Mode = n));
      ...
      function A(t) {
        ...
        let A = f.QrCode.encodeText(n, g[s]).getModules();
        const R = a ? p : 0,
          z = A.length + 2 * R,
          x = (function (t, e, n, r) {
            ...
            const s = n ? p : 0,
              ...
              a = (r.width || i) * l,
              h = (r.height || i) * l,
              c = null == r.x ? t.length / 2 - a / 2 : r.x * l,
              u = null == r.y ? t.length / 2 - h / 2 : r.y * l;
            let d = null;
            if (r.excavate) {
              let t = Math.floor(c),
                e = Math.floor(u);
            ...
            return { x: c, y: u, h, w: a, excavation: d };
          })(A, r, a, h);
        let y = null;
        var P, N;
        null != h &&
          ...
          (null != x.excavation &&
            ...
            (A = P.slice().map((t, e) =>
              e < N.y || e >= N.y + N.h
                ? t
                : t.map((t, e) => (e < N.x || e >= N.x + N.w) && t),
            ))),
          (y = o().createElement("image", {
            xlinkHref: h.src,
            height: x.h,
            width: x.w,
            x: x.x + R,
          ...
          return (
            t.forEach(function (t, r) {
              ...
              t.forEach(function (o, i) {
                if (!o && null !== s)
                  return (
                    n.push(`M${s + e} ${r + e}h${i - s}v1H${s + e}z`),
                    void (s = null)
                  );
                if (i !== t.length - 1) o && null === s && (s = i);
                else {
                  if (!o) return;
                  null === s
                    ? n.push(`M${i + e},${r + e} h1v1H${i + e}z`)
                    : n.push(`M${s + e},${r + e} h${i + 1 - s}v1H${s + e}z`);
                }
              });
            }),
            n.join("")
        ...
        return o().createElement(
          "svg",
          u({ height: r, width: r, viewBox: `0 0 ${z} ${z}` }, c),
      ...
      t.exports = {
        ...
        findBestMatch: function (t, n) {
          ...
          for (let o = 0; o < n.length; o++) {
            const i = n[o],
              l = e(t, i);
            (r.push({ target: i, rating: l }), l > r[s].rating && (s = o));
          }
          return { ratings: r, bestMatch: r[s], bestMatchIndex: s };
        },
      };
    },
  },
