  ...
  [3534],
  {
    3246: (e, o, i) => {
      ...
      const m = ({
        ...
        const u = o.match(/{{Link}}(.*?){{\/Link}}/),
          h = u ? u[1] : "",
          M = "external" === p && "_blank" === d;
        return (0, a.jsx)(t.Text, {
          ...e,
          children: (0, s.A)({
            mixedString: o,
            components: {
              Link: (0, a.jsx)(n.Link, {
                onClick: () => {
                  if ((g ? g() : (0, c.recordEvent)(i, m), "external" !== p))
                    return ((window.location.href = l), !1);
                },
                href: l,
                type: p,
                target: M ? "_blank" : void 0,
                "aria-label": M
                  ? `${h} (${(0, r.__)("opens in a new tab", "woocommerce")})`
                  : void 0,
              }),
            },
          }),
    ...
    18886: (e, o, i) => {
      ...
      function s(e, o, i = !1, t) {
        return (function (e, o = !1, i, t) {
          const s = [];
          return t
            ? ((e.product_types || []).forEach((e) => {
                t[e] &&
                  t[e].product &&
                  (o || !i.includes(t[e].slug)) &&
                  s.push(t[e]);
              }),
              s)
            : s;
        })(o, i, t, e).map((e) => e.id || e.product);
      }
      (i.d(o, { Dr: () => s, gI: () => t }), i(18537));
    },
    97607: (e, o, i) => {
      (i.r(o), i.d(o, { default: () => E }));
      var t = i(47143),
        s = i(40314),
        n = i(18886),
        c = i(27723),
        ...
        d = i(3862),
        g = i(39793);
      const u = ({ isPluginInstalled: e }) => {
        const { layoutString: o } = (0, p.useLayoutContext)();
        return (0, g.jsxs)("div", {
          className:
            "woocommerce-list__item-inner woocommerce-shipping-plugin-item",
          children: [
            (0, g.jsx)("div", {
            ...
            (0, g.jsxs)("div", {
              ...
              children: [
                (0, g.jsxs)("span", {
                  ...
                  children: [
                    (0, c.__)("WooCommerce Shipping", "woocommerce"),
                    (0, g.jsx)(a.Pill, {
                      children: (0, c.__)("Recommended", "woocommerce"),
                    }),
                  ],
                }),
                (0, g.jsxs)("span", {
                  ...
                  children: [
                    ...
                    (0, g.jsx)("br", {}),
                    (0, g.jsx)(r.ExternalLink, {
                      href: "https://woocommerce.com/woocommerce-shipping/",
                      children: (0, c.__)("Learn more", "woocommerce"),
                    }),
                  ],
                }),
              ],
            ...
            (0, g.jsx)("div", {
              ...
              children: (0, g.jsx)(r.Button, {
                isSecondary: !0,
                onClick: () => {
                  ((0, l.recordEvent)("tasklist_click", {
                    task_name: "shipping-recommendation",
                    context: `${o}/wc-settings`,
                  }),
                    (0, m.navigateTo)({
                      url: (0, m.getNewPath)(
                        { task: "shipping-recommendation" },
                        "/",
                        {},
                      ),
                    }));
                ...
                children: e
                  ? (0, c.__)("Activate", "woocommerce")
                  : (0, c.__)("Get started", "woocommerce"),
              }),
            }),
          ],
        });
      ...
      var h = i(17336),
        M = i(86087);
      const N = "woocommerce_admin_reviewed_default_shipping_zones",
        w = "woocommerce_admin_created_default_shipping_zones",
        x = "woocommerce-settings-shipping-tour-floater-wrapper",
        j = "woocommerce-settings-smart-defaults-shipping-tour-floater",
        _ = "table.wc-shipping-zones",
        I = 'a[href*="woocommerce-shipping-settings"]',
        D = (e) => {
          const o = e.map((e) => {
              const o = document?.querySelector(e)?.getBoundingClientRect();
              if (!o)
                throw new Error(
                  "Shipping tour: Couldn’t find element with selector: " + e,
                );
              return o;
            }),
            i = document.querySelector(`.${x}`)?.getBoundingClientRect() || {
              top: 0,
              left: 0,
            },
            t = Math.min(...o.map((e) => e.top)),
            s = Math.min(...o.map((e) => e.left)),
            n = Math.max(...o.map((e) => e.right)) - s,
            c = Math.max(...o.map((e) => e.bottom)) - t,
            r = t - i.top;
          return { left: s - i.left, top: r, width: n, height: c };
        },
        y = ({ dims: e }) =>
          (0, g.jsx)("div", {
            style: { position: "relative", pointerEvents: "none", ...e },
            className: j,
          }),
        T = [
          [
        ...
        S = ({ step: e }) => {
          ...
          (0, M.useLayoutEffect)(() => {
            i.current?.parentElement &&
              i.current.parentElement.insertBefore(
                i.current,
                document.querySelector("table.wc-shipping-zones"),
              );
          }, []);
          const t = null !== (o = T[e]) && void 0 !== o ? o : T[T.length - 1],
            [s, n] = (0, M.useState)(D(t));
          (0, M.useEffect)(() => {
            n(D(t));
          ...
          const c = document.querySelector(_)?.parentElement;
          if (!c)
            throw new Error(
          ...
          return (0, M.createPortal)(
            (0, g.jsx)("div", {
              ...
              children: (0, g.jsx)(y, { dims: s }),
            }),
            c,
          );
        },
        z = ({ showShippingRecommendationsStep: e }) => {
          const { updateOptions: o } = (0, t.useDispatch)(s.optionsStore),
            { show: i, isUspsDhlEligible: r } = (() => {
              const {
                hasCreatedDefaultShippingZones: e,
                hasReviewedDefaultShippingOptions: o,
                businessCountry: i,
                isLoading: c,
              } = (0, t.useSelect)((e) => {
                const { hasFinishedResolution: o, getOption: i } = e(
                  s.optionsStore,
                );
                return {
                  isLoading:
                    !o("getOption", [w]) &&
                    !o("getOption", [N]) &&
                    !o("getOption", ["woocommerce_default_country"]),
                  hasCreatedDefaultShippingZones: "yes" === i(w),
                  hasReviewedDefaultShippingOptions: "yes" === i(N),
                  businessCountry: (0, n.gI)(i("woocommerce_default_country")),
                };
              }, []);
              return {
                isLoading: c,
                show:
                  ...
                  e &&
                  !o,
                isUspsDhlEligible: "US" === i,
              };
            })(),
            [m, p] = (0, M.useState)(0),
            { createNotice: d } = (0, t.useDispatch)("core/notices"),
            u = {
              placement: "auto",
              options: {
                effects: {
                ...
                callbacks: {
                  onNextStep: (e) => {
                    (p(e),
                      (0, l.recordEvent)(
                        "walkthrough_settings_shipping_next_click",
                        { step_name: u.steps[e - 1].meta.name },
                      ));
                  },
                  onPreviousStep: (e) => {
                    (p(e),
                      (0, l.recordEvent)(
                        "walkthrough_settings_shipping_back_click",
                        { step_name: u.steps[e + 1].meta.name },
                      ));
                  },
                },
              ...
              steps: [
                {
                  referenceElements: { desktop: `.${j}` },
                  meta: {
                    name: "shipping-zones",
                    heading: (0, c.__)("Shipping zones", "woocommerce"),
                    descriptions: {
                      desktop: (0, g.jsxs)(g.Fragment, {
                        children: [
                          (0, g.jsx)("span", {
                            children: (0, c.__)(
                ...
                },
                {
                  ...
                  meta: {
                    ...
                    heading: (0, c.__)("Shipping methods", "woocommerce"),
                    descriptions: {
                      desktop: (0, g.jsxs)(g.Fragment, {
                        children: [
                          (0, g.jsx)("span", {
              ...
              closeHandler: async (e, i, t) => {
                ((await o({ [N]: "yes" })).success ||
                  (d(
                    "error",
                    (0, c.__)(
                  ...
                  "close-btn" === t
                    ? (0, l.recordEvent)(
                        "walkthrough_settings_shipping_dismissed",
                        { step_name: e[i].meta.name },
                      )
                    : "done-btn" === t &&
                      (0, l.recordEvent)(
                        "walkthrough_settings_shipping_completed",
                      ));
              },
            };
          return (
            document.querySelector(I) &&
              r &&
              u.steps.push({
                referenceElements: { desktop: I },
                meta: {
                  name: "woocommerce-shipping",
                  heading: (0, c.__)("WooCommerce Shipping", "woocommerce"),
                  descriptions: {
                    desktop: (0, c.__)(
            ...
            e &&
              u.steps.push({
                referenceElements: {
                  desktop: "div.woocommerce-recommended-shipping-extensions",
                },
                meta: {
            ...
            (0, M.useEffect)(() => {
              i && (0, l.recordEvent)("walkthrough_settings_shipping_view");
            }, [i]),
            i
              ? (0, g.jsxs)("div", {
                  children: [
                    (0, g.jsx)(S, { step: m }),
                    (0, g.jsx)(a.TourKit, { config: u }),
                  ],
                })
              : null
          );
        ...
        E = () => {
          const {
            ...
            installedPlugins: o,
            countryCode: i,
            isSellingDigitalProductsOnly: c,
          } = (0, t.useSelect)((e) => {
            const o = e(s.settingsStore).getSettings("general"),
              { getActivePlugins: i, getInstalledPlugins: t } = e(
                s.pluginsStore,
              ),
              c = e(s.onboardingStore).getProfileItems().product_types;
            return {
              activePlugins: i(),
              installedPlugins: t(),
              countryCode: (0, n.gI)(o.general?.woocommerce_default_country),
              isSellingDigitalProductsOnly:
                1 === c?.length && "downloads" === c[0],
            };
          }, []);
          return e.includes("woocommerce-shipping") || "US" !== i || c
            ? (0, g.jsx)(z, { showShippingRecommendationsStep: !1 })
            : (0, g.jsxs)(g.Fragment, {
                children: [
                  (0, g.jsx)(z, { showShippingRecommendationsStep: !0 }),
                  (0, g.jsx)(h.ShippingRecommendationsList, {
                    children: (0, g.jsx)(u, {
                      isPluginInstalled: o.includes("woocommerce-shipping"),
                    }),
                  }),
                ],
              });
    ...
    17336: (e, o, i) => {
      (i.r(o),
        i.d(o, { ShippingRecommendationsList: () => _, default: () => I }));
      var t = i(27723),
        s = i(47143),
        n = i(86087),
        c = i(14908),
      ...
      const u = (0, n.createContext)(""),
        h = ({ onDismiss: e = () => null, children: o }) => {
          const { updateOptions: i } = (0, s.useDispatch)(r.optionsStore),
            c = (0, n.useContext)(u),
            a = () => {
              (e(), i({ [c]: "yes" }));
            };
          return (0, g.jsxs)(m.CardHeader, {
            children: [
              (0, g.jsx)("div", {
              ...
              (0, g.jsx)("div", {
                children: (0, g.jsx)(p.EllipsisMenu, {
                  label: (0, t.__)("Task List Options", "woocommerce"),
                  renderContent: () =>
                    (0, g.jsx)("div", {
                      className: "woocommerce-dismissable-list__controls",
                      children: (0, g.jsx)(m.Button, {
                        onClick: a,
                        children: (0, t.__)("Hide this", "woocommerce"),
                      }),
                    }),
                }),
              }),
        ...
        M = ({ children: e, className: o, dismissOptionName: i }) =>
          (0, s.useSelect)(
            (e) => {
              const { getOption: o, hasFinishedResolution: t } = e(
                  r.optionsStore,
                ),
                s = t("getOption", [i]),
                n = "yes" === o(i);
            ...
            ? (0, g.jsx)(m.Card, {
                size: "medium",
                className: (0, d.A)("woocommerce-dismissable-list", o),
                children: (0, g.jsx)(u.Provider, { value: i, children: e }),
              })
            : null;
      var N = i(3862);
      const w = ({ onSetupClick: e, pluginsBeingSetup: o }) => {
        const { createSuccessNotice: i } = (0, s.useDispatch)("core/notices"),
          n = (0, s.useSelect)(
            (e) => e(r.pluginsStore).isJetpackConnected(),
            [],
          );
        return (0, g.jsxs)("div", {
          className:
          ...
          children: [
            ...
            (0, g.jsxs)("div", {
              ...
              children: [
                (0, g.jsxs)("span", {
                  className: "woocommerce-list__item-title",
                  children: [
                    (0, t.__)("WooCommerce Shipping", "woocommerce"),
                    (0, g.jsx)(p.Pill, {
                      children: (0, t.__)("Recommended", "woocommerce"),
                    }),
                  ],
                }),
                (0, g.jsxs)("span", {
                  ...
                  children: [
                    ...
                    (0, g.jsx)("br", {}),
                    (0, g.jsx)(m.ExternalLink, {
                      href: "https://woocommerce.com/woocommerce-shipping/",
                      children: (0, t.__)("Learn more", "woocommerce"),
                    }),
                  ],
                }),
              ],
            ...
            (0, g.jsx)("div", {
              ...
              children: (0, g.jsx)(m.Button, {
                isSecondary: !0,
                onClick: () => {
                  e(["woocommerce-shipping"]).then(() => {
                    const e = [];
                    (n ||
                      e.push({
                        url: (0, a.getAdminLink)(
                ...
                isBusy: o.includes("woocommerce-shipping"),
                disabled: o.length > 0,
                children: (0, t.__)("Get started", "woocommerce"),
              }),
            }),
          ],
        });
      ...
      const _ = ({ children: e }) =>
            ...
            children: [
              ...
              (0, g.jsx)(m.CardFooter, {
                children: (0, g.jsx)(x.d, {
                  ...
                  linkType: (0, j.isFeatureEnabled)("marketplace")
                    ? "wc-admin"
                    : "external",
                  eventName:
        ...
        I = () => {
          const [e, o] = (() => {
            const [e, o] = (0, n.useState)([]),
              { installAndActivatePlugins: i } = (0, s.useDispatch)(
                r.pluginsStore,
              );
            return [
              e,
                ...
                e.length > 0
                  ...
                  : (o(t),
                    i(t)
                      ...
                      .catch((e) => ((0, l.R)(e), o([]), Promise.reject()))),
            ];
          })();
          return (0, s.useSelect)(
            (e) => e(r.pluginsStore).getActivePlugins(),
            [],
          ).includes("woocommerce-shipping")
            ? null
            : (0, g.jsx)(_, {
                children: (0, g.jsx)(w, {
                  pluginsBeingSetup: e,
    ...
    45761: (e, o, i) => {
      ...
      function n(e) {
        ...
        return Boolean(o?.is_enabled);
      }
    },
    50348: (e, o, i) => {
      i.d(o, { isFeatureEnabled: () => t.G7 });
      var t = i(45761);
    },
    3862: (e) => {
      e.exports =
