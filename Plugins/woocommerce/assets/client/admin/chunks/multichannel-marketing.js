  ...
  [7752],
  {
    ...
    7905: (e, t, a) => {
      ...
      var n = a(93832),
        ...
        o = a(56109);
      const s = (e, t = {}) => {
        const { pathname: a, search: s } = window.location,
          c = (0, r.getSetting)("connectNonce", "");
        return (
          (t = {
            "wccom-site": (0, o.Qk)("siteUrl"),
            "wccom-back": a + s,
            "wccom-woo-version": (0, r.getSetting)("wcVersion"),
            "wccom-connect-nonce": c,
            ...t,
          }),
          (0, n.addQueryArgs)(e, t)
        );
      };
    },
    12974: (e, t, a) => {
      a.d(t, { A: () => r });
      var n = a(42435);
      const r = (e) => ({ __html: (0, n.sanitizeHTML)(e) });
    },
    59810: (e, t, a) => {
      (a.r(t), a.d(t, { default: () => vt }));
      var n = {};
      (a.r(n),
        a.d(n, {
          receiveCampaignTypes: () => I,
          receiveCampaigns: () => D,
          receiveRecommendedChannelsError: () => f,
          receiveRecommendedChannelsSuccess: () => A,
          receiveRegisteredChannelsError: () => k,
          receiveRegisteredChannelsSuccess: () => y,
        }));
      var r = {};
      (a.r(r),
        a.d(r, {
          getCampaignTypes: () => b,
          getCampaigns: () => E,
          getRecommendedChannels: () => S,
          getRegisteredChannels: () => z,
        }));
      var o = {};
      (a.r(o),
        a.d(o, {
          getCampaignTypes: () => B,
          getCampaigns: () => P,
          getRecommendedChannels: () => T,
          getRegisteredChannels: () => L,
        }));
      var s = {};
      (a.r(s),
        a.d(s, {
          amazonEbayIntegration: () => G,
          automatewoo: () => Y,
          automatewooAlt: () => W,
          automatewooBirthdays: () => Y,
          automatewooReferrals: () => Y,
          blank: () => H,
          creativeMailByConstantContact: () => re,
          facebook: () => K,
          facebookForWoocommerce: () => K,
          googleAds: () => X,
          googleListingsAndAds: () => X,
          hubspotForWoocommerce: () => ee,
          integrationWithSalesforce: () => se,
          klaviyo: () => ne,
          mailchimpForWoocommerce: () => te,
          mailpoet: () => ae,
          pinterest: () => q,
          pinterestForWoocommerce: () => q,
          tiktokForBusiness: () => ce,
          trustpilotReviews: () => me,
          vimeo: () => le,
          woocommerceAmazonEbayIntegration: () => G,
          woocommerceFreeGiftCoupons: () => ge,
          woocommerceGroupCoupons: () => ue,
          woocommerceSmartCoupons: () => pe,
          woocommerceStoreCredit: () => de,
          woocommerceUrlCoupons: () => he,
          woocommerceZapier: () => ie,
          zeroBsCrm: () => oe,
        }));
      var c = a(86087),
        i = a(40314),
        l = a(30502),
        m = a(47143);
      const d = "wc/marketing-multichannel",
        g = "/wc-admin/marketing",
        h = "RECEIVE_REGISTERED_CHANNELS_SUCCESS",
        u = "RECEIVE_REGISTERED_CHANNELS_ERROR",
        p = "RECEIVE_RECOMMENDED_CHANNELS_SUCCESS",
        j = "RECEIVE_RECOMMENDED_CHANNELS_ERROR",
        x = "RECEIVE_CAMPAIGNS",
        w = "RECEIVE_CAMPAIGN_TYPES",
        C = {
      ...
      var M = a(66161);
      const _ = (e) => ({ type: "AWAIT_RESPONSE_JSON", response: e }),
        v = { ...M.controls, AWAIT_RESPONSE_JSON: (e) => e.response.json() },
        N = (e) =>
          ((e) => !!e && "object" == typeof e)(e) &&
          "code" in e &&
          "data" in e &&
          "message" in e,
        y = (e) => ({ type: h, payload: e }),
        k = (e) => ({ type: u, payload: e, error: !0 }),
        A = (e) => ({ type: p, payload: e }),
        f = (e) => ({ type: j, payload: e, error: !0 }),
        D = (e) => ({ type: x, ...e }),
        I = (e) =>
          N(e)
            ? { type: w, payload: e, error: !0 }
            : { type: w, payload: e, error: !1 },
        z = (e) => e.registeredChannels,
        S = (e) => e.recommendedChannels,
        E = (e, t, a) => {
          const n = `${t}-${a}`;
          return {
            campaignsPage: e.campaigns.pages[n] || null,
            meta: e.campaigns.meta,
          };
        },
        b = (e) => e.campaignTypes;
      function* L() {
        try {
          const e = yield (0, M.apiFetch)({ path: `${g}/channels` });
          yield y(e);
        } catch (e) {
          throw (N(e) && (yield k(e)), e);
        }
      }
      function* T() {
        try {
          const e = yield (0, M.apiFetch)({
            path: `${g}/recommendations?category=channels`,
          });
          yield A(e);
        } catch (e) {
          throw (N(e) && (yield f(e)), e);
        }
      }
      const O = (e) => {
      ...
      function* P(e, t) {
        try {
          const a = yield (0, M.apiFetch)({
              path: `${g}/campaigns?page=${e}&per_page=${t}`,
              parse: !1,
            }),
            n = O(a),
            r = yield _(a);
      ...
      function* B() {
        try {
          const e = yield (0, M.apiFetch)({ path: `${g}/campaign-types` });
          yield I(e);
        } catch (e) {
          N(e) && (yield I(e));
        }
      }
      const R = (0, m.createReduxStore)(d, {
        reducer: (e = C, t) => {
          switch (t.type) {
            case h:
          ...
          children: [
            (0, F.jsx)("defs", {
              children: (0, F.jsx)("clipPath", {
                id: "b",
                children: (0, F.jsx)("rect", { width: "100", height: "100" }),
              }),
            }),
            (0, F.jsxs)("g", {
              id: "a",
      ...
      var $ = a(27723),
        J = a(56109);
      const K = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/facebook.svg`,
          alt: (0, $.__)("Facebook", "woocommerce"),
          style: { padding: "4px" },
        }),
        q = (0, F.jsx)(Q.SVG, {
          width: "303",
        ...
        X = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/google.svg`,
          alt: (0, $.__)("Google", "woocommerce"),
          style: { padding: "4px" },
        }),
        ee = (0, F.jsxs)(Q.SVG, {
          xmlns: "http://www.w3.org/2000/svg",
        ...
        ne = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/klaviyo.png`,
          alt: (0, $.__)("Klaviyo", "woocommerce"),
        }),
        re = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/creative-mail-by-constant-contact.png`,
          alt: (0, $.__)("Creative Mail by Constant Contact", "woocommerce"),
        }),
        oe = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/jetpack-crm.svg`,
          alt: (0, $.__)("Jetpack CRM", "woocommerce"),
        }),
        se = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/salesforce.jpg`,
          alt: (0, $.__)("Salesforce", "woocommerce"),
        }),
        ce = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/tiktok.jpg`,
          alt: (0, $.__)("TikTok", "woocommerce"),
        }),
        ie = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/zapier.png`,
          alt: (0, $.__)("Zapier", "woocommerce"),
        }),
        le = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/vimeo.png`,
          alt: (0, $.__)("Vimeo", "woocommerce"),
        }),
        me = (0, F.jsx)("img", {
          src: `${J.GZ}images/marketing/trustpilot.png`,
          alt: (0, $.__)("Trustpilot", "woocommerce"),
        }),
        de = (0, F.jsx)(Q.SVG, {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
        ...
        render() {
          ...
          return (
            ...
            (0, F.jsx)("div", {
              ...
              children: (0, F.jsx)(V.A, { icon: t, size: 36 }),
            })
          );
        }
      }
      ...
      const ye = ({
          ...
          const [o, s] = (0, c.useState)(r),
            i = () => {
              s(!o);
            };
          return (0, F.jsxs)(_e.Card, {
            className: (0, U.A)("woocommerce-collapsible-card", a),
            children: [
              (0, F.jsxs)(_e.CardHeader, {
                onClick: i,
                children: [
                  (0, F.jsx)(Se, { children: e }),
                  (0, F.jsx)(_e.Button, {
                    isSmall: !0,
                    icon: o ? ve.A : Ne.A,
                    label: o
                      ? (0, $.__)("Expand", "woocommerce")
                      : (0, $.__)("Collapse", "woocommerce"),
                    onClick: i,
                  }),
                ],
              }),
              !o &&
                (0, F.jsxs)(F.Fragment, {
                  children: [
                    t,
                    !!n && (0, F.jsx)(_e.CardFooter, { children: n }),
                  ],
                }),
            ],
          });
        ...
        ke = ({
          ...
          (0, F.jsxs)(_e.CardBody, {
            className: (0, U.A)("woocommerce_marketing_plugin_card_body", e),
            children: [
              (0, F.jsx)("div", {
              ...
              (0, F.jsxs)("div", {
                ...
                children: [
                  (0, F.jsxs)("div", {
                    className:
                      "woocommerce_marketing_plugin_card_body__details-name",
                    children: [a, n],
                  }),
                  (0, F.jsx)("div", {
                    className:
      ...
      var Ae = a(83306);
      const fe = () =>
        (0, J.Qk)("allowMarketplaceSuggestions", !1)
          ? "woocommerce.com"
          : "plugin-woocommerce";
      var De = a(7905),
        Ie = a(46772);
      const ze = ({ plugin: e, onInstalledAndActivated: t = () => {} }) => {
          const [a, n] = (0, c.useState)(null),
            { installAndActivatePlugins: r } = (0, m.useDispatch)(
              i.pluginsStore,
            ),
            { installState: o } = (0, m.useSelect)(
              (t) => {
                const { getPluginInstallState: a } = t(i.pluginsStore);
                return { installState: a(e.product) };
              },
              [e.product],
            ),
            s = async () => {
              n(e.product);
              try {
                (0, Ae.recordEvent)("marketing_recommended_extension", {
                  name: e.title,
                  source: fe(),
                });
                const a = await r([e.product]);
                (t(e.product), (0, Ie.R)(a));
              } catch (e) {
                (0, Ie.R)(e);
              }
              n(null);
          ...
          return (0, F.jsx)(ke, {
            icon: (0, F.jsx)("img", { src: e.icon, alt: e.title }),
            name: e.title,
            pills: e.tags.map((e) =>
              (0, F.jsx)(we.Pill, { children: e.name }, e.slug),
            ),
            ...
            button: (() => {
              ...
              return "installed" === o
                ? (0, F.jsx)(_e.Button, {
                    ...
                    disabled: t,
                    onClick: s,
                    children: (0, $.__)("Activate", "woocommerce"),
                  })
                : e.direct_install
                  ? (0, F.jsx)(_e.Button, {
                      variant: "secondary",
                      ...
                      disabled: t,
                      onClick: s,
                      children: (0, $.__)("Install extension", "woocommerce"),
                    })
                  : (0, F.jsx)(_e.Button, {
                      variant: "secondary",
                      href: (0, De.r)(e.url),
                      ...
                      children: (0, $.__)("View details", "woocommerce"),
                    });
            })(),
          });
        },
        ...
        be = () =>
          (0, F.jsx)("div", {
            ...
            children: (0, F.jsx)(we.Spinner, {}),
          });
      var Le = a(6513);
      const Te = "woocommerce_marketing_overview_multichannel_banner_dismissed",
        Oe = () =>
          (0, m.useSelect)((e) => {
            const { hasFinishedResolution: t, getRecommendedChannels: a } =
                e(d),
              { data: n, error: r } = a(),
              { getActivePlugins: o } = e(i.pluginsStore),
              s = o(),
              c = n && (0, Z.differenceWith)(n, s, (e, t) => e.product === t);
            return {
              loading: !t("getRecommendedChannels", []),
              data: c,
              error: r,
            };
          }, []),
        ...
        Be = (e) => {
          const t = e.errors_count >= 1 ? "error" : "none",
            a =
              e.errors_count >= 1
                ? (0, $.sprintf)(
                    (0, $.__)("%d issues to resolve", "woocommerce"),
                    e.errors_count,
                  )
                : (0, $.__)("No issues to resolve", "woocommerce");
          return {
            slug: e.slug,
            title: e.name,
            description: e.description,
            ...
            syncStatus: Pe[e.product_listings_status],
            issueType: t,
            issueText: a,
          };
        },
        Re = () => {
          const { invalidateResolution: e } = (0, m.useDispatch)(d),
            t = (0, c.useCallback)(() => {
              e("getRegisteredChannels", []);
            }, [e]);
          return (0, m.useSelect)(
            (e) => {
              const { hasFinishedResolution: a, getRegisteredChannels: n } =
                  e(d),
                r = n();
              return {
        ...
        Ue = () => {
          const { installedPlugins: e, activatingPlugins: t } = (0,
            m.useSelect)((e) => {
              const { getInstalledPlugins: t, getActivatingPlugins: a } = e(
                l.M,
              );
            ...
            { loading: r, data: o } = Oe(),
            {
              activateInstalledPlugin: s,
              loadInstalledPluginsAfterActivation: c,
            } = (0, m.useDispatch)(l.M),
            i = a || r,
            d = (0, Z.chain)(e)
              .differenceWith(n || [], (e, t) => e.slug === t.slug)
              .differenceWith(o || [], (e, t) => e.slug === t.product)
              .value();
          return {
            data: i ? [] : d,
            activatingPlugins: t,
        ...
        Ze = () => {
          ...
          return (0, m.useSelect)(
            (e) => {
              const { hasFinishedResolution: a, getCampaignTypes: n } = e(d),
                r = n();
              return {
        ...
        Qe = (e = 1, t = 5) => {
          ...
          return (0, m.useSelect)(
            (n) => {
              const { hasFinishedResolution: r, getCampaigns: o } = n(d),
                { campaignsPage: s, meta: c } = o(e, t);
              return {
        ...
        Fe = (e) => new URL(e).origin !== location.origin,
        He = (e) => {
          const { className: t, ...a } = e,
            ...
            { refetch: i } = Re(),
            { data: l } = Oe(),
            { loadInstalledPluginsAfterActivation: m } = Ue(),
            d = !!o?.length,
            g = !!l?.length,
            h = (e) => {
              (s(), i(), m(e));
            };
          return (0, F.jsxs)(_e.Modal, {
            ...a,
            className: (0, U.A)(
              t,
              "woocommerce-marketing-create-campaign-modal",
            ),
            title: (0, $.__)("Create a new campaign", "woocommerce"),
            children: [
              (0, F.jsxs)("div", {
                ...
                children: [
                  (0, F.jsx)("div", {
                    className:
                      "woocommerce-marketing-new-campaigns__question-label",
                    children: d
                      ? (0, $.__)(
                          "Where would you like to promote your products?",
                          "woocommerce",
                        )
                      : (0, $.__)("No campaign types found.", "woocommerce"),
                  }),
                  o?.map((e) =>
                    (0, F.jsxs)(
                      _e.Flex,
                      {
                        ...
                        children: [
                          ...
                          (0, F.jsx)(_e.FlexBlock, {
                            children: (0, F.jsxs)(_e.Flex, {
                              direction: "column",
                              gap: 1,
                              children: [
                                (0, F.jsx)(_e.FlexItem, {
                                  className:
                                    "woocommerce-marketing-new-campaign-type__name",
                                  children: e.name,
                                }),
                                (0, F.jsx)(_e.FlexItem, {
                                  className:
                                    "woocommerce-marketing-new-campaign-type__description",
                          ...
                          (0, F.jsx)(_e.FlexItem, {
                            children: (0, F.jsx)(_e.Button, {
                              variant: "secondary",
                              href: e.createUrl,
                              target: Fe(e.createUrl) ? "_blank" : "_self",
                              children: (0, F.jsxs)(_e.Flex, {
                                gap: 1,
                                children: [
                                  (0, F.jsx)(_e.FlexItem, {
                      ...
                      !n &&
                        (0, F.jsx)(_e.FlexItem, {
                          children: l.map((e) =>
                            (0, F.jsx)(
                              ze,
                              { plugin: e, onInstalledAndActivated: h },
                              e.plugin,
                            ),
                          ),
                        }),
      ...
      var Ye = a(94302),
        We = a(48214);
      const $e = a.p + "e6774bfd47e76d1fdbb5.svg",
        Je = ({ onDismissClick: e, onAddChannelsClick: t }) => {
          const [a, n] = (0, c.useState)(!1),
            { data: r } = Re(),
            { data: o } = Oe(),
            { data: s } = Ze(),
            i = !(!r?.length || !s?.length),
                    ...
                    children: [
                      ...
                      (0, F.jsx)(_e.FlexItem, {
                        children: (0, F.jsxs)(_e.Flex, {
                          children: [
                            (0, F.jsx)("img", {
                              src: "data:image/svg+xml;base64,",
                              alt: (0, $.__)("WooCommerce logo", "woocommerce"),
                              width: "24",
                              height: "24",
                            }),
                            (0, F.jsx)(_e.FlexBlock, {
                      ...
                      children: [
                        ...
                        l &&
                          (0, F.jsx)(_e.Button, {
                            variant: "secondary",
                            onClick: t,
                            children: (0, $.__)("Add channels", "woocommerce"),
                          }),
                      ],
                    }),
                  a && (0, F.jsx)(He, { onRequestClose: () => n(!1) }),
                ],
              }),
              (0, F.jsxs)("div", {
                className:
                ...
                children: [
                  (0, F.jsx)(_e.Button, {
                    ...
                    onClick: e,
                    children: (0, F.jsx)(V.A, { icon: We.A }),
                  }),
                  (0, F.jsx)("div", {
                    className:
      ...
      var qe = a(96476);
      const Xe = (0, $.__)("Campaigns", "woocommerce"),
        et = [
          { key: "campaign", label: (0, $.__)("Campaign", "woocommerce") },
          {
            key: "cost",
            label: (0, $.__)("Cost", "woocommerce"),
            isNumeric: !0,
          },
          {
            key: "sales",
            label: (0, $.__)("Sales", "woocommerce"),
            isNumeric: !0,
          },
        ],
        tt = () => {
          const [e, t] = (0, c.useState)(1),
            [a, n] = (0, c.useState)(!1),
            { loading: r, data: o, meta: s } = Qe(e, 5),
            { data: i } = Ze(),
            l = s?.total,
            m = !!i?.length,
            d = !!(l && l > 5);
          return (0, F.jsxs)(_e.Card, {
            ...
            children: [
              (0, F.jsxs)(_e.CardHeader, {
                children: [
                  (0, F.jsx)(Se, {
                    children: (0, $.__)("Campaigns", "woocommerce"),
                  }),
                  m &&
                    (0, F.jsx)(_e.Button, {
                      variant: "secondary",
                      onClick: () => n(!0),
                      children: (0, $.__)("Create new campaign", "woocommerce"),
                    }),
                  a && (0, F.jsx)(He, { onRequestClose: () => n(!1) }),
                ],
              }),
              r
                ? (0, F.jsx)(we.TablePlaceholder, {
                    caption: Xe,
                    headers: et,
                    numberOfRows: 5,
                  })
                : o
                  ? 0 === o.length
                    ? (0, F.jsxs)(_e.CardBody, {
                        className:
                          "woocommerce-marketing-campaigns-card__content",
                        children: [
                          (0, F.jsx)(V.A, {
                            className:
                          ...
                          (0, F.jsx)("div", {
                            className:
                              "woocommerce-marketing-campaigns-card__content-title",
                            children: (0, $.__)(
                              "Advertise with marketing campaigns",
                              "woocommerce",
                            ),
                          ...
                          (0, F.jsx)("div", {
                            className:
                              "woocommerce-marketing-campaigns-card__content-description",
                            children: (0, $.__)(
                    ...
                    : (0, F.jsx)(we.Table, {
                        ...
                        rows: o.map((e) => [
                          {
                            display: (0, F.jsxs)(_e.Flex, {
                              gap: 4,
                              children: [
                                (0, F.jsx)(_e.FlexItem, {
                                  className:
                                    "woocommerce-marketing-campaigns-card__campaign-logo",
                                  children: (0, F.jsx)("img", {
                                    src: e.icon,
                                    alt: e.channelName,
                                    width: "16",
                                ...
                                (0, F.jsx)(_e.FlexBlock, {
                                  children: (0, F.jsxs)(_e.Flex, {
                                    ...
                                    children: [
                                      (0, F.jsx)(_e.FlexItem, {
                                        className:
                                          "woocommerce-marketing-campaigns-card__campaign-title",
                                        children: (0, F.jsx)(we.Link, {
                                          type: (0, qe.isWCAdmin)(e.manageUrl)
                                            ? "wc-admin"
                                            : "external",
                                          href: e.manageUrl,
                                          children: e.title,
                  ...
                  : (0, F.jsxs)(_e.CardBody, {
                      ...
                      children: [
                        ...
                        (0, F.jsx)("div", {
                          className:
                            "woocommerce-marketing-campaigns-card-body__content-description",
                          children: (0, $.__)(
      ...
      var at = a(46779),
        nt = a(94348),
        rt = a(92991);
      const ot = "woocommerce-marketing-sync-status",
        st = ({ status: e }) =>
          "failed" === e
            ? (0, F.jsxs)("div", {
                className: (0, U.A)(ot, `${ot}__failed`),
                children: [
                  (0, F.jsx)(rt.A, { size: 18 }),
                  (0, $.__)("Sync failed", "woocommerce"),
                ],
              })
            : "syncing" === e
              ? (0, F.jsxs)("div", {
                  className: (0, U.A)(ot, `${ot}__syncing`),
                  children: [
                    (0, F.jsx)(nt.A, { size: 18 }),
                    (0, $.__)("Syncing", "woocommerce"),
                  ],
                })
              : (0, F.jsxs)("div", {
                  className: (0, U.A)(ot, `${ot}__synced`),
                  children: [
                    (0, F.jsx)(at.A, { size: 18 }),
                    (0, $.__)("Synced", "woocommerce"),
                  ],
                }),
        ct = "woocommerce-marketing-issue-status",
        it = ({ registeredChannel: e }) =>
          "error" === e.issueType
            ? (0, F.jsxs)("div", {
                className: (0, U.A)(ct, `${ct}__error`),
                children: [(0, F.jsx)(rt.A, { size: 18 }), e.issueText],
              })
            : "warning" === e.issueType
              ? (0, F.jsxs)("div", {
                  className: (0, U.A)(ct, `${ct}__warning`),
                  children: [(0, F.jsx)(rt.A, { size: 18 }), e.issueText],
                })
              : (0, F.jsx)("div", { className: ct, children: e.issueText }),
        lt = ({ registeredChannel: e }) => {
          const t = e.isSetupCompleted
              ? (0, F.jsxs)("div", {
                  ...
                  children: [
                    !!e.syncStatus &&
                      (0, F.jsxs)(F.Fragment, {
                        children: [
                          (0, F.jsx)(st, { status: e.syncStatus }),
                          (0, F.jsx)("div", {
                            className:
                    ...
                    (0, F.jsx)(it, { registeredChannel: e }),
                  ],
                })
              : e.description,
            a = e.isSetupCompleted
              ? (0, F.jsx)(_e.Button, {
                  variant: "secondary",
                  href: e.manageUrl,
                  children: (0, $.__)("Manage", "woocommerce"),
                })
              : (0, F.jsx)(_e.Button, {
                  variant: "primary",
                  href: e.setupUrl,
                  children: (0, $.__)("Finish setup", "woocommerce"),
                });
          return (0, F.jsx)(ke, {
        ...
        mt = (0, c.forwardRef)(
          (
            {
              registeredChannels: e,
              recommendedChannels: t,
              onInstalledAndActivated: a,
            },
            n,
          ) => {
            const r = e.length >= 1,
              ...
              (0, c.useImperativeHandle)(
                ...
                () => ({
                  scrollIntoAddChannels: () => {
                    (s(!0),
                      i.current?.focus(),
                      i.current?.scrollIntoView({ block: "center" }));
                  },
                }),
                [],
              ),
              (0, F.jsxs)(_e.Card, {
                ...
                children: [
                  (0, F.jsxs)(_e.CardHeader, {
                    children: [
                      (0, F.jsx)(Se, {
                        children: (0, $.__)("Channels", "woocommerce"),
                      }),
                      !r &&
                        (0, F.jsx)(Ee, {
                          children: (0, $.__)(
                  ...
                  e.map((t, a) =>
                    (0, F.jsxs)(
                      ...
                      {
                        children: [
                          (0, F.jsx)(lt, { registeredChannel: t }),
                          a !== e.length - 1 && (0, F.jsx)(_e.CardDivider, {}),
                        ],
                      },
                      t.slug,
                    ),
        ...
        dt = () => {
          const {
            data: e,
            activatingPlugins: t,
            activateInstalledPlugin: a,
          } = Ue();
          return 0 === e.length
            ? null
            : (0, F.jsx)(ye, {
                header: (0, $.__)("Installed extensions", "woocommerce"),
                children: e.map((n, r) => {
                  return (0, F.jsxs)(
                    c.Fragment,
                    {
                      children: [
                        (0, F.jsx)(ke, {
                          icon: (0, F.jsx)(xe, { product: n.slug }),
                          name: n.name,
                          ...
                          button:
                            ...
                            "installed" === o.status
                              ? (0, F.jsx)(_e.Button, {
                                  variant: "secondary",
                                  isBusy: t.includes(o.slug),
                                  disabled: t.includes(o.slug),
                                  onClick: () => {
                                    ((0, Ae.recordEvent)(
                                      "marketing_installed_activate",
                                      { name: o.name },
                                    ),
                                      a(o.slug));
                                  },
                              ...
                              : "activated" === o.status
                                ? (0, F.jsx)(_e.Button, {
                                    ...
                                    onClick: () => {
                                      (0, Ae.recordEvent)(
                                        "marketing_installed_finish_setup",
                                        { name: o.name },
                                      );
                                    },
                                    children: (0, $.__)(
                                ...
                                : "configured" === o.status
                                  ? (0, F.jsx)(_e.Button, {
                                      variant: "secondary",
                                      href: o.dashboardUrl || o.settingsUrl,
                                      onClick: () => {
                                        (0, Ae.recordEvent)(
                                          "marketing_installed_options",
                                          { name: o.name, link: "manage" },
                                        );
                                      },
                                      children: (0, $.__)(
                                        "Manage",
                        ...
                        r !== e.length - 1 && (0, F.jsx)(_e.CardDivider, {}),
                      ],
                    },
                    n.slug,
                  );
        ...
        gt = "getRecommendedPlugins",
        ht = "marketing",
        ut = () => {
          const { loading: e, data: t } = (0, m.useSelect)((e) => {
              const { getRecommendedPlugins: t, hasFinishedResolution: a } = e(
                l.M,
              );
              return { loading: !a(gt, [ht]), data: t(ht) };
            }, []),
            { loading: a, data: n } = Oe(),
            {
              invalidateResolution: r,
              installAndActivateRecommendedPlugin: o,
            } = (0, m.useDispatch)(l.M),
            s = (e && !t.length) || (a && !n),
            c = e || a,
            i = (0, Z.differenceWith)(
              t,
              n || [],
              (e, t) => e.product === t.product,
            );
          return {
            isInitializing: s,
            isLoading: c,
        ...
        jt = ({ isLoading: e, plugins: t, onInstallAndActivate: a }) => {
          const [n, r] = (0, c.useState)(null),
            { installAndActivatePlugins: o } = (0, m.useDispatch)(
              i.pluginsStore,
            ),
            { loadInstalledPluginsAfterActivation: s } = Ue();
          return (0, F.jsx)(_e.TabPanel, {
            tabs: pt(t),
            children: (i) => {
              const l = t.filter((e) =>
                  e.subcategories.some((e) => e.slug === i.name),
                ),
                m = (t) => {
                  const c = !!n || e;
                          ...
                          (async (e) => {
                            ...
                            try {
                              (0, Ae.recordEvent)(
                                ...
                                { name: e.title, source: fe() },
                              );
                              const t = await o([e.product]);
                              (a(e.product), s(e.product), (0, Ie.R)(t));
                            } catch (e) {
                              (0, Ie.R)(e);
                            }
                            r(null);
        ...
        xt = () => {
          const {
            ...
            isLoading: t,
            data: a,
            installAndActivate: n,
          } = ut();
          return (0, F.jsx)(ye, {
            header: (0, $.__)("Discover more marketing tools", "woocommerce"),
            children: e
              ? (0, F.jsx)(_e.CardBody, { children: (0, F.jsx)(be, {}) })
              : 0 === a.length
                ? (0, F.jsxs)(_e.CardBody, {
                    className:
                      "woocommerce-marketing-discover-tools-card-body-empty-content",
                    children: [
                      (0, F.jsx)(V.A, { icon: Ge, size: 32 }),
                      (0, F.jsx)("div", {
                        children: (0, $.__)(
                      ...
                      (0, F.jsx)(_e.Button, {
                        ...
                        onClick: () => {
                          (0, Ae.recordEvent)(
                            "marketing_explore_more_extensions",
                          );
                        },
                        children: (0, $.__)(
        ...
        Ct = ({ post: e }) =>
          (0, F.jsxs)("a", {
            ...
            onClick: () => {
              (0, Ae.recordEvent)("marketing_knowledge_article", {
                title: e.title,
              });
            },
            children: [
              (0, F.jsx)("div", {
                className:
                  "woocommerce-marketing-learn-marketing-card__post-img",
                children:
                  !!e.image && (0, F.jsx)("img", { src: e.image, alt: "" }),
              }),
              (0, F.jsx)("div", {
                className:
                  "woocommerce-marketing-learn-marketing-card__post-title",
                children: e.title,
              }),
              (0, F.jsxs)("div", {
                className:
        ...
        Mt = () => {
          ...
          return (0, F.jsx)(ye, {
            ...
            header: (0, $.__)("Learn about marketing a store", "woocommerce"),
            footer: a
              ? (0, F.jsx)("div", {
                  role: "progressbar",
                  className:
                    "woocommerce-marketing-learn-marketing-card__footer--placeholder",
                })
              : n || !r || 0 === r.length
                ? null
                : (0, F.jsx)(we.Pagination, {
                    showPagePicker: !1,
                    showPerPagePicker: !1,
                    page: e,
                    perPage: 2,
            ...
            children: (0, F.jsx)("div", {
              ...
              children: a
                ? [...Array(2).keys()].map((e) => (0, F.jsx)(wt, {}, e))
                : n
                  ? (0, F.jsx)(we.EmptyContent, {
                      title: (0, $.__)(
                  ...
                  : 0 === r.length
                    ? (0, F.jsx)(we.EmptyContent, {
                        title: (0, $.__)("No posts yet", "woocommerce"),
                        message: (0, F.jsx)(Me, {}),
                        illustration: "",
                        actionLabel: "",
                      })
      ...
      const vt = () => {
        const {
            ...
            const { updateOptions: e } = (0, m.useDispatch)(i.optionsStore),
              { loading: t, data: a } = (0, m.useSelect)((e) => {
                const { getOption: t, hasFinishedResolution: a } = e(
                  i.optionsStore,
                );
                return { loading: !a("getOption", [Te]), data: t(Te) };
              }, []);
            return {
              loading: t,
              ...
              dismissIntroductionBanner: () => {
                (e({ [Te]: "yes" }),
                  (0, Ae.recordEvent)(
                    "marketing_multichannel_banner_dismissed",
                    {},
                  ));
              },
            };
          ...
          { loading: n, meta: r } = Qe(),
          { loading: o, data: s, refetch: l } = Ze(),
          { loading: d, data: g, refetch: h } = Re(),
          { loading: u, data: p } = Oe(),
          { loadInstalledPluginsAfterActivation: j } = Ue(),
          { currentUserCan: x } = (0, i.useUser)(),
          w = (0, c.useRef)(null);
        if (
          e ||
          (n && void 0 === r?.total) ||
          ...
          return (0, F.jsx)(be, {});
        const C = !(!g?.length || (!t && !r?.total)),
          M = !(!g || !p || (!g.length && !p.length)),
          _ = !!(0, J.Qk)("allowMarketplaceSuggestions", !1),
          v = _ && x("install_plugins");
        return (0, F.jsxs)("div", {
          className: "woocommerce-marketing-overview-multichannel",
          children: [
            (0, F.jsx)(_t.A, { format: "promo-card" }),
            !t &&
              (0, F.jsx)(Je, {
                onDismissClick: a,
                onAddChannelsClick: () => {
                  w.current?.scrollIntoAddChannels();
                },
              }),
            C && (0, F.jsx)(tt, {}),
            M &&
              (0, F.jsx)(mt, {
                ref: w,
                registeredChannels: g,
                recommendedChannels: p,
    ...
    25595: (e, t, a) => {
      ...
      var n = a(4921),
        ...
        m = a(12974),
        d = a(39793);
      const g = { info: o.A, check: s.A, percent: c.A };
      function h(e) {
        const {
            id: t,
            description: a,
        ...
        const C = (0, n.A)(
            ...
            `woocommerce-marketplace__notice--${h}`,
            { "is-dismissible": c },
            u,
          ),
          M = g[s || "info"],
          _ = (0, n.A)(
            ...
            `woocommerce-marketplace__notice-icon--${h}`,
          );
        return (0, d.jsxs)("div", {
          className: C,
          children: [
            ...
            (0, d.jsxs)("div", {
              ...
              children: [
                (0, d.jsx)("p", {
                  ...
                  dangerouslySetInnerHTML: (0, m.A)(a),
                }),
                o &&
                  (0, d.jsx)("div", {
      ...
      const m = { percent: i.A },
        d = ({ promotion: e }) => {
          ...
          if (
            ...
            return null;
          const u = "promo-card" + (e.style ? ` ${e.style}` : ""),
            p = (0, l.jsxs)("div", {
              ...
              children: [
                ...
                (0, l.jsx)("div", {
                  ...
                  dangerouslySetInnerHTML: (0, c.A)(e.content?.en_US),
                }),
              ],
            }),
            j = (0, l.jsxs)("div", {
              ...
              children: [
                (0, l.jsx)(n.Button, {
                  ...
                  onClick: () => (
                    (0, s.recordEvent)("marketplace_promotion_actioned", {
                      path: i,
                  ...
                  children:
                    null !== (a = e.cta_label?.en_US) && void 0 !== a ? a : "",
                }),
                (0, l.jsx)(n.Button, {
                  ...
                  children: (0, r.__)("Dismiss", "woocommerce"),
                }),
              ],
            });
          function x() {
    ...
    79492: (e, t, a) => {
      ...
      const i = ({ format: e }) => {
        ...
        const a = (
          ...
          l = i.get("page"),
          m = Date.now(),
          d = decodeURIComponent(i.get("path") || ""),
          g = i.get("tab"),
        ...
        return (0, c.jsx)(c.Fragment, {
          children: a.map((e, t) => {
            ...
            if (
              !e.pages.some((e) => {
                if (e.pathname) return e.pathname === h;
                if (!e.path) return !1;
                const t = (e) => (e.startsWith("/") ? e : `/${e}`),
                  a = t(e.path),
                  n = t(d);
                return e.page === l && a === n && (e.tab ? g : !g);
              })
            )
              return null;
            const a = new Date(e.date_from_gmt).getTime(),
              n = new Date(e.date_to_gmt).getTime();
            return m < a || m > n
              ? null
              : "promo-card" === e.format
                ? (0, c.jsx)(s.A, { promotion: e }, t)
                      ...
                      o.A,
                      {
                        id:
                          null !== (i = e.menu_item_id) && void 0 !== i
                            ...
                            : `promotion-${t}`,
                        description:
                          e.content[r.ne.userLocale] || e.content.en_US,
    ...
    46779: (e, t, a) => {
      t.A = function (e) {
        var t = e.size,
          ...
          l = ["gridicon", "gridicons-checkmark-circle", c, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return r.default.createElement(
          "svg",
          s({ className: l, height: a, width: a, onClick: n }, i, {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          }),
      ...
      var n,
        r = (n = a(51609)) && n.__esModule ? n : { default: n },
    ...
    94348: (e, t, a) => {
      t.A = function (e) {
        var t = e.size,
          ...
          l = ["gridicon", "gridicons-sync", c, !1, !1, !1]
            .filter(Boolean)
            .join(" ");
        return r.default.createElement(
          "svg",
          ...
          r.default.createElement(
            ...
            null,
            r.default.createElement("path", {
              d: "M23.5 13.5l-3.086 3.086L19 18l-4.5-4.5 1.414-1.414L18 14.172V12c0-3.308-2.692-6-6-6V4a8 8 0 018 8v2.172l2.086-2.086L23.5 13.5zM6 12V9.828l2.086 2.086L9.5 10.5 5 6 3.586 7.414.5 10.5l1.414 1.414L4 9.828V12a8 8 0 008 8v-2c-3.308 0-6-2.692-6-6z",
            }),
          ),
        );
      };
