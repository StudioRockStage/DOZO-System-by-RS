    ...
    94736: (t, e, n) => {
      e.A = function (t) {
        ...
        return i.default.createElement(
          "svg",
          o({ className: u, height: n, width: n, onClick: r }, l, {
      ...
      var r = n(41947),
        ...
        v = (function (t) {
          function e(e, n) {
            ...
            var i,
              s = n && !n.isMounting ? e.enter : e.appear;
            return (
              (r.appearStatus = null),
              e.in
                ? s
                  ? ((i = f), (r.appearStatus = h))
                  : (i = E)
                : (i = e.unmountOnExit || e.mountOnEnter ? d : f),
              (r.state = { status: i }),
              (r.nextCallback = null),
              r
            );
          ...
          return (
            ...
            (n.render = function () {
              ...
              return (
                ...
                delete i.exit,
                null === e
                  ? l().createElement(u.A.Provider, { value: s }, o)
                  : l().createElement(
                      u.A.Provider,
                      { value: s },
                      l().createElement(e, i, o),
                    )
              );
            }),
            e
        ...
        var o = i(t.children),
          a = (function (t, e) {
            ...
            var r,
              ...
              s = [];
            for (var o in t)
              o in e ? s.length && ((i[o] = s), (s = [])) : s.push(o);
            var a = {};
            for (var l in e) {
              if (i[l])
            ...
            for (r = 0; r < s.length; r++) a[s[r]] = n(s[r]);
            return a;
          })(e, o);
        return (
