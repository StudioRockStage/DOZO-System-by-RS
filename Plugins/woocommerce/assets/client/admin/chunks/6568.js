    ...
    46568: (I, M, i) => {
      ...
      const u = ({ onConnect: I }) =>
        (0, T.jsx)(a.A, {
          ...
          onConnect: () => {
            ((0, A.recordEvent)(
              "tasklist_shipping_recommendation_connect_store",
              { connect: !0 },
            ),
              I?.());
          },
      ...
      var S = i(46772),
        l = i(98642);
      const d = (I) => "object" == typeof I && null !== I,
        x = ({ nextStep: I, pluginsToActivate: M }) => {
          const { updateOptions: i } = (0, e.useDispatch)(g.optionsStore),
            { isResolving: N, tosAccepted: D } = (0, e.useSelect)((I) => {
              const { getOption: M, hasFinishedResolution: i } = I(
                  g.optionsStore,
                ),
                e = M("wcshipping_options");
              return {
                isResolving:
                  !i("getOption", ["woocommerce_setup_jetpack_opted_in"]) ||
                  !i("getOption", ["wcshipping_options"]),
                tosAccepted:
                  (d(e) && e?.tos_accepted) ||
                  "1" === M("woocommerce_setup_jetpack_opted_in"),
              };
            }, []);
          return (
            (0, t.useEffect)(() => {
                    ...
                    (0, T.jsx)(z.Plugins, {
                      onComplete: (M, g) => {
                        ((0, S.R)(g),
                          ...
                          i({ woocommerce_setup_jetpack_opted_in: !0 }),
                          I());
                      },
                      onError: (I, M) => (0, S.R)(M),
                      pluginSlugs: M,
      ...
      var C = i(18886),
        O = i(41418),
        y = i(62513);
      const p = ({ nextStep: I, onLocationComplete: M }) => {
        const { createNotice: i } = (0, e.useDispatch)("core/notices"),
          { updateAndPersistSettingsForGroup: N } = (0, e.useDispatch)(
            g.settingsStore,
          ),
          { generalSettings: D, isResolving: j } = (0, e.useSelect)((I) => {
            const { getSettings: M, hasFinishedResolution: i } = I(
              g.settingsStore,
            );
            return {
              generalSettings: M("general")?.general,
              isResolving: !i("getSettings", ["general"]),
            };
          }, []);
        return (
          (0, t.useEffect)(() => {
          ...
          j
            ...
            : (0, T.jsx)(y.A, {
                onComplete: (M) => {
                  const i = (0, C.gI)(M.countryState);
                  ((0, A.recordEvent)(
                    "tasklist_shipping_recommendation_set_location",
                    { country: i },
                  ),
                    I());
                },
                ...
                settings: D,
                updateAndPersistSettingsForGroup: N,
                createNotice: i,
              })
        );
      };
      ...
      const L = [
          {
            ...
            title: (0, o.__)("Buy postage when you need it", "woocommerce"),
            description: (0, o.__)(
          ...
          },
          {
            ...
            title: (0, o.__)("Print at home", "woocommerce"),
            description: (0, o.__)(
          ...
          },
          {
            ...
            title: (0, o.__)("Discounted rates", "woocommerce"),
            description: (0, o.__)(
      ...
      var r = i(3246),
        E = i(50348);
      const w = ["woocommerce-shipping"],
        Y = (0, j.compose)(
          (0, e.withSelect)((I) => {
            const { getSettings: M } = I(g.settingsStore),
              { hasFinishedResolution: i } = I(g.optionsStore),
              { getActivePlugins: e } = I(g.pluginsStore);
            return {
              activePlugins: e(),
              generalSettings: M("general")?.general,
              isJetpackConnected: I(g.pluginsStore).isJetpackConnected(),
              isResolving:
                !i("getOption", ["woocommerce_setup_jetpack_opted_in"]) ||
                !i("getOption", ["wcshipping_options"]) ||
                !I(g.pluginsStore).hasFinishedResolution(
                  "isJetpackConnected",
                  [],
                ),
            };
          }),
        )(({ activePlugins: I, isJetpackConnected: M, isResolving: i }) => {
          const [g, e] = (0, t.useState)([]),
            [N, D] = (0, t.useState)(0),
            [j, A] = (0, t.useState)(!1),
            [a, S] = (0, t.useState)(!1),
            l = () => {
          ...
          (0, t.useEffect)(() => {
            const N = (0, c.difference)(w, I);
            (!i && 0 === N.length && M && d(), N.length <= g.length || e(N));
          }, [I, M, i, g]);
          const C = [
              {
                key: "store_location",
                label: (0, o.__)("Set store location", "woocommerce"),
                description: (0, o.__)(
              ...
              {
                key: "plugins",
                label: (0, o.__)("Install WooCommerce Shipping", "woocommerce"),
                description: (0, o.__)(
                ...
                content: (0, T.jsxs)("div", {
                  children: [
                    (0, T.jsx)(k, {}),
                    (0, T.jsx)(x, { nextStep: l, pluginsToActivate: g }),
                  ],
                }),
              },
              {
                key: "connect",
                label: (0, o.__)("Connect your store", "woocommerce"),
                description: (0, o.__)(
                ...
                content: M
                  ? (0, T.jsx)(n.Button, {
                      ...
                      isBusy: j,
                      isPrimary: !0,
                      children: (0, o.__)("Complete task", "woocommerce"),
                    })
                  : (0, T.jsx)(u, {}),
              },
            ],
          ...
          return (0, T.jsxs)("div", {
            ...
            children: [
              (0, T.jsx)(n.Card, {
                ...
                children: (0, T.jsx)(n.CardBody, {
                  children: (0, T.jsx)(z.Stepper, {
                    isPending: i,
                    isVertical: !0,
                    currentStep: O.key,
                    steps: C,
              ...
              (0, T.jsx)(r.d, {
                ...
                targetUrl: (0, E.isFeatureEnabled)("marketplace")
                  ? (0, s.getAdminLink)(
                ...
                linkType: (0, E.isFeatureEnabled)("marketplace")
                  ? "wc-admin"
                  : "external",
              }),
            ],
      ...
      (0, N.registerPlugin)(
        "wc-admin-onboarding-task-shipping-recommendation",
        {
          scope: "woocommerce-tasks",
          render: () =>
            (0, T.jsx)(D.WooOnboardingTask, {
              id: "shipping-recommendation",
              children: ({ onComplete: I, query: M, task: i }) =>
                (0, T.jsx)(Y, { onComplete: I, query: M, task: i }),
            }),
        },
      );
    },
