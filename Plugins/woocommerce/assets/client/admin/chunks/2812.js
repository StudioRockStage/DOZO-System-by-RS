/*! For license information please see 2812.js.LICENSE.txt */
  ...
  [2812],
  {
    32812: (e, t, n) => {
                  ...
                  switch (e.type) {
                    ...
                    default:
                      ...
                      return void console.warn(
                        `Unhandled inspection event type: ${e.type}`,
                      );
                  }
                })(e);
                t && n(t);
      ...
      function O(e) {
        ...
        if (!t)
          return (
            console.error(
              "Window does not exist; inspector cannot be started.",
            ),
            new w()
          );
        const n = {
            ...
            ((this.targetWindow = this.options.iframe
              ...
              this.options.iframe &&
                (this.options.iframe.addEventListener("load", () => {
                  this.targetWindow =
                    this.options.iframe?.contentWindow ?? null;
                }),
                this.options.iframe?.setAttribute(
                  "src",
                  String(this.options.url),
                )),
      ...
      function T(e = {}) {
        ...
        return (
          ...
          (l.onopen = () => {
            (console.log(
              "Connected to Sky, link to your live inspect session:",
            ),
              console.log(f));
          }),
          g
              ...
              ((this.ws = new A.default(this.options.url)),
                (this.ws.onopen = () => {
                  (console.log("websocket open"),
                    ...
                    this.deferredEvents.forEach((e) => {
                      const t = e,
                        n = this.options.serialize(t);
                      this.ws.send((0, $.default)(n));
                    }));
                }),
                (this.ws.onclose = () => {
    ...
    57698: (e) => {
      ...
      function u(e, r, o, i, s, c, l) {
        ...
        if (((c += 1), "object" == typeof e && null !== e)) {
          for (f = 0; f < i.length; f++)
            if (i[f] === e) return void a(n, e, r, s);
          if (void 0 !== l.depthLimit && c > l.depthLimit)
            return void a(t, e, r, s);
      ...
      function l(e, t, n, s) {
        ...
        try {
          a =
            0 === o.length
              ? JSON.stringify(u, t, n)
              : JSON.stringify(u, d(t), n);
        } catch (e) {
          return JSON.stringify(
            "[unable to serialize, circular reference is too complex to analyze]",
          );
      ...
      function f(e, o, i, s, u, l, d) {
        ...
        if (((l += 1), "object" == typeof e && null !== e)) {
          for (p = 0; p < s.length; p++)
            if (s[p] === e) return void a(n, e, o, u);
          try {
            if ("function" == typeof e.toJSON) return;
          } catch (e) {
            return;
          }
          if (void 0 !== d.depthLimit && l > d.depthLimit)
            return void a(t, e, o, u);
        ...
        h = class e extends EventTarget {
          ...
          send(e) {
            if (this._ws && this._ws.readyState === this.OPEN)
              ...
              const { maxEnqueuedMessages: t = d.maxEnqueuedMessages } =
                this._options;
            ...
            this._retryCount >= e
              ...
              : (this._retryCount++,
                ...
                this._wait()
                  ...
                  .catch((e) => {
                    ((this._connectLock = !1),
                      this._handleError(new c(Error(e.message), this)));
                  }));
          }
          _handleTimeout() {
            (this._debug("timeout event"),
              this._handleError(new c(Error("TIMEOUT"), this)));
          }
          _disconnect(e = 1e3, t) {
            ...
            case "object": {
              ...
              if (Array.isArray(v)) {
                ...
                return (
                  (e += void 0 !== i ? i : "null"),
                  v.length - 1 > h &&
                    (e += `${t}"... ${d(v.length - h - 1)} not stringified"`),
                  "" !== f && (e += `\n${n}`),
                  c.pop(),
                  `[${e}]`
                );
            ...
            case "object": {
              ...
              if (Array.isArray(n)) {
                ...
                return (
                  (t += void 0 !== l ? l : "null"),
                  n.length - 1 > h &&
                    (t += `${o}"... ${d(n.length - h - 1)} not stringified"`),
                  "" !== u && (t += `\n${e}`),
                  s.pop(),
                  `[${t}]`
                );
            ...
            case "object": {
              ...
              if (Array.isArray(n)) {
                ...
                return (
                  (e += void 0 !== s ? s : "null"),
                  n.length - 1 > h &&
                    (e += `${r}"... ${d(n.length - h - 1)} not stringified"`),
                  (e += `\n${t}`),
                  l.pop(),
                  `[${e}]`
                );
            ...
            case "object": {
              ...
              if (Array.isArray(n)) {
                ...
                return (
                  (t += void 0 !== o ? o : "null"),
                  n.length - 1 > h &&
                    (t += `,"... ${d(n.length - h - 1)} not stringified"`),
                  l.pop(),
                  `[${t}]`
                );
              }
    ...
    1343: (e, t, n) => {
        ...
        a = (function (e) {
          ...
          return (
            ...
            (t.prototype.register = function (t, n) {
              "object" == typeof n
                ? (n.allowProps &&
                    this.classToAllowedProps.set(t, n.allowProps),
      ...
      var f = (function () {
        ...
        _ = function (e) {
          return e.map(String).map(w).join(".");
        },
        O = function (e) {
      ...
      var j = [
        ...
        I(
          function (e) {
            return b(e) || (t = e) === 1 / 0 || t === -1 / 0;
            var t;
          },
          "number",
          function (e) {
            return b(e) ? "NaN" : e > 0 ? "Infinity" : "-Infinity";
          },
          Number,
        ),
        I(
      ...
      var P = x(
          function (e, t) {
            return !!m(e) && !!t.symbolRegistry.getIdentifier(e);
          },
          function (e, t) {
      ...
      var W = function (e, t, n) {
          if ((D(t), 0 === t.length)) return n(e);
          for (var r = e, o = 0; o < t.length - 1; o++) {
            var i = t[o];
            if (y(r)) r = r[+i];
            else if (p(r)) r = r[i];
            else if (v(r)) r = U(r, (s = +i));
            else if (g(r)) {
          ...
          var c = t[t.length - 1];
          if ((y(r) ? (r[+c] = n(r[+c])) : p(r) && (r[c] = n(r[c])), v(r))) {
            var l = U(r, +c),
              f = n(l);
      ...
      var q = function (e, t, n, r, o, i, s) {
        ...
        if (!f) {
          ...
          var b = s.get(e);
          if (b) return r ? { transformedValue: null } : b;
        }
        if (
          !(function (e, t) {
            return p(e) || y(e) || g(e) || v(e) || $(e, t);
          })(e, n)
        ) {
          var _ = R(e, n),
            O = _
              ? { transformedValue: _.value, annotations: [_.type] }
              : { transformedValue: e };
        ...
        var S = R(e, n),
          E =
            null !== (a = null == S ? void 0 : S.value) && void 0 !== a ? a : e,
          k = y(E) ? [] : {},
          I = {};
        u(E, function (a, c) {
          var l = q(a, t, n, r, V(V([], z(o)), [c]), V(V([], z(i)), [e]), s);
          ((k[c] = l.transformedValue),
            y(l.annotations)
              ? (I[c] = l.annotations)
              : p(l.annotations) &&
                u(l.annotations, function (e, t) {
                  I[w(c) + "." + t] = e;
                }));
        });
        var j = h(I)
        ...
        X = (function () {
          ...
          return (
            (e.prototype.serialize = function (e) {
              var t = new Map(),
                n = q(e, t, this, this.dedupe),
                r = { json: n.transformedValue };
              n.annotations &&
                (r.meta = Q(Q({}, r.meta), { values: n.annotations }));
              var o,
                i,
                s,
                a,
                  ...
                  o.forEach(function (e) {
                    if (!(e.length <= 1)) {
                      ...
                      var t = z(e),
                        n = t[0],
                        r = t.slice(1);
                      0 === n.length ? (a = r.map(_)) : (s[_(n)] = r.map(_));
                    }
                  }),
                  a ? (h(s) ? [a] : [a, s]) : h(s) ? void 0 : s);
              return (
                u && (r.meta = Q(Q({}, r.meta), { referentialEqualities: u })),
                r
              );
            }),
            (e.prototype.deserialize = function (e) {
              var t = e.json,
                ...
                r = K(t);
              return (
                (null == n ? void 0 : n.values) && (r = B(r, n.values, this)),
            ...
            (e.prototype.registerCustom = function (e, t) {
              this.customTransformerRegistry.register(Q({ name: t }, e));
            }),
    ...
    29978: (e, t, n) => {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0));
      var r,
        o = (r = n(89575)) && r.__esModule ? r : { default: r };
      t.default = function (e) {
    ...
    30044: (e, t) => {
      ...
      t.default = function (e) {
        ...
        for (let e = 0; e < s; ++e) {
          ...
          for (let e = 16; e < 80; ++e)
            i[e] = r(i[e - 3] ^ i[e - 8] ^ i[e - 14] ^ i[e - 16], 1);
          let s = o[0],
            u = o[1],
            c = o[2],
            l = o[3],
    ...
    1464: (e, t, n) => {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0));
      var r,
        o = (r = n(29704)) && r.__esModule ? r : { default: r },
        i = n(98420);
      let s,
        a,
        u = 0,
    ...
    33403: (e, t, n) => {
      ...
      var r,
        o = n(98420),
        i = (r = n(29978)) && r.__esModule ? r : { default: r };
    ...
    89575: (e, t, n) => {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0));
      var r,
        o = (r = n(38514)) && r.__esModule ? r : { default: r };
      t.default = function (e) {
