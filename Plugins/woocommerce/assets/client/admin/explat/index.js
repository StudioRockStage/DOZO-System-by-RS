...
(() => {
  var e = {
      ...
      11548: (e, t, r) => {
        ...
        var n = r(72418),
          ...
          c = o("%Reflect.apply%", !0) || n.call(l, p),
      ...
      29654: (e, t) => {
        ...
        ((t.parse = function (e, t) {
          ...
          for (
            var n = {}, o = t || {}, a = e.split(";"), p = o.decode || r, l = 0;
            l < a.length;
            l++
          ) {
            var c = a[l],
              s = c.indexOf("=");
            if (!(s < 0)) {
              var u = c.substring(0, s).trim();
              if (null == n[u]) {
                var f = c.substring(s + 1, c.length).trim();
                ('"' === f[0] && (f = f.slice(1, -1)), (n[u] = i(f, p)));
              }
            }
          }
          return n;
          ...
          (t.serialize = function (e, t, r) {
            ...
            var p = a(t);
            if (p && !o.test(p)) throw new TypeError("argument val is invalid");
            var l = e + "=" + p;
            if (null != i.maxAge) {
              var c = i.maxAge - 0;
        ...
        e.exports = function (e, t, r) {
          ...
          if (i)
            i(e, t, {
              ...
              enumerable: null === n && u ? u.enumerable : !n,
              value: r,
      ...
      40885: (e, t, r) => {
        ...
        var c = function () {
          ...
          g = {
            ...
            "%ArrayIteratorPrototype%": u && y ? y([][Symbol.iterator]()) : n,
            ...
            "%isFinite%": isFinite,
            "%isNaN%": isNaN,
            "%IteratorPrototype%": u && y ? y(y([][Symbol.iterator]())) : n,
            "%JSON%": "object" == typeof JSON ? JSON : n,
            "%Map%": "undefined" == typeof Map ? n : Map,
            "%MapIteratorPrototype%":
              "undefined" != typeof Map && u && y
      ...
      83282: (e, t, r) => {
        var n = "function" == typeof Map && Map.prototype,
          ...
          l =
            Object.getOwnPropertyDescriptor && p
              ...
              : null,
          c = p && l && "function" == typeof l.get ? l.get : null,
          s = p && Set.prototype.forEach,
          u =
        ...
        e.exports = function e(t, n, o, p) {
          ...
          var d = !z(l, "customInspect") || l.customInspect;
          ...
          var _ = void 0 === l.depth ? 5 : l.depth;
          if (
          ...
          if (void 0 === p) p = [];
          else if (H(p, t) >= 0) return "[Circular]";
          function J(t, r, n) {
            if ((r && (p = j.call(p)).push(r), n)) {
              var i = { depth: l.depth };
              return (
                z(l, "quoteStyle") && (i.quoteStyle = l.quoteStyle),
                e(t, i, o + 1, p)
              );
            }
            return e(t, l, o + 1, p);
          ...
          if (
            ...
            for (
              var ne = "<" + x.call(String(t.nodeName)),
                oe = t.attributes || [],
                ie = 0;
              ie < oe.length;
              ie++
            )
              ne += " " + oe[ie].name + "=" + W(C(oe[ie].value), "double", l);
            return (
              (ne += ">"),
          ...
          if (
            ...
            return "cause" in Error.prototype ||
              ...
              : "{ [" +
                  String(t) +
                  "] " +
                  A.call(E.call("[cause]: " + J(t.cause), pe), ", ") +
                  " }";
          }
          if ("object" == typeof t && d) {
            if (U && "function" == typeof t[U] && M)
              return M(t, { depth: _ - o });
            if ("symbol" !== d && "function" == typeof t.inspect)
              return t.inspect();
          }
          if (
            (function (e) {
        ...
        function V(e, t) {
          ...
          return W(
            w.call(w.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, J),
            "single",
            t,
          );
        }
        ...
        var n = r(50323),
          ...
          c = function (e, t, r, n) {
            if (e) {
              ...
              for (
                var u = 0;
                r.depth > 0 && null !== (p = a.exec(i)) && u < r.depth;
      ...
      61007: (e, t, r) => {
        ...
        var n = r(2435),
          ...
          m = {},
          d = function e(t, r, i, a, p, c, u, f, d, g, h, b, w, v, x, S) {
            for (
              var E, A = t, j = S, O = 0, P = !1;
              void 0 !== (j = j.get(m)) && !P;
            ...
            if (
              ...
              if (p) return u && !v ? u(r, y.encoder, x, "key", b) : r;
              A = "";
            }
            if (
              "string" == typeof (E = A) ||
              ...
              return u
                ? [
                    w(v ? r : u(r, y.encoder, x, "key", b)) +
                      "=" +
                      w(u(A, y.encoder, x, "value", b)),
                  ]
                : [w(r) + "=" + w(String(A))];
            var I,
              N = [];
            ...
            for (
              var T = a && l(A) && 1 === A.length ? r + "[]" : r, R = 0;
              R < I.length;
              ++R
            ) {
              var F = I[R],
                  ...
                  (o = e.filter),
                {
                  addQueryPrefix:
                    "boolean" == typeof e.addQueryPrefix
                      ...
                      : y.addQueryPrefix,
                  allowDots:
                    void 0 === e.allowDots ? y.allowDots : !!e.allowDots,
                  charset: t,
                  charsetSentinel:
                    "boolean" == typeof e.charsetSentinel
                      ? e.charsetSentinel
        ...
        e.exports = {
          ...
          compact: function (e) {
            for (
              ...
              for (
                var o = t[n], a = o.obj[o.prop], p = Object.keys(a), l = 0;
                l < p.length;
                ++l
              ) {
                var c = p[l],
            ...
            return (
              ...
              i(t) && i(r)
                ...
                : Object.keys(r).reduce(function (t, i) {
                    var a = r[i];
                    return (
                      o.call(t, i) ? (t[i] = e(t[i], a, n)) : (t[i] = a),
                      t
                    );
                  }, a)
            );
      ...
      73745: (e, t, r) => {
        ...
        var n = r(40885),
          ...
          l = n("%Math.floor%");
        e.exports = function (e, t) {
          if ("function" != typeof e) throw new p("`fn` is not a function");
          ...
          if ("length" in e && a) {
            var s = a(e, "length");
            (s && !s.configurable && (n = !1), s && !s.writable && (c = !1));
          }
          return (
            (n || c || !r) &&
  ...
  ((() => {
    ...
    (r.r(n),
      r.d(n, {
        Experiment: () => L,
        ExperimentWithAuth: () => V,
        ProvideExperimentData: () => $,
        ProvideExperimentDataWithAuth: () => J,
        dangerouslyGetExperimentAssignment: () => C,
        dangerouslyGetExperimentAssignmentWithAuth: () => q,
        initializeExPlat: () => D,
        loadExperimentAssignment: () => W,
        loadExperimentAssignmentWithAuth: () => z,
        useExperiment: () => B,
        useExperimentWithAuth: () => H,
      }));
    let e = Date.now();
    function t() {
      const t = Date.now();
      return ((e = e < t ? t : e + 1), e);
    }
    function o(e) {
      return t() < 1e3 * e.ttl + e.retrievedTimestamp;
    }
    const i = (e, r = 60) => ({
      experimentName: e,
      variationName: null,
    ...
    try {
      window.localStorage && (a = window.localStorage);
    } catch (e) {}
    const p = a;
    function l(e) {
      ...
      if (
        !(function (e) {
          return (
            l(e) &&
            c(e.experimentName) &&
            (c(e.variationName) || null === e.variationName) &&
    ...
    const u = "explat-experiment-",
      f = (e) => `${u}-${e}`;
    function y(e) {
      s(e);
      const t = m(e.experimentName);
      ...
      p.setItem(f(e.experimentName), JSON.stringify(e));
    }
    function m(e) {
      const t = p.getItem(f(e));
    ...
    const h = "explat-last-anon-id",
      b = "explat-last-anon-id-retrieval-time",
      w = async (e) => {
        const r = await e();
        if (r) return (p.setItem(h, r), p.setItem(b, String(t())), r);
        const n = p.getItem(h),
          o = p.getItem(b);
        return n && o && t() - parseInt(o, 10) < 864e5 ? n : null;
      };
    Error;
    const v =
        ...
        ? function (e) {
            return {
              loadExperimentAssignment: async (t) => (
                e.logError({
                  message:
                    "Attempting to load ExperimentAssignment in SSR context",
                  experimentName: t,
                }),
                i(t)
              ),
              dangerouslyGetExperimentAssignment: (t) => (
                e.logError({
                  message:
                    "Attempting to dangerously get ExperimentAssignment in SSR context",
                  experimentName: t,
                }),
                i(t)
              ),
        ...
        : function (e) {
                    ...
                    n ||
                      (n = (async () => {
                        const n = await (async function (e, r) {
                          const n = t(),
                            { variations: a, ttl: p } = (function (e) {
                              if (
                                ...
                                return e;
                              throw new Error(
                                "Invalid FetchExperimentAssignmentResponse",
                              );
                            })(
                              await e.fetchExperimentAssignment({
                                anonId: await w(e.getAnonId),
                                experimentName: r,
                              }),
                            ),
                            c = Math.max(60, p),
                          ...
                          if (0 === u.length) return i(r, c);
                          const f = u[0];
                          if (f.experimentName !== r)
                            throw new Error(
                              "Newly fetched ExperimentAssignment's experiment name does not match request.",
                            );
                          if (!o(f))
                            throw new Error(
                              "Newly fetched experiment isn't alive.",
                            );
                          return f;
                        })(e, r);
                        return (y(n), n);
            ...
            return {
              loadExperimentAssignment: async (e) => {
                try {
                  if (!c(e)) throw new Error(`Invalid experimentName: "${e}"`);
                  const i = m(e);
                  if (i && o(i)) return i;
                  void 0 === n[e] && (n[e] = r(e));
                  let a = 1e4;
                  ...
                  Promise.race([
                    ...
                    new Promise((e, t) =>
                      setTimeout(
                        () =>
                          t(new Error(`Promise has timed-out after ${p}ms.`)),
                        p,
                      ),
                    ),
                  ]));
              ...
              dangerouslyGetExperimentAssignment: (r) => {
                try {
                  if (!c(r)) throw new Error(`Invalid experimentName: ${r}`);
                  const n = m(r);
                  if (!n)
                    throw new Error(
    ...
    var x = r(39793),
      S = r(51609);
    const E = { isEligible: !0 };
    function A(e) {
      const t = (t, r = {}) => {
        const n = { ...E, ...r },
          [o] = (0, S.useState)(t),
          [i, a] = (0, S.useState)([!0, null]);
        return (
          (0, S.useEffect)(() => {
            let r = !0;
            return (
      ...
      O = (e) => {
        ...
        try {
            ...
            };
          {
            ...
            (e.append("error", JSON.stringify(o)),
              window
    ...
    var P = r(4594);
    const _ = window.wp.hooks,
      I = window.wp.apiFetch;
    var N = r.n(I);
    const k = window.wcTracks?.isEnabled || void 0 !== window?._wca?.push,
      T = ({ experimentName: e, anonId: t }) => {
        const r = (0, _.applyFilters)("woocommerce_explat_request_args", {
          experiment_name: e,
        ...
        if (
          !((e) =>
            ...
            e.hasOwnProperty("woo_wcadmin_install_timestamp"))(r)
        )
          throw new Error(`Invalid query Params: ${JSON.stringify(r)}`);
        if (!/^[A-Za-z0-9_]+$/.test(r.experiment_name))
          throw new Error(`Invalid A/B test name: ${r.experiment_name}`);
        return r;
      };
    var R = r(29654);
    let F = null;
    const M = async () => (k ? await F : null),
      D = () => {
        k &&
          (async () => {
            let e = 0;
            return (
              (F = new Promise((t) => {
                const r = () => {
                  const n = R.parse(document.cookie).tk_ai || null;
                  "string" != typeof n || "" === n
                    ? 99 <= e
                      ? t(null)
                      : ((e += 1), setTimeout(r, 50))
    ...
    const U = v({
        fetchExperimentAssignment: async ({ experimentName: e, anonId: t }) => {
          ...
          const r = T({ experimentName: e, anonId: t });
          if (!r.anon_id)
            throw new Error(
          ...
          const n = await window.fetch(
            `https://public-api.wordpress.com/wpcom/v2/experiments/0.1.0/assignments/woocommerce?${(0, P.stringify)(r)}`,
          );
          return await n.json();
        },
        getAnonId: M,
      ...
      { loadExperimentAssignment: W, dangerouslyGetExperimentAssignment: C } =
        U,
      { useExperiment: B, Experiment: L, ProvideExperimentData: $ } = A(U),
      G = v({
        fetchExperimentAssignment: async ({ experimentName: e, anonId: t }) => {
          if (!k)
            throw new Error(
          ...
          return await N()({
            path: `/wc-admin/experiments/assignment?${(0, P.stringify)(T({ experimentName: e, anonId: t }))}`,
          });
        },
        getAnonId: M,
        logError: O,
      ...
      { loadExperimentAssignment: z, dangerouslyGetExperimentAssignment: q } =
        G,
      { useExperiment: H, Experiment: V, ProvideExperimentData: J } = A(G);
  })(),
