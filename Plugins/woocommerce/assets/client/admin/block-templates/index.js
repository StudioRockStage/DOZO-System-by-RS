(() => {
  var __webpack_modules__ = {
      26078: (e, t, u) => {
        ...
        const n = u(56821),
          r = {
            findRule(e, t) {
              for (let u = 0; u < e.rules.length; u++)
                if (e.rules[u].name === t) return e.rules[u];
            },
            indexOfRule(e, t) {
              for (let u = 0; u < e.rules.length; u++)
                if (e.rules[u].name === t) return u;
              return -1;
            },
            alwaysConsumesOnSuccess(e, t) {
              ...
              const s = n.build({
                choice: (e) => e.alternatives.every(s),
                sequence: (e) => e.elements.some(s),
                simple_and: o,
                simple_not: o,
                optional: o,
                zero_or_more: o,
                repeated(e) {
                  ...
                  return !(
                    ...
                    0 === t.value ||
                    (!s(e.expression) &&
                      !(t.value > 1 && e.delimiter && s(e.delimiter)))
                  );
                },
                semantic_and: o,
                semantic_not: o,
      ...
      2491: (module, __unused_webpack_exports, __webpack_require__) => {
        "use strict";
        const generateBytecode = __webpack_require__(99856),
          generateJS = __webpack_require__(62256),
          inferenceMatchResult = __webpack_require__(63190),
          removeProxyRules = __webpack_require__(76974),
          reportDuplicateLabels = __webpack_require__(81375),
          reportDuplicateRules = __webpack_require__(92829),
          reportInfiniteRecursion = __webpack_require__(1733),
          reportInfiniteRepetition = __webpack_require__(97782),
          reportUndefinedRules = __webpack_require__(10328),
          reportIncorrectPlucking = __webpack_require__(23645),
          Session = __webpack_require__(3899),
          visitor = __webpack_require__(56821),
          { base64 } = __webpack_require__(6854);
          ...
          compile(ast, passes, options) {
            ...
            if (options.allowedStartRules.some((e) => "*" === e))
              ...
              for (const e of options.allowedStartRules)
                if (-1 === allRules.indexOf(e))
                  throw new Error(`Unknown start rule "${e}"`);
            if (
            ...
            switch (
              (Object.keys(passes).forEach((e) => {
                ((session.stage = e),
                  ...
                  passes[e].forEach((t) => {
                    (session.info(`Process pass ${e}.${t.name}`),
              ...
              case "source-with-inline-map": {
                ...
                return (
                  e.code +
                  `//# sourceMappingURL=data:application/json;charset=utf-8;base64,${u}\n`
                );
              }
              case "ast":
                return ast;
      ...
      99856: (e, t, u) => {
        ...
        const n = u(26078),
          r = u(90620),
          o = u(56821),
          { ALWAYS_MATCH: s, SOMETIMES_MATCH: a, NEVER_MATCH: i } = u(63190);
        e.exports = function (e, t) {
          ...
          function m(e, t, u, n) {
            return e === s
              ...
              : e === i
                ? n
                : t.concat([u.length, n.length], u, n);
          }
          function F(e, t, u, n) {
          ...
          function D(e, t, u) {
            const n = E(!0, Object.keys(u.env), e);
            return g(
              [r.UPDATE_SAVED_POS],
              F(n, 0, u.env, u.sp),
              m(
          ...
          function x(e, t, u, n) {
            switch (e.type) {
              ...
              default:
                throw new Error(
                  `Unknown boundary type "${e.type}" for the "repeated" node`,
                );
            }
          }
          function v(e, t) {
            if (null !== t.value) {
              const u =
                "constant" === t.type
                  ? [r.IF_GE, t.value]
                  : [r.IF_GE_DYNAMIC, t.sp];
              return m(a, u, [r.PUSH_FAILED], e);
            }
            return e;
          }
          const y =
            ((b = {
              ...
              named(e, t) {
                const u = 0 | e.match,
                  n = u === i ? null : d({ type: "rule", value: e.name });
                return g(
                  [r.SILENT_FAILS_ON],
                  y(e.expression, t),
                  [r.SILENT_FAILS_OFF],
                ...
                (function e(t, u) {
                  ...
                  return n === s
                    ...
                    : g(
                        o,
                        t.length > 1
                          ? m(a, [r.IF_ERROR], g([r.POP], e(t.slice(1), u)), [])
                          : [],
                      );
                })(e.alternatives, t),
              action(e, t) {
                const u = C(t.env),
                  n =
                    "sequence" !== e.expression.type ||
                    0 === e.expression.elements.length,
                  o = y(e.expression, {
                    sp: t.sp + (n ? 1 : 0),
                    env: u,
                    action: e,
                  }),
                  s = 0 | e.expression.match,
                  a = n && s !== i ? E(!1, Object.keys(u), e) : null;
                return n
                  ? g(
                      [r.PUSH_CURR_POS],
                      o,
                      m(
                        s,
                        [r.IF_NOT_ERROR],
                        g([r.LOAD_SAVED_POS, 1], F(a, 1, u, t.sp + 2)),
                        [],
                      ),
                      [r.NIP],
                    )
              ...
              sequence: (e, t) =>
                g(
                  ...
                  (function t(u, n) {
                    ...
                    if (n.action) {
                      const t = E(!1, Object.keys(n.env), n.action);
                      return g(
              ...
              labeled(e, u) {
                ...
                const o = e.label,
                  s = u.sp + 1;
                (o && ((n = C(u.env)), (u.env[e.label] = s)),
                  e.pick && u.pluck.push(s));
                const a = y(e.expression, { sp: u.sp, env: n, action: null });
                return o &&
                  e.labelLocation &&
                  t &&
                  "source-and-map" === t.output
                  ? g(
                      [r.SOURCE_MAP_LABEL_PUSH, s, h(o), f(e.labelLocation)],
                      a,
                      [r.SOURCE_MAP_LABEL_POP, s],
                    )
                  : a;
              },
              text: (e, t) =>
                g(
                  ...
                  m(0 | e.match, [r.IF_NOT_ERROR], g([r.POP], [r.TEXT]), [
                    r.NIP,
                  ]),
                ),
                ...
                const u = e.min ? e.min : e.max,
                  ...
                  i = e.min
                    ? x(
                        ...
                        t.env,
                        t.sp,
                        2 + ("function" === e.max.type ? 1 : 0),
                      )
                    : { pre: [], post: [], sp: t.sp },
                  c = x(e.max, t.env, i.sp, s),
                  l = y(e.expression, {
                    sp: c.sp + s,
                    env: C(t.env),
                    action: null,
                  ...
                  A = (function (e, t, u, n, o) {
                    return e
                      ...
                      : u;
                  })(e.delimiter, 0 | e.expression.match, p, t, s),
                  h = v(A, e.max),
                  d = o ? v(l, e.max) : l,
                  E = g(
                    n ? [r.PUSH_CURR_POS] : [],
              ...
              Object.entries(b).forEach(([e, t]) => {
                b[e] = function (e, ...u) {
                  ...
                  return void 0 !== n && e.location
                    ? g([r.SOURCE_MAP_PUSH, f(e.location)], n, [
                        r.SOURCE_MAP_POP,
                      ])
                    : n;
                };
      ...
      62256: (e, t, u) => {
        ...
        const n = u(26078),
          ...
          o = u(65311),
          s = u(66925),
          { stringEscape: a, regexpClassEscape: i } = u(6854),
          { SourceNode: c } = u(3640),
          l = u(89798);
        function p(e, t, u) {
        ...
        e.exports = function (e, t) {
          ...
          function C(e) {
            return e.codeLocation
              ? p(e.code, e.codeLocation, "$" + e.type)
              : e.code;
          }
          e.code = (function (e) {
            function n() {
              return [
                `// Generated by Peggy ${s}.`,
                "//",
                "// https://peggyjs.org/",
              ];
            }
            ...
            const o = {
              ...
              es() {
                ...
                return (
                  ...
                  u.length > 0 &&
                    (u.forEach((e) => {
                      r.push(
                        "import " + e + ' from "' + a(t.dependencies[e]) + '";',
                      );
                    }),
                    r.push("")),
                  r.push(
              ...
              umd() {
                const o = Object.keys(t.dependencies),
                  s = o.map((e) => t.dependencies[e]),
                  i = "[" + s.map((e) => '"' + a(e) + '"').join(", ") + "]",
                  c = s.map((e) => 'require("' + a(e) + '")').join(", "),
                  l = o.join(", "),
                  p = n();
                return (
                  p.push(
            ...
            (function () {
              ...
              (e.topLevelInitializer &&
                (s.push(C(e.topLevelInitializer)), s.push("")),
                s.push(
              ...
              const p =
                  "{ " +
                  t.allowedStartRules.map((e) => e + ": " + f(e)).join(", ") +
                  " }",
              ...
              return (
                s.push(
                  ...
                  new c(null, null, t.grammarSource, [
                          ...
                          (e, t) =>
                            ...
                            (function (e) {
                              switch (e.type) {
                                case "rule":
                                  return (
                                    'peg$otherExpectation("' + a(e.value) + '")'
                                  );
                                case "literal":
                                  return (
                    ...
                    e.functions.map(function (e, t) {
                      return A(
                        `\n  var ${E(t)} = function(${e.params.join(", ")}) {`,
                        e.body,
                        e.location,
                        "};",
                      );
                ...
                t.cache && s.push("  var peg$resultsCache = {};", ""),
                t.trace &&
                  s.push(
                ...
                e.rules.forEach((i) => {
                  (s.push(
                    ...u(
                      (function (s) {
                        const i = [],
                          c = new o(s.name, "s", "var", s.bytecode),
                          p = (function t(n) {
                            let o = 0;
                            const a = n.length,
                              i = [];
                            ...
                            for (; o < a; )
                              switch (n[o]) {
                                ...
                                case r.SOURCE_MAP_PUSH:
                                  (c.sourceMapPush(i, e.locations[n[o + 1]]),
                                    (o += 2));
                                  break;
                ...
                e.initializer && (s.push(C(e.initializer)), s.push("")),
                s.push(
      ...
      63190: (e, t, u) => {
        ...
        function a(e) {
          ...
          function i(e, t) {
            ...
            return n === u ? 1 : t ? (r === u ? s : 0) : r > 0 ? s : 0;
          }
          const c = n.build({
            rule(e) {
              let t,
            ...
            repeated(e) {
              const t = c(e.expression),
                u = e.delimiter ? c(e.delimiter) : s,
                n = e.min ? e.min : e.max;
              return "constant" !== n.type || "constant" !== e.max.type
                ? (e.match = 0)
                : 0 === e.max.value ||
                    (null !== e.max.value && n.value > e.max.value)
                  ? (e.match = s)
                  : t === s
                    ? (e.match = 0 === n.value ? 1 : s)
                    : 1 === t
        ...
        e.exports = function (e, t, u) {
          ...
          (e.rules.forEach((s, a) => {
            ...
            "rule" === (i = s).type &&
                ...
                r.build({
                  rule_ref(r) {
                    r.name === t &&
                      ((r.name = o),
                      u.info(
                        `Proxy rule "${t}" replaced by the rule "${o}"`,
                        r.location,
                        [
                          {
              ...
              })(e, s.name, s.expression.name),
              -1 === t.allowedStartRules.indexOf(s.name) && o.push(a));
          }),
            o.reverse(),
            o.forEach((t) => {
              e.rules.splice(t, 1);
          ...
          const s = n.build({
            ...
            labeled(e, t) {
              ...
              (n &&
                ...
                u.error(
                  `Label "${e.label}" is already defined`,
                  e.labelLocation,
            ...
            one_or_more: o,
            repeated(e, t) {
              (e.delimiter && s(e.delimiter, r(t)), s(e.expression, r(t)));
            },
            group: o,
          });
          s(e);
          ...
          n.build({
            rule(e) {
              Object.prototype.hasOwnProperty.call(r, e.name)
                ? u.error(
                    `Rule "${e.name}" is already defined`,
                    e.nameLocation,
                    [
                      {
      ...
      1733: (e, t, u) => {
        ...
        e.exports = function (e, t, u) {
          const o = [],
            ...
            a = r.build({
              rule(e) {
                (o.push(e.name), a(e.expression), o.pop());
              },
              sequence(t) {
                t.elements.every(
                  (t) => (a(t), !n.alwaysConsumesOnSuccess(e, t)),
                );
              },
              repeated(t) {
                (a(t.expression),
                  ...
                  return (
                    ...
                    void u.error(
                      ...
                      s.map((e, t, u) => ({
                        message:
                          t + 1 !== u.length
                            ? `Step ${t + 1}: call of the rule "${e.name}" without input consumption`
                            : `Step ${t + 1}: call itself without input consumption - left recursion`,
                        location: e.location,
                      })),
                    )
                  );
      ...
      10328: (e, t, u) => {
        ...
        e.exports = function (e, t, u) {
          r.build({
            rule_ref(t) {
              n.findRule(e, t.name) ||
                u.error(`Rule "${t.name}" is not defined`, t.location);
            },
          })(e);
        };
      },
      3899: (e, t, u) => {
        ...
        class r {
          constructor(e) {
            ("function" == typeof (e = void 0 !== e ? e : {}).error &&
              (this.error = e.error),
        ...
        e.exports = class {
          ...
          warning(...e) {
            (this.problems.push(["warning", ...e]),
              this._callbacks.warning(this.stage, ...e));
          }
          info(...e) {
            (this.problems.push(["info", ...e]),
              this._callbacks.info(this.stage, ...e));
          }
          checkErrors() {
      ...
      65311: (e, t, u) => {
        ...
        class o {
            ...
            if (t) {
              if (this.sourceMapStack.length) {
                const e = o.sourceNode(t.location, u.splice(0, 2), t.label),
                  { parts: r, location: s } = this.sourceMapPopInternal(),
                  a =
                    s.start.offset < t.location.end.offset
                      ? { start: t.location.end, end: s.end, source: s.source }
                      : s,
                  i = o.sourceNode(a, u.concat("\n"));
                return (
                  this.sourceMapStack.push([r, r.length + 1, s]),
          ...
          pop(e) {
            return void 0 !== e
              ? ((this.sp -= e),
                Array.from({ length: e }, (e, t) => this.name(this.sp + 1 + t)))
              : this.name(this.sp--);
          }
          top() {
          ...
          defines() {
            return this.maxSp < 0
              ...
              : this.type +
                  " " +
                  Array.from({ length: this.maxSp + 1 }, (e, t) =>
                    this.name(t),
                  ).join(", ") +
                  ";";
          }
          ...
          sourceMapPop(e) {
            ...
            if (
              ...
              t.end.offset <
                this.sourceMapStack[this.sourceMapStack.length - 1][2].end
                  .offset
            ) {
      ...
      60343: (e, t, u) => {
        ...
        class o extends Error {
          ...
          format(e) {
            ...
            function u(e, u, r = "") {
              let o = "";
              const s = t.find(({ source: t }) => t === e.source),
                a = e.start,
                i = n.offsetStart(e);
              if (s) {
                const t = e.end,
                  n = s.text[a.line - 1],
                  c =
                    (a.line === t.line ? t.column : n.length + 1) - a.column ||
                    1;
                (r && (o += `\nnote: ${r}`),
                  (o += `\n --\x3e ${e.source}:${i.line}:${i.column}\n${"".padEnd(u)} |\n${i.line.toString().padStart(u)} | ${n}\n${"".padEnd(u)} | ${"".padEnd(a.column - 1)}${"".padEnd(c, "^")}`));
              } else
                ((o += `\n at ${e.source}:${i.line}:${i.column}`),
                  r && (o += `: ${r}`));
              return o;
            }
              ...
              .map((e) =>
                (function (e, t, r, o = []) {
                  ...
                  ((s = r
                    ? o.reduce(
                        (e, { location: t }) =>
                          Math.max(e, n.offsetStart(t).line),
                        r.start.line,
                      )
                    : Math.max.apply(
                        null,
                  ...
                  let a = `${e}: ${t}`;
                  r && (a += u(r, s));
                  for (const e of o) a += u(e.location, s, e.message);
                  return a;
                })(...e),
              )
              .join("\n\n");
        ...
        e.exports = class {
          ...
          offset(e) {
            return {
              ...
              column:
                1 === e.line ? e.column + this.start.column - 1 : e.column,
      ...
      67274: (e) => {
        ...
        function o(e, t, u) {
          return (
            ...
            e.length > t
              ? e
              : ((t -= e.length), e + (u += u.repeat(t)).slice(0, t))
          );
        }
        (!(function (e, t) {
          function u() {
            ...
            if (this.location) {
              ...
              var r = this.location.start,
                s =
                  ...
                  "function" == typeof this.location.source.offset
                    ? this.location.source.offset(r)
                    : r,
                a = this.location.source + ":" + s.line + ":" + s.column;
              if (n) {
                var i = this.location.end,
                  c = o("", s.line.toString().length, " "),
                  l = n[r.line - 1],
                  p =
                    (r.line === i.line ? i.column : l.length + 1) - r.column ||
                    1;
                t +=
                  "\n --\x3e " +
                  a +
            ...
            parse: function (e, o) {
              var s,
                ...
                ru = function (e) {
                  return (
                    wn.indexOf(e[0]) >= 0 &&
                      Hu(`Label can't be a reserved word "${e[0]}"`, e[1]),
                    e
                  );
                },
                ou = function (e, u) {
                ...
                _u = function (t, u) {
                  return (
                    t.charCodeAt(0) > u.charCodeAt(0) &&
                      Hu(
                        "Invalid character range: " + e.substring(Iu, ku) + ".",
                      ),
                    [t, u]
                  );
                },
              ...
              function Ju() {
                ...
                if (
                  ...
                  r !== a ? ((o = Pn()), (n = r)) : ((ku = n), (n = a)),
                  n === a && (n = null),
                  (r = []),
                  (o = ku),
                  (s = Xu()) !== a ? (Pn(), (o = s)) : ((ku = o), (o = a)),
                  o !== a)
                )
                  for (; o !== a; )
                    (r.push(o),
              ...
              function nn() {
                ...
                return (
                  ...
                  (u = (function () {
                    var t, u, n, r;
                    if (((t = ku), (u = ku), (n = []), (r = vn()) !== a))
                      for (; r !== a; ) (n.push(r), (r = vn()));
                    else n = a;
                    return (
                      (u = n !== a ? e.substring(u, ku) : n) !== a &&
                        ((Iu = t), (u = Lu(u))),
                      (t = u)
                    );
                  })()),
              ...
              function hn() {
                var e, t, u, n;
                if ((Uu++, (e = ku), (t = dn()) !== a)) {
                  for (u = [], n = En(); n !== a; ) (u.push(n), (n = En()));
                  ((Iu = e), (e = fu(t, u)));
                } else ((ku = e), (e = a));
                return (Uu--, e === a && ((t = a), 0 === Uu && Vu(at)), e);
              }
              function dn() {
                var t, u, n;
                return (
              ...
              function fn() {
                ...
                if (
                  ...
                  for (n = [], r = Cn(); r !== a; ) (n.push(r), (r = Cn()));
                  (34 === e.charCodeAt(ku)
                    ? ((r = Y), ku++)
                    : ((r = a), 0 === Uu && Vu(Et)),
                    r !== a ? ((Iu = t), (t = gu(n))) : ((ku = t), (t = a)));
                } else ((ku = t), (t = a));
                if (t === a)
                  if (
                    ((t = ku),
                    ...
                    for (n = [], r = gn(); r !== a; ) (n.push(r), (r = gn()));
                    (39 === e.charCodeAt(ku)
                      ? ((r = V), ku++)
                      : ((r = a), 0 === Uu && Vu(ft)),
                      r !== a ? ((Iu = t), (t = mu(n))) : ((ku = t), (t = a)));
                  } else ((ku = t), (t = a));
                return (Uu--, t === a && ((u = a), 0 === Uu && Vu(dt)), t);
              }
              function Cn() {
                var t, u, n, r;
                return (
                  ...
                  n !== a && (r = on()) !== a
                    ? (u = n = [n, r])
                    : ((ku = u), (u = a)),
                  (t = u !== a ? e.substring(t, ku) : u) === a &&
                    ((t = ku),
                    92 === e.charCodeAt(ku)
                      ? ((u = q), ku++)
                      : ((u = a), 0 === Uu && Vu(ct)),
                    u !== a && (n = Dn()) !== a ? (t = n) : ((ku = t), (t = a)),
                    t === a && (t = _n())),
                  t
                );
              }
              ...
              function On() {
                ...
                return (
                  t === a &&
                    ...
                    (u = (function () {
                      var e, t;
                      for (e = [], (t = sn()) === a && (t = pn()); t !== a; )
                        (e.push(t), (t = sn()) === a && (t = pn()));
                      return e;
                    })()),
                    (n = An()) === a && (n = null),
                    (r = cn()) !== a
                      ...
                      (n = (function () {
                        ...
                        return (
                          ...
                          e.length > ku
                            ...
                            : ((u = a), 0 === Uu && Vu(He)),
                          Uu--,
                          u === a ? (t = void 0) : ((ku = t), (t = a)),
                          t
                        );
                      })()),
                      n !== a ? (t = u = [u, n]) : ((ku = t), (t = a)))),
                  t
                );
              }
              const wn = o.reservedWords || [];
              if ((s = l()) !== a && ku === e.length) return s;
              throw (
                s !== a && ku < e.length && Vu({ type: "end" }),
                (function (e, t, u) {
      ...
      54897: (e, t, u) => {
        ...
        const n = u(60343),
          ...
          a = {
            ...
            generate(e, t) {
              const u =
                  "plugins" in (t = void 0 !== t ? t : {}) ? t.plugins : [],
                n = {
                  parser: a.parser,
                  passes: (function (e) {
                    const t = {};
                  ...
                  reservedWords: a.RESERVED_WORDS.slice(),
                };
              return (
                u.forEach((e) => {
                  e.use(n, t);
      ...
      57416: (e, t, u) => {
        ...
        class a {
          ...
          static fromSourceMap(e) {
            const t = e.sourceRoot,
              u = new a({ file: e.file, sourceRoot: t });
            return (
              ...
              e.sources.forEach(function (n) {
                let o = n;
                (null != t && (o = r.relative(t, n)),
                  u._sources.has(o) || u._sources.add(o));
                const s = e.sourceContentFor(n);
                null != s && u.setSourceContent(n, s);
              }),
              u
            );
          }
          ...
          applySourceMap(e, t, u) {
            ...
            null != s && (n = r.relative(s, n));
            const a =
                this._mappings.toArray().length > 0 ? new o() : this._sources,
              i = new o();
          ...
          _serializeMappings() {
            ...
            for (let d = 0, E = h.length; d < E; d++) {
              if (((t = h[d]), (e = ""), t.generatedLine !== a))
                ...
                if (!r.compareByGeneratedPositionsInflated(t, h[d - 1]))
                  continue;
                e += ",";
              }
        ...
        ((a.prototype._version = 3), (t.SourceMapGenerator = a));
      },
      93404: (e, t, u) => {
        const n = u(57416).SourceMapGenerator,
          r = u(12098),
          o = /(\r?\n)/,
          s = "$$$isSourceNode$$$";
        class a {
              ...
              t.eachMapping(function (e) {
                if (null !== h) {
                  if (!(p < e.generatedLine)) {
                    ...
                    return (
                      (s[i] = l.substr(e.generatedColumn - A)),
                      (A = e.generatedColumn),
                      d(h, t),
                      void (h = e)
                    );
                ...
                (A < e.generatedColumn &&
                  ...
                  (s[i] = l.substr(e.generatedColumn)),
                  (A = e.generatedColumn)),
                  (h = e));
              }, this),
              i < s.length && (h && d(h, c()), n.add(s.splice(i).join(""))),
              t.sources.forEach(function (e) {
                const o = t.sourceContentFor(e);
                null != o &&
                  (null != u && (e = r.join(u, e)), n.setSourceContent(e, o));
              }),
              n
            );
            function d(e, t) {
          ...
          join(e) {
            ...
            if (n > 0) {
              for (t = [], u = 0; u < n - 1; u++)
                (t.push(this.children[u]), t.push(e));
      ...
      12098: (e, t) => {
        ...
        function r(e) {
          ...
          if (
            ...
            return !1;
          for (let u = t - 10; u >= 0; u--)
            if (36 !== e.charCodeAt(u)) return !1;
          return !0;
        }
        function o(e, t) {
          return e === t
        ...
        ((t.normalize = d),
          (t.join = function (e, t) {
            ...
            if ("scheme-relative" === u) return d(t);
            if ("scheme-relative" === n) return i(t, i(e, s)).slice(5);
            if ("path-absolute" === u) return d(t);
            if ("path-absolute" === n) return i(t, i(e, s)).slice(11);
            const r = c(t + e);
          ...
          (t.relative = function (e, t) {
            ...
            return "string" == typeof u ? u : d(t);
          }));
      },
      3640: (e, t, u) => {
        ((t.SourceMapGenerator = u(57416).SourceMapGenerator),
          (t.SourceNode = u(93404).SourceNode));
      },
    },
  ...
  function __webpack_require__(e) {
    ...
    return (
      __webpack_modules__[e](u, u.exports, __webpack_require__),
      u.exports
    );
  }
  ...
  ((() => {
    ...
    const e = window.wp.element,
      ...
      n = (n) => {
        ...
        (0, e.useEffect)(() => {
          n &&
            ((0, u.select)(t.store).getEntityConfig(
              "root",
              "wcLayoutTemplate",
            ) ||
              (0, u.dispatch)(t.store).addEntities([
                {
                  kind: "root",
        ...
        const { record: s, isResolving: a } = (0, t.useEntityRecord)(
          "root",
          "wcLayoutTemplate",
          n || "__invalid-template-id",
          { enabled: r && !!n },
        );
        return { layoutTemplate: s, isResolving: a };
      },
      ...
      s = window.wp.blocks,
      a = __webpack_require__(54897).generate(
    ...
    function p(t, n) {
      return (r) => {
        const { context: o } = r,
          {
            _templateBlockHideConditions: s,
            _templateBlockDisableConditions: a,
          } = r.attributes,
          ...
          { shouldHide: l, shouldDisable: p } = (0, u.useSelect)(
            (e) => {
              ...
              return {
                shouldHide:
                  s && Array.isArray(s) && s.some((e) => i(e.expression, t)),
                shouldDisable:
                  a && Array.isArray(a) && a.some((e) => i(e.expression, t)),
              };
            },
            [c, s, a],
          );
        return !t || l
          ...
          : (0, e.createElement)(t, {
              ...
              attributes: {
                ...r.attributes,
                disabled: r.attributes.disabled || p,
              },
            });
      };
    }
    let A = (0, c.isWpVersion)("6.7", "<");
    const h = (0, c.getSetting)("admin");
    function d(e) {
      const t = {
        ...e,
        _templateBlockId: { type: "string", role: "content" },
        _templateBlockOrder: { type: "integer", role: "content" },
        _templateBlockHideConditions: { type: "array", role: "content" },
        _templateBlockDisableConditions: { type: "array", role: "content" },
        disabled: e.disabled || { type: "boolean", role: "content" },
      };
      return A
        ? Object.keys(t).reduce(
            (e, u) => (
              t[u].role
                ? (e[u] = { ...t[u], __experimentalRole: t[u].role })
                : (e[u] = t[u]),
              e
            ),
            {},
    ...
    function E(e, t) {
      ...
      const { metadata: u, settings: n, name: r } = e,
        { edit: o } = n;
      if (!o) return;
      const a = { ...u, attributes: d(u.attributes) };
      return (0, s.registerBlockType)(
        { name: r, ...a },
        { ...n, edit: p(o, null != t ? t : l) },
      );
    }
    A && h.gutenberg_version && (A = parseFloat(h?.gutenberg_version) < 19.4);
  })(),
