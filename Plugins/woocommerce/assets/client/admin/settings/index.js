...
(() => {
  ...
  var e = {
      94931: (e, r, t) => {
        ...
        r.jsx = function (e, r, t) {
          ...
          r))
            s.call(r, o) && !c.hasOwnProperty(o) && (w[o] = r[o]);
          if (e && e.defaultProps)
            for (o in (r = e.defaultProps)) void 0 === w[o] && (w[o] = r[o]);
          return {
            $$typeof: n,
            type: e,
            key: a,
  ...
  const s = document.getElementById("wc-settings-page");
  ((0, t.createRoot)(s).render((0, n.jsx)(o.SettingsEditor, {})),
    ((window.wc = window.wc || {}).settings = {}));
})();
