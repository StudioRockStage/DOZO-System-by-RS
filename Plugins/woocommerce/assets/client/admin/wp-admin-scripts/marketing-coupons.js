...
(() => {
  ...
  var e = {
      94931: (e, t, n) => {
        ...
        function l(e, t, n) {
          ...
          t))
            i.call(t, o) && !c.hasOwnProperty(o) && (s[o] = t[o]);
          if (e && e.defaultProps)
  ...
  (n.r(o),
    n.d(o, {
      amazonEbayIntegration: () => v,
      automatewoo: () => E,
      automatewooAlt: () => _,
      automatewooBirthdays: () => E,
      automatewooReferrals: () => E,
      blank: () => C,
      creativeMailByConstantContact: () => D,
      facebook: () => T,
      facebookForWoocommerce: () => T,
      googleAds: () => R,
      googleListingsAndAds: () => R,
      hubspotForWoocommerce: () => O,
      integrationWithSalesforce: () => $,
      klaviyo: () => V,
      mailchimpForWoocommerce: () => A,
      mailpoet: () => I,
      pinterest: () => L,
      pinterestForWoocommerce: () => L,
      tiktokForBusiness: () => H,
      trustpilotReviews: () => U,
      vimeo: () => z,
      woocommerceAmazonEbayIntegration: () => v,
      woocommerceFreeGiftCoupons: () => F,
      woocommerceGroupCoupons: () => q,
      woocommerceSmartCoupons: () => J,
      woocommerceStoreCredit: () => B,
      woocommerceUrlCoupons: () => W,
      woocommerceZapier: () => Z,
      zeroBsCrm: () => G,
    }));
  var r = {};
  (n.r(r),
    n.d(r, {
      activateInstalledPlugin: () => ve,
      handleFetchError: () => we,
      installAndActivateRecommendedPlugin: () => Ee,
      loadInstalledPluginsAfterActivation: () => Ce,
      receiveActivatingPlugin: () => ue,
      receiveBlogPosts: () => fe,
      receiveInstalledPlugins: () => me,
      receiveMiscRecommendations: () => ge,
      receiveRecommendedPlugins: () => he,
      removeActivatingPlugin: () => pe,
      setError: () => xe,
    }));
  var s = {};
  (n.r(s),
    n.d(s, {
      getActivatingPlugins: () => je,
      getBlogPosts: () => Se,
      getBlogPostsError: () => Ne,
      getInstalledPlugins: () => _e,
      getMiscRecommendations: () => ke,
      getRecommendedPlugins: () => ye,
    }));
  var i = {};
  (n.r(i),
    n.d(i, {
      getBlogPosts: () => Me,
      getMiscRecommendations: () => Pe,
      getRecommendedPlugins: () => be,
    }));
  ...
  const u = function () {
      for (var e, t, n = 0, o = "", r = arguments.length; n < r; n++)
        (e = arguments[n]) && (t = m(e)) && (o && (o += " "), (o += t));
      return o;
    },
    p = window.wp.data,
    h = window.wc.tracks,
    g = (0, a.forwardRef)(function ({ icon: e, size: t = 24, ...n }, o) {
      return (0, a.cloneElement)(e, { width: t, height: t, ...n, ref: o });
    }),
    f = window.lodash,
    w = window.wp.primitives;
  var x = n(39793);
  const C = (0, x.jsx)(w.SVG, {
      width: "36",
      height: "36",
      fill: "none",
      ...
      children: [
        (0, x.jsx)("defs", {
          children: (0, x.jsx)("clipPath", {
            id: "b",
            children: (0, x.jsx)("rect", { width: "100", height: "100" }),
          }),
        }),
        (0, x.jsxs)("g", {
          id: "a",
          clipPath: "url(#b)",
          children: [
            (0, x.jsx)("rect", { width: "100", height: "100", fill: "#fff" }),
            (0, x.jsx)("rect", { width: "100", height: "100", fill: "#eee" }),
            (0, x.jsxs)("g", {
    ...
    y = ["wcAdminSettings", "preloadSettings"],
    k = (0, j.getSetting)("admin", {}),
    S = Object.keys(k).reduce(
      (e, t) => (y.includes(t) || (e[t] = k[t]), e),
      {},
    ),
    N = {
      onboarding: {
  ...
  function b(e, t = !1, n = (e) => e, o = N) {
    ...
    return n(S.hasOwnProperty(e) ? S[e] : t, t);
  }
  ((0, j.getSetting)("adminUrl"),
    (0, j.getSetting)("countries"),
    (0, j.getSetting)("currency"));
  const P = (0, j.getSetting)("locale"),
    M = ((0, j.getSetting)("siteTitle"), (0, j.getSetting)("wcAssetUrl"));
  b("orderStatuses");
  const T = (0, x.jsx)("img", {
      src: `${M}images/marketing/facebook.svg`,
      alt: (0, c.__)("Facebook", "woocommerce"),
      style: { padding: "4px" },
    }),
    L = (0, x.jsx)(w.SVG, {
      width: "303",
    ...
    R = (0, x.jsx)("img", {
      src: `${M}images/marketing/google.svg`,
      alt: (0, c.__)("Google", "woocommerce"),
      style: { padding: "4px" },
    }),
    O = (0, x.jsxs)(w.SVG, {
      xmlns: "http://www.w3.org/2000/svg",
    ...
    V = (0, x.jsx)("img", {
      src: `${M}images/marketing/klaviyo.png`,
      alt: (0, c.__)("Klaviyo", "woocommerce"),
    }),
    D = (0, x.jsx)("img", {
      src: `${M}images/marketing/creative-mail-by-constant-contact.png`,
      alt: (0, c.__)("Creative Mail by Constant Contact", "woocommerce"),
    }),
    G = (0, x.jsx)("img", {
      src: `${M}images/marketing/jetpack-crm.svg`,
      alt: (0, c.__)("Jetpack CRM", "woocommerce"),
    }),
    $ = (0, x.jsx)("img", {
      src: `${M}images/marketing/salesforce.jpg`,
      alt: (0, c.__)("Salesforce", "woocommerce"),
    }),
    H = (0, x.jsx)("img", {
      src: `${M}images/marketing/tiktok.jpg`,
      alt: (0, c.__)("TikTok", "woocommerce"),
    }),
    Z = (0, x.jsx)("img", {
      src: `${M}images/marketing/zapier.png`,
      alt: (0, c.__)("Zapier", "woocommerce"),
    }),
    z = (0, x.jsx)("img", {
      src: `${M}images/marketing/vimeo.png`,
      alt: (0, c.__)("Vimeo", "woocommerce"),
    }),
    U = (0, x.jsx)("img", {
      src: `${M}images/marketing/trustpilot.png`,
      alt: (0, c.__)("Trustpilot", "woocommerce"),
    }),
    B = (0, x.jsx)(w.SVG, {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
  ...
  class K extends a.Component {
    render() {
      const e = (0, f.camelCase)(this.props.product);
      let t = C;
      return (
        e in o && (t = o[e]),
        (0, x.jsx)("div", {
          ...
          children: (0, x.jsx)(g, { icon: t, size: 36 }),
        })
      );
    }
  }
  const X = K,
    Q = window.wc.components;
  var Y = n(51609),
    ee = n.n(Y);
  function te(e) {
    return e.startsWith("{{/")
  ...
  function ne(e, t) {
    ...
    for (let s = 0; s < e.length; s++) {
      ...
      if ("string" !== i.type) {
        if (void 0 === t[i.value])
          throw new Error(
            `Invalid interpolation, missing component node: \`${i.value}\``,
          );
    ...
    if (n) {
      const s = (function (e, t) {
        ...
        i = ne(e.slice(o + 1, s), t),
        a = (0, Y.cloneElement)(n, {}, i);
      if ((r.push(a), s < e.length - 1)) {
        const n = ne(e.slice(s + 1), t);
        r = r.concat(n);
      }
    }
    return (
      ...
      0 === r.length
        ...
        : 1 === r.length
          ? r[0]
          : (0, Y.createElement)(Y.Fragment, null, ...r)
    );
  }
  function oe(e) {
    const { mixedString: t, components: n, throwErrors: o } = e;
    if (!n) return t;
    if ("object" != typeof n) {
      if (o)
        throw new Error(
  ...
  const re = () =>
    ...
    ie = window.wp.url,
    ae = window.wp.dataControls,
    ce = "wc/marketing",
    le = "/wc-admin/marketing",
    de = {
  ...
  function me(e) {
    return { type: de.SET_INSTALLED_PLUGINS, plugins: e };
  }
  function ue(e) {
    return { type: de.SET_ACTIVATING_PLUGIN, pluginSlug: e };
  }
  function pe(e) {
    return { type: de.REMOVE_ACTIVATING_PLUGIN, pluginSlug: e };
  }
  function he(e, t) {
    return {
      type: de.SET_RECOMMENDED_PLUGINS,
      data: { plugins: e, category: t },
    };
  }
  function ge(e) {
    return {
      type: de.SET_MISC_RECOMMENDATIONS,
      data: { miscRecommendations: e },
    };
  }
  function fe(e, t) {
    return { type: de.SET_BLOG_POSTS, data: { posts: e, category: t } };
  }
  function we(e, t) {
  ...
  function xe(e, t) {
    return { type: de.SET_ERROR, category: e, error: t };
  }
  function* Ce(e) {
    try {
      const t = yield (0, ae.apiFetch)({
        path: `${le}/overview/installed-plugins`,
      });
      if (!t) throw new Error();
      (yield me(t), yield pe(e));
    } catch (e) {
      yield we(
        e,
        (0, c.__)(
  ...
  function* ve(e) {
    ...
    try {
      if (
        !(yield (0, ae.apiFetch)({
          path: le + "/overview/activate-plugin",
          method: "POST",
          data: { plugin: e },
        }))
      )
  ...
  function* Ee(e, t) {
    return {
      type: de.INSTALL_AND_ACTIVATE_RECOMMENDED_PLUGIN,
  ...
  function* be(e) {
    try {
      const t = yield e ? `&category=${e}` : "",
        n = yield (0, ae.apiFetch)({
          path: `${le}/recommended?per_page=50${t}`,
        });
  ...
  function* Pe() {
    try {
      const e = yield (0, ae.apiFetch)({ path: `${le}/misc-recommendations` });
  ...
  const { installedExtensions: Te } = b("marketing", {}),
    Le = {
      installedPlugins: Te,
      activatingPlugins: [],
      recommendedPlugins: {},
    ...
    Re = (0, p.createReduxStore)(ce, {
      ...
      reducer: (e = Le, t) => {
        switch (t.type) {
          case de.SET_INSTALLED_PLUGINS:
            return { ...e, installedPlugins: t.plugins };
          case de.SET_ACTIVATING_PLUGIN:
            return {
              ...e,
              activatingPlugins: [...e.activatingPlugins, t.pluginSlug],
            };
          case de.REMOVE_ACTIVATING_PLUGIN:
            return {
              ...e,
              activatingPlugins: (0, f.without)(
                e.activatingPlugins,
                t.pluginSlug,
              ),
            };
          case de.SET_RECOMMENDED_PLUGINS:
            return {
              ...e,
              recommendedPlugins: {
          ...
          case de.INSTALL_AND_ACTIVATE_RECOMMENDED_PLUGIN:
          ...
          case de.SET_BLOG_POSTS:
            return {
              ...e,
              blogPosts: { ...e.blogPosts, [t.data.category]: t.data.posts },
            };
          case de.SET_MISC_RECOMMENDATIONS:
            return { ...e, miscRecommendations: t.data.miscRecommendations };
          case de.SET_ERROR:
            return {
              ...e,
              errors: {
  ...
  const Oe = ({
      ...
      const s = "woocommerce-marketing-recommended-extensions-item",
        i = ((e, t = {}) => {
          const { pathname: n, search: o } = window.location,
            r = (0, j.getSetting)("connectNonce", "");
          return (
            (t = {
              "wccom-site": b("siteUrl"),
              "wccom-back": n + o,
              "wccom-woo-version": (0, j.getSetting)("wcVersion"),
              "wccom-connect-nonce": r,
              ...t,
            }),
            (0, ie.addQueryArgs)(e, t)
          );
        })(n);
      return (
        "coupons" === r && "automatewoo" === o && (o = "automatewoo-alt"),
        (0, x.jsxs)("a", {
          href: i,
          className: s,
          onClick: () => {
            (0, h.recordEvent)("marketing_recommended_extension", {
              name: e,
              source: b("allowMarketplaceSuggestions", !1)
                ? "woocommerce.com"
                : "plugin-woocommerce",
            });
          },
    ...
    Ae = () => {
      ...
      return (0, x.jsxs)("div", {
        ...
        children: [
          (0, x.jsx)("div", {
            className:
              "woocommerce-admin-marketing-product-icon is-placeholder",
          }),
          (0, x.jsxs)("div", {
            className: `${e}__text`,
            children: [
              ...
              (0, x.jsxs)("p", {
                children: [
                  (0, x.jsx)("span", { className: "is-placeholder" }),
                  (0, x.jsx)("span", { className: "is-placeholder" }),
                  (0, x.jsx)("span", { className: "is-placeholder" }),
                ],
              }),
    ...
    Ie = window.wc.experimental,
    Ve = (e) => {
      const { title: t, description: n, children: o, className: r } = e;
      return (0, x.jsxs)(se.Card, {
        className: u(r, "woocommerce-admin-marketing-card"),
        children: [
          (0, x.jsx)(se.CardHeader, {
          ...
          (0, x.jsx)(se.CardBody, { children: o }),
        ],
      });
    },
    De = (0, d.compose)(
      (0, p.withSelect)((e, t) => {
        const { getRecommendedPlugins: n, isResolving: o } = e(ce);
        return {
          extensions: n(t.category),
          isLoading: o("getRecommendedPlugins", [t.category]),
        };
      }),
      (0, p.withDispatch)((e) => {
      ...
      ({
        extensions: e,
        isLoading: t,
        title: n = (0, c.__)("Recommended extensions", "woocommerce"),
        description: o = (0, c.__)(
        ...
        const s = r
          ? `woocommerce-marketing-recommended-extensions-card__category-${r}`
          : "";
        return (0, x.jsx)(Ve, {
          title: n,
          description: o,
          className: u("woocommerce-marketing-recommended-extensions-card", s),
          children: t
            ? (0, x.jsx)("div", {
                className: u(
            ...
            : (0, x.jsx)("div", {
                ...
                children: e.map((e) =>
                  (0, x.jsx)(Oe, { category: r, ...e }, e.product),
                ),
              }),
        });
      },
  ...
  const ze = ee().createContext(null);
  function Ue(e, t) {
    var n = Object.create(null);
    return (
      e &&
        Y.Children.map(e, function (e) {
          return e;
        }).forEach(function (e) {
          n[e.key] = (function (e) {
  ...
  function Fe(e, t, n) {
    var o = Ue(e.children),
      r = (function (e, t) {
        ...
        for (o = 0; o < s.length; o++) a[s[o]] = n(s[o]);
        return a;
      })(t, o);
    return (
      Object.keys(r).forEach(function (s) {
        var i = r[s];
        if ((0, Y.isValidElement)(i)) {
          var a = s in t,
            c = s in o,
            l = t[s],
            d = (0, Y.isValidElement)(l) && !l.props.in;
          !c || (a && !d)
            ? c || !a || d
              ? c &&
                a &&
                (0, Y.isValidElement)(l) &&
                (r[s] = (0, Y.cloneElement)(i, {
                  onExited: n.bind(null, i),
                  in: l.props.in,
                  exit: Be(i, "exit", e),
                  enter: Be(i, "enter", e),
                }))
              : (r[s] = (0, Y.cloneElement)(i, { in: !1 }))
            : (r[s] = (0, Y.cloneElement)(i, {
                onExited: n.bind(null, i),
                in: !0,
                exit: Be(i, "exit", e),
      ...
      return (
        ...
        (n.render = function () {
          var e = this.props,
            t = e.component,
            n = e.childFactory,
            o = Ge(e, ["component", "childFactory"]),
            r = this.state.contextValue,
            s = We(this.state.children).map(n);
          return (
            delete o.appear,
            delete o.enter,
            delete o.exit,
            null === t
              ? ee().createElement(ze.Provider, { value: r }, s)
              : ee().createElement(
                  ze.Provider,
                  { value: r },
                  ee().createElement(t, o, s),
                )
          );
        }),
        t
    ...
    st = (function (e) {
      function t(t, n) {
        ...
        return (
          ...
          t.in
            ? s
              ? ((r = tt), (o.appearStatus = nt))
              : (r = ot)
            : (r = t.unmountOnExit || t.mountOnEnter ? et : tt),
          (o.state = { status: r }),
          (o.nextCallback = null),
          o
        );
      ...
      return (
        ...
        (n.performEnter = function (e) {
          var t = this,
            ...
            r = this.props.nodeRef ? [o] : [Qe().findDOMNode(this), o],
            s = r[0],
            i = r[1],
            a = this.getTimeouts(),
            c = o ? a.appear : a.enter;
          e || n
            ? (this.props.onEnter(s, i),
              this.safeSetState({ status: nt }, function () {
                (t.props.onEntering(s, i),
                  t.onTransitionEnd(c, function () {
                    t.safeSetState({ status: ot }, function () {
        ...
        (n.performExit = function () {
          var e = this,
            t = this.props.exit,
            n = this.getTimeouts(),
            o = this.props.nodeRef ? void 0 : Qe().findDOMNode(this);
          t
            ? (this.props.onExit(o),
        ...
        (n.render = function () {
          ...
          return ee().createElement(
            ...
            "function" == typeof n
              ? n(e, o)
              : ee().cloneElement(ee().Children.only(n), o),
          );
        }),
        t
      );
  ...
  var ct = function (e, t) {
    ...
    lt = (function (e) {
      ...
      return (
        ...
        (n.render = function () {
          var e = this.props,
            t = (e.classNames, Ge(e, ["classNames"]));
          return ee().createElement(
            at,
            $e({}, t, {
  ...
  ((lt.defaultProps = { classNames: "" }), (lt.propTypes = {}));
  const dt = lt,
    mt = ({ children: e, animationKey: t, animate: n }) => {
      const [o, r] = (0, a.useState)(null),
        s = (0, a.useRef)(),
        i = u("woocommerce-marketing-slider", n && `animate-${n}`),
        c = {};
      o && (c.height = o);
      const l = (0, f.debounce)(() => {
          ...
          children: (0, x.jsx)(Je, {
            children: (0, x.jsx)(
              dt,
              {
                ...
                classNames: "slide",
                onEnter: () => {
                  const e = s.current.querySelector(".slide-enter");
                  r(e.clientHeight);
                },
    ...
    ut = (e) => {
      ...
      return (0, x.jsxs)(
        "div",
        {
          className: `is-loading ${t}`,
          "aria-hidden": "true",
          children: [
            (0, x.jsx)("div", { className: `${t}-img is-placeholder` }),
            (0, x.jsxs)("div", {
              className: `${t}-text`,
              children: [
                (0, x.jsx)("h3", {
                ...
                (0, x.jsx)("p", { className: `${t}-meta is-placeholder` }),
              ],
            }),
          ],
        },
    ...
    pt = (0, d.compose)(
      (0, p.withSelect)((e, t) => {
        const { getBlogPosts: n, getBlogPostsError: o, isResolving: r } = e(ce);
        return {
          posts: n(t.category),
          isLoading: r("getBlogPosts", [t.category]),
          error: o(t.category),
        };
      }),
      (0, p.withDispatch)((e) => {
      ...
      ({
        ...
        isLoading: t,
        error: n,
        title: o = (0, c.__)("WooCommerce knowledge base", "woocommerce"),
        description: r = (0, c.__)(
        ...
        const [i, l] = (0, a.useState)(1),
          ...
          p = s
            ? `woocommerce-marketing-knowledgebase-card__category-${s}`
            : "";
        return (0, x.jsx)(Ve, {
          title: o,
          description: r,
          ...
          children: t
            ? (0, x.jsx)("div", {
                ...
                children: (0, x.jsxs)("div", {
                  ...
                  children: [(0, x.jsx)(ut, {}), (0, x.jsx)(ut, {})],
                }),
              })
            : n
              ? (() => {
              ...
              : 0 === e.length
                ? (() => {
                    const e = (0, c.__)("No posts yet", "woocommerce");
                    return (0, x.jsx)(Q.EmptyContent, {
                      title: e,
                      message: (0, x.jsx)(re, {}),
                      illustration: "",
                                ...
                                "a",
                                {
                                  ...
                                  children: [
                                    !!e.image &&
                                      (0, x.jsx)("div", {
                                        className:
                                          "woocommerce-marketing-knowledgebase-card__post-img",
                                    ...
                                    (0, x.jsxs)("div", {
                                      className:
                                        "woocommerce-marketing-knowledgebase-card__post-text",
                                      children: [
                                        ...
                                        (0, x.jsxs)("p", {
                                          ...
                                          children: [
                                            (0, c.__)("By", "woocommerce") +
                                              " ",
                                            e.author_name,
                                            !!e.author_avatar &&
                                              (0, x.jsx)("img", {
                                                src: e.author_avatar.replace(
                                                  "s=96",
                                                  "s=32",
                                                ),
                                                className:
                          ...
                          (e > i
                            ? ((t = "left"),
                              (0, h.recordEvent)(
                                ...
                                { direction: "forward", page: e },
                              ))
                            : ((t = "right"),
                              (0, h.recordEvent)(
                                "marketing_knowledge_carousel",
                                { direction: "back", page: e },
                              )),
                            l(e),
                            m(t));
                        },
    ...
    xt = window.wc.sanitize,
    Ct = (e) => ({ __html: (0, xt.sanitizeHTML)(e) }),
    vt = { info: ht, check: gt, percent: ft };
  function Et(e) {
    const {
        id: t,
        description: n,
    ...
    const h = u(
        ...
        `woocommerce-marketplace__notice--${i}`,
        { "is-dismissible": s },
        c,
      ),
      f = vt[r || "info"],
      w = u(
        ...
        `woocommerce-marketplace__notice-icon--${i}`,
      );
    return (0, x.jsxs)("div", {
      className: h,
      children: [
  ...
  const _t = {
    ...
    jt = ({ promotion: e }) => {
      ...
      const o = window.location.pathname + window.location.search,
        ...
        [s, i] = (0, a.useState)(!r().includes(o));
      if (
        ((0, a.useEffect)(() => {
          s &&
            (0, h.recordEvent)("marketplace_promotion_viewed", {
              path: o,
              format: "promo-card",
            });
        }, [s]),
        ...
        return null;
      const l = "promo-card" + (e.style ? ` ${e.style}` : ""),
        d = (0, x.jsxs)("div", {
          ...
          children: [
            ...
            (0, x.jsx)("div", {
              ...
              dangerouslySetInnerHTML: Ct(e.content?.en_US),
            }),
          ],
        }),
        m = (0, x.jsxs)("div", {
          ...
          children: [
            (0, x.jsx)(se.Button, {
              ...
              onClick: () => (
                (0, h.recordEvent)("marketplace_promotion_actioned", {
                  path: o,
              ...
              children:
                null !== (n = e.cta_label?.en_US) && void 0 !== n ? n : "",
            }),
            (0, x.jsx)(se.Button, {
              ...
              onClick: () => {
                (i(!1),
                  localStorage.setItem(
                    ...
                    JSON.stringify(r().concat(o)),
                  ),
                  (0, h.recordEvent)("marketplace_promotion_dismissed", {
                    path: o,
                    format: "promo-card",
                  }));
              },
      ...
      function u() {
        if (e.icon && Object.hasOwn(_t, e.icon)) {
          const t = _t[e.icon];
          return t
            ? (0, x.jsx)("div", {
    ...
    yt = ({ format: e }) => {
      ...
      const n = (
        ...
        r = o.get("page"),
        s = Date.now(),
        i = decodeURIComponent(o.get("path") || ""),
        a = o.get("tab"),
      ...
      return (0, x.jsx)(x.Fragment, {
        children: n.map((e, t) => {
          ...
          if (
            !e.pages.some((e) => {
              if (e.pathname) return e.pathname === c;
              if (!e.path) return !1;
              const t = (e) => (e.startsWith("/") ? e : `/${e}`),
                n = t(e.path),
                o = t(i);
              return e.page === r && n === o && (e.tab ? a : !a);
            })
          )
            return null;
          const n = new Date(e.date_from_gmt).getTime(),
            o = new Date(e.date_to_gmt).getTime();
          return s < n || s > o
            ? null
            : "promo-card" === e.format
              ? (0, x.jsx)(jt, { promotion: e }, t)
              : "notice" === e.format && e?.content
                ? (0, x.jsx)(
                    Et,
                    {
                      id:
                        null !== (m = e.menu_item_id) && void 0 !== m
                          ? m
                          : `promotion-${t}`,
                      description: e.content[P.userLocale] || e.content.en_US,
    ...
    kt = () => {
      const { currentUserCan: e } = (0, l.useUser)(),
        t = !!b("allowMarketplaceSuggestions", !1),
        n = t && e("install_plugins");
      return (0, x.jsxs)("div", {
        className: "woocommerce-marketing-coupons",
        children: [
          (0, x.jsx)(yt, { format: "promo-card" }),
          n &&
            (0, x.jsx)(De, {
              title: (0, c.__)("Recommended coupon extensions", "woocommerce"),
              description: (0, c.__)(
    ...
    St = document.getElementById("posts-filter");
  if (St) {
    const e = document.createElement("div");
    (e.setAttribute("id", "coupon-root"),
      (0, a.createRoot)(St.parentNode.appendChild(e)).render(
        (0, x.jsx)(kt, {}),
      ));
  }
  (window.wc = window.wc || {}).marketingCoupons = {};
})();
