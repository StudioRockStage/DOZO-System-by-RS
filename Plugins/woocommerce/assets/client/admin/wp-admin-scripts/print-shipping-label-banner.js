...
(() => {
  ...
  var e = {
      94931: (e, t, n) => {
        ...
        function a(e, t, n) {
          ...
          t))
            o.call(t, s) && !c.hasOwnProperty(s) && (a[s] = t[s]);
          if (e && e.defaultProps)
  ...
  function p(e, t) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if ("string" !== r.type) {
        if (void 0 === t[r.value])
          throw new Error(
            `Invalid interpolation, missing component node: \`${r.value}\``,
          );
    ...
    if (n) {
      const o = (function (e, t) {
        ...
        r = p(e.slice(s + 1, o), t),
        c = (0, a.cloneElement)(n, {}, r);
      if ((i.push(c), o < e.length - 1)) {
        const n = p(e.slice(o + 1), t);
        i = i.concat(n);
      }
    }
    return (
      ...
      0 === i.length
        ...
        : 1 === i.length
          ? i[0]
          : (0, a.createElement)(a.Fragment, null, ...i)
    );
  }
  function d(e) {
  ...
  class _ extends s.Component {
    ...
    render() {
      const { onClose: e, visible: t } = this.props;
      return t
        ? (0, g.jsxs)(r.Modal, {
            title: (0, o.__)("Are you sure?", "woocommerce"),
            onRequestClose: e,
              ...
              (0, g.jsxs)("div", {
                ...
                children: [
                  (0, g.jsx)(r.Button, {
                    ...
                    children: (0, o.__)("Remind me later", "woocommerce"),
                  }),
                  (0, g.jsx)(r.Button, {
                    isPrimary: !0,
                    onClick: this.closeForeverClicked,
                    children: (0, o.__)("I don't need this", "woocommerce"),
                  }),
                ],
              }),
            ],
  ...
  const b = (0, c.compose)(
      (0, m.withDispatch)((e) => {
        const { updateOptions: t } = e(i.optionsStore);
        return { updateOptions: t };
      }),
    )(_),
    v = (0, s.forwardRef)(function ({ icon: e, size: t = 24, ...n }, i) {
      return (0, s.cloneElement)(e, { width: t, height: t, ...n, ref: i });
    }),
    S = window.wp.primitives,
    f = (0, g.jsx)(S.SVG, {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "-2 -2 24 24",
      children: (0, g.jsx)(S.Path, {
    ...
    x = "start",
    j = {
      [y]: (0, o.__)("download", "woocommerce"),
      [k]: (0, o.__)("install", "woocommerce"),
      [C]: (0, o.__)("activate", "woocommerce"),
      [E]: (0, o.__)("set up", "woocommerce"),
      [x]: (0, o.__)("start", "woocommerce"),
    };
  function P({ isSetupError: e, errorReason: t }) {
    return e
      ? (0, g.jsxs)("div", {
          className: "wc-admin-shipping-banner-install-error",
          children: [
            (0, g.jsx)(v, { icon: f, className: "warning-icon" }),
            ((e) => {
              const t = e in j ? j[e] : j[E];
              return (0, o.sprintf)(
                (0, o.__)(
  ...
  const B = window.wp.apiFetch;
  var L = n.n(B);
  const I = (0, u.getSetting)("wcAssetUrl", ""),
    A = "woocommerce-shipping",
    W = "woocommerce-services";
  class M extends s.Component {
    ...
    createShippingLabelClicked = () => {
      ...
      (this.setState({ isShippingLabelButtonBusy: !0 }),
        ...
        e.includes(A)
          ...
          : this.installAndActivatePlugins(A));
    };
    async installAndActivatePlugins(e) {
      const {
        ...
        activePlugins: i,
        isWcstCompatible: o,
        isIncompatibleWCShippingInstalled: r,
      } = this.props;
      if (s) return !1;
      !0 === (await t([e])).success
        ? !0 === (await n([e])).success
    ...
    acceptTosAndGetWCSAssets = () =>
      L()({
        path: "/wcshipping/v1/tos",
        method: "POST",
        data: { accepted: !0 },
      })
        .then(() =>
          (function (e) {
            const t = `wcshipping/v1/config/label-purchase/${e}`;
            return L()({ path: t, method: "GET" });
          })(this.props.orderId),
        )
        .then((e) => ((window.WCShipping_Config = e.config), e))
        .then(() => L()({ path: "/wcshipping/v1/assets", method: "GET" }))
        .then((e) => this.loadWcsAssets(e))
        .catch(() => {
          this.setState({ wcsSetupError: !0 });
        });
    ...
    loadWcsAssets({ assets: e }) {
      ...
      const t = "woocommerce-order-label",
        n = "woocommerce-order-shipment-tracking",
        s = e.wcshipping_create_label_script,
        i = e.wcshipping_create_label_style,
        r = e.wcshipping_shipment_tracking_script,
        c = e.wcshipping_shipment_tracking_style,
        { activePlugins: a } = this.props;
      document.getElementById(t)?.remove();
      const l = this.generateMetaBoxHtml(
        t,
        (0, o.__)("Shipping Label", "woocommerce"),
      ...
      const p = this.generateMetaBoxHtml(
        n,
        (0, o.__)("Shipment Tracking", "woocommerce"),
      ...
      (document
        ...
        Promise.all([
          ...
          new Promise((e, t) => {
            if ("" !== i) {
              ...
              ((n.rel = "stylesheet"),
                ...
                (n.onload = e),
                (n.onerror = t),
                (n.id = "wcshipping-injected-styles"),
          ...
          (this.setState({
            ...
            window.jQuery && window.jQuery("#woocommerce-order-label").show(),
            (document.getElementById(
              "woocommerce-admin-print-label",
            ).style.display = "none"),
            a.includes(W) || this.openWcsModal());
        }));
    }
    openWcsModal() {
      const e = "#woocommerce-shipping-shipping-label-shipping_label button";
      if (window.MutationObserver) {
        var t, n;
        new window.MutationObserver((t, n) => {
          const s = document.querySelector(e);
          s && (s.click(), n.disconnect());
        }).observe(
          null !==
            (t =
              null !==
                ...
                ? n
                : document.getElementById("wpbody-content")) && void 0 !== t
            ? t
            : document.body,
        ...
        const t = setInterval(() => {
          ...
          n && (n.click(), clearInterval(t));
        }, 300);
      }
    }
    render() {
      const {
          isDismissModalOpen: e,
          showShippingBanner: t,
          isShippingLabelButtonBusy: n,
        } = this.state,
        { isWcstCompatible: s } = this.props;
      if (!t && !s)
        return (
          document
          ...
          (0, g.jsx)("p", {
            children: (0, g.jsx)("strong", {
              children: d({
                ...
                components: {
                  pluginPageLink: (0, g.jsx)(w.Link, {
                    href: (0, u.getAdminLink)("plugins.php"),
                    target: "_blank",
                    type: "wp-admin",
                  }),
                },
      ...
      if (!t) return null;
      const { actionButtonLabel: i, headline: c } = this.props;
      return (0, g.jsxs)("div", {
        children: [
          (0, g.jsxs)("div", {
            ...
            children: [
              (0, g.jsx)("img", {
                ...
                src: I + "images/shippingillustration.svg",
                alt: (0, o.__)("Shipping ", "woocommerce"),
              }),
              (0, g.jsxs)("div", {
                className: "wc-admin-shipping-banner-blob",
                children: [
                  (0, g.jsx)("h3", { children: c }),
                  (0, g.jsx)("p", {
                    children: d({
                      mixedString: (0, o.sprintf)(
                        (0, o.__)(
                      ...
                      components: {
                        tosLink: (0, g.jsx)(r.ExternalLink, {
                          href: "https://wordpress.com/tos",
                          target: "_blank",
                          type: "external",
                        }),
                        wcsLink: (0, g.jsx)(r.ExternalLink, {
  ...
  const O = (0, c.compose)(
      (0, m.withSelect)((e) => {
        const {
            isPluginsRequesting: t,
            isJetpackConnected: n,
            getActivePlugins: s,
          } = e(i.pluginsStore),
          r = t("activatePlugins") || t("installPlugins"),
          c = s(),
          a = c.includes(W)
            ? (0, o.__)("Install WooCommerce Shipping", "woocommerce")
            : (0, o.__)("Create shipping label", "woocommerce"),
          l = c.includes(W)
            ? (0, o.__)(
      ...
      (0, m.withDispatch)((e) => {
        const { activatePlugins: t, installPlugins: n } = e(i.pluginsStore);
        return { activatePlugins: t, installPlugins: n };
      }),
    )(M),
    D = ["wcAdminSettings", "preloadSettings"],
    R = (0, u.getSetting)("admin", {}),
    T = Object.keys(R).reduce(
      (e, t) => (D.includes(t) || (e[t] = R[t]), e),
      {},
    ),
    N = {
      onboarding: {
  ...
  function $(e, t = !1, n = (e) => e, s = N) {
    ...
    return n(T.hasOwnProperty(e) ? T[e] : t, t);
  }
  ((0, u.getSetting)("adminUrl"),
    (0, u.getSetting)("countries"),
    (0, u.getSetting)("currency"),
    (0, u.getSetting)("locale"),
    (0, u.getSetting)("siteTitle"),
    (0, u.getSetting)("wcAssetUrl"),
    $("orderStatuses"));
  const q = document.getElementById("wc-admin-shipping-banner-root"),
    H = (q.dataset.args && JSON.parse(q.dataset.args)) || {},
    U = (0, i.withPluginsHydration)({
      ...$("plugins"),
      jetpackStatus: $("dataEndpoints", {}).jetpackStatus,
    })(O);
  ((0, s.createRoot)(q).render((0, g.jsx)(U, { itemsCount: H.items })),
    ((window.wc = window.wc || {}).printShippingLabelBanner = {}));
})();
