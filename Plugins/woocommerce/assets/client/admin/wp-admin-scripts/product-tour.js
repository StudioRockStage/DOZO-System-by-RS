...
(() => {
      ...
      94931: (e, t, o) => {
        ...
        function a(e, t, o) {
          var r,
            ...
            a = null,
            u = null;
          for (r in (void 0 !== o && (a = "" + o),
          void 0 !== t.key && (a = "" + t.key),
          void 0 !== t.ref && (u = t.ref),
          t))
            i.call(t, r) && !d.hasOwnProperty(r) && (n[r] = t[r]);
          if (e && e.defaultProps)
  ...
  const o = window.wp.element,
    ...
    i = window.wc.tracks,
    s = ({ iframeSelector: e, isActive: t }) => (
      (0, o.useEffect)(() => {
        if (!t) return;
        const o = (({ iframeSelector: e, childSelector: t, className: o }) => {
          const r = document.querySelector(e),
            c =
              r?.contentDocument ||
              (r?.contentWindow && r?.contentWindow.document);
          if (c) {
    ...
    d = ({ editorWrapSelector: e }) => {
      const t = (0, o.useRef)(document.querySelector(e));
      t || console.warn(`Editor Wrap ${e} not found`);
      const [r, c] = (0, o.useState)(
        t.current && t.current.classList.contains("html-active")
          ? "html"
          : "tmce",
      );
      return (
        (0, o.useEffect)(() => {
          const t = (e) => {
              e.target &&
                c(e.target.classList.contains("switch-html") ? "html" : "tmce");
            },
    ...
    a = (e) => document.querySelector(e).value,
    u = (e) => {
      const t = document.querySelector(e),
        o = t?.contentWindow?.document.querySelector("#tinymce");
      return o?.innerHTML || "";
    },
    p = (e) => document.querySelector(e)?.value || "",
    l = (e) =>
      e
        ? u("#content_ifr")
        : p("#wp-content-editor-container > .wp-editor-area"),
    m = (e) =>
      e
        ? u("#excerpt_ifr")
        : p("#wp-excerpt-editor-container > .wp-editor-area");
  var w = (function o(r) {
    var c = t[r];
  ...
  const h = () => {
      const [e, t] = (0, o.useState)(!1),
        { setIsLoaded: u, hasUpdatedInfo: p } = (() => {
          const { isTmce: e } = d({ editorWrapSelector: "#wp-content-wrap" }),
            { isTmce: t } = d({ editorWrapSelector: "#wp-excerpt-wrap" }),
            [r, c] = (0, o.useState)({}),
            [n, i] = (0, o.useState)(!1),
            s = (0, o.useCallback)(
              () => ({
                ...
                "product-data": a("#_regular_price"),
                "product-short-description": m(t),
                "product-image":
                  document.querySelector("#set-post-thumbnail img")?.src || "",
                "product-tags": Array.from(
                  document.querySelectorAll("#product_tag li"),
                )
        ...
        { isTmce: h } = d({ editorWrapSelector: "#wp-content-wrap" }),
        { isTmce: _ } = d({ editorWrapSelector: "#wp-excerpt-wrap" }),
        { style: f } = s({ isActive: e && h, iframeSelector: "#content_ifr" }),
        { style: y } = s({ isActive: e && _, iframeSelector: "#excerpt_ifr" }),
        g = (({
            ...
            s = [
              {
                ...
                meta: {
                  name: "product-name",
                  heading: (0, c.__)("Product name", "woocommerce"),
                  descriptions: {
                    desktop: (0, c.__)(
              ...
              },
              {
                ...
                meta: {
                  name: "product-data",
                  heading: (0, c.__)("Add your product data", "woocommerce"),
                  descriptions: {
                    desktop: (0, c.__)(
              ...
              },
              {
                ...
                meta: {
                  name: "product-image",
                  heading: (0, c.__)("Add your product image", "woocommerce"),
                  descriptions: {
                    desktop: (0, c.__)(
              ...
              },
              {
                ...
                meta: {
                  name: "product-tags",
                  heading: (0, c.__)("Add your product tags", "woocommerce"),
                  descriptions: {
                    desktop: (0, c.__)(
              ...
              },
              {
                ...
                meta: {
                  name: "publish",
                  heading: (0, c.__)("Publish your product 🎉", "woocommerce"),
                  descriptions: {
                    desktop: (0, c.__)(
                  ...
                  primaryButton: {
                    text: (0, c.__)("Keep editing", "woocommerce"),
                  },
                },
              },
            ],
              ...
              popperModifiers: [
                {
                  name: "arrow",
                  options: {
                    padding: ({ popper: e }) => ({ right: e.width - 34 }),
                  },
                },
              ],
          ...
          isContentEditorTmceActive: h,
          isExcerptEditorTmceActive: _,
          closeHandler: (e, o) => {
            (t(!1),
              e.length - 1 === o
                ? (0, i.recordEvent)("walkthrough_product_completed")
                : (0, i.recordEvent)("walkthrough_product_dismissed", {
                    step_name: e[o].meta.name,
                  }));
          },
          onNextStepHandler: (e) => {
            const t = g.steps[e - 1].meta.name;
            (0, i.recordEvent)("walkthrough_product_step_completed", {
              step_name: t,
              added_info: p(t) ? "yes" : "no",
            });
          },
        });
      return (
        (0, o.useEffect)(() => {
          ...
          if (
            ((e = (e) => {
              (e.preventDefault(),
                t(!0),
                (0, i.recordEvent)("walkthrough_product_enable_button_click"));
            }),
            window.document
            ...
            const e = ((e) => {
              ...
              const c = setInterval(() => {
                ...
                (r === e &&
                  (t(!0),
                  (0, i.recordEvent)("walkthrough_product_view", {
                    spotlight: "yes",
  ...
  (_.setAttribute("id", "product-tour-root"),
    (0, o.createRoot)(document.body.appendChild(_)).render((0, w.jsx)(h, {})),
    ((window.wc = window.wc || {}).productTour = {}));
})();
