...
(() => {
  ...
  var e,
    ...
    t = {
      27655: (e, r, t) => {
        ...
        function n(e) {
          return e
            ? Array.from(e.querySelectorAll(":scope > input[type=hidden]")).map(
                (e) => {
                  const r =
                    (t = e) && t.dataset && t.dataset.name
                      ? { term_id: parseInt(t.value, 10), name: t.dataset.name }
                      : null;
                  var t;
                  return (e.remove(), r);
                },
      ...
      94931: (e, r, t) => {
        ...
        function p(e, r, t) {
          var o,
            ...
            p = null,
            l = null;
          for (o in (void 0 !== t && (p = "" + t),
          void 0 !== r.key && (p = "" + r.key),
  ...
  ((n.m = t),
    ...
    (n.u = (e) => "chunks/category-metabox.js?ver=d28c25fa1719d9f7c19d"),
    (n.miniCssF = (e) => {}),
    (n.g = (function () {
    ...
    (n.l = (t, o, a, i) => {
      if (e[t]) e[t].push(o);
        ...
        if (void 0 !== a)
          for (
            var p = document.getElementsByTagName("script"), l = 0;
            l < p.length;
            l++
          ) {
            var d = p[l];
        ...
        (c ||
          ...
          c.setAttribute("data-webpack", r + a),
          (c.src = t)),
          (e[t] = [o]));
        var u = (r, o) => {
            ((c.onerror = c.onload = null), clearTimeout(w));
            var n = e[t];
            if (
              (delete e[t],
    ...
    (() => {
      ...
      var r = (r, t) => {
          ...
          for (r && r(t); p < i.length; p++)
            ((a = i[p]), n.o(e, a) && e[a] && e[a][0](), (e[a] = 0));
        },
        t = (globalThis.webpackChunk_wcAdmin_webpackJsonp =
  ...
  var i = n(86087),
    c = n(27655),
    s = n(39793);
  const p = (0, i.lazy)(() => n.e(6666).then(n.bind(n, 57173))),
    l = document.querySelector("#taxonomy-product_cat-metabox");
  if (l) {
    const e = (0, c._z)(l.parentElement);
    (0, i.createRoot)(l).render(
      (0, s.jsx)(i.Suspense, {
        fallback: null,
        children: (0, s.jsx)(p, { initialSelected: e }),
      }),
      l,
    );
  }
  (window.wc = window.wc || {}).productCategoryMetabox = a;
})();
