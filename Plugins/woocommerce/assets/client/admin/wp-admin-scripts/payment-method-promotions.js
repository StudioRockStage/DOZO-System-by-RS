...
(() => {
  var e = {
      ...
      37148: (e, t, l) => {
        ...
        ((n.Layout = ({ children: e, className: t }) =>
          ...
          (n.Sequence = ({
            ...
            const s = c.Children.toArray(l)[r];
            return (0, c.createElement)(c.Fragment, null, s);
          }));
      },
      14695: (e, t, l) => {
        "use strict";
        ...
        const z = [
            ...
            {
              name: "amex",
              component: (0, c.createElement)(s.A, { key: "amex" }),
            },
            {
              name: "discover",
            ...
            {
              name: "woopay",
              component: (0, c.createElement)(p.A, { key: "woopay" }),
            },
            {
              name: "applepay",
            ...
            {
              name: "googlepay",
              component: (0, c.createElement)(h.A, { key: "googlepay" }),
            },
            {
              name: "afterpay",
              component: (0, c.createElement)(f.A, { key: "afterpay" }),
            },
            {
              name: "affirm",
              component: (0, c.createElement)(y.A, { key: "affirm" }),
            },
            {
              name: "klarna",
            ...
            {
              name: "cartebancaire",
              component: (0, c.createElement)(v.A, { key: "cartebancaire" }),
            },
            {
              name: "unionpay",
            ...
            {
              name: "diners",
              component: (0, c.createElement)(C.A, { key: "diners" }),
            },
            {
              name: "eftpos",
              component: (0, c.createElement)(Z.A, { key: "eftpos" }),
            },
            {
              name: "jcb",
              component: (0, c.createElement)(d.A, { key: "jcb" }),
            },
            {
              name: "bancontact",
              component: (0, c.createElement)(w.A, { key: "bancontact" }),
            },
            {
              name: "becs",
              component: (0, c.createElement)(g.A, { key: "becs" }),
            },
            {
              name: "eps",
              component: (0, c.createElement)(u.A, { key: "eps" }),
            },
            {
              name: "ideal",
              component: (0, c.createElement)(H.A, { key: "ideal" }),
            },
            {
              name: "przelewy24",
              component: (0, c.createElement)(L.A, { key: "przelewy24" }),
            },
            {
              name: "grabpay",
              component: (0, c.createElement)(b.A, { key: "grabpay" }),
            },
          ],
          V = ({
            ...
            maxElementsMobile: s = 5,
            totalPaymentMethods: m = 21,
          }) => {
            const [o, h] = (0, a.useState)(t),
              [d, p] = (0, a.useState)(!1),
              f = (0, a.useRef)(null),
              y = (e) => {
            ...
            const M = z.slice(0, v(o)).filter((t) => e || "woopay" !== t.name),
              C = z.slice(v(o)).filter((t) => e || "woopay" !== t.name);
      ...
      85816: (e, t, l) => {
        "use strict";
        (l.d(t, { WooPaymentsMethodsLogos: () => a.L }),
          l(56427),
          l(14908),
          l(86087),
          l(98846),
      ...
      29568: (e, t, l) => {
        ...
        l(84343);
        var a = l(27723);
        ((0, a.__)("Metro Manila", "woocommerce"),
          (0, a.__)("Roma", "woocommerce"));
      },
      94736: (e, t, l) => {
        "use strict";
        var a;
        (a = l(51609)) && a.__esModule;
      },
      94931: (e, t, l) => {
        "use strict";
        var a = l(51609),
        ...
        function m(e, t, l) {
          var a,
            ...
            m = null,
            o = null;
          for (a in (void 0 !== l && (m = "" + l),
          void 0 !== t.key && (m = "" + t.key),
          void 0 !== t.ref && (o = t.ref),
          t))
            n.call(t, a) && !s.hasOwnProperty(a) && (r[a] = t[a]);
          if (e && e.defaultProps)
  ...
  ((l.n = (e) => {
    ...
    (() => {
      ...
      var e = l(86087),
        t = l(56427),
        a = l(98846);
      const c = window.wc.data;
      var r = l(83306);
      const n = window.wp.data,
        i = window.wc.sanitize;
      var s = l(27723),
        m = l(85816),
        o = l(39793);
      function h(e) {
        return {
          __html: (0, i.sanitizeHTML)(e, {
            tags: ["a", "img", "br"],
      ...
      const d = ({
        ...
        const { gatewayId: f, pluginSlug: y, url: E } = l,
          [v, M] = (0, e.useState)(!1),
          [C, Z] = (0, e.useState)(!0),
          { installAndActivatePlugins: H } = (0, n.useDispatch)(c.pluginsStore),
          { createNotice: w } = (0, n.useDispatch)("core/notices"),
          { updatePaymentGateway: u } = (0, n.useDispatch)(
            c.paymentGatewaysStore,
          ),
          { gatewayIsActive: g, paymentGateway: L } = (0, n.useSelect)((e) => {
            const { getPaymentGateway: t } = e(c.paymentGatewaysStore),
              l = e(c.pluginsStore).getActivePlugins(),
              a = l && l.includes(y);
            let r;
            return (
              a && (r = t(y.replace(/\-/g, "_"))),
              { gatewayIsActive: a, paymentGateway: r }
            );
          }, []),
          b = (0, n.useSelect)(
        ...
        (0, e.useEffect)(() => {
          g && L && L.settings_url && (window.location.href = L.settings_url);
        }, [g, L]);
        const z = () => {
          (Z(!1),
            (0, r.recordEvent)("settings_payments_promotions_dismiss", {
              id: f,
            }),
            u(f, { settings: { is_dismissed: "yes" } }));
        };
        return C
          ? (0, o.jsx)(o.Fragment, {
              children: p.map((e) =>
                e.className.includes("name")
                  ? (0, o.jsx)(
                      "td",
                      {
                        className: "name",
                          ...
                          children: [
                            ...
                            "pre_install_woocommerce_payments_promotion" ===
                              ...
                              (0, o.jsx)("div", {
                                ...
                                children: (0, o.jsx)(
                                  m.WooPaymentsMethodsLogos,
                                  { maxElements: 5, isWooPayEligible: b },
                                ),
                              }),
                            "pre_install_woocommerce_payments_promotion" !==
                              f && d
                  ...
                  : e.className.includes("status")
                    ? (0, o.jsx)(
                        "td",
                        { className: "pre-install-payment-gateway__status" },
                        e.className,
                      )
                    : e.className.includes("action")
                      ? (0, o.jsx)(
                          "td",
                          {
                            className: "action",
                            children: (0, o.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, o.jsx)(t.Button, {
                                  ...
                                  onClick: () => {
                                    v ||
                                      ...
                                      (0, r.recordEvent)(
                                        ...
                                        { extension_selected: y },
                                      ),
                                      H([y]).catch((e) => {
                                        (e.message && w("error", e.message),
                                          M(!1));
                                      }));
                                  },
                                  isSecondary: !0,
                                  isBusy: v,
                                  "aria-disabled": v,
                                  children: (0, s.__)("Install", "woocommerce"),
                                }),
                              ],
                            }),
                          },
                      ...
                      : (0, o.jsx)(
                          "td",
                          {
                            ...
                            dangerouslySetInnerHTML:
                              e.className.includes("sort") ||
                              e.className.includes("renewals")
                                ? { __html: e.html }
                                : h(e.html),
                          },
                          e.className,
      ...
      [
        ...
        const l = document.querySelector(`[data-gateway_id="${t.gatewayId}"]`);
        if (l) {
          const a = [...l.children].map((e) => ({
              className: e.className,
              html: e.innerHTML,
              width: e.getAttribute("width") || void 0,
            })),
            c = l.getElementsByClassName("wc-payment-gateway-method-title"),
            r = l.getElementsByClassName("gateway-subtitle");
          (0, e.createRoot)(l).render(
            (0, o.jsx)(d, {
              columns: a,
              paymentMethod: t,
              title: 1 === c.length ? c[0].innerHTML : void 0,
              subTitleContent: 1 === r.length ? r[0].innerHTML : void 0,
            }),
          );
        }
      });
    })(),
    ((window.wc = window.wc || {}).paymentMethodPromotions = {}));
})();
