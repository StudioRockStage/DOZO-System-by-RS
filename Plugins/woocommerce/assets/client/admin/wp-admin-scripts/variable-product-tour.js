...
(() => {
  ...
  var e = {
      94931: (e, t, r) => {
        ...
        t.jsx = function (e, t, r) {
          ...
          t))
            a.call(t, o) && !c.hasOwnProperty(o) && (i[o] = t[o]);
          if (e && e.defaultProps)
  ...
  const d = () => {
      const [e, t] = (0, r.useState)(!1),
        { updateUserPreferences: d, variable_product_tour_shown: u } = (0,
        a.useUserPreferences)(),
        p = {
          steps: [
            {
          ...
          options: {
            effects: {
              spotlight: {
                interactivity: { enabled: !0, rootElementSelector: "#wpwrap" },
              },
              arrowIndicator: !0,
              liveResize: {
                mutation: !0,
          ...
          closeHandler: (e, r) => {
            (d({ variable_product_tour_shown: "yes" }),
              t(!1),
              r === e.length - 1
                ? (0, s.recordEvent)("variable_product_tour_completed", {
                    step: i(e, r),
                  })
                : (0, s.recordEvent)("variable_product_tour_dismissed", {
                    step: i(e, r),
                  }));
          },
        };
      return (
        (0, r.useEffect)(() => {
          ...
          function r() {
            "variable" === e.value &&
              (t(!0),
              (0, s.recordEvent)("variable_product_tour_started", {
                step: i(p.steps, 0),
              }));
          }
        }),
        e ? (0, c.jsx)(n.TourKit, { config: p }) : null
      );
    },
    u = document.createElement("div");
  (u.setAttribute("id", "variable-product-tour-root"),
    (0, r.createRoot)(document.body.appendChild(u)).render((0, c.jsx)(d, {})),
    ((window.wc = window.wc || {}).variableProductTour = {}));
})();
