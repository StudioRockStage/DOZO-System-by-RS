...
(() => {
      ...
      94931: (e, M, c) => {
        ...
        function t(e, M, c) {
          var i,
            ...
            I = null,
            s = null;
          for (i in (void 0 !== c && (I = "" + c),
          void 0 !== M.key && (I = "" + M.key),
          void 0 !== M.ref && (s = M.ref),
          M))
            r.call(M, i) && !N.hasOwnProperty(i) && (t[i] = M[i]);
          if (e && e.defaultProps)
            for (i in (M = e.defaultProps)) void 0 === t[i] && (t[i] = M[i]);
          return {
            $$typeof: o,
            type: e,
            key: I,
  ...
  function c(i) {
    ...
    var r = (M[i] = { exports: {} });
    return (e[i](r, r.exports, c), r.exports);
  }
  ((c.n = (e) => {
    ...
    (c.d = (e, M) => {
      for (var i in M)
        c.o(M, i) &&
          !c.o(e, i) &&
          Object.defineProperty(e, i, { enumerable: !0, get: M[i] });
    }),
    (c.o = (e, M) => Object.prototype.hasOwnProperty.call(e, M)));
  const i = window.wp.element,
    o = window.wp.i18n,
    r = window.wp.components,
    j = window.wp.primitives;
  var N = c(39793);
  const t = (0, N.jsx)(j.SVG, {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
      children: (0, N.jsx)(j.Path, {
    ...
    n = window.wc.experimental,
    u = window.wc.tracks,
    D = window.wp.url,
    d = window.wc.wcSettings,
    g = window.wp.apiFetch;
  var x = c.n(g);
  const T = ({ action: e, productId: M, nonce: c }, i) => {
    const o = (0, D.addQueryArgs)(
      new URL("admin-ajax.php", (0, d.getSetting)("adminUrl")).toString(),
      { action: e, product_id: M, _ajax_nonce: c },
    );
    x()({
      url: o,
      method: "GET",
  ...
  function y({
    ...
    const [L, w] = (0, i.useState)(!0);
    (0, i.useEffect)(() => {
      L &&
        (0, u.recordEvent)("product_usage_notice_opened", {
          product_id: c,
          screen_id: z,
        });
    }, [L, c, z]);
    const A = a.expired,
      O = () => {
        (({ remindLaterAction: e, productId: M, remindLaterNonce: c }, i) => {
          T({ action: e, productId: M, nonce: c }, i);
        })({ remindLaterAction: x, productId: c, remindLaterNonce: y }, () => {
          (w(!1),
            (0, u.recordEvent)("product_usage_notice_maybe_later_clicked", {
              product_id: c,
              screen_id: z,
            }));
        });
      ...
      m = () => {
        const e = A
          ...
          M = [
            ...
            },
            {
              key: "get-supports",
              icon: I,
              title: (0, o.__)("Help when you need it", "woocommerce"),
              content: (0, o.__)(
            ...
            },
            {
              ...
              icon: s,
              title: (0, o.__)("Supporting the ecosystem", "woocommerce"),
              content: (0, o.__)(
        ...
        return (0, N.jsxs)("div", {
          className: "woocommerce-subscription-benefits",
          children: [
            (0, N.jsx)("h3", { children: e }),
            M.map(({ key: e, icon: M, title: c, content: i }) =>
              (0, N.jsxs)(
                "div",
                {
                  ...
                  children: [
                    (0, N.jsx)("div", {
                      className: "woocommerce-subscription-benefits__icon",
                      children: (0, N.jsx)(r.Icon, { icon: M }),
                    }),
                    (0, N.jsxs)("div", {
                      className: "woocommerce-subscription-benefits__content",
                      children: [
                        (0, N.jsx)(n.Text, {
                          as: "h4",
                          lineHeight: "20px",
                        ...
                        (0, N.jsx)(n.Text, { as: "p", children: i }),
                      ],
                    }),
                  ],
                },
    ...
    return L
      ? (0, N.jsx)(r.Modal, {
          ...
          onRequestClose: () => {
            (({ dismissAction: e, productId: M, dismissNonce: c }, i) => {
              T({ action: e, productId: M, nonce: c }, i);
            })({ dismissAction: d, productId: c, dismissNonce: g }, () => {
              (w(!1),
                (0, u.recordEvent)("product_usage_notice_dismissed", {
                  product_id: c,
                  screen_id: z,
                }));
            });
          ...
          children: (0, N.jsxs)(r.Flex, {
            ...
            children: [
              (0, N.jsx)(r.FlexItem, {
                children: (() => {
                  const i = A
                      ? (0, o.__)("Expired", "woocommerce")
                      : (0, o.__)("Unregistered", "woocommerce"),
                    t = A
                      ? (0, o.sprintf)((0, o.__)("Renew %s", "woocommerce"), j)
                      : (0, o.sprintf)(
                          (0, o.__)("Subscribe to %s", "woocommerce"),
                          j,
                        ),
                    I = A
                      ? (0, o.sprintf)(
                          (0, o.__)("Renew for $%s", "woocommerce"),
                          D,
                        )
                      : (0, o.sprintf)(
                          (0, o.__)("Subscribe for $%s", "woocommerce"),
                          D,
                        );
                  return (0, N.jsxs)(r.Card, {
                    className: "primary",
                    children: [
                      (0, N.jsxs)(r.CardHeader, {
                        children: [
                          (0, N.jsx)("div", {
                            children: (0, N.jsx)(n.Text, {
                              className:
                                "subscription-status subscription-status__expired",
                              children: i,
                            }),
                          }),
                      ...
                      (0, N.jsx)(r.CardBody, { children: m() }),
                      (0, N.jsxs)(r.CardFooter, {
                        children: [
                          (0, N.jsx)(r.Button, {
                            onClick: O,
                            variant: "secondary",
                            children: (0, o.__)("Maybe later", "woocommerce"),
                          }),
                          (0, N.jsx)(r.Button, {
                            isPrimary: !0,
                            target: "_blank",
                            ...
                            onClick: () =>
                              A
                                ? (w(!1),
                                  void (0, u.recordEvent)(
                                    "product_usage_notice_renew_clicked",
                                    { product_id: c, screen_id: z },
                                  ))
                                : (w(!1),
                                  void (0, u.recordEvent)(
                                    "product_usage_notice_subscribe_clicked",
                                    { product_id: c, screen_id: z },
                                  )),
                            children: I,
                          }),
              ...
              (0, N.jsx)(r.FlexItem, {
                children: (0, N.jsx)(r.Card, {
                  className: "secondary",
                  children: (0, N.jsx)(r.CardMedia, {
                    children: (0, N.jsx)(r.ResponsiveWrapper, {
                      naturalWidth: 240,
                      naturalHeight: 240,
  ...
  (Q.setAttribute("id", "woo-product-usage-notice"),
    (0, i.createRoot)(document.body.appendChild(Q)).render(
      (0, N.jsx)(y, {
        renewUrl: a,
        subscribeUrl: z,
        productId: L,
    ...
    ((window.wc = window.wc || {}).wooProductUsageNotice = {}));
})();
