(() => {
  ...
  const e = window.wp.i18n,
    ...
    n = ["wcAdminSettings", "preloadSettings"],
    o = (0, t.getSetting)("admin", {}),
    i = Object.keys(o).reduce(
      (e, t) => (n.includes(t) || (e[t] = o[t]), e),
      {},
    ),
    c = {
      onboarding: {
  ...
  ((0, t.getSetting)("adminUrl"),
    (0, t.getSetting)("countries"),
    (0, t.getSetting)("currency"),
    (0, t.getSetting)("locale"),
    (0, t.getSetting)("siteTitle"),
    (0, t.getSetting)("wcAssetUrl"),
    (function (t, o = !1, c = (e) => e) {
      if (n.includes(t))
        throw new Error(
          (0, e.__)(
      ...
      c(i.hasOwnProperty(t) ? i[t] : o, o);
    })("orderStatuses"),
    window.wcSettings && c && Object.keys(c).length,
    ((window.wc = window.wc || {}).wcsettingsDeprecation = {}));
})();
