...
(() => {
  ...
  var e = {
      94931: (e, o, t) => {
        ...
        o.jsx = function (e, o, t) {
          ...
          void 0 !== o.ref && (m = o.ref),
          o))
            a.call(o, r) && !s.hasOwnProperty(r) && (i[r] = o[r]);
          if (e && e.defaultProps)
  ...
  const t = window.wp.element,
    ...
    c = window.wc.data,
    s = (e) => {
      const o = (document.getElementById("wpadminbar")?.offsetHeight || 0) + 8;
      e.top < o
        ? window.scrollBy(0, e.top - o)
        : e.bottom > window.innerHeight &&
          window.scrollBy(0, e.bottom - window.innerHeight);
    },
    i = window.wp.i18n;
  var l = (function t(r) {
    var n = o[r];
  ...
  const m = () => {
      const [e, o] = (0, t.useState)(!0),
        { updateOptions: m } = (0, a.useDispatch)(c.optionsStore),
        p = (() => {
          ...
          return [
            ...
            },
            {
              ...
              meta: {
                ...
                heading: (0, i.__)("Find exactly what you need", "woocommerce"),
                descriptions: {
                  desktop: (0, i.__)(
            ...
            },
            {
              ...
              meta: {
                ...
                heading: (0, i.__)("Browse for new ideas", "woocommerce"),
                descriptions: {
                  desktop: (0, t.createInterpolateElement)(
                    (0, i.__)(
            ...
            },
            {
              ...
              meta: {
                ...
                heading: (0, i.__)("Manage your purchases", "woocommerce"),
                descriptions: {
                  desktop: (0, t.createInterpolateElement)(
                    (0, i.__)(
                    ...
                    ),
                    {
                      a1: (0, t.createElement)(
                        ...
                        (0, i.__)("30-day money-back guarantee", "woocommerce"),
                      ),
                      a2: (0, t.createElement)(
                        ...
                        (0, i.__)("email and live chat support", "woocommerce"),
                      ),
                      br: e,
                    },
                  ),
      ...
      if (
          ...
          if ("true" === new URLSearchParams(location.search).get("tutorial")) {
            const e = ((e) => {
              ...
              const a = setInterval(() => {
                ...
                (r === e &&
                  ((() => {
                    const e = p[0]?.meta?.name;
                    (o(!0),
                      (0, n.recordEvent)("in_app_marketplace_tour_started", {
                        step: e,
                      }));
                  })(),
                  clearInterval(a)),
        ...
        (0, t.useEffect)(() => {
          if (e) {
            ...
            const t = setTimeout(o, 500),
              r = ((e, o) => {
                const t = document.querySelector(".woocommerce-marketplace");
                let r = t?.offsetTop;
                return setInterval(() => {
                  const e = t?.offsetTop;
                  (r !== e && o(), (r = e));
      ...
      const d = (({
        ...
        return {
          ...
          options: {
            effects: {
              ...
              autoScroll: { behavior: "auto", block: t },
            },
            popperModifiers: [
              ...
              },
              {
                ...
                enabled: !0,
                phase: "read",
                fn({ state: e, instance: o }) {
                  if (a !== e.elements.reference) {
                    const t = e.elements.reference.closest("#adminmenu")
                      ? "right"
                      : c;
                    e.placement !== t && o.setOptions({ placement: t });
                  }
                  const t = e.elements.popper.getBoundingClientRect(),
                    r = e.elements.arrow?.getBoundingClientRect(),
                    i = r?.height || 0;
                  a !== e.elements.reference &&
                    0 !== i &&
                    n !== t.top &&
                    (s(t), (n = t.top), (a = e.elements.reference));
                },
              },
            ],
            callbacks: { onNextStep: o },
          },
          steps: r,
          closeHandler: e,
        };
        ...
        closeHandler: (e, t) => {
          (o(!1),
            m({ woocommerce_admin_dismissed_in_app_marketplace_tour: "yes" }));
          const r = new URL(window.location.href);
          if (
            (r.searchParams.delete("tutorial"),
            window.history.replaceState(null, "", r),
            p.length - 1 === t)
          )
            (0, n.recordEvent)("in_app_marketplace_tour_completed");
          else {
            const o = e[t]?.meta?.name;
            (0, n.recordEvent)("in_app_marketplace_tour_dismissed", {
              step: o,
            });
          }
        },
        onNextStepHandler: (e) => {
          const o = p[e]?.meta?.name || "";
          (0, n.recordEvent)("in_app_marketplace_tour_step_viewed", {
            step: o,
          });
        },
      ...
      return (0, l.jsx)(r.TourKit, { config: d });
    },
    p = document.createElement("div");
  (p.setAttribute("id", "wc-addons-tour-root"),
    (0, t.createRoot)(document.body.appendChild(p)).render((0, l.jsx)(m, {})),
    ((window.wc = window.wc || {}).wcAddonsTour = {}));
})();
