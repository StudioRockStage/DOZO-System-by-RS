(() => {
  ...
  productScreen &&
    ...
    (() => {
      const t = document.querySelectorAll(".row-actions span"),
      ...
      (i?.addEventListener("click", function () {
        (0, e.recordEvent)("products_list_filter_click", {
          search_string_length: s?.value.length,
          filter_category: "" !== u.value,
          filter_product_type: a.value,
          filter_stock_status: m.value,
        });
      }),
        o?.addEventListener("click", function () {
          const t = document.querySelectorAll('[name="post[]"]:checked').length;
          (0, e.recordEvent)("products_list_bulk_actions_click", {
            selected_action: c.value,
            product_number: t,
          });
        }),
        n?.addEventListener("click", function () {
          (0, e.recordEvent)("products_list_bulk_edit_update", {
            product_number:
            ...
            comments: p('[name="comment_status"]'),
            status: p('[name="_status"]'),
            product_tags: p('[name="tax_input[product_tag]"]'),
            price: p('[name="change_regular_price"]'),
            sale: p('[name="change_sale_price"]'),
            tax_status: p('[name="_tax_status"]'),
            tax_class: p('[name="_tax_class"]'),
            weight: p('[name="change_weight"]'),
            dimensions: p('[name="change_dimensions"]'),
            shipping_class: p('[name="_shipping_class"]'),
            visibility: p('[name="_visibility"]'),
            featured: p('[name="_featured"]'),
            stock_status: p('[name="_stock_status"]'),
            manage_stock: p('[name="_manage_stock"]'),
            stock_quantity: p('[name="change_stock"]'),
            backorders: p('[name="_backorders"]'),
            sold_individually: p('[name="_sold_individually"]'),
          });
        }),
        r?.addEventListener("click", function () {
          (0, e.recordEvent)("products_list_bulk_edit_cancel");
        }),
        t.forEach((t) => {
          t.addEventListener("click", function (t) {
            const c = t.target?.parentElement?.classList[0],
              o = {
                edit: "edit",
                inline: "quick_edit",
                trash: "trash",
            ...
            c &&
              o[c] &&
              (0, e.recordEvent)("products_list_product_action_click", {
                selected_action: o[c],
              });
          });
        }),
        d.forEach((t) => {
          t.addEventListener("click", function (t) {
            const c = t.target.classList.contains("not-featured");
            (0, e.recordEvent)("products_list_featured_click", {
              featured: c ? "yes" : "no",
            });
          });
        }),
        l?.addEventListener("click", function () {
          (0, e.recordEvent)("products_search", {
            search_string_length: s.value.length,
            filter_category: "" !== u.value,
            filter_product_type: a.value,
            filter_stock_status: m.value,
        ...
        _.forEach((t) => {
          t.addEventListener("click", function (t) {
            const c = t.target.closest("th");
            if (!c) return;
            const o = c.classList.contains("asc");
            (0, e.recordEvent)("products_list_column_header_click", {
              field_slug: c.id,
              order: o ? "desc" : "asc",
            });
          });
  ...
  function o(e, t, c = 0) {
    c > 6 ||
      setTimeout(() => {
        document.querySelector(e) ? t() : o(e, t, ++c);
      }, 500);
  }
  const r = () => document.querySelector("#product-type")?.value,
    n = () => {
      var e;
      ...
      let c = "",
        o = "";
      if (t) {
        const e = document.querySelector(".block-editor-rich-text__editable");
        c = e?.value || "";
      } else {
        const e = document.querySelector('[name="tax_input[product_tag]"]');
        o = e?.value || "";
        const t = document.querySelector("#content");
        t && ((n = t), "none" !== window.getComputedStyle(n).display)
          ? (c = t.value)
      ...
      const d = Array.from(
        ...
        .map((e) => ({
          id: e.getAttribute("data-product-type-option-id"),
          isEnabled: e.checked,
        }))
      ...
      return {
        ...
        is_downloadable: document.querySelector("#_downloadable")?.checked
          ? "Yes"
          : "No",
        is_virtual: document.querySelector("#_virtual")?.checked ? "Yes" : "No",
        manage_stock: document.querySelector("#_manage_stock")?.checked
          ? "Yes"
          : "No",
        ...
        enable_reviews: document.querySelector("#comment_status")?.checked
          ? "Yes"
          : "No",
        is_block_editor: t,
        menu_order:
          0 !==
          parseInt(
            null !== (e = document.querySelector("#menu_order")?.value) &&
              void 0 !== e
              ? e
              : 0,
            10,
        ...
        product_image:
          parseInt(document.querySelector("#_thumbnail_id")?.value || "0", 10) >
          0
            ? "Yes"
            : "No",
        purchase_note: document.querySelector("#_purchase_note")?.value.length
          ? "Yes"
          : "No",
        sale_price: document.querySelector("#_sale_price")?.value
          ? "Yes"
          : "No",
        short_description: document.querySelector("#excerpt")?.value.length
          ? "Yes"
          : "No",
    ...
    d = (e = "") =>
      `${document.querySelector(`#${e}mm`)?.value || ""}-${document.querySelector(`#${e}jj`)?.value || ""}-${document.querySelector(`#${e}aa`)?.value || ""} ${document.querySelector(`#${e}hh`)?.value || ""}:${document.querySelector(`#${e}mn`)?.value || ""}`,
    i = () => ({
      status: document.querySelector("#post_status")?.value,
      visibility: document.querySelector('input[name="visibility"]:checked')
        ?.value,
      date: d() !== d("hidden_") ? "yes" : "no",
    ...
    u = (e, t) =>
      Object.fromEntries(Object.entries(e).map(([e, c]) => [`${t}${e}`, c])),
    a = (e) => {
      const t = {};
      return (
        (t.product_type = r()),
        "inventory" === e &&
          (t.is_store_stock_management_enabled =
            null !== document.querySelector("#_manage_stock")),
        t
      );
    },
    l = () => {
      (c("#product_attributes", [
        {
          ...
          callback: () => {
            (0, e.recordEvent)("product_attributes_add_term", {
              page: "product",
            });
          },
        },
        ...
        (() => {
          ...
          (document
            ...
            ?.addEventListener("click", () => {
              (0, e.recordEvent)("product_preview_changes");
            }),
            document
              .querySelector(".submitduplicate")
              ?.addEventListener("click", () => {
                (0, e.recordEvent)("product_copy", n());
              }),
            document
              .querySelector(".submitdelete")
              ?.addEventListener("click", () => {
                (0, e.recordEvent)("product_delete", n());
              }),
            document
              .querySelectorAll(
              ...
              .forEach((t) => {
                t.addEventListener("click", () => {
                  (0, e.recordEvent)("product_publish_widget_edit", {
                    ...i(),
                    ...n(),
                  });
                });
            ...
            document
              ...
              .forEach((c) => {
                c.addEventListener("click", () => {
                  (0, e.recordEvent)("product_publish_widget_save", {
                    ...u(i(), "new_"),
                    ...u(t, "current_"),
                    ...n(),
                  });
            ...
            document
              ...
              .forEach((t) => {
                t.addEventListener("click", (t) => {
                  const c = t.target.closest(".postbox");
                  c &&
                    (0, e.recordEvent)("product_widget_order_change", {
                      widget: c.id,
                    });
                });
              }),
            document
              ...
              ?.addEventListener("click", () => {
                (0, e.recordEvent)("product_screen_options_open");
              }),
            document
              .querySelectorAll(
                "#adv-settings .metabox-prefs input[type=checkbox]",
              )
              .forEach((t) => {
                t.addEventListener("change", () => {
                  (0, e.recordEvent)("product_screen_elements", {
                    selected_element: t.value,
                    checkbox: t.checked,
                  });
                });
              }),
            document
              ...
              .forEach((t) => {
                t.addEventListener("change", () => {
                  (0, e.recordEvent)("product_layout", {
                    selected_layout: t.value,
                  });
                });
              }),
            document
              ...
              ?.addEventListener("change", (t) => {
                (0, e.recordEvent)("product_additional_settings", {
                  checkbox: t.target.checked,
                });
              }),
            document
              .querySelector(
              ...
              ?.addEventListener("click", () => {
                (0, e.recordEvent)("product_view_product_click", n());
              }));
          const c = ".notice-success.is-dismissible > button";
          o(c, () => {
            document.querySelector(c)?.addEventListener("click", () => {
              (0, e.recordEvent)("product_view_product_dismiss", n());
            });
          });
        })(),
        (() => {
          function t() {
            (0, e.recordEvent)("product_tags_delete", {
              page: "product",
              tag_list_size:
          ...
          function c() {
            document
              .querySelectorAll("#product_tag .ntdelbutton")
              .forEach((e) => {
          ...
          function r(t) {
            ((0, e.recordEvent)("product_tags_add", {
              page: "product",
              tag_string_length: t.target.textContent?.length,
              tag_list_size:
                document.querySelector(".tagchecklist")?.children.length || 0,
              most_used: !0,
            }),
          ...
          function n() {
            document
              .querySelectorAll("#tagcloud-product_tag .tag-cloud-link")
              .forEach((e) => {
                (e.removeEventListener("click", r),
                  e.addEventListener("click", r));
              });
          }
          (o("#product_tag .tagchecklist", c),
            document.querySelector(".tagadd")?.addEventListener("click", () => {
              const t = document.querySelector("#new-tag-product_tag");
              t &&
                t.value &&
                t.value.length > 0 &&
                ((0, e.recordEvent)("product_tags_add", {
                  page: "product",
                  tag_string_length: t.value.length,
                  tag_list_size:
            ...
            document
              ...
              ?.addEventListener("click", () => {
                o("#tagcloud-product_tag", n);
              }));
        })(),
        document
          .querySelector("#product_attributes .add_custom_attribute")
          ?.addEventListener("click", () => {
            (0, e.recordEvent)("product_attributes_buttons", {
              action: "add_new",
            });
          }),
        window
        ...
        document
          ...
          ?.addEventListener("click", (t) => {
            ...
            (0, e.recordEvent)("product_attributes_save", {
              page: "product",
        ...
        document
          ...
          ?.addEventListener("click", () => {
            (0, e.recordEvent)("product_variations_empty_state", {
        ...
        c("#variable_product_options", [
          {
            eventName: "click",
            childQuery: ".add_variation_manually",
            callback: () => {
              (0, e.recordEvent)("product_variations_buttons", {
          ...
          },
          {
            ...
            callback: () => {
              const t = document.querySelector("#field_to_edit");
              if (!t) return;
              const c = t.selectedIndex,
                o = t.options[c];
              o &&
                (0, e.recordEvent)("product_variations_buttons", {
                  action: "bulk_actions",
        ...
        document.querySelectorAll(".product_data_tabs > li").forEach((t) => {
          const c = ((e) => {
            const t = Array.from(e.classList).filter((e) =>
              e.endsWith("_options"),
            );
            return t.length > 0 ? t[0].slice(0, -8) : "";
          })(t);
          t.querySelector("a")?.addEventListener("click", () => {
            (0, e.recordEvent)("product_tab_click", {
              product_tab: c,
              ...a(c),
            });
          });
        ...
        document
          ...
          ?.addEventListener("click", (t) => {
            (0, e.recordEvent)("product_manage_stock_click", {
              is_enabled: t.target?.checked,
            });
          }),
        document
  ...
  function s(e) {
    ...
    (r &&
      ...
      window.addEventListener("beforeunload", function () {
        ...
        window.wp.autosave
          ? (c = window.wp.autosave.server.postChanged())
          : e && (c = !e.isHidden() && e.isDirty());
      }),
      (0, t.addCustomerEffortScoreExitPageListener)(e, () => c));
  }
  (productScreen &&
    "edit" === productScreen.name &&
    ((() => {
      const t = n();
      ((0, e.recordEvent)("product_edit_view", { product_id: t?.product_id }),
        l());
    })(),
    s("product_edit_view")),
    productScreen &&
      "new" === productScreen.name &&
      ((0, e.recordEvent)("product_add_view"), l(), s("product_add_view")),
    ((window.wc = window.wc || {}).productTracking = {}));
})();
