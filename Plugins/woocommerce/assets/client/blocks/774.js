"use strict";
(globalThis.webpackChunkwebpackWcBlocksPaymentMethodExtensionJsonp =
  globalThis.webpackChunkwebpackWcBlocksPaymentMethodExtensionJsonp || []).push(
  [
    [774],
    {
      774: (e, t, n) => {
        ...
        var d = "data-react-paypal-script-id",
          f = "react-paypal-js",
          p = "dataNamespace",
          v = "dataSdkIntegrationSource",
          m = "3.117.0",
          h =
          ...
          switch (t.type) {
            case o.LOADING_STATUS:
              return "object" == typeof t.value
                ...
                : s(s({}, e), { loadingStatus: t.value });
            case o.RESET_OPTIONS:
              return (
                (c = e.options[d]),
                (null ==
                (i = self.document.querySelector(
                  "script[".concat(d, '="').concat(c, '"]'),
                ))
                  ? void 0
                  : i.parentNode) && i.parentNode.removeChild(i),
                s(s({}, e), {
                  loadingStatus: r.PENDING,
                  options: s(
                    s(((n = {}), (n[v] = f), n), t.value),
                    ((a = {}), (a[d] = "".concat(b(t.value))), a),
                  ),
                })
              );
            case o.SET_BRAINTREE_INSTANCE:
              return s(s({}, e), { braintreePayPalCheckoutInstance: t.value });
            default:
              return e;
          }
        }
        var S = (0, c.createContext)(null);
        function w() {
          var e = (function (e) {
            if (
          ...
          return [
            s(s({}, e), {
              isInitial: e.loadingStatus === r.INITIAL,
              isPending: e.loadingStatus === r.PENDING,
              isResolved: e.loadingStatus === r.RESOLVED,
              isRejected: e.loadingStatus === r.REJECTED,
            }),
            e.dispatch,
          ];
        }
        ...
        var N = function (e) {
          var t,
            ...
            m = e.forceReRender,
            h = void 0 === m ? [] : m,
            b = u(e, ["className", "disabled", "children", "forceReRender"]),
            g = f ? { opacity: 0.38 } : {},
            S = ""
              .concat(a, " ")
              .concat(f ? "paypal-buttons-disabled" : "")
              .trim(),
            P = (0, c.useRef)(null),
            O = (0, c.useRef)(null),
            I =
              ...
              (r.current = Object.assign(r.current, n)),
              r.current),
            R = w()[0],
            k = R.isResolved,
            T = R.options,
            ...
            x = D[0],
            L = D[1],
            M = (0, c.useState)(null)[1];
          function _() {
            null !== O.current && O.current.close().catch(function () {});
          }
          return (
            (null === (t = O.current) || void 0 === t
              ? void 0
              : t.updateProps) && O.current.updateProps({ message: b.message }),
            (0, c.useEffect)(
              function () {
                if (!1 === k) return _;
                var e = y(T.dataNamespace);
                    ...
                    M(function () {
                      throw new Error(
                        E({
                          ...
                          sdkRequestedComponents: T.components,
                          sdkDataNamespace: T[p],
                        }),
                      );
                    }),
                    _
                ...
                try {
                  O.current = e.Buttons(
                    s(s({}, I), {
                      onInit: function (e, t) {
                        (A(t), "function" == typeof b.onInit && b.onInit(e, t));
                      },
                    }),
                  );
                } catch (e) {
                ...
                return !1 === O.current.isEligible()
                  ? (L(!1), _)
                  : P.current
                    ? (O.current.render(P.current).catch(function (e) {
                        null !== P.current &&
            ...
            i().createElement(
              ...
              null,
              x
                ? i().createElement("div", { ref: P, style: g, className: S })
                : v,
            )
          );
        };
        ...
        function O(e, t) {
          ...
          var n = (function (e) {
              var t,
                ...
                s = Object.keys(i)
                  .filter(function (e) {
                    return void 0 !== i[e] && null !== i[e] && "" !== i[e];
                  })
                  .reduce(
                    function (e, t) {
                      var n,
              ...
              return (
                u["merchant-id"] &&
                  -1 !== u["merchant-id"].indexOf(",") &&
                  ((l["data-merchant-id"] = u["merchant-id"]),
                  (u["merchant-id"] = "*")),
                {
                  url: "".concat(c, "?").concat(
                    ((t = u),
            ...
            c = I(a);
          return (
            o["data-js-sdk-library"] ||
              (o["data-js-sdk-library"] = "paypal-js"),
            (function (e, t) {
              ...
              : (function (e, t) {
                ...
                })({ url: r, attributes: o }, t).then(function () {
                  var e = I(a);
                  if (e) return e;
                  throw new Error(
                    "The window.".concat(
        ...
        var k = function (e) {
          ...
          return (
                    ...
                    return b(function () {
                      throw new Error(
                        E({
                          ...
                          sdkDataNamespace: d[p],
                        }),
                      );
                    });
                  !(function (e) {
                    var t = f.current;
                    if (!t || !e.isEligible()) return h(!1);
            ...
            i().createElement(
              i().Fragment,
              null,
              m ? i().createElement("div", { ref: f, className: n }) : r,
            )
          );
        };
        ...
        var T = function (e) {
          ...
          return (
                    ...
                    return b(function () {
                      throw new Error(
                        E({
                          ...
                          sdkRequestedComponents: v.components,
                          sdkDataNamespace: v[p],
                        }),
                      );
                    });
                  ((h.current = e.Messages(s({}, a))),
                    h.current.render(m.current).catch(function (e) {
                      null !== m.current &&
                        0 !== m.current.children.length &&
                        b(function () {
                          throw new Error(
            ...
            i().createElement("div", { ref: m, className: n })
          );
        };
        T.displayName = "PayPalMessages";
        var j = function (e) {
          var t,
            n = e.options,
            a = void 0 === n ? { clientId: "test" } : n,
            u = e.children,
            l = e.deferLoading,
            p = void 0 !== l && l,
            m = (0, c.useReducer)(g, {
              options: s(
                s({}, a),
                ((t = {}),
                (t.dataJsSdkLibrary = f),
                (t[v] = f),
                (t[d] = "".concat(b(a))),
                t),
              ),
              loadingStatus: p ? r.INITIAL : r.PENDING,
            }),
            h = m[0],
            y = m[1];
          return (
            (0, c.useEffect)(
              function () {
                if (!1 === p && h.loadingStatus === r.INITIAL)
                  return y({ type: o.LOADING_STATUS, value: r.PENDING });
                if (h.loadingStatus === r.PENDING) {
                  var e = !0;
                  return (
                    O(h.options)
                      .then(function () {
                        e && y({ type: o.LOADING_STATUS, value: r.RESOLVED });
                      })
                      .catch(function (t) {
                        (console.error(
                          ""
                          ...
                          e &&
                            y({
                              type: o.LOADING_STATUS,
                              value: { state: r.REJECTED, message: String(t) },
                            }));
                      }),
                    function () {
                      e = !1;
              ...
              [h.options, p, h.loadingStatus],
            ),
            i().createElement(
              S.Provider,
              { value: s(s({}, h), { dispatch: y }) },
              u,
            )
          );
        };
