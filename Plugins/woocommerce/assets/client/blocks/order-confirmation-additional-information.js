          ...
          edit: () => {
            ...
            return (0, l.jsx)("div", {
              ...
              children: (0, l.jsx)("div", {
                className:
                  "wc-block-order-confirmation-additional-information-placeholder",
                children: (0, c.__)(
    ...
    (n.O = (o, r, t, i) => {
      if (!r) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [r, t, i] = e[d], s = !0, c = 0; c < r.length; c++)
            (!1 & i || a >= i) && Object.keys(n.O).every((e) => n.O[e](r[c]))
              ? r.splice(c--, 1)
              : ((s = !1), i < a && (a = i));
          if (s) {
            e.splice(d--, 1);
