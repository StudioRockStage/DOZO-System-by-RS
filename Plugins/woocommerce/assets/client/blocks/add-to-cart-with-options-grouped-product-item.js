  ...
  var e,
    ...
    r = {
      5449: (e, t, o) => {
        ...
        var u = o(790);
        const w = (0, a.createHigherOrderComponent)(
            (e) =>
          ...
          h = window.wc.wcBlocksSharedContext,
          m = window.wp.data,
          g = window.wc.data,
          v = w(function ({
            attributes: e,
            ...
            const n = (0, d.__experimentalUseBlockPreview)({ blocks: r }),
              i = (0, d.useInnerBlocksProps)(
                { role: "listitem" },
                { templateLock: "insert" },
              );
            return (0, u.jsx)(d.BlockContextProvider, {
              value: { postId: e.productId, postType: "product" },
              children: (0, u.jsxs)(h.ProductDataContextProvider, {
                product: o,
                isLoading: t,
                children: [
                  s ? (0, u.jsx)("div", { ...i }) : (0, u.jsx)(u.Fragment, {}),
                  (0, u.jsx)("div", {
                    role: "listitem",
                    style: { display: s ? "none" : void 0 },
        ...
        (0, r.registerBlockType)(n, {
          edit: function (e) {
            const { clientId: t } = e,
              { className: o } = e.attributes,
              r = (0, d.useBlockProps)({ className: o }),
              { product: s, isLoading: c } = (0, h.useProductDataContext)(),
            ...
            (0, i.useEffect)(() => {
              const e = async (e) => {
                e &&
                  0 !== e.length &&
                  (0, m.resolveSelect)(g.productsStore)
                    .getProducts({
                      include: e,
                      per_page: e.length,
                      _fields: ["id"],
              ...
              !c &&
                s &&
                0 === p &&
                (((e) => !!e && "id" in e && 0 !== e.id)(s)
                  ? e(s.grouped_products)
                  : (0, m.resolveSelect)(g.productsStore)
                      .getProducts({ type: "grouped", per_page: 1 })
                      .then((t) => {
                        t.length > 0
                          ? e(t[0].grouped_products)
                          : (0, m.resolveSelect)(g.productsStore)
                              .getProducts({ per_page: 3, _fields: ["id"] })
                              .then((e) => {
                                e.length > 0 && a(e);
                              });
                      }));
            }, [c, s, p]);
            const { blocks: l } = (0, m.useSelect)(
                (e) => {
                  const { getBlocks: o } = e(d.store);
                  return { blocks: o(t) };
                },
                [t],
              ),
            ...
            return (0, u.jsx)("div", {
              ...r,
              children: (0, u.jsx)(h.InnerBlockLayoutContextProvider, {
                parentName:
                ...
                children: (0, u.jsx)("div", {
                  ...
                  children: n?.map((e) =>
                    (0, u.jsx)(
                      v,
                      {
                        attributes: { productId: e.id },
                        blocks: l,
                        isSelected: (w || n[0]?.id) === e.id,
                        onSelect: () => b(e.id),
                      },
                      e.id,
                    ),
          ...
          save: function () {
            const e = d.useBlockProps.save(),
              t = d.useInnerBlocksProps.save({ ...e, role: "listitem" });
            return (0, u.jsx)("div", { ...t });
          },
        });
      },
      1609: (e) => {
  ...
  ((c.m = r),
    ...
    (c.O = (t, o, r, s) => {
      if (!o) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [o, r, s] = e[p], i = !0, d = 0; d < o.length; d++)
            (!1 & s || n >= s) && Object.keys(c.O).every((e) => c.O[e](o[d]))
              ? o.splice(d--, 1)
              : ((i = !1), s < n && (n = s));
          if (i) {
            e.splice(p--, 1);
    ...
    (() => {
      ...
      var t = (t, o) => {
          ...
          for (t && t(o); a < n.length; a++)
            ((s = n[a]), c.o(e, s) && e[s] && e[s][0](), (e[s] = 0));
          return c.O(p);
        },
