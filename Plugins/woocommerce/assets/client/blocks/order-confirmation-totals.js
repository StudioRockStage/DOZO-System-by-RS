  ...
  var e,
    ...
    r = {
      6145: (e, o, t) => {
        ...
        var m = t(7723);
        const p = window.wc.priceFormat;
        t(4628);
        (0, r.registerBlockType)(a, {
          icon: {
            src: (0, i.jsx)(l.A, {
              icon: n,
                      ...
                      children: (0, i.jsxs)("tr", {
                        children: [
                          (0, i.jsx)("th", {
                            ...
                            children: (0, m.__)("Product", "woocommerce"),
                          }),
                          (0, i.jsx)("th", {
                            className:
                              "wc-block-order-confirmation-totals__total",
                            children: (0, m.__)("Total", "woocommerce"),
                          }),
                        ],
                      }),
                    }),
    ...
    (c.O = (o, t, r, l) => {
      if (!t) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [t, r, l] = e[d], n = !0, a = 0; a < t.length; a++)
            (!1 & l || i >= l) && Object.keys(c.O).every((e) => c.O[e](t[a]))
              ? t.splice(a--, 1)
              : ((n = !1), l < i && (i = l));
          if (n) {
            e.splice(d--, 1);
