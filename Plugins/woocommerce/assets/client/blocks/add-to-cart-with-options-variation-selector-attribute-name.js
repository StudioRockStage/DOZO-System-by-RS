        ...
        (0, o.registerBlockType)(n, {
          edit: function (e) {
            const { attributes: t } = e,
              { className: r } = t,
              o = (0, s.__experimentalUseColorProps)(t),
              [a, i] = (0, s.useSettings)("typography.fluid", "layout"),
              n = (0, s.getTypographyClassesAndStyles)(t, {
                typography: { fluid: a },
                layout: { wideSize: i?.wideSize },
              }),
              u = (0, s.__experimentalGetSpacingClassesAndStyles)(t),
              m = (0, s.useBlockProps)({
                className: (0, c.A)(r, o.className, n.className, u.className),
                style: { ...o.stye, ...n.style, ...u.style },
              }),
              { data: d } = (0, l.useCustomDataContext)("attribute");
            if (d)
              return (0, p.jsx)("label", {
                ...m,
                htmlFor: d.taxonomy,
                children: d.name,
              });
    ...
    (i.O = (t, r, o, a) => {
      if (!r) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [r, o, a] = e[p], s = !0, l = 0; l < r.length; l++)
