(() => {
  ...
  class r {
      ...
      const e = (0, t.subscribe)(() => {
        ...
        if (r)
          if ("post" === r || "page" === r)
            ...
            e();
            const r = String(o.getEditedPostSlug());
    ...
    unregisterBlock(t) {
      const { blockName: i, isVariationBlock: o, variationName: r } = t;
      try {
        o && r
          ? ((0, e.unregisterBlockVariation)(i, r),
            this.attemptedRegisteredBlocks.delete(r))
          : ((0, e.unregisterBlockType)(i),
            this.attemptedRegisteredBlocks.delete(i));
      } catch (e) {
        console.debug(`Failed to unregister block ${i}:`, e);
      }
    }
    registerBlock(i) {
      const {
      ...
      try {
        const i = a || r;
        if (this.hasAttemptedRegistration(i)) return;
        const l = (0, t.select)("core/edit-site");
        if (!l && !c) return;
        if (n) (0, e.registerBlockVariation)(r, s);
        else {
          const t = (0, o.isEmpty)(s?.ancestor)
              ? ["woocommerce/single-product"]
              : s?.ancestor,
            i = l && this.currentTemplateId?.includes("single-product");
          (0, e.registerBlockType)(r, { ...s, ancestor: i ? void 0 : t });
        }
        this.attemptedRegisteredBlocks.add(i);
      } catch (e) {
  ...
  const s = JSON.parse(
    ...
    l = window.wp.coreData;
  function d({ layoutClassNames: e }) {
    const t = (0, a.useBlockProps)({ className: e });
    return (0, c.jsx)("div", {
      ...t,
      children: (0, c.jsx)("p", {
        children: (0, n.__)(
  ...
  function u(e) {
    const { context: { postType: t, postId: i } = {}, layoutClassNames: o } = e,
      [, , r] = (0, l.useEntityProp)("postType", t, "content", i),
      s = (0, a.useBlockProps)({ className: o });
    return r?.protected
      ? (0, c.jsx)("div", {
          ...s,
          children: (0, c.jsx)(a.Warning, {
            children: (0, n.__)(
      ...
      : (0, c.jsx)("div", {
          ...s,
          dangerouslySetInnerHTML: { __html: r?.rendered },
        });
  }
  function p() {
  ...
  (((e) => {
    ...
    const i = (({ name: e, ...t }) => t)(e),
      {
        isVariationBlock: o,
        variationName: s,
        isAvailableOnPostEditor: n,
        ...a
      } = { ...i, ...({ isAvailableOnPostEditor: !0 } || {}) },
      c = {
        blockName: t,
        settings: { ...a },
        isVariationBlock: null != o && o,
        variationName: null != s ? s : void 0,
        isAvailableOnPostEditor: null != n && n,
      };
    r.getInstance().registerBlockConfig(c);
  })({
    ...s,
    icon: (0, c.jsxs)(m.SVG, {
    ...
    edit: function ({
      context: e,
      __unstableLayoutClassNames: i,
      __unstableParentLayout: o,
      clientId: r,
    }) {
      const { postId: s, postType: l } = e,
        m = (0, a.useHasRecursion)(s),
        { hasInvalidContext: g, warningElement: h } = (({
          clientId: e,
          postType: i,
          blockName: o,
        }) => ({
          hasInvalidContext: (0, t.useSelect)(
            (t) =>
              t(a.store).getBlockParentsByBlockName(e, "core/post-template")
                .length > 0 && "product" !== i,
            [e, i],
          ),
          warningElement: (0, c.jsx)("div", {
            ...(0, a.useBlockProps)(),
            children: (0, c.jsx)(a.Warning, {
          ...
          clientId: r,
          postType: l,
          blockName: (0, n.__)("Product Description", "woocommerce"),
        });
      return g
        ? h
        : s && l && m
          ? (0, c.jsx)(p, {})
          : (0, c.jsx)(a.RecursionProvider, {
              uniqueId: s,
              children:
                s && l
                  ? (0, c.jsx)(u, {
