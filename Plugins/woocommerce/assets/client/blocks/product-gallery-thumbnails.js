  ...
  var e,
    ...
    r = {
      2928: (e, t, o) => {
        ...
        var s = o(6087);
        const c = window.wp.coreData,
          n = window.wp.data;
        var u = o(4921),
          m = o(7723);
        const p = window.wp.components,
          d = ({ attributes: e, setAttributes: t }) => {
            const { thumbnailSize: o, aspectRatio: r } = e,
              i = [
                {
                  value: "",
                  label: (0, m.__)("Select Aspect Ratio", "woocommerce"),
                  disabled: !0,
                },
                { value: "auto", label: (0, m.__)("Auto", "woocommerce") },
                { value: "1", label: (0, m.__)("Square - 1:1", "woocommerce") },
                {
                  value: "4/3",
                  label: (0, m.__)("Standard - 4:3", "woocommerce"),
                },
                {
                  value: "3/4",
                  label: (0, m.__)("Portrait - 3:4", "woocommerce"),
                },
                {
                  value: "3/2",
                  label: (0, m.__)("Classic - 3:2", "woocommerce"),
                },
                {
                  value: "2/3",
                  label: (0, m.__)("Classic Portrait - 2:3", "woocommerce"),
                },
                {
                  value: "16/9",
                  label: (0, m.__)("Wide - 16:9", "woocommerce"),
                },
                {
                  value: "9/16",
                  label: (0, m.__)("Tall - 9:16", "woocommerce"),
                },
              ];
            return (0, l.jsxs)(p.PanelBody, {
              children: [
                (0, l.jsx)(p.__experimentalUnitControl, {
                  label: (0, m.__)("Thumbnail Size", "woocommerce"),
                  value: o,
                  onChange: (e) => {
                    const o = Number(e?.replace("%", "") || 25),
                      r = Math.min(Math.max(o, 10), 50);
                    t({ thumbnailSize: r + "%" });
                  },
                  units: [{ value: "%", label: "%" }],
                  min: 10,
                ...
                (0, l.jsx)(p.SelectControl, {
                  ...
                  value: r,
                  options: i,
                  label: (0, m.__)("Aspect Ratio", "woocommerce"),
                  onChange: (e) => {
                    t({ aspectRatio: e });
                  },
                  help: (0, m.__)(
        ...
        (0, r.registerBlockType)(b, {
          ...
          edit: ({ attributes: e, setAttributes: t, context: o }) => {
            const { thumbnailSize: r, aspectRatio: m } = e,
              { product: p } =
                ((b = o.postId),
                (0, n.useSelect)(
                  (e) => {
                    if (!b) return { product: void 0, isResolving: !1 };
                    const t = "string" == typeof b ? parseInt(b, 10) : b;
                    return {
                      product: e(c.store).getEditedEntityRecord(
                        "root",
                        "product",
                        t,
                      ),
                      isResolving: e(c.store).isResolving(
                        "getEditedEntityRecord",
                        ["root", "product", t],
                      ),
                      isResolutionFinished: e(c.store).hasFinishedResolution(
                        "getEditedEntityRecord",
                        ["root", "product", t],
                      ),
                    };
            ...
            const h =
                p && p.images && p.images.length > 0
                  ...
                  : Array(10).fill({ src: i.PLACEHOLDER_IMG_SRC, alt: "" }),
              w = h.length > 1,
              g = (0, s.useRef)(null),
              [f, v] = (0, s.useState)({ bottom: !1, right: !1 });
            (0, s.useEffect)(() => {
              const e = g.current;
              if (!e) return;
              ...
              return (
                t.observe(e),
                e.parentElement && t.observe(e.parentElement),
                () => {
                  t.disconnect();
                }
              );
            }, [r]);
            const _ = Number(r.replace("%", "")),
              y = (0, u.A)("wc-block-product-gallery-thumbnails", {
                "wc-block-product-gallery-thumbnails--overflow-right": f.right,
                "wc-block-product-gallery-thumbnails--overflow-bottom":
                  f.bottom,
              }),
              x = (0, a.useBlockProps)({
                className: y,
                style: { "--wc-block-product-gallery-thumbnails-size": _ },
              }),
              C = { aspectRatio: m };
            return (0, l.jsxs)(l.Fragment, {
              children: [
                (0, l.jsx)(a.InspectorControls, {
                  children: (0, l.jsx)(d, { attributes: e, setAttributes: t }),
                }),
                w &&
                  (0, l.jsx)("div", {
                    ...x,
  ...
  ((i.m = r),
      ...
      if (!o) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [o, r, l] = e[u], s = !0, c = 0; c < o.length; c++)
            (!1 & l || a >= l) && Object.keys(i.O).every((e) => i.O[e](o[c]))
              ? o.splice(c--, 1)
              : ((s = !1), l < a && (a = l));
          if (s) {
            e.splice(u--, 1);
    ...
    (() => {
      ...
      var t = (t, o) => {
          ...
          for (t && t(o); n < a.length; n++)
            ((l = a[n]), i.o(e, l) && e[l] && e[l][0](), (e[l] = 0));
          return i.O(u);
        },
