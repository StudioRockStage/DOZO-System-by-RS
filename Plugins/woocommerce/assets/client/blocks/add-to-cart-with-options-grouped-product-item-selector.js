    ...
    r = {
      9367: (t, e, o) => {
        ...
        const s = JSON.parse(
          ...
          i = window.wc.wcBlocksSharedContext,
        ...
        const p = () =>
          ...
          b = () => {
            const { isLoading: t, product: e } = (0, i.useProductDataContext)();
            if (t || !((t) => !!t && "id" in t && 0 !== t.id)(e))
              return (0, u.jsx)(a.Spinner, {});
            const {
              permalink: o,
              add_to_cart: r,
              has_options: c,
            ...
            return !c && n && s
              ...
              : (0, u.jsx)("a", {
                  ...
                  className:
                    "button wp-element-button add_to_cart_button wc-block-components-product-button__button",
                  href: o,
                  children: r?.text || (0, d.__)("Add to Cart", "woocommerce"),
                });
          };
        (o(1541),
    ...
    (n.O = (e, o, r, c) => {
      if (!o) {
        ...
        for (d = 0; d < t.length; d++) {
          for (var [o, r, c] = t[d], i = !0, a = 0; a < o.length; a++)
            (!1 & c || s >= c) && Object.keys(n.O).every((t) => n.O[t](o[a]))
              ? o.splice(a--, 1)
              : ((i = !1), c < s && (s = c));
          if (i) {
            t.splice(d--, 1);
