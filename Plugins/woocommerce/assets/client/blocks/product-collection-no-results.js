      ...
      7267: (e, t, o) => {
            ...
            [
              [
                "core/paragraph",
                {
                  textAlign: "center",
                  fontSize: "medium",
                  content: `<strong>${(0, a.__)("No results found", "woocommerce")}</strong>`,
                },
              ],
              [
                "core/paragraph",
                {
                  content: `${(0, a.__)("You can try", "woocommerce")} <a href="#" class="wc-link-clear-any-filters">${(0, a.__)("clearing any filters", "woocommerce")}</a> ${(0, a.__)("or head to our", "woocommerce")} <a href="#" class="wc-link-stores-home">${(0, a.__)("store's home", "woocommerce")}</a>`,
                },
              ],
            ],
          ],
        ...
        (0, r.registerBlockType)(c, {
          ...
          edit: () => {
            ...
            return (0, l.jsx)("div", {
              ...e,
              children: (0, l.jsx)(i.InnerBlocks, { template: s }),
            });
          },
          save: function () {
            return (0, l.jsx)(i.InnerBlocks.Content, {});
          },
        });
      },
      1609: (e) => {
    ...
    (c.O = (t, o, r, n) => {
      if (!o) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [o, r, n] = e[u], a = !0, l = 0; l < o.length; l++)
            (!1 & n || i >= n) && Object.keys(c.O).every((e) => c.O[e](o[l]))
              ? o.splice(l--, 1)
              : ((a = !1), n < i && (i = n));
          if (a) {
            e.splice(u--, 1);
