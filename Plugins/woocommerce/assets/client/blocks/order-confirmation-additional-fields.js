      ...
      1284: (e, t, o) => {
        ...
        const s = JSON.parse(
          ...
          d =
            ...
            c.pluginUrl,
            l.STORE_PAGES.shop,
            l.STORE_PAGES.checkout,
            l.STORE_PAGES.checkout,
            l.STORE_PAGES.privacy,
            l.STORE_PAGES.privacy,
            l.STORE_PAGES.terms,
            l.STORE_PAGES.terms,
            l.STORE_PAGES.cart,
            ...
            (0, l.getSetting)("shippingEnabled", !0),
          ...
          g =
            (Object.fromEntries(
              Object.keys(u).map((e) => [e, p[e].states || {}]),
            ),
            Object.fromEntries(
              Object.keys(u).map((e) => [e, p[e].locale || {}]),
            ),
            {
              address: [
                "first_name",
          ...
          m =
            ((0, l.getSetting)("addressFieldsLocations", g).address,
            (0, l.getSetting)("addressFieldsLocations", g).contact,
            (0, l.getSetting)("addressFieldsLocations", g).order,
            (0, l.getSetting)("additionalOrderFields", {})),
          f = (0, l.getSetting)("additionalContactFields", {});
        (0, l.getSetting)("additionalAddressFields", {});
        var w = o(7723),
          b = (o(9757), o(790));
        const S = ({ additionalFields: e = [] }) =>
          (0, b.jsx)("dl", {
            className: "wc-block-components-additional-fields-list",
            children: Object.entries(e).map(([, e]) => {
              const { label: t, type: o, options: r } = e;
              let i = (0, w.__)("Placeholder", "woocommerce");
              return (
                "checkbox" === o && (i = (0, w.__)("Yes", "woocommerce")),
                "select" === o && (i = r[0].label),
                (0, b.jsxs)(b.Fragment, {
                  children: [
                    (0, b.jsx)("dt", { children: t }),
                    (0, b.jsx)("dd", { children: i }),
                  ],
                })
              );
            }),
        ...
        (0, r.registerBlockType)(s, {
          ...
          edit: () => {
            ...
            return (0, b.jsx)("div", {
              ...e,
              children: (0, b.jsx)(S, { additionalFields: t }),
            });
          },
          save: () => null,
        });
    ...
    (n.O = (t, o, r, i) => {
      if (!o) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [o, r, i] = e[d], a = !0, l = 0; l < o.length; l++)
            (!1 & i || s >= i) && Object.keys(n.O).every((e) => n.O[e](o[l]))
              ? o.splice(l--, 1)
              : ((a = !1), i < s && (s = i));
          if (a) {
            e.splice(d--, 1);
