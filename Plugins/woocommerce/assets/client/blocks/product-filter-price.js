  ...
  var e,
    ...
    o = {
      5154: (e, r, t) => {
        ...
        var a = t(6087),
          l = t(4347);
        const u = window.wc.wcTypes;
        var p = t(9456),
          d = t(923),
          m = t.n(d);
        function f(e) {
          const r = (0, a.useRef)(e);
          return (m()(e, r.current) || (r.current = e), r.current);
        }
        const y = window.wc.wcBlocksData,
          ...
          v =
            ...
            (e) => {
              const r = g();
              e = e || r;
              const t = (0, w.useSelect)(
                  (r) =>
                    r(y.QUERY_STATE_STORE_KEY).getValueForQueryContext(
                      e,
                      void 0,
                    ),
                  [e],
                ),
                { setValueForQueryContext: o } = (0, w.useDispatch)(
          ...
          x = (e, r, t) => {
            const o = g();
            t = t || o;
            const c = (0, w.useSelect)(
                (o) => o(y.QUERY_STATE_STORE_KEY).getValueForQueryKey(t, e, r),
                [t, e],
              ),
              { setQueryValue: n } = (0, w.useDispatch)(
                y.QUERY_STATE_STORE_KEY,
              );
            return [
              c,
          ...
          C = ({
            ...
            i = `${i}-collection-data`;
            const [d] = v(i),
              [m, _] = x("calculate_attribute_counts", [], i),
              [C, h] = x("calculate_taxonomy_counts", [], i),
              [b, k] = x("calculate_price_range", null, i),
              [E, j] = x("calculate_stock_status_counts", null, i),
              [S, O] = x("calculate_rating_counts", null, i),
              P = f(e || {}),
              T = f(r),
              R = f(t),
              q = f(o),
            ...
            ((0, a.useEffect)(() => {
              "object" == typeof P &&
                ...
                (m.find(
                  (e) =>
                    (0, u.objectHasProp)(P, "taxonomy") &&
                    e.taxonomy === P.taxonomy,
                ) ||
                  _([...m, P]));
            }, [P, m, _]),
              (0, a.useEffect)(() => {
                T && !C.includes(T) && h([...C, T]);
              }, [T, C, h]),
              (0, a.useEffect)(() => {
                b !== R && void 0 !== R && k(R);
              }, [R, k, b]),
            ...
            const M = (0, a.useMemo)(
                  ...
                  ((e) => {
                    ...
                    return (
                      Array.isArray(e.calculate_attribute_counts) &&
                        (r.calculate_attribute_counts = (0, p.di)(
              ...
              { results: Y, isLoading: Q } = ((e) => {
                ...
                const s = (0, a.useRef)({ results: [], isLoading: !0 }),
                  i = f(c),
                  l = f(o),
                  p = (() => {
                ...
                return (null !== d && (s.current = d), s.current);
              })({
        ...
        const b = (e = []) =>
          ...
          k = window.wc.priceFormat;
        function E(e, r) {
          return (
            ("number" == typeof e ? e : parseInt(e, 10)) / 10 ** r.minorUnit
          );
        }
        function j(e) {
          if (!(0, u.objectHasProp)(e, "price_range"))
            return { minPrice: 0, maxPrice: 0, minRange: 0, maxRange: 0 };
          const r = (0, k.getCurrencyFromPriceResponse)(e.price_range),
            t =
              (0, u.objectHasProp)(e.price_range, "min_price") &&
              (0, u.isString)(e.price_range.min_price)
                ? E(e.price_range.min_price, r)
                : 0,
            o =
              (0, u.objectHasProp)(e.price_range, "max_price") &&
              (0, u.isString)(e.price_range.max_price)
                ? E(e.price_range.max_price, r)
                : 0;
          return { minPrice: t, maxPrice: o, minRange: t, maxRange: o };
        }
        t(1652);
        const S = ({ children: e }) =>
          (0, n.jsxs)("div", {
        ...
        (0, o.registerBlockType)(s, {
            ...
            return (0, n.jsx)("div", {
              ...
              children: (0, n.jsx)(S, {
                children: (0, n.jsx)(i.BlockContextProvider, {
                  value: { filterData: { price: j(r), isLoading: t } },
                  children: (0, n.jsx)(i.InnerBlocks, {
                    allowedBlocks: b(),
                    template: [
                      [
                        "core/heading",
                        {
                          level: 3,
                          content: (0, h.__)("Price", "woocommerce"),
                          style: {
                            spacing: {
                              margin: { bottom: "0.625rem", top: "0" },
                            },
                          },
                        },
                      ],
          ...
          save: () => {
            const e = i.useBlockProps.save(),
              r = i.useInnerBlocksProps.save(e);
  ...
  ((n.m = o),
    ...
    (n.O = (r, t, o, c) => {
      if (!t) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [t, o, c] = e[u], i = !0, a = 0; a < t.length; a++)
            (!1 & c || s >= c) && Object.keys(n.O).every((e) => n.O[e](t[a]))
              ? t.splice(a--, 1)
              : ((i = !1), c < s && (s = c));
          if (i) {
            e.splice(u--, 1);
    ...
    (() => {
      ...
      var r = (r, t) => {
          ...
          for (r && r(t); l < s.length; l++)
            ((c = s[l]), n.o(e, c) && e[c] && e[c][0](), (e[c] = 0));
          return n.O(u);
        },
