  ...
  var e,
    ...
    r = {
      642: (e, o, t) => {
        ...
        var n = t(7723);
        const l = window.wp.serverSideRender;
        var d = t.n(l);
        ...
        var w = t(790);
        const m = () =>
            (0, w.jsx)(h.Placeholder, {
              icon: (0, w.jsx)(a.A, { icon: s.A }),
              label: (0, n.__)("Product Categories List", "woocommerce"),
          ...
          g = ({ attributes: e, setAttributes: o, name: t }) => {
            const r = (0, p.useSelect)((e) => e("core/edit-widgets"), []),
              a = (() => {
                const e = (0, p.select)(u.store)?.getCurrentPostType();
                      ...
                      children: [
                        (0, w.jsx)(h.PanelBody, {
                          ...
                          children: (0, w.jsxs)(
                            ...
                            {
                              label: (0, n.__)("Display style", "woocommerce"),
                              isBlock: !0,
                              value: l ? "dropdown" : "list",
                              onChange: (e) =>
                                o({ isDropdown: "dropdown" === e }),
                              children: [
                                (0, w.jsx)(
                                  h.__experimentalToggleGroupControlOption,
                                  {
                                    value: "list",
                                    label: (0, n.__)("List", "woocommerce"),
                                  },
                                ),
                                (0, w.jsx)(
                                  h.__experimentalToggleGroupControlOption,
                                  {
                                    value: "dropdown",
                                    label: (0, n.__)("Dropdown", "woocommerce"),
                                  },
                                ),
                              ],
                            },
                        ...
                        (0, w.jsxs)(h.PanelBody, {
                          title: (0, n.__)("Content", "woocommerce"),
                          initialOpen: !0,
                          children: [
                            (0, w.jsx)(h.ToggleControl, {
                              label: (0, n.__)(
                                "Show product count",
                                "woocommerce",
                              ),
                              checked: t,
                              onChange: () => o({ hasCount: !t }),
                            }),
                            !l &&
                              (0, w.jsx)(h.ToggleControl, {
                                label: (0, n.__)(
                                ...
                                checked: r,
                                onChange: () => o({ hasImage: !r }),
                              }),
                            (0, w.jsx)(h.ToggleControl, {
                              label: (0, n.__)("Show hierarchy", "woocommerce"),
                              checked: d,
                              onChange: () => o({ isHierarchical: !d }),
                            }),
                            (0, w.jsx)(h.ToggleControl, {
                              label: (0, n.__)(
        ...
        (t(1008),
          ...
          (0, r.registerBlockType)(c, {
              ...
              from: [
                {
                  ...
                  isMatch: ({ idBase: e, instance: o }) =>
                    "woocommerce_product_categories" === e && !!o?.raw,
                  transform: ({ instance: e }) =>
                    (0, r.createBlock)("woocommerce/product-categories", {
                      hasCount: !!e.raw.count,
                      hasEmpty: !e.raw.hide_empty,
                      isDropdown: !!e.raw.dropdown,
                      isHierarchical: !!e.raw.hierarchical,
                    }),
                },
              ],
            },
            deprecated: [
              {
                ...
                save(e) {
                  const {
                    ...
                    s = {};
                  return (
                    o && (s["data-has-count"] = !0),
                    t && (s["data-has-empty"] = !0),
                    r && (s["data-is-dropdown"] = !0),
                    a && (s["data-is-hierarchical"] = !0),
                    (0, w.jsx)("div", {
            ...
            edit: function (e) {
              const o = (0, i.useBlockProps)();
              return (0, w.jsx)("div", {
                ...o,
                children: (0, w.jsx)(g, { ...e }),
              });
            },
            save: () => null,
          }));
  ...
  ((s.m = r),
    ...
    (s.O = (o, t, r, a) => {
      if (!t) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [t, r, a] = e[d], i = !0, n = 0; n < t.length; n++)
            (!1 & a || c >= a) && Object.keys(s.O).every((e) => s.O[e](t[n]))
              ? t.splice(n--, 1)
              : ((i = !1), a < c && (c = a));
          if (i) {
            e.splice(d--, 1);
    ...
    (() => {
      ...
      var o = (o, t) => {
          ...
          for (o && o(t); l < c.length; l++)
            ((a = c[l]), s.o(e, a) && e[a] && e[a][0](), (e[a] = 0));
          return s.O(d);
        },
