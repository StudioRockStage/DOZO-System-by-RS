  ...
  var e,
    ...
    r = {
      2027: (e, o, t) => {
        ...
        var p = t(790);
        function u({ value: e, onChange: o }) {
          return (0, p.jsxs)(c.__experimentalToggleGroupControl, {
            __next40pxDefaultSize: !0,
            __nextHasNoMarginBottom: !0,
            label: (0, a.__)("Arrow", "woocommerce"),
            value: e,
            onChange: o,
            help: (0, a.__)(
        ...
        (t(5398),
          (0, r.registerBlockType)(i, {
            icon: n.A,
            edit: function ({
              attributes: { paginationArrow: e },
              setAttributes: o,
              clientId: t,
            }) {
              const r = (0, s.useSelect)(
                  (e) => {
                    const { getBlocks: o } = e(l.store),
                      r = o(t);
                    return r?.find((e) =>
                      [
                        "woocommerce/product-reviews-pagination-previous",
                ...
                n = (0, l.useBlockProps)(),
                i = (0, l.useInnerBlocksProps)(n, { template: w });
              return (0, s.useSelect)((e) => {
                const { getSettings: o } = e(l.store),
                  { __experimentalDiscussionSettings: t } = o();
                return t?.pageComments;
              }, [])
                ? (0, p.jsxs)(p.Fragment, {
                    children: [
                      r &&
                        (0, p.jsx)(l.InspectorControls, {
                          children: (0, p.jsx)(c.PanelBody, {
                            title: (0, a.__)("Settings", "woocommerce"),
                            children: (0, p.jsx)(u, {
                              value: e,
                              onChange: (e) => {
                                o({ paginationArrow: e });
            ...
            save: function () {
              return (0, p.jsx)(l.InnerBlocks.Content, {});
            },
          }));
      },
      4180: () => {},
    ...
    (i.O = (o, t, r, n) => {
      if (!t) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [t, r, n] = e[p], s = !0, c = 0; c < t.length; c++)
