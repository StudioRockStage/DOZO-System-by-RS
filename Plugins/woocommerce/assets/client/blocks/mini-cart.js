(() => {
  var e,
    ...
    r = {
      6561: (e, o, t) => {
        ...
        var r = t(5573),
          n = t(790);
        const c = (0, n.jsxs)(r.SVG, {
          viewBox: "0 0 24 24",
          version: "1.1",
          id: "svg713",
          xmlns: "http://www.w3.org/2000/svg",
          children: [
            (0, n.jsx)("defs", { id: "defs705" }),
            (0, n.jsx)("path", {
              id: "path882",
        ...
        const _ = [
          ...
          b = ({ children: e, style: o = {}, ...t }) => {
            const r = (0, g.useRef)(null),
              c = () => {
                r.current &&
                  h.focus.focusable.find(r.current).forEach((e) => {
                    (_.includes(e.nodeName) && e.setAttribute("tabindex", "-1"),
                      e.hasAttribute("contenteditable") &&
                        e.setAttribute("contenteditable", "false"));
                  });
              },
              l = (0, w.YQ)(c, 0, { leading: !0 });
            return (
              (0, g.useLayoutEffect)(() => {
                let e;
                return (
                  c(),
                  r.current &&
                    ((e = new window.MutationObserver(l)),
                    e.observe(r.current, {
                      childList: !0,
                      attributes: !0,
                      subtree: !0,
          ...
          j = (0, m.getSetting)("wcBlocksConfig", {
            pluginUrl: "",
            productCount: 0,
            defaultAvatar: "",
            restApiRoutes: {},
          ...
          R =
            (Object.fromEntries(
              Object.keys(T).map((e) => [e, E[e].states || {}]),
            ),
            Object.fromEntries(
              Object.keys(T).map((e) => [e, E[e].locale || {}]),
            ),
            {
              address: [
                "first_name",
        ...
        function A(e) {
          for (; e; ) {
            ...
            if (o && "rgba(0, 0, 0, 0)" !== o && "transparent" !== o) return o;
            e = e.parentElement;
          }
          return "rgb(255, 255, 255)";
        }
        ((0, m.getSetting)("addressFieldsLocations", R).address,
          (0, m.getSetting)("addressFieldsLocations", R).contact,
          (0, m.getSetting)("addressFieldsLocations", R).order,
          (0, m.getSetting)("additionalOrderFields", {}),
          (0, m.getSetting)("additionalContactFields", {}),
          (0, m.getSetting)("additionalAddressFields", {}));
        const P = ({ colorTypes: e, miniCartButtonRef: o }) => {
          const t = (0, d.__experimentalUseMultipleOriginColorsAndGradients)(),
            r = ((e) => {
              const o = [];
              return (
                e.colors &&
                ...
                e.gradients &&
                  e.gradients.forEach((e) => {
                    o.push(...e.gradients);
                  }),
                o
              );
            })(t),
            { clientId: c } = (0, d.useBlockEditContext)(),
            l = (0, f.useSelect)(
              (e) => {
                const { getBlockAttributes: o } = e(d.store);
                return o(c) || {};
              },
              [c],
            ),
            { updateBlockAttributes: i } = (0, f.useDispatch)(d.store),
            a = (0, g.useMemo)(
              () =>
                ((e, o, t, r) =>
                  Object.entries(e).reduce((e, [n, c]) => {
                    var l;
                    const i = ((e, o, t, r) => (n) => {
                        const c =
                          ((e, o, t) => {
                            if (!o) return;
                            const r =
                              e?.find((e) => e.color === o || e.slug === o) ||
                              {};
                            return (
                              r?.color || (r.color = o),
                              (r.class = (0, d.getColorClassName)(t, r?.slug)),
                              r
                            );
                          })(t, n, o) || {};
                        r({ [e]: c });
            ...
            s = (0, g.useMemo)(() => {
              ...
              for (let t = 0; t < a.length; t++) {
                const r = a[t];
                if (!r.colorValue || !o.current) continue;
                const c = A(o.current);
                (0, d.ContrastChecker)({
                  backgroundColor: c,
                  ...
                  e.push(
                    (0, n.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          (0, n.jsx)("p", { children: r.label }),
                          (0, n.jsx)(d.ContrastChecker, {
                            backgroundColor: c,
                            textColor: r.colorValue,
                          }),
                        ],
          ...
          return (
            t.hasColorsOrGradients &&
            (0, n.jsxs)(d.InspectorControls, {
              group: "color",
              children: [
                (0, n.jsx)(d.__experimentalColorGradientSettingsDropdown, {
        ...
        const B = ({
          ...
          M = { name: void 0, color: void 0, slug: void 0 };
        (window.wc.wcTypes, t(274));
        t(3140);
        const V = {
          ...s.supports,
          typography: {
            ...s.supports.typography,
        ...
        ((0, i.registerBlockType)(s, {
          icon: {
            src: (0, n.jsx)(l.A, {
              icon: c,
              className:
                "wc-block-editor-components-block-icon wc-block-editor-mini-cart__icon",
            }),
          },
          supports: { ...V },
          example: { ...s.example },
          ...
          edit: ({ attributes: e, setAttributes: o }) => {
            const {
                cartAndCheckoutRenderStyle: t,
                addToCartBehaviour: r,
                onCartClickBehaviour: c,
                hasHiddenPrice: i,
                priceColor: a = M,
                iconColor: s = M,
                productCountColor: h = M,
                miniCartIcon: w,
                productCountVisibility: _,
              } = (function (e) {
                const o = { ...e };
                return (
                  o.priceColorValue &&
                    !o.priceColor &&
                    ((o.priceColor = { color: e.priceColorValue }),
                    delete o.priceColorValue),
                  o.iconColorValue &&
                    !o.iconColor &&
                    ((o.iconColor = { color: e.iconColorValue }),
                    delete o.iconColorValue),
                  o.productCountColorValue &&
                    !o.productCountColor &&
                    ((o.productCountColor = {
                      color: e.productCountColorValue,
                    }),
                    delete o.productCountColorValue),
                  o
                );
              })(e),
              j = (0, g.useRef)(null),
              O = {
                priceColor: {
                  label: (0, C.__)("Price", "woocommerce"),
                  context: "price-color",
                },
                iconColor: {
                  label: (0, C.__)("Icon", "woocommerce"),
                  context: "icon-color",
                },
                productCountColor: {
                  label: (0, C.__)("Product Count", "woocommerce"),
                  context: "product-count-color",
                },
              },
              E = (0, d.useBlockProps)({ className: "wc-block-mini-cart" }),
              T = (() => {
                const e = (0, f.select)(v.store)?.getCurrentPostType();
                return "wp_template" === e || "wp_template_part" === e;
              })(),
              R = (0, m.getSetting)("templatePartEditUri", "");
            ((e, o) => {
              const t = (0, g.useRef)(null);
              (0, g.useEffect)(() => {
                let r = document.querySelector(".editor-styles-wrapper");
                if (!r) {
                  ...
                  if (!o) return;
                  r = o.querySelector(".editor-styles-wrapper");
                }
                if (!r) return;
                ...
                (a ||
                  ...
                  r.appendChild(a)),
                  (t.current = a));
                const s = o({ editorBackgroundColor: c, editorColor: l });
                a.textContent = s;
                const d = new MutationObserver(() => {
                  const e = window.getComputedStyle(r),
                    ...
                    i = e?.color;
                  if (n !== c || i !== l) {
                    const e = o({ editorBackgroundColor: n, editorColor: i });
                    t.current && (t.current.textContent = e);
                  }
                });
                return (
                  d.observe(r, { attributes: !0, attributeFilter: ["class"] }),
                  () => {
                    (d.disconnect(),
                      t.current &&
                        t.current.parentNode &&
                        t.current.parentNode.removeChild(t.current));
                  }
                );
              }, [o, e]);
            })(
              "mini-cart-badge",
              ({ editorBackgroundColor: e, editorColor: o }) =>
                `\n\t\t\tspan:where(.wc-block-mini-cart__badge) {\n\t\t\t\tcolor: ${e};\n\t\t\t\tbackground-color: ${o};\n\t\t\t}\n\t\t`,
            );
            const A = "never" === _ || "always" === _ ? 0 : 2;
            return (0, n.jsxs)("div", {
              ...E,
              children: [
                (0, n.jsxs)(d.InspectorControls, {
                  children: [
                    (0, n.jsxs)(p.PanelBody, {
                      title: (0, C.__)("Settings", "woocommerce"),
                      children: [
                        (0, n.jsxs)(p.__experimentalToggleGroupControl, {
                          className:
                            "wc-block-editor-mini-cart__cart-icon-toggle",
                          isBlock: !0,
                          label: (0, C.__)("Cart Icon", "woocommerce"),
                          value: w,
                          onChange: (e) => {
                            o({ miniCartIcon: e });
                          },
                          children: [
                            (0, n.jsx)(
                              ...
                              {
                                value: "cart",
                                label: (0, n.jsx)(l.A, { size: 32, icon: x }),
                              },
                            ),
                            (0, n.jsx)(
                              p.__experimentalToggleGroupControlOption,
                              {
                                value: "bag",
                                label: (0, n.jsx)(l.A, { size: 32, icon: y }),
                              },
                            ),
                            (0, n.jsx)(
                              p.__experimentalToggleGroupControlOption,
                              {
                                value: "bag-alt",
                                label: (0, n.jsx)(l.A, { size: 32, icon: k }),
                              },
                            ),
                          ],
                        }),
                        (0, n.jsx)(p.BaseControl, {
                          id: "wc-block-mini-cart__display-toggle",
                          label: (0, C.__)("Display", "woocommerce"),
                          children: (0, n.jsx)(p.ToggleControl, {
                            label: (0, C.__)(
                              "Display total price",
                              "woocommerce",
                            ),
                        ...
                        (0, n.jsx)(p.BaseControl, {
                          ...
                          children: (0, n.jsx)(p.RadioControl, {
                            className:
                              "wc-block-mini-cart__product-count-radiocontrol",
                            selected: _,
                            options: [
                              {
                                label: (0, C.__)(
                              ...
                              {
                                label: (0, C.__)("Never", "woocommerce"),
                                value: "never",
                              },
                            ],
                            help: (0, C.__)(
                            ...
                            onChange: (e) => o({ productCountVisibility: e }),
                          }),
                        }),
                        T &&
                          (0, n.jsxs)(p.__experimentalToggleGroupControl, {
                            ...
                            value: t,
                            onChange: (e) => {
                              o({ cartAndCheckoutRenderStyle: e });
                            },
                            help: (0, C.__)(
                            ...
                            children: [
                              ...
                              (0, n.jsx)(
                                ...
                                {
                                  value: "removed",
                                  label: (0, C.__)("Remove", "woocommerce"),
                                },
                              ),
                            ],
                          }),
                    ...
                    (0, n.jsxs)(p.PanelBody, {
                      title: (0, C.__)("Cart Drawer", "woocommerce"),
                      children: [
                        R &&
                          (0, n.jsxs)(n.Fragment, {
                            children: [
                              (0, n.jsx)("img", {
                                ...
                                src: (0, C.isRTL)()
                                  ? `${S}blocks/mini-cart/cart-drawer-rtl.svg`
                                  : `${S}blocks/mini-cart/cart-drawer.svg`,
                                alt: "",
                              }),
                              (0, n.jsx)("p", {
                                children: (0, C.__)(
                              ...
                              (0, n.jsx)("p", {
                                ...
                                children: (0, n.jsx)(p.ExternalLink, {
                                  href: R,
                                  children: (0, C.__)(
                        ...
                        (0, n.jsxs)(p.BaseControl, {
                          id: "wc-block-mini-cart__add-to-cart-behaviour-toggle",
                          label: (0, C.__)("Behavior", "woocommerce"),
                          children: [
                            (0, n.jsx)(p.ToggleControl, {
                              label: (0, C.__)(
                            ...
                            (0, n.jsx)(p.ToggleControl, {
                              ...
                              checked: "navigate_to_checkout" === c,
                            }),
                          ],
                        }),
                      ],
                ...
                (0, n.jsx)(P, { colorTypes: O, miniCartButtonRef: j }),
                (0, n.jsx)(b, {
          ...
          (0, a.addFilter)(
            ...
            function (e, o) {
              return "core/template-part" === o
                ? {
                    ...e,
                    variations: e.variations.map((e) =>
                      "area_mini-cart" === e.name ? { ...e, scope: [] } : e,
                    ),
                  }
                : e;
            },
  ...
  function c(e) {
    ...
    var t = (n[e] = { exports: {} });
    return (r[e](t, t.exports, c), t.exports);
  }
  ((c.m = r),
    (e = []),
    (c.O = (o, t, r, n) => {
      if (!t) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [t, r, n] = e[d], i = !0, a = 0; a < t.length; a++)
            (!1 & n || l >= n) && Object.keys(c.O).every((e) => c.O[e](t[a]))
              ? t.splice(a--, 1)
              : ((i = !1), n < l && (l = n));
          if (i) {
            e.splice(d--, 1);
    ...
    (c.t = function (e, r) {
      ...
      var l = {};
      o = o || [null, t({}), t([]), t(t)];
      for (var i = 2 & r && e; "object" == typeof i && !~o.indexOf(i); i = t(i))
        Object.getOwnPropertyNames(i).forEach((o) => (l[o] = () => e[o]));
    ...
    (() => {
      ...
      var o = (o, t) => {
          ...
          for (o && o(t); s < l.length; s++)
            ((n = l[s]), c.o(e, n) && e[n] && e[n][0](), (e[n] = 0));
          return c.O(d);
        },
  ...
  var l = c.O(void 0, [94], () => c(6561));
  ((l = c.O(l)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})["mini-cart"] =
      l));
})();
