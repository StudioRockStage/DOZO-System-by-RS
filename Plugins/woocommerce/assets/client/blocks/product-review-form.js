    ...
    o = {
      9547: (e, t, r) => {
        ...
        const v = () => {
            ...
            return (0, w.jsxs)("div", {
              children: [
                (0, w.jsx)("span", {
                  ...
                  role: "heading",
                  "aria-level": 3,
                  children: (0, d.__)("Add a review", "woocommerce"),
                }),
                (0, w.jsxs)("form", {
                  noValidate: !0,
                  ...
                  children: [
                    (0, w.jsxs)("div", {
                      ...
                      children: [
                        (0, w.jsx)("span", {
                          children: (0, d.__)("Your rating *", "woocommerce"),
                        }),
                        (0, w.jsx)("p", {
                          className:
                    ...
                    (0, w.jsxs)("p", {
                      children: [
                        (0, w.jsx)("label", {
                          htmlFor: `review-${e}`,
                          children: (0, d.__)("Your review *", "woocommerce"),
                        }),
                        (0, w.jsx)("textarea", {
                          id: `review-${e}`,
                          name: "review",
                    ...
                    (0, w.jsx)("p", {
                      ...
                      children: (0, w.jsx)("input", {
                        ...
                        className: (0, s.A)(
                          ...
                          (0, c.__experimentalGetElementClassName)("button"),
                        ),
                        value: (0, d.__)("Submit", "woocommerce"),
                        "aria-disabled": "true",
                      }),
                    }),
                  ],
          ...
          f = ({ postId: e, postType: t }) => {
            const { updateProduct: r } = (0, u.useDispatch)(m.productsStore),
              o = (0, u.useSelect)(
                (t) => (e ? t(m.productsStore).getProduct(Number(e)) : null),
                [e],
              ),
              i = void 0 === t || void 0 === e,
              n = (0, u.useSelect)(
                (e) => !!t && !!e(p.store).getPostType(t)?.supports.comments,
                [t],
              );
            if (!i && o && !o?.reviews_allowed) {
              const t = [
                (0, w.jsx)(
                  a.Button,
                  {
                    ...
                    onClick: () =>
                      void (e && r(Number(e), { reviews_allowed: true })),
                    variant: "primary",
                    children: (0, d._x)(
                      "Enable reviews",
            ...
            return n
              ? (0, w.jsx)(a.Disabled, { children: (0, w.jsx)(v, {}) })
              : (0, w.jsx)(c.Warning, {
                  children: (0, d.__)(
        ...
        (0, o.registerBlockType)(n, {
          icon: i.A,
          edit: function e({ attributes: t, context: r, setAttributes: o }) {
            const { textAlign: i } = t,
              { postId: n, postType: u } = r,
              p = (0, l.useInstanceId)(e),
              m = (0, d.sprintf)("comments-form-edit-%d-desc", p),
              v = (0, c.useBlockProps)({
                className: (0, s.A)("comment-respond", {
                  [`has-text-align-${i}`]: i,
                }),
                "aria-describedby": m,
              });
            return (0, w.jsxs)(w.Fragment, {
              children: [
                (0, w.jsx)(c.BlockControls, {
                  group: "block",
                  children: (0, w.jsx)(c.AlignmentControl, {
                    value: i,
                    onChange: (e) => {
                      o({ textAlign: e });
                    },
                ...
                (0, w.jsxs)("div", {
                  ...v,
                  children: [
                    (0, w.jsx)(f, { postId: n, postType: u }),
                    (0, w.jsx)(a.VisuallyHidden, {
                      id: m,
                      children: (0, d.__)(
                        "Reviews form disabled in editor.",
                        "woocommerce",
                      ),
                    }),
                  ],
    ...
    (n.O = (t, r, o, i) => {
      if (!r) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [r, o, i] = e[d], c = !0, a = 0; a < r.length; a++)
            (!1 & i || s >= i) && Object.keys(n.O).every((e) => n.O[e](r[a]))
              ? r.splice(a--, 1)
              : ((c = !1), i < s && (s = i));
          if (c) {
            e.splice(d--, 1);
