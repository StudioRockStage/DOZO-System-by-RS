        ...
        (0, r.registerBlockType)(d, {
          ...
          edit: ({ attributes: e, setAttributes: o }) => {
            const t = (0, n.useBlockProps)(),
              r = (0, a.getSetting)("storeHasDownloadableProducts");
            return (0, l.jsx)("div", {
              ...t,
              className: (0, c.A)(t.className, { "store-has-downloads": r }),
              children: (0, l.jsx)(n.InnerBlocks, {
          ...
          save: () => (0, l.jsx)(n.InnerBlocks.Content, {}),
          attributes: p,
        });
      },
      4968: () => {},
  ...
  ((s.m = r),
    ...
    (s.O = (o, t, r, n) => {
      if (!t) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [t, r, n] = e[d], a = !0, c = 0; c < t.length; c++)
            (!1 & n || i >= n) && Object.keys(s.O).every((e) => s.O[e](t[c]))
              ? t.splice(c--, 1)
              : ((a = !1), n < i && (i = n));
          if (a) {
            e.splice(d--, 1);
    ...
    (s.t = function (e, r) {
      ...
      for (var a = 2 & r && e; "object" == typeof a && !~o.indexOf(a); a = t(a))
        Object.getOwnPropertyNames(a).forEach((o) => (i[o] = () => e[o]));
      return ((i.default = () => e), s.d(n, i), n);
    }),
    (s.d = (e, o) => {
      for (var t in o)
        s.o(o, t) &&
    ...
    (() => {
      ...
      var o = (o, t) => {
          ...
          for (o && o(t); l < i.length; l++)
            ((n = i[l]), s.o(e, n) && e[n] && e[n][0](), (e[n] = 0));
          return s.O(d);
        },
