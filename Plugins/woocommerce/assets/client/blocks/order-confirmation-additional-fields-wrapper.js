    ...
    r = {
      3392: (e, t, o) => {
        ...
        const s = window.wc.wcSettings,
          c = (0, s.getSetting)("wcBlocksConfig", {
            pluginUrl: "",
            productCount: 0,
            defaultAvatar: "",
            restApiRoutes: {},
          ...
          u =
            ((0, s.getSetting)("addressFieldsLocations", g).address,
            (0, s.getSetting)("addressFieldsLocations", g).contact,
            (0, s.getSetting)("addressFieldsLocations", g).order,
            (0, s.getSetting)("additionalOrderFields", {})),
          f = (0, s.getSetting)("additionalContactFields", {});
        ((0, s.getSetting)("additionalAddressFields", {}), o(9970));
        var m = o(790);
        const w = JSON.parse(
        ...
        (0, r.registerBlockType)(w, {
          ...
          edit: ({ attributes: e, setAttributes: t }) => {
            const o = (0, i.useBlockProps)({
              ...
              r = { ...u, ...f };
            return 0 === Object.entries(r).length
              ? null
              : (0, m.jsx)("div", {
                  ...o,
                  children: (0, m.jsx)(i.InnerBlocks, {
          ...
          save: () => (0, m.jsx)(i.InnerBlocks.Content, {}),
          attributes: b,
        });
      },
      9970: () => {},
    ...
    (n.O = (t, o, r, i) => {
      if (!o) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [o, r, i] = e[d], s = !0, c = 0; c < o.length; c++)
            (!1 & i || a >= i) && Object.keys(n.O).every((e) => n.O[e](o[c]))
              ? o.splice(c--, 1)
              : ((s = !1), i < a && (a = i));
          if (s) {
            e.splice(d--, 1);
