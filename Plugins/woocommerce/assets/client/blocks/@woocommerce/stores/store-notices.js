  ...
  { state: s } = (0, o.store)(
    "woocommerce/store-notices",
    {
      state: {
        get role() {
          const t = n();
          return "error" === t.notice.type || "success" === t.notice.type
            ? "alert"
            : "status";
        },
        get iconPath() {
          const t = n().notice.type;
          return r[t];
        },
        get isError() {
          const { notice: t } = n();
        ...
        get notices() {
          const t = (0, o.getContext)("woocommerce/product-collection");
          if (t) return t?.notices;
          const e = n();
          return e && e.notices ? e.notices : [];
        },
      },
      actions: {
        addNotice: (t) => {
          const { notices: e } = s,
            o = e.find((e) => e.notice === t.notice),
            n = o
              ? o.id
              : `${Date.now()}-${Math.random().toString(36).substring(2, 15)}`;
          return (o || e.push({ ...t, id: n }), n);
        },
        removeNotice: (t) => {
          const { notices: e } = s;
          t = "string" == typeof t ? t : n().notice.id;
          const o = e.findIndex(({ id: e }) => e === t);
          -1 !== o && e.splice(o, 1);
        },
      },
      callbacks: {
        renderNoticeContent: () => {
          const t = n(),
            { ref: e } = (0, o.getElement)();
          e && (e.innerHTML = t.notice.notice);
        },
        scrollIntoView: () => {
          const { ref: t } = (0, o.getElement)();
