    ...
    r = {
      3327: (e, o, t) => {
        ...
        const i = (0, n.jsxs)(s.SVG, {
          ...
          l = JSON.parse(
            '{"name":"woocommerce/product-results-count","title":"Product Results Count","description":"Display the number of products on the archive page or search result page.","category":"woocommerce","keywords":["WooCommerce"],"supports":{"interactivity":{"clientNavigation":true},"color":{"text":true,"background":false},"typography":{"fontSize":true}},"attributes":{},"usesContext":["queryId"],"textdomain":"woocommerce","apiVersion":3,"$schema":"https://schemas.wp.org/trunk/block.json"}',
          ),
  ...
  ((s.m = r),
    ...
    (s.O = (o, t, r, c) => {
      if (!t) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [t, r, c] = e[u], i = !0, l = 0; l < t.length; l++)
            (!1 & c || n >= c) && Object.keys(s.O).every((e) => s.O[e](t[l]))
              ? t.splice(l--, 1)
              : ((i = !1), c < n && (n = c));
          if (i) {
            e.splice(u--, 1);
    ...
    (s.t = function (e, r) {
      ...
      for (var i = 2 & r && e; "object" == typeof i && !~o.indexOf(i); i = t(i))
        Object.getOwnPropertyNames(i).forEach((o) => (n[o] = () => e[o]));
