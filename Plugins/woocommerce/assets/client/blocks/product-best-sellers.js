    ...
    s = {
      9955: (e, t, r) => {
        ...
        const b = window.wp.htmlEntities,
            ...
            return e
              ...
              .map((e, t) =>
                r.test(e)
                  ...
                  : (0, m.jsx)(E.Fragment, { children: e }, t),
              );
          },
          C = ({ label: e }) =>
            (0, m.jsx)("span", {
            ...
            return (0, m.jsxs)("span", {
              ...
              children: [
                ...
                (0, m.jsx)("span", {
                  ...
                  children: v((0, b.decodeEntities)(t.name), r),
                }),
              ],
            });
            var o;
          ...
          S = ({
            ...
            const [x, g] = h,
              ...
              y = !!o.children?.length,
              _ = x === o.id,
              S = (0, f.A)(["woocommerce-search-list__item", `depth-${r}`, t], {
                "has-breadcrumbs": w,
                "has-children": y,
                "has-count": p,
                "is-expanded": _,
                  ...
                  children: c
                    ? (0, m.jsxs)(m.Fragment, {
                        children: [
                          ...
                          (0, m.jsx)(k, { item: o, search: a }),
                          p ? (0, m.jsx)(C, { label: e || o.count }) : null,
                        ],
                      })
                    : (0, m.jsxs)(m.Fragment, {
                        children: [
                          (0, m.jsx)(l.CheckboxControl, {
                            className: "woocommerce-search-list__item-input",
                            checked: i,
                            ...(!i &&
        ...
        const R = ({
            ...
            const [n, a] = (0, E.useState)(!1),
              d = (0, P.useInstanceId)(R);
            if (((i = i || t), !t)) return null;
            t = (0, b.decodeEntities)(t);
            const h = (0, f.A)("woocommerce-tag", c, { "has-remove": !!o }),
              x = `woocommerce-tag__label-${d}`,
            ...
            return (0, m.jsxs)("span", {
              ...
              children: [
                ...
                r &&
                  n &&
                  (0, m.jsx)(l.Popover, { onClose: () => a(!1), children: r }),
                o &&
                  (0, m.jsx)(l.Button, {
        ...
        const B = (e) => (0, m.jsx)(N, { ...e }),
            ...
            return (0, m.jsxs)("div", {
              ...
              children: [
                (0, m.jsxs)("div", {
                  ...
                  children: [
                    (0, m.jsx)("strong", { children: s.selected(c) }),
                    c > 0
                      ? (0, m.jsx)(l.Button, {
                          variant: "link",
                          isDestructive: !0,
                          onClick: () => o([]),
                          "aria-label": s.clear,
                          children: (0, u.__)("Clear all", "woocommerce"),
                        })
                      : null,
                  ],
                }),
              ...
              ? (0, m.jsxs)("div", {
                  ...
                  children: [
                    (0, m.jsx)("span", {
                      ...
                      children: (0, m.jsx)(s.A, { icon: O.A, role: "img" }),
                    }),
                    (0, m.jsx)("span", {
                      className: "woocommerce-search-list__not-found-text",
                      children: t ? (0, u.sprintf)(n.noResults, t) : n.noItems,
                    }),
                  ],
                })
              : (0, m.jsx)("ul", {
          ...
          M = (e) => {
            ...
            return (0, m.jsxs)("div", {
              ...
              children: [
                "text" === x &&
                  (0, m.jsx)(T, { ...e, onRemove: k, messages: v }),
                (0, m.jsx)("div", {
                  className: "woocommerce-search-list__search",
                  children:
                    "text" === x
                      ? (0, m.jsx)(l.TextControl, {
                          label: v.search,
                          type: "search",
                          value: p,
                          onChange: (e) => w(e),
                        })
                      : (0, m.jsx)(l.FormTokenField, {
                          disabled: o,
                          label: v.search,
                          onChange: N,
                          onInputChange: (e) => w(e),
          ...
          L = ((0, l.withSpokenMessages)(M), window.wp.url),
        ...
        const D = window.wp.escapeHtml,
              ...
              ? "general" === t
                ? (0, m.jsxs)("span", {
                    children: [
                      ...
                      (0, m.jsx)("br", {}),
                      (0, m.jsx)("code", { children: (0, D.escapeHTML)(e) }),
                    ],
                  })
                : "api" === t
                  ? (0, m.jsxs)("span", {
          ...
          z = (e) => {
            const { id: t, name: r, parent: s, count: o } = e;
            return {
              id: t,
              name: r,
              parent: s,
        ...
        const G =
            ((Y = ({
              ...
              const h = {
                clear: (0, u.__)("Clear all product categories", "woocommerce"),
                list: (0, u.__)("Product Categories", "woocommerce"),
                noItems: (0, u.__)(
              ...
              return (0, m.jsxs)(m.Fragment, {
                children: [
                  (0, m.jsx)(M, {
                    ...
                    list: x,
                    isLoading: r,
                    selected: x.filter(({ id: e }) => c.includes(Number(e))),
                    onChange: s,
                    renderItem: (e) => {
                      const { item: t, search: r, depth: s = 0 } = e,
                        o = t.breadcrumbs.length
                  ...
                  !!o &&
                    (0, m.jsx)("div", {
                      hidden: c.length < 2,
                      children: (0, m.jsx)(l.SelectControl, {
          ...
          K = (e) => {
            ...
            return (0, m.jsxs)(
              n.InspectorControls,
              {
                children: [
                  (0, m.jsx)(l.PanelBody, {
                    title: (0, u.__)("Layout", "woocommerce"),
                    initialOpen: !0,
                    children: (0, m.jsx)(g, {
                      columns: i,
                      rows: a,
                  ...
                  (0, m.jsx)(l.PanelBody, {
                    title: (0, u.__)("Content", "woocommerce"),
                    initialOpen: !0,
                    children: (0, m.jsx)(w, {
                      settings: c,
            ...
            return t.isPreview
              ...
              : (0, m.jsxs)("div", {
                  ...
                  children: [
                    (0, m.jsx)(K, { ...e }),
                    (0, m.jsx)(l.Disabled, {
                      children: (0, m.jsx)(d(), { block: r, attributes: t }),
                    }),
                  ],
                });
          },
          X = {
            columns: {
              type: "number",
              default: (0, p.getSetting)("defaultColumns", 3),
            },
            rows: {
              type: "number",
              default: (0, p.getSetting)("defaultRows", 3),
            },
            ...
            from: [
              {
                ...
                transform: (e) =>
                  (0, i.createBlock)("woocommerce/product-best-sellers", e),
              },
            ],
          },
          edit: (e) => {
