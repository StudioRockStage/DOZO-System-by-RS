(() => {
    ...
    o = {
      3343: (e, t, r) => {
              ...
              ? "general" === t
                ? (0, p.jsxs)("span", {
                    children: [
                      ...
                      (0, p.jsx)("br", {}),
                      (0, p.jsx)("code", { children: (0, h.escapeHTML)(e) }),
                    ],
                  })
                : "api" === t
                  ? (0, p.jsxs)("span", {
        ...
        const g = ({
          ...
          (0, p.jsxs)(c.Placeholder, {
            icon: (0, p.jsx)(s.A, { icon: w.A }),
          ...
          _ = ({
            ...
            return !a && n
              ? ((i = r || "span"),
                (o = {
                  ...o,
                  className: (0, m.A)(o.className, "screen-reader-text"),
                }),
                (0, p.jsx)(i, { ...o, children: t }))
              : ((i = r || l.Fragment),
                a && n && e !== t
                  ? (0, p.jsxs)(i, {
                      ...o,
          ...
          y = ({
            ...
            (0, p.jsx)("div", {
              ...
              children: (0, p.jsx)("button", {
                ...
                onClick: e,
                children: (0, p.jsx)(_, { label: t, screenReaderLabel: r }),
              }),
            }),
          f = window.wc.blocksComponents;
        r(6878);
        const R = ({ onChange: e, readOnly: t, value: r }) =>
          (0, p.jsx)(f.SortSelect, {
            className:
        ...
        function x(e) {
          ...
          for (let i = 0; i < e.length; i++)
            ((t = e.substring(i)),
              (r = t.match(/^&[a-z0-9#]+;/)),
              r ? ((o = r[0]), s.push(o), (i += o.length - 1)) : s.push(e[i]));
          return s;
        }
        const j = (e, t, r = "...") => {
                ...
                if ("<" !== d[0])
                  if (v >= r) d = "";
                    ...
                    if (((w = r - v), " " === t[w - 1]))
                      ...
                      ((m = t.slice(w).indexOf(" ")),
                        s || (-1 !== m ? (w += m) : (w = d.length)));
                    if (((d = t.slice(0, w).join("") + i), a)) {
                  ...
                  if (v >= r)
                    if (((p = d.match(/[a-zA-Z]+/)), (u = p ? p[0] : ""), u))
                      if ("</" !== d.substring(0, 2)) (g.push(u), (d = ""));
                      else {
                        for (; g[g.length - 1] !== u && g.length; ) g.pop();
                        (g.length && (d = ""), g.pop());
                      }
                    else d = "";
                } else d = "";
            ...
            const s = ((e, t, r) => {
              ...
              for (; o.start <= o.end; )
                ((o.middle = Math.floor((o.start + o.end) / 2)),
                  (t.innerHTML = j(e, o.middle)),
                  (o = k(o, t.clientHeight, r)));
              return o.middle;
            })(e, t, r);
            return j(e, s - o.length, o);
          },
          O = {
        ...
        class T extends l.Component {
          ...
          constructor(e) {
            (super(e),
              ...
              (this.reviewContent = (0, l.createRef)()),
              (this.reviewSummary = (0, l.createRef)()),
        ...
        function A(e, t) {
          return (0, p.jsx)("div", {
            ...
            children: (0, p.jsx)("a", {
              ...
              "aria-labelledby": t,
              children: (0, L.decodeEntities)(e.product_name),
            }),
          });
        }
        function E(e) {
        ...
        function I(e, t) {
          ...
          return (0, p.jsx)("div", {
            id: t,
            "aria-label": `${(0, L.decodeEntities)(e.product_name)} ${s}`,
            className:
        ...
        r(5183);
        const B = ({ attributes: e, reviews: t }) => {
          const r = (0, d.getSetting)("showAvatars", !0),
            o = (0, d.getSetting)("reviewRatingsEnabled", !0),
            s = (r || "product" === e.imageType) && e.showReviewImage,
            i = o && e.showReviewRating,
            a = { ...e, showReviewImage: s, showReviewRating: i };
          return (0, p.jsx)("ul", {
            className: "wc-block-review-list wc-block-components-review-list",
            children:
              0 === t.length
                ? (0, p.jsx)(D, { attributes: a })
                : t.map((e, t) =>
                    (0, p.jsx)(D, { attributes: a, review: e }, e.id || t),
                  ),
          });
        };
        var H = r(923),
          F = r.n(H);
        const G = window.wp.apiFetch;
        var W = r.n(G);
        const $ = (e) => {
            const {
              className: t,
          ...
          J = (e) => {
            const {
              ...
              l = {
                ...
                "data-reviews-on-load-more": a,
                "data-show-load-more": n,
                "data-show-orderby": c,
              };
            return (
        ...
        class U extends l.Component {
          render() {
            ...
            if (0 === s.length && !r) return (0, p.jsx)(o, { attributes: e });
            const a = (0, d.getSetting)("reviewRatingsEnabled", !0);
            return (0, p.jsxs)(c.Disabled, {
              children: [
                e.showOrderby &&
                  a &&
                  (0, p.jsx)(R, {
                ...
                (0, p.jsx)(B, { attributes: e, reviews: s }),
                e.showLoadMore &&
                  i > s.length &&
                  (0, p.jsx)(y, {
        ...
        const z = ((e) => {
            ...
            class r extends l.Component {
              ...
              getArgs(e) {
                const {
                  ...
                  a = { order: r, orderby: o, per_page: i - e, offset: e };
                if (t) {
                  const e = Array.isArray(t) ? t : JSON.parse(t);
                  a.category_id = Array.isArray(e) ? e.join(",") : e;
                }
                return (s && (a.product_id = s), a);
              }
              replaceReviews() {
                var e;
              ...
              appendReviews() {
                ...
                const t =
                  ...
                  { reviews: o } = this.state;
                r <= o.length || this.updateListOfReviews(o).then(t);
              }
              ...
              setError = async (e) => {
                ...
                (this.setState({ reviews: [], loading: !1, error: o }), r(o));
              };
              render() {
                const { reviewsToDisplay: t } = this.props,
                  {
            ...
            const { displayName: o = e.name || "Component" } = e;
            return ((r.displayName = `WithReviews(${o})`), r);
          })(U),
          V = ({
            attributes: e,
            icon: t,
          ...
          q = () =>
            (0, p.jsx)(c.Placeholder, {
              ...
              label: (0, n.__)("All Reviews", "woocommerce"),
              children: (0, n.__)(
            ...
            return (0, p.jsxs)(p.Fragment, {
              children: [
                ...
                e.showReviewImage &&
                  (0, p.jsxs)(p.Fragment, {
                    children: [
                      (0, p.jsxs)(c.__experimentalToggleGroupControl, {
                        label: (0, n.__)("Review image", "woocommerce"),
                        isBlock: !0,
                        value: e.imageType,
                        onChange: (e) => t({ imageType: e }),
                        children: [
                          (0, p.jsx)(c.__experimentalToggleGroupControlOption, {
                            value: "reviewer",
          ...
          Z = ({ attributes: e, setAttributes: t }) =>
            (0, p.jsxs)(p.Fragment, {
              children: [
                (0, p.jsxs)(
                  a.InspectorControls,
                  {
                    children: [
                      (0, p.jsxs)(c.PanelBody, {
                        ...
                        children: [
                          (0, p.jsx)(c.ToggleControl, {
                            label: (0, n.__)("Product name", "woocommerce"),
                            checked: e.showProductName,
                            onChange: () =>
                              t({ showProductName: !e.showProductName }),
                          }),
                          X(e, t),
                        ],
                      }),
                ...
                (0, p.jsx)(V, {
                  ...
                  name: (0, n.__)("All Reviews", "woocommerce"),
                  noReviewsPlaceholder: q,
                }),
              ],
            }),
          K = (0, d.getSetting)("wcBlocksConfig", {
            pluginUrl: "",
            productCount: 0,
            defaultAvatar: "",
            restApiRoutes: {},
          ...
          ee = (0, d.getSetting)("countryData", {}),
          te = {
            ...Object.fromEntries(
              Object.keys(ee)
                .filter((e) => !0 === ee[e].allowBilling)
                .map((e) => [e, Q[e] || ""]),
            ),
            ...Object.fromEntries(
              Object.keys(ee)
                .filter((e) => !0 === ee[e].allowShipping)
                .map((e) => [e, Q[e] || ""]),
            ),
          },
          re =
            (Object.fromEntries(
              Object.keys(te).map((e) => [e, ee[e].states || {}]),
            ),
            Object.fromEntries(
              Object.keys(te).map((e) => [e, ee[e].locale || {}]),
            ),
            {
              address: [
                "first_name",
          ...
          se = JSON.parse(
            '{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"woocommerce/all-reviews","title":"All Reviews","category":"woocommerce","keywords":["WooCommerce"],"description":"Show a list of all product reviews.","textdomain":"woocommerce","supports":{"html":false,"interactivity":{"clientNavigation":true},"color":{"background":false},"typography":{"fontSize":true}}}',
          );
        (0, o.registerBlockType)(se, {
          icon: {
            src: (0, p.jsx)(s.A, {
              icon: i.A,
          ...
          example: {
            ...oe,
            attributes: { ...oe.attributes, showProductName: !0 },
          },
          attributes: {
            ...
            from: [
              {
                ...
                isMatch: ({ idBase: e, instance: t }) =>
                  "woocommerce_recent_reviews" === e && !!t?.raw,
                transform: ({ instance: e }) =>
                  (0, o.createBlock)("woocommerce/all-reviews", {
          ...
          save: ({ attributes: e }) =>
            (0, p.jsx)("div", {
              ...a.useBlockProps.save({ className: $(e) }),
              ...J(e),
            }),
        });
      },
  ...
  var a = i.O(void 0, [94], () => i(3343));
  ((a = i.O(a)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {})["all-reviews"] =
      a));
})();
