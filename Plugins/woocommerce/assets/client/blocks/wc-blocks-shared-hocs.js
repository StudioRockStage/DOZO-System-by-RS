(() => {
  ...
  (e.r(t),
    e.d(t, {
      withFilteredAttributes: () => f,
      withProductDataContext: () => h,
    }));
  ...
  const u = window.wc.wcTypes,
    i = (e) => {
      const t = { namespace: "/wc/store/v1", resourceName: "products" },
        { results: s, isLoading: a } = ((e) => {
          ...
          return (null !== f && (l.current = f), l.current);
        })({ ...t, query: e }),
        { value: i } = ((e, t) => {
          const {
            namespace: n,
          ...
          const i = c(u),
            d = c(a),
            { value: l, isLoading: p = !0 } = (0, o.useSelect)(
              (t) => {
                const o = t(r.COLLECTIONS_STORE_KEY),
                  a = [e, n, s, i, d];
                return {
                  value: o.getCollectionHeader(...a),
                  isLoading: o.hasFinishedResolution("getCollectionHeader", a),
                };
              },
              [e, n, s, d, i],
            );
          return { value: l, isLoading: p };
        })("x-wp-total", { ...t, query: e });
      return {
        products: s,
        totalProducts: parseInt(i, 10),
        productsLoading: a,
      };
    },
    ...
    w = (e) => {
      const {
        ...
        a = ((e, t, r) => (e ? r : t || r))(s, t, o),
        { products: c, productsLoading: u } = i({ include: a }),
        w = { product: a > 0 && c.length > 0 ? p(c, a) : null, isLoading: u };
      return n
        ? (0, l.jsx)(d.ProductDataContextProvider, {
            product: n,
            isLoading: !1,
    ...
    h = (e) => (t) => {
      const r = (0, d.useProductDataContext)({
        isAdmin: t.isAdmin,
        product: t.product,
      });
      return (!t.product && r.hasContext) || t.isAdmin
        ? (0, l.jsx)(e, { ...t })
        : (0, l.jsx)(w, { ...t, OriginalComponent: e });
    },
    f = (e) => (t) => (r) => {
      const o = ((e, t) => {
        const r = [];
