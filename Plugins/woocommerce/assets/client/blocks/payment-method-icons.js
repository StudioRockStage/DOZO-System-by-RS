  ...
  ((() => {
    ...
    const e = window.wp.blocks,
      ...
      c = (0, s.jsxs)(o.SVG, {
        ...
        viewBox: "0 0 24 24",
        children: [
          (0, s.jsx)("path", { fill: "none", d: "M0 0h24v24H0z" }),
          (0, s.jsx)("path", {
      ...
      a = ({ type: e, icon: o }) => {
        ...
        return (
          e &&
            o &&
            (n = (0, s.jsx)("div", {
              className: "wc-block-payment-method-icons__item",
    ...
    (n(5151),
      (0, e.registerBlockType)(t, {
        icon: { src: (0, s.jsx)(o.Icon, { icon: c }) },
        edit: ({ attributes: e, setAttributes: n }) => {
          const t = (0, r.useBlockProps)(),
            c = window.wcSettings?.availablePaymentMethods || {},
            { numberOfIcons: m } = e;
          if (c && Object.keys(c).length > 0) {
            const e = Object.keys(c).reduce(
                (e, o) =>
                  c[o] && c[o].icon
                    ? (e.push({ type: o, icon: c[o].icon }), e)
                    : e,
                [],
              ),
              l = 0 === m ? e.length : Math.min(m, e.length);
            return (0, s.jsxs)("div", {
              ...t,
              children: [
                (0, s.jsx)(r.InspectorControls, {
                  children: (0, s.jsx)(o.PanelBody, {
                    title: (0, i.__)(
                      "Payment Method Icon Settings",
                      "woocommerce",
                    ),
                    children: (0, s.jsx)(o.RangeControl, {
                      label: (0, i.__)("Number of icons", "woocommerce"),
                      value: m,
                      onChange: (e) => n({ numberOfIcons: e || 0 }),
                      min: 0,
                      max: e.length,
                      help: (0, i.__)(
                ...
                (0, s.jsx)("div", {
                  className: "wc-block-payment-method-icons",
                  children: e
                    .slice(0, l)
                    .map((e) =>
                      (0, s.jsx)(a, { type: e?.type, icon: e?.icon }, e?.type),
                    ),
                }),
              ],
            });
