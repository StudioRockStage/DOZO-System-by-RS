(() => {
  ...
  ((0, e.registerBlockType)(c, {
    ...
    edit: () => {
      const e = (0, r.useInnerBlocksProps)(
      ...
      return (0, o.jsx)("div", { ...c, children: (0, o.jsx)("div", { ...e }) });
    },
    save: () => {
      const e = r.useBlockProps.save({
          className: "wc-block-product-gallery-large-image__inner-blocks",
        }),
        c = r.useInnerBlocksProps.save(e);
      return (0, o.jsx)("div", { ...c });
    },
  }),
