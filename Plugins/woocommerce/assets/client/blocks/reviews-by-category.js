      ...
      2: (e, t, o) => {
        ...
        const u = {
          ...
          p = (e, t = e) => {
            ...
            const s = ["0"],
              i = (e = {}) =>
                e.parent ? [...i(r[e.parent]), e.name] : e.name ? [e.name] : [],
              n = (e) =>
                e.map((e) => {
                  const t = o[e.id];
                  return (
            ...
            return (0, h.jsxs)("span", {
              ...
              children: [
                ...
                (0, h.jsx)("span", {
                  ...
                  children: g((0, w.decodeEntities)(t.name), o),
                }),
              ],
            });
            var s;
          ...
          b = ({
            ...
            const [y, f] = b,
              j = null != e && void 0 !== s.count && null !== s.count,
              R = !!s.breadcrumbs?.length,
              k = !!s.children?.length,
              S = y === s.id,
              C = (0, l.A)(["woocommerce-search-list__item", `depth-${o}`, t], {
                "has-breadcrumbs": R,
                "has-children": k,
                "has-count": j,
                "is-expanded": S,
            ...
            const N = x.name || `search-list-item-${r}`,
              T = `${N}-${s.id}`,
              O = (0, d.useCallback)(() => {
                f(S ? -1 : Number(s.id));
              }, [S, s.id, f]);
                  ...
                  children: n
                    ? (0, h.jsxs)(h.Fragment, {
                        children: [
                          ...
                          (0, h.jsx)(_, { item: s, search: u }),
                          j ? (0, h.jsx)(v, { label: e || s.count }) : null,
                        ],
                      })
                    : (0, h.jsxs)(h.Fragment, {
                        children: [
                          (0, h.jsx)(c.CheckboxControl, {
                            ...
                            checked: i,
                            ...(!i &&
                            s.children.some((e) => p.find((t) => t.id === e.id))
                              ? { indeterminate: !0 }
                              : {}),
                            label: g((0, w.decodeEntities)(s.name), u),
                            onChange: () => {
                              i
                                ? a(m(p, s.children, "id"))()
                                : a(
                  ...
                  children: [
                    n
                      ...
                      : (0, h.jsx)(c.CheckboxControl, {
                          ...
                          name: N,
                          className: "woocommerce-search-list__item-input",
                          value: (0, w.decodeEntities)(s.value),
                          label: g((0, w.decodeEntities)(s.name), u),
                          onChange: a(s),
                          checked: i,
                        }),
        ...
        const R = ({
            ...
            const [m, u] = (0, d.useState)(!1),
              p = (0, f.useInstanceId)(R);
            if (((i = i || t), !t)) return null;
            t = (0, w.decodeEntities)(t);
            const g = (0, l.A)("woocommerce-tag", n, { "has-remove": !!r }),
              v = `woocommerce-tag__label-${p}`,
            ...
            return (0, h.jsxs)("span", {
              ...
              children: [
                ...
                o &&
                  m &&
                  (0, h.jsx)(c.Popover, { onClose: () => u(!1), children: o }),
                r &&
                  (0, h.jsx)(c.Button, {
        ...
        const S = (e) => (0, h.jsx)(x, { ...e }),
            ...
            return (0, h.jsxs)("div", {
              ...
              children: [
                (0, h.jsxs)("div", {
                  ...
                  children: [
                    (0, h.jsx)("strong", { children: r.selected(n) }),
                    n > 0
                      ? (0, h.jsx)(c.Button, {
                          variant: "link",
                          isDestructive: !0,
                          onClick: () => s([]),
                          "aria-label": r.clear,
                          children: (0, a.__)("Clear all", "woocommerce"),
                        })
                      : null,
                  ],
                }),
          ...
          T = ({
            ...
            const { messages: c, renderItem: l, selected: d, isSingle: m } = n,
              w = l || S;
            return 0 === e.length
              ? (0, h.jsxs)("div", {
                  ...
                  children: [
                    (0, h.jsx)("span", {
                      ...
                      children: (0, h.jsx)(s.A, { icon: y.A, role: "img" }),
                    }),
                    (0, h.jsx)("span", {
                      className: "woocommerce-search-list__not-found-text",
                      children: t ? (0, a.sprintf)(c.noResults, t) : c.noItems,
                    }),
                  ],
                })
              : (0, h.jsx)("ul", {
          ...
          O = (e) => {
                ...
                () =>
                  ((e, t, o) => {
                    ...
                    const r = new RegExp(
                      ...
                      s = e.map((e) => !!r.test(e.name) && e).filter(Boolean);
                    return o ? p(s, e) : s;
                  })(n, x, r),
                [n, x, r],
              );
            ...
            return (0, h.jsxs)("div", {
              ...
              children: [
                "text" === _ &&
                  (0, h.jsx)(N, { ...e, onRemove: C, messages: k }),
                (0, h.jsx)("div", {
                ...
                s
                  ...
                  : (0, h.jsx)(T, {
                      ...
                      onSelect: E,
                      instanceId: R,
                      useExpandedPanelId: j,
                    }),
              ],
            });
          },
          E = ((0, c.withSpokenMessages)(O), window.wp.url),
          L = window.wp.apiFetch;
        var P = o.n(L);
        const I = window.wc.wcSettings,
          A = (0, I.getSetting)("wcBlocksConfig", {
            pluginUrl: "",
            productCount: 0,
            defaultAvatar: "",
            restApiRoutes: {},
          ...
          M =
            ...
            A.pluginUrl,
            I.STORE_PAGES.shop,
            I.STORE_PAGES.checkout,
            I.STORE_PAGES.checkout,
            I.STORE_PAGES.privacy,
            I.STORE_PAGES.privacy,
            I.STORE_PAGES.terms,
            I.STORE_PAGES.terms,
            I.STORE_PAGES.cart,
            ...
            (0, I.getSetting)("shippingMethodsExist", !1),
            (0, I.getSetting)("shippingEnabled", !0),
            (0, I.getSetting)("countries", {})),
          D = (0, I.getSetting)("countryData", {}),
          F = {
            ...Object.fromEntries(
              Object.keys(D)
                .filter((e) => !0 === D[e].allowBilling)
                .map((e) => [e, M[e] || ""]),
            ),
            ...Object.fromEntries(
              Object.keys(D)
                .filter((e) => !0 === D[e].allowShipping)
                .map((e) => [e, M[e] || ""]),
            ),
          },
          $ =
            (Object.fromEntries(
              Object.keys(F).map((e) => [e, D[e].states || {}]),
            ),
            Object.fromEntries(
              Object.keys(F).map((e) => [e, D[e].locale || {}]),
            ),
            {
              address: [
                "first_name",
          ...
          B =
            ((0, I.getSetting)("addressFieldsLocations", $).address,
            (0, I.getSetting)("addressFieldsLocations", $).contact,
            (0, I.getSetting)("addressFieldsLocations", $).order,
              ...
              ? "general" === t
                ? (0, h.jsxs)("span", {
                    children: [
                      ...
                      (0, h.jsx)("br", {}),
                      (0, h.jsx)("code", { children: (0, H.escapeHTML)(e) }),
                    ],
                  })
                : "api" === t
                  ? (0, h.jsxs)("span", {
          ...
          J = (e) => {
            const { id: t, name: o, parent: r, count: s } = e;
            return {
              id: t,
              name: o,
              parent: r,
        ...
        const U =
            ...
            return (0, h.jsxs)(h.Fragment, {
              children: [
                (0, h.jsx)(O, {
                  ...
                  list: p,
                  isLoading: o,
                  selected: p.filter(({ id: e }) => n.includes(Number(e))),
                  onChange: r,
                  renderItem: (e) => {
                    const { item: t, search: o, depth: r = 0 } = e,
                ...
                !!s &&
                  (0, h.jsx)("div", {
                    hidden: n.length < 2,
                    children: (0, h.jsx)(c.SelectControl, {
          ...
          ({ selected: e, ...t }) => {
            ...
            return (
              (0, d.useEffect)(() => {
                var e;
                ((e = { selected: l.current }),
                P()({
                  path: (0, E.addQueryArgs)("wc/store/v1/products/categories", {
                    per_page: 0,
                    ...e,
                  }),
                }))
                ...
                (0, h.jsx)(h.Fragment, {
                  children: o
                    ...
                    : (0, h.jsx)(c.Button, {
                        variant: "secondary",
                        onClick: r,
                        children: (0, a.__)("Retry", "woocommerce"),
                      }),
                }),
            ],
          });
        o(6919);
        const K = window.wc.sanitize,
          Q = ({
            label: e,
            screenReaderLabel: t,
            wrapperElement: o,
            ...
            return !n && a
              ? ((i = o || "span"),
                (r = {
                  ...r,
                  className: (0, l.A)(r.className, "screen-reader-text"),
                }),
                (0, h.jsx)(i, { ...r, children: t }))
              : ((i = o || d.Fragment),
                n && a && e !== t
                  ? (0, h.jsxs)(i, {
                      ...r,
                  ...
                  : (0, h.jsx)(i, { ...r, children: e }));
          },
          X = ({
            onClick: e,
            label: t = (0, a.__)("Load more", "woocommerce"),
            screenReaderLabel: o = (0, a.__)("Load more", "woocommerce"),
          }) =>
            (0, h.jsx)("div", {
              className:
              ...
              children: (0, h.jsx)("button", {
                ...
                onClick: e,
                children: (0, h.jsx)(Q, { label: t, screenReaderLabel: o }),
              }),
            }),
          Y = window.wc.blocksComponents;
        o(6878);
        const Z = ({ onChange: e, readOnly: t, value: o }) =>
          (0, h.jsx)(Y.SortSelect, {
            className:
            ...
            options: [
              {
                key: "most-recent",
                label: (0, a.__)("Most recent", "woocommerce"),
              },
              {
                key: "highest-rating",
                label: (0, a.__)("Highest rating", "woocommerce"),
              },
              {
                key: "lowest-rating",
                label: (0, a.__)("Lowest rating", "woocommerce"),
              },
            ],
            readOnly: t,
        ...
        function ee(e) {
          ...
          for (let i = 0; i < e.length; i++)
            ((t = e.substring(i)),
              (o = t.match(/^&[a-z0-9#]+;/)),
              o ? ((r = o[0]), s.push(r), (i += r.length - 1)) : s.push(e[i]));
          return s;
        }
        const te = (e, t, o = "...") => {
            const r = (function (e, t) {
              ...
              for (let e = 0; e < l.length; e++) {
                ...
                if ("<" !== d[0])
                  ...
                  if (g >= o)
                    if (((u = d.match(/[a-zA-Z]+/)), (p = u ? u[0] : ""), p))
                      if ("</" !== d.substring(0, 2)) (v.push(p), (d = ""));
                      else {
                        for (; v[v.length - 1] !== p && v.length; ) v.pop();
                        (v.length && (d = ""), v.pop());
                      }
                    else d = "";
                } else d = "";
          ...
          oe = (e, t, o) => (
            t <= o ? (e.start = e.middle + 1) : (e.end = e.middle - 1),
            e
          ),
          re = (e, t, o, r) => {
            const s = ((e, t, o) => {
              ...
              for (; r.start <= r.end; )
                ((r.middle = Math.floor((r.start + r.end) / 2)),
                  (t.innerHTML = te(e, r.middle)),
                  (r = oe(r, t.clientHeight, o)));
              return r.middle;
            })(e, t, o);
            return te(e, s - r.length, r);
          },
          se = {
        ...
        class ie extends d.Component {
          ...
          getButton() {
            const { isExpanded: e } = this.state,
              { className: t, lessText: o, moreText: r } = this.props,
              s = e ? o : r;
            if (s)
              return (0, h.jsx)("a", {
                href: "#more",
                ...
                children: [
                  ...
                  e.verified &&
                    (0, h.jsx)("div", {
                      ...
                      children: (0, a.__)("Verified buyer", "woocommerce"),
                    }),
                ],
              });
        }
        ...
        function le(e, t) {
          return (0, h.jsx)("div", {
            ...
            children: (0, h.jsx)("a", {
              ...
              "aria-labelledby": t,
              children: (0, w.decodeEntities)(e.product_name),
            }),
          });
        }
        function de(e) {
        ...
        function me(e) {
          const { date_created: t, formatted_date_created: o } = e;
          return (0, h.jsx)("time", {
            className:
          ...
          const { rating: o } = e,
            ...
            i = {
              __html: (0, a.sprintf)(
                ...
                (0, a.sprintf)('<strong class="rating">%f</strong>', o),
              ),
            };
          return (0, h.jsx)("div", {
            id: t,
            "aria-label": `${(0, w.decodeEntities)(e.product_name)} ${s}`,
            className:
              "wc-block-review-list-item__rating wc-block-components-review-list-item__rating",
            children: (0, h.jsx)("div", {
              "aria-hidden": "true",
              className: `wc-block-review-list-item__rating__stars wc-block-components-review-list-item__rating__stars wc-block-review-list-item__rating__stars--${o}`,
              role: "img",
        ...
        o(7313);
        const he = ({ attributes: e, review: t = {} }) => {
          const {
              imageType: o,
              showReviewDate: r,
              showReviewerName: s,
        ...
        o(5183);
        const ue = ({ attributes: e, reviews: t }) => {
          const o = (0, I.getSetting)("showAvatars", !0),
            r = (0, I.getSetting)("reviewRatingsEnabled", !0),
            s = (o || "product" === e.imageType) && e.showReviewImage,
            i = r && e.showReviewRating,
            n = { ...e, showReviewImage: s, showReviewRating: i };
          return (0, h.jsx)("ul", {
            className: "wc-block-review-list wc-block-components-review-list",
            children:
              0 === t.length
                ? (0, h.jsx)(he, { attributes: n })
                : t.map((e, t) =>
                    (0, h.jsx)(he, { attributes: n, review: e }, e.id || t),
                  ),
          });
        };
        var pe = o(923),
        ...
        const ve = (e) => {
            ...
            return (
              r && (m = "wc-block-reviews-by-product"),
              Array.isArray(o) && (m = "wc-block-reviews-by-category"),
              (0, l.A)(m, t, {
                "has-image": c,
                "has-name": i,
                "has-date": s,
        ...
        class be extends d.Component {
          render() {
            ...
            if (0 === s.length && !o) return (0, h.jsx)(r, { attributes: e });
            const n = (0, I.getSetting)("reviewRatingsEnabled", !0);
            return (0, h.jsxs)(c.Disabled, {
              children: [
                ...
                (0, h.jsx)(ue, { attributes: e, reviews: s }),
                e.showLoadMore &&
                  i > s.length &&
                  (0, h.jsx)(X, {
                    screenReaderLabel: (0, a.__)(
                      "Load more reviews",
                      "woocommerce",
                    ),
                    onClick: () => null,
        ...
        const xe = ((e) => {
            ...
            class o extends d.Component {
              ...
              shouldReplaceReviews(e, t) {
                return (
                  ...
                  !ge()(e.categoryIds, t.categoryIds)
                );
              }
              ...
              appendReviews() {
                ...
                const t =
                    null !== (e = this.props.onReviewsAppended) && void 0 !== e
                      ? e
                      : () => {},
                  { reviewsToDisplay: o } = this.props,
                  { reviews: r } = this.state;
                o <= r.length || this.updateListOfReviews(r).then(t);
              }
              updateListOfReviews(e = []) {
                const { reviewsToDisplay: t } = this.props,
                  { totalReviews: o } = this.state,
                  r = Math.min(o, t) - e.length;
                return (
                  this.setState({
                    loading: !0,
                    reviews: e.concat(Array(r).fill({})),
                  }),
                  ((s = this.getArgs(e.length)),
                  P()({
                    path:
              ...
              setError = async (e) => {
                ...
                const o =
                    null !== (t = this.props.onReviewsLoadError) && void 0 !== t
                      ...
                      : () => {},
                  r = await B(e);
                (this.setState({ reviews: [], loading: !1, error: r }), o(r));
              };
              render() {
                const { reviewsToDisplay: t } = this.props,
                  {
            ...
            return ((o.displayName = `WithReviews(${r})`), o);
          })(be),
          ye = ({
            attributes: e,
            icon: t,
            ...
            const {
              ...
              { order: g, orderby: v } = ((e) => {
                if ((0, I.getSetting)("reviewRatingsEnabled", !0)) {
                  if ("lowest-rating" === e)
          ...
          Se = (0, c.withSpokenMessages)(
            ({ attributes: e, debouncedSpeak: t, setAttributes: o }) => {
              const { editMode: r, categoryIds: l } = e;
              if (!l || r)
                    ...
                    (0, h.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, h.jsx)(c.Button, {
                          ...
                          children: (0, a.__)("Done", "woocommerce"),
                        }),
                      ],
                    }),
                  ],
                ...
                children: [
                  ...
                  (0, h.jsxs)(
                    n.InspectorControls,
                    {
                      children: [
                        (0, h.jsx)(c.PanelBody, {
                          title: (0, a.__)("Category", "woocommerce"),
                          initialOpen: !1,
                          children: (0, h.jsx)(U, {
                            selected: e.categoryIds,
                            onChange: (e = []) => {
                        ...
                        (0, h.jsxs)(c.PanelBody, {
                          ...
                          children: [
                            (0, h.jsx)(c.ToggleControl, {
                              ...
                              onChange: () =>
                                o({ showProductName: !e.showProductName }),
                            }),
                            Re(e, o),
                          ],
                        }),
        ...
        const Ce = {
              ...
              previewReviews: [
                {
                  ...
                  review: `<p>${(0, a.__)("I bought this product last week and I'm very happy with it.", "woocommerce")}</p>\n`,
                ...
                },
                {
                  ...
                  review: `<p>${(0, a.__)("This product is awesome, I love it!", "woocommerce")}</p>\n`,
                  reviewer_avatar_urls: {
                    48: A.defaultAvatar,
                    96: A.defaultAvatar,
                  },
          ...
          Ne = JSON.parse(
            '{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"woocommerce/reviews-by-category","title":"Reviews by Category","category":"woocommerce","keywords":["WooCommerce"],"description":"Show product reviews from specific categories.","textdomain":"woocommerce","supports":{"html":false,"interactivity":{"clientNavigation":true},"color":{"background":false},"typography":{"fontSize":true}}}',
          );
        (0, r.registerBlockType)(Ne, {
          icon: {
            src: (0, h.jsx)(s.A, {
              icon: i.A,
          ...
          edit: (e) => {
            ...
            return (0, h.jsx)("div", {
              ...t,
              children: (0, h.jsx)(Se, { ...e }),
            });
          },
          save: ({ attributes: e }) =>
            (0, h.jsx)("div", {
              ...n.useBlockProps.save({ className: ve(e) }),
              ..._e(e),
            }),
        });
      },
    ...
    (i.O = (t, o, r, s) => {
      if (!o) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [o, r, s] = e[d], a = !0, c = 0; c < o.length; c++)
            (!1 & s || n >= s) && Object.keys(i.O).every((e) => i.O[e](o[c]))
              ? o.splice(c--, 1)
              : ((a = !1), s < n && (n = s));
          if (a) {
            e.splice(d--, 1);
