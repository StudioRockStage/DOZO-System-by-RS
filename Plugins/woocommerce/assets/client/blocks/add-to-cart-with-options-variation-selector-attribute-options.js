      ...
      6411: (t, e, o) => {
        ...
        (o(8180),
          (0, r.registerBlockType)(s, {
            edit: function (t) {
              const { attributes: e, setAttributes: o } = t,
                { className: r, optionStyle: i } = e,
                n = (0, a.useBlockProps)({ className: r });
              ((t, e) => {
                const o = (0, p.useRef)(null);
                (0, p.useEffect)(() => {
                  ...
                  if (!r) {
                    ...
                    if (!e) return;
                    r = e.querySelector(".editor-styles-wrapper");
                  }
                  if (!r) return;
                  const i = window.getComputedStyle(r),
                    ...
                    s = i?.color;
                  if (!n || !s) return;
                  const l = `${t}-editor-theme-colors`;
                  let a = r.querySelector(`#${l}`);
                  (a ||
                    ((a = document.createElement("style")),
                    (a.id = l),
                    r.appendChild(a)),
                    (o.current = a));
                  const c = e({ editorBackgroundColor: n, editorColor: s });
                  a.textContent = c;
                  const d = new MutationObserver(() => {
                    const t = window.getComputedStyle(r),
                      ...
                      l = t?.color;
                    if (i !== n || l !== s) {
                      const t = e({ editorBackgroundColor: i, editorColor: l });
                      o.current && (o.current.textContent = t);
                    }
                  });
                  return (
                    d.observe(r, {
                ...
                ({ editorBackgroundColor: t, editorColor: e }) =>
                  `\n\t\t\t:where(.wc-block-add-to-cart-with-options-variation-selector-attribute-options__pill--selected) {\n\t\t\t\t--pill-color: ${t};\n\t\t\t\t--pill-background-color: ${e};\n\t\t\t}\n\t\t`,
              );
              const { data: s } = (0, d.useCustomDataContext)("attribute");
              if (!s) return null;
              const u = s.terms.map((t, e) => ({
                value: t.slug,
                label: t.name,
                disabled: e > 1 && e === s.terms.length - 1,
              }));
              return (0, w.jsxs)("div", {
                ...n,
                children: [
                  (0, w.jsx)(a.InspectorControls, {
                    children: (0, w.jsx)(c.PanelBody, {
                      title: (0, l.__)("Style", "woocommerce"),
                      children: (0, w.jsxs)(
                        c.__experimentalToggleGroupControl,
                        {
                          label: (0, l.__)("Style", "woocommerce"),
                          value: null != i ? i : "pills",
                          onChange: (t) => {
                            ("pills" !== t && "dropdown" !== t) ||
                              o({ optionStyle: t });
                          },
                          ...
                          children: [
                            (0, w.jsx)(
                              c.__experimentalToggleGroupControlOption,
                              {
                                value: "pills",
                                label: (0, l.__)("Pills", "woocommerce"),
                              },
                            ),
                            (0, w.jsx)(
                              c.__experimentalToggleGroupControlOption,
                              {
                                value: "dropdown",
                                label: (0, l.__)("Dropdown", "woocommerce"),
                              },
                            ),
                          ],
                        },
                  ...
                  (0, w.jsx)(c.Disabled, {
                    children:
                      "dropdown" === i
                        ...
                        : (0, w.jsx)(b, { id: s.taxonomy, options: u }),
                  }),
                ],
              });
            },
            attributes: s.attributes,
            icon: { src: (0, w.jsx)(i.A, { icon: n.A }) },
            save: () => null,
          }));
      },
      8180: () => {},
    ...
    (n.O = (e, o, r, i) => {
      if (!o) {
        ...
        for (d = 0; d < t.length; d++) {
          for (var [o, r, i] = t[d], l = !0, a = 0; a < o.length; a++)
