(() => {
  var e,
    ...
    c = {
      2273: (e, t, o) => {
        ...
        var s = o(7723);
        const a = JSON.parse(
          '{"name":"woocommerce/customer-account","title":"Customer account","description":"A block that allows your customers to log in and out of their accounts in your store.","category":"woocommerce","keywords":["WooCommerce","My Account"],"supports":{"interactivity":{"clientNavigation":true},"align":true,"color":{"text":true},"typography":{"fontSize":true,"__experimentalFontFamily":true},"spacing":{"margin":true,"padding":true}},"attributes":{"displayStyle":{"type":"string","default":"icon_and_text"},"iconStyle":{"type":"string","default":"default"},"iconClass":{"type":"string","default":"icon"}},"textdomain":"woocommerce","apiVersion":3,"$schema":"https://schemas.wp.org/trunk/block.json"}',
        );
        var u = o(4921);
        ...
        let y = (function (e) {
            return (
              (e.ICON_AND_TEXT = "icon_and_text"),
              (e.TEXT_ONLY = "text_only"),
              (e.ICON_ONLY = "icon_only"),
              e
            );
          })({}),
          x = (function (e) {
        ...
        const g = { default: m, alt: w, line: _ },
          b = ({ iconStyle: e, displayStyle: t, iconClass: o }) =>
            t === y.TEXT_ONLY
              ? null
              : (0, l.jsx)(n.A, { className: o, icon: g[e], size: 18 }),
          h = ({ displayStyle: e }) => {
            if (e === y.ICON_ONLY) return null;
            const t = (0, C.getSetting)("currentUserId", null);
            return (0, l.jsx)("span", {
              className: "label",
              children: t
                ? (0, s.__)("My Account", "woocommerce")
                : (0, s.__)("Log in", "woocommerce"),
            });
          },
          f = ({ attributes: e }) => {
            const { displayStyle: t, iconStyle: o, iconClass: c } = e,
              n =
                t === y.ICON_ONLY
                  ? { "aria-label": (0, s.__)("My Account", "woocommerce") }
                  : {};
            return (0, l.jsxs)("a", {
              href: (0, C.getSetting)(
                "dashboardUrl",
              ...
              ...n,
              children: [
                (0, l.jsx)(b, { iconStyle: o, displayStyle: t, iconClass: c }),
                (0, l.jsx)(h, { displayStyle: t }),
              ],
            });
          };
        var v = o(6087);
        const j = () => {
            const e = `${(0, C.getSetting)("adminUrl")}admin.php?page=wc-settings&tab=account`,
              t = (0, v.createInterpolateElement)(
                `<a>${(0, s.__)("Manage account settings", "woocommerce")}</a>`,
                { a: (0, l.jsx)(p.ExternalLink, { href: e }) },
              );
            return (0, l.jsx)("div", {
              className: "wc-block-editor-customer-account__link",
              children: t,
            });
          },
          O = ({ attributes: e, setAttributes: t }) => {
            const { displayStyle: o, iconStyle: c } = e,
              r = [y.ICON_ONLY, y.ICON_AND_TEXT].includes(o);
            return (0, l.jsxs)(
              d.InspectorControls,
              {
                children: [
                  (0, l.jsx)(p.PanelBody, { children: (0, l.jsx)(j, {}) }),
                  (0, l.jsxs)(p.PanelBody, {
                    title: (0, s.__)("Display settings", "woocommerce"),
                    children: [
                      (0, l.jsx)(p.SelectControl, {
                        className: "customer-account-display-style",
                        label: (0, s.__)("Icon options", "woocommerce"),
                        value: o,
                        onChange: (e) => {
                          t({ displayStyle: e });
                        },
                        ...
                        options: [
                          {
                            value: y.ICON_AND_TEXT,
                            label: (0, s.__)("Icon and text", "woocommerce"),
                          },
                          {
                            value: y.TEXT_ONLY,
                          ...
                          {
                            value: y.ICON_ONLY,
                            label: (0, s.__)("Icon-only", "woocommerce"),
                          },
                        ],
                      }),
                      r
                        ? (0, l.jsxs)(p.__experimentalToggleGroupControl, {
                            label: (0, s.__)("Display Style", "woocommerce"),
                            isBlock: !0,
                            value: c,
                            onChange: (e) => t({ iconStyle: e }),
                            className:
        ...
        (o(2078),
          (0, c.registerBlockType)(a, {
            ...
            edit: ({ attributes: e, setAttributes: t }) => {
              const { className: o } = e,
                c = (0, d.useBlockProps)({
                  className: (0, u.A)("wc-block-editor-customer-account", o),
                });
              return (0, l.jsx)(l.Fragment, {
                children: (0, l.jsxs)("div", {
                  ...c,
                  children: [
                    (0, l.jsx)(d.InspectorControls, {
                      children: (0, l.jsx)(O, {
                        attributes: e,
                        setAttributes: t,
                      }),
                    ...
                    (0, l.jsx)(p.Disabled, {
                      children: (0, l.jsx)(f, { attributes: e }),
                    }),
                  ],
                }),
              });
          ...
          (0, c.registerBlockVariation)("woocommerce/customer-account", {
            name: "woocommerce/customer-account",
            title: (0, s.__)("Customer account", "woocommerce"),
            isDefault: !0,
            attributes: {
              ...a.attributes,
  ...
  function r(e) {
    ...
    var o = (n[e] = { exports: {} });
    return (c[e](o, o.exports, r), o.exports);
  }
  ((r.m = c),
    (e = []),
    (r.O = (t, o, c, n) => {
      if (!o) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [o, c, n] = e[u], i = !0, s = 0; s < o.length; s++)
            (!1 & n || l >= n) && Object.keys(r.O).every((e) => r.O[e](o[s]))
              ? o.splice(s--, 1)
              : ((i = !1), n < l && (l = n));
          if (i) {
            e.splice(u--, 1);
    ...
    (r.t = function (e, c) {
      ...
      var l = {};
      t = t || [null, o({}), o([]), o(o)];
      for (var i = 2 & c && e; "object" == typeof i && !~t.indexOf(i); i = o(i))
        Object.getOwnPropertyNames(i).forEach((t) => (l[t] = () => e[t]));
      return ((l.default = () => e), r.d(n, l), n);
    }),
    (r.d = (e, t) => {
      for (var o in t)
        r.o(t, o) &&
