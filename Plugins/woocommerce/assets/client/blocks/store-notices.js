(() => {
    ...
    s = {
      2947: (e, t, o) => {
        ...
        const k = (0, x.forwardRef)((e, t) => {
          ...
          return (0, c.jsx)(b.$, { ref: t, className: a, ...i, children: l });
        });
        var j = o(195);
        const y = ({
          className: e,
          ...
          ((e, t) => {
            const o = "string" == typeof e ? e : (0, x.renderToString)(e);
            (0, x.useEffect)(() => {
              o && (0, j.speak)(o, t);
            }, [o, t]);
          })(s, a),
            ...
            children: [
              ...
              !!i &&
                (0, c.jsx)(k, {
                  ...
                  "aria-label": (0, p.__)("Dismiss this notice", "woocommerce"),
                  onClick: (e) => {
  ...
  function n(e) {
    ...
    var o = (r[e] = { exports: {} });
    return (s[e](o, o.exports, n), o.exports);
  }
  ((n.m = s),
    (e = []),
    (n.O = (t, o, s, r) => {
      if (!o) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [o, s, r] = e[p], i = !0, a = 0; a < o.length; a++)
            (!1 & r || c >= r) && Object.keys(n.O).every((e) => n.O[e](o[a]))
              ? o.splice(a--, 1)
              : ((i = !1), r < c && (c = r));
          if (i) {
            e.splice(p--, 1);
