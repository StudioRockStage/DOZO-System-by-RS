  ...
  var e,
    ...
    r = {
      5876: (e, t, o) => {
        ...
        var c = o(5573),
          s = o(790);
        const l = (0, s.jsx)(c.SVG, {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
          children: (0, s.jsx)(c.Path, {
        ...
        function b(e) {
          const t = ((e) => {
              const { backgroundColor: t, textColor: o, style: r } = e;
              return {
                textColor: w(o, r?.color?.text),
                backgroundColor: w(t, r?.color?.background),
              };
            })(e),
            o = {
              "--wc-product-filters-text-color": t.textColor || "#111",
          ...
          return (
            m(e, "style") &&
              m(e.style, "spacing") &&
              m(e.style.spacing, "blockGap") &&
              "string" == typeof e.style.spacing.blockGap &&
              (o["--wc-product-filter-block-spacing"] =
                (r = e.style.spacing.blockGap).includes(":") && r.includes("|")
                  ? `var(--wp--${r.replace("var:", "").replaceAll("|", "--")})`
                  : r),
            o
          );
        }
        ...
        const v = [
          [
            ...
            {
              level: 2,
              content: (0, p.__)("Filters", "woocommerce"),
              style: {
        ...
        (0, r.registerBlockType)(n, {
          icon: (0, s.jsx)(i.A, { icon: l }),
          edit: (e) => {
            const { attributes: t } = e,
              { isPreview: o } = t,
              [r, c] = (0, d.useState)(!1),
              n = (0, a.useBlockProps)({
                className: (0, f.A)("wc-block-product-filters", {
                  "is-overlay-opened": r,
                }),
                style: b(t),
              });
            return (0, s.jsx)("div", {
              ...
              children: o
                ? (0, s.jsx)("div", {
                    className: "wc-block-product-filters__overlay-content",
                    children: (0, s.jsx)(a.InnerBlocks, {
                      templateLock: !1,
                      template: v,
                    }),
                  })
                : (0, s.jsxs)(s.Fragment, {
                    children: [
                      ...
                      (0, s.jsx)("div", {
                        className: "wc-block-product-filters__overlay",
                            ...
                            children: [
                              ...
                              (0, s.jsx)("footer", {
                                ...
                                children: (0, s.jsx)("button", {
                                  className:
                                    "wc-block-product-filters__apply wp-block-button__link wp-element-button",
                                  onClick: () => c(!r),
                                  children: (0, s.jsx)("span", {
                                    children: (0, p.__)("Apply", "woocommerce"),
                                  }),
                                }),
                              }),
                            ],
          ...
          save: ({ attributes: e }) => {
            const t = a.useBlockProps.save({
                className: (0, f.A)("wc-block-product-filters"),
                style: b(e),
              }),
              o = a.useInnerBlocksProps.save(t);
            return (0, s.jsx)("div", { ...o });
          },
        });
      },
      1981: () => {},
    ...
    (s.O = (t, o, r, c) => {
      if (!o) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [o, r, c] = e[p], i = !0, n = 0; n < o.length; n++)
            (!1 & c || l >= c) && Object.keys(s.O).every((e) => s.O[e](o[n]))
              ? o.splice(n--, 1)
              : ((i = !1), c < l && (l = c));
          if (i) {
            e.splice(p--, 1);
