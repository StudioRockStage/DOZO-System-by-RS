    ...
    r = {
      6132: (e, o, t) => {
        ...
        const l = (0, n.jsxs)(c.SVG, {
          ...
          i = JSON.parse(
            '{"name":"woocommerce/catalog-sorting","title":"Catalog Sorting","description":"Enable customers to change the sorting order of the products.","category":"woocommerce","keywords":["WooCommerce"],"supports":{"interactivity":{"clientNavigation":true},"color":{"text":true,"background":false},"typography":{"fontSize":true}},"attributes":{"fontSize":{"type":"string","default":"small"},"useLabel":{"type":"boolean","default":false}},"textdomain":"woocommerce","apiVersion":3,"$schema":"https://schemas.wp.org/trunk/block.json"}',
          ),
          ...
          (0, n.jsx)(n.Fragment, {
            children: e
              ? (0, n.jsxs)(n.Fragment, {
                  children: [
                    (0, n.jsx)("label", {
                      ...
                      children: (0, h.__)("Sort by", "woocommerce"),
                    }),
                    (0, n.jsx)("select", {
                      className: "orderby",
                      id: "woocommerce-orderby",
                      children: (0, n.jsx)("option", {
                        children: (0, h.__)("Default", "woocommerce"),
                      }),
                    }),
                  ],
                })
              : (0, n.jsx)("select", {
                  className: "orderby",
                  children: (0, n.jsx)("option", {
                    children: (0, h.__)("Default sorting", "woocommerce"),
                  }),
                }),
          });
        (t(7950),
          (0, r.registerBlockType)(i, {
            ...
            edit: ({ attributes: e, setAttributes: o }) => {
              ...
              return (0, n.jsxs)(n.Fragment, {
                children: [
                  (0, n.jsx)(a.InspectorControls, {
                    children: (0, n.jsx)(d.PanelBody, {
                      title: (0, h.__)("Accessibility", "woocommerce"),
                      children: (0, n.jsx)(d.ToggleControl, {
                        label: (0, h.__)("Show visual label", "woocommerce"),
                        help: (0, h.__)(
                          'Displays "Sort by" text before the dropdown menu to improve clarity and accessibility.',
                          "woocommerce",
                        ),
                        checked: t,
                        onChange: (e) => o({ useLabel: e }),
                      }),
                    }),
                  }),
                  (0, n.jsx)("div", {
                    ...r,
                    children: (0, n.jsx)(d.Disabled, {
                      children: (0, n.jsx)(u, { useLabel: t }),
                    }),
                  }),
                ],
              });
  ...
  ((c.m = r),
    ...
    (c.O = (o, t, r, s) => {
      if (!t) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [t, r, s] = e[d], l = !0, i = 0; i < t.length; i++)
            (!1 & s || n >= s) && Object.keys(c.O).every((e) => c.O[e](t[i]))
              ? t.splice(i--, 1)
              : ((l = !1), s < n && (n = s));
          if (l) {
            e.splice(d--, 1);
    ...
    (c.t = function (e, r) {
      ...
      for (var l = 2 & r && e; "object" == typeof l && !~o.indexOf(l); l = t(l))
        Object.getOwnPropertyNames(l).forEach((o) => (n[o] = () => e[o]));
