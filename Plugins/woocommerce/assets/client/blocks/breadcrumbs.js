(() => {
        ...
        (r(4922),
          (0, o.registerBlockType)(n, {
            ...
            edit: () => {
              ...
              return (0, l.jsx)("div", {
                ...e,
                children: (0, l.jsxs)(s.Disabled, {
                  children: [
                    (0, l.jsx)("a", {
                      href: "/",
                      children: (0, a.__)("Breadcrumbs", "woocommerce"),
                    }),
                    (0, a.__)(" / Navigation / Path", "woocommerce"),
                  ],
                }),
              });
            },
    ...
    (n.O = (t, r, o, i) => {
      if (!r) {
        ...
        for (u = 0; u < e.length; u++) {
          for (var [r, o, i] = e[u], s = !0, a = 0; a < r.length; a++)
            (!1 & i || c >= i) && Object.keys(n.O).every((e) => n.O[e](r[a]))
              ? r.splice(a--, 1)
              : ((s = !1), i < c && (c = i));
          if (s) {
            e.splice(u--, 1);
  ...
  var c = n.O(void 0, [94], () => n(3100));
  ((c = n.O(c)),
    (((this.wc = this.wc || {}).blocks = this.wc.blocks || {}).breadcrumbs =
      c));
})();
