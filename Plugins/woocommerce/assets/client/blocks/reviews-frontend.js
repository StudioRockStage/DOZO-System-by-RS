    ...
    s = {
      3469: (e, t, r) => {
        ...
        class h extends s.Component {
          ...
          static getDerivedStateFromError(e) {
            return void 0 !== e.statusText && void 0 !== e.status
              ? {
                  errorMessage: (0, w.jsxs)(w.Fragment, {
                    children: [
                      (0, w.jsx)("strong", { children: e.status }),
                      ": ",
                      e.statusText,
                    ],
                  }),
          ...
          g = ({
            ...
            const n = () => {
                ...
                return n || a
                  ? (0, w.jsx)(u, {
                      ...i,
                      children: (0, w.jsx)(e, { ...o, attributes: r }),
                    })
                  : (0, w.jsx)(u, {
                      ...i,
                      children: (0, w.jsx)(s.Suspense, {
                        fallback: (0, w.jsx)("div", {
                          className: "wc-block-placeholder",
                          children: "Loading...",
                        }),
                        children: e && (0, w.jsx)(e, { ...o, attributes: r }),
                      }),
                    });
              },
              a = (0, s.createRoot)(t);
            return (a.render((0, w.jsx)(n, {})), a);
          },
          b = ({
            Block: e,
            containers: t,
        ...
        const R = ({
            ...
            return !a && c
              ? ((n = r || "span"),
                (o = {
                  ...o,
                  className: (0, x.A)(o.className, "screen-reader-text"),
                }),
                (0, w.jsx)(n, { ...o, children: t }))
              : ((n = r || s.Fragment),
                a && c && e !== t
                  ? (0, w.jsxs)(n, {
                      ...o,
                  ...
                  : (0, w.jsx)(n, { ...o, children: e }));
          },
          j = ({
            onClick: e,
            label: t = (0, o.__)("Load more", "woocommerce"),
            screenReaderLabel: r = (0, o.__)("Load more", "woocommerce"),
          }) =>
            (0, w.jsx)("div", {
              className:
              ...
              children: (0, w.jsx)("button", {
                ...
                onClick: e,
                children: (0, w.jsx)(R, { label: t, screenReaderLabel: r }),
              }),
            }),
          S = window.wc.blocksComponents;
        r(6878);
        const E = ({ onChange: e, readOnly: t, value: r }) =>
          (0, w.jsx)(S.SortSelect, {
            className:
              "wc-block-review-sort-select wc-block-components-review-sort-select",
            label: (0, o.__)("Order by", "woocommerce"),
            onChange: e,
            options: [
              {
                key: "most-recent",
                label: (0, o.__)("Most recent", "woocommerce"),
              },
              {
                key: "highest-rating",
                label: (0, o.__)("Highest rating", "woocommerce"),
              },
              {
                key: "lowest-rating",
                label: (0, o.__)("Lowest rating", "woocommerce"),
              },
            ],
            readOnly: t,
            screenReaderLabel: (0, o.__)("Order reviews by", "woocommerce"),
            value: r,
          });
        function O(e) {
          let t,
        ...
        const L = (e, t, r = "...") => {
            const s = (function (e, t) {
              ...
              for (let e = 0; e < l.length; e++) {
                if (
                  ((d = l[e]), (m = c ? d : d.replace(/[ ]+/g, " ")), !d.length)
                )
                  continue;
                const t = O(m);
                if ("<" !== d[0])
                  if (v >= r) d = "";
                    ...
                    if (((p = r - v), " " === t[p - 1]))
                      ...
                      ((w = t.slice(p).indexOf(" ")),
                        o || (-1 !== w ? (p += w) : (p = d.length)));
                    if (((d = t.slice(0, p).join("") + i), n)) {
            ...
            const o = ((e, t, r) => {
              ...
              for (; s.start <= s.end; )
                ((s.middle = Math.floor((s.start + s.end) / 2)),
                  (t.innerHTML = L(e, s.middle)),
                  (s = P(s, t.clientHeight, r)));
              return s.middle;
            })(e, t, r);
            return L(e, o - s.length, s);
          },
          A = {
                ...
                children: [
                  ...
                  e.verified &&
                    (0, w.jsx)("div", {
                      ...
                      title: (0, o.__)("Verified buyer", "woocommerce"),
                      children: (0, o.__)("Verified buyer", "woocommerce"),
                    }),
                ],
              });
        }
        function D(e) {
          return (0, w.jsx)(N, {
            maxLines: 10,
            moreText: (0, o.__)("Read full review", "woocommerce"),
            lessText: (0, o.__)("Hide full review", "woocommerce"),
            className:
        ...
        function I(e, t) {
          return (0, w.jsx)("div", {
            ...
            children: (0, w.jsx)("a", {
              ...
              "aria-labelledby": t,
              children: (0, C.decodeEntities)(e.product_name),
            }),
          });
        }
        function F(e) {
        ...
        function G(e, t) {
          const { rating: r } = e,
            ...
            i = (0, o.sprintf)(
              ...
              (0, o.__)("Rated %f out of 5", "woocommerce"),
              r,
            ),
            n = {
              __html: (0, o.sprintf)(
                ...
                (0, o.sprintf)('<strong class="rating">%f</strong>', r),
              ),
            };
          return (0, w.jsx)("div", {
            id: t,
            "aria-label": `${(0, C.decodeEntities)(e.product_name)} ${i}`,
            className:
        ...
        const U = ({ attributes: e, review: t = {} }) => {
          ...
          return (0, w.jsxs)("li", {
            className: (0, x.A)(
              ...
              {
                "is-loading": p,
                "wc-block-components-review-list-item__item--has-image": n,
              },
            ),
            "aria-hidden": p,
            children: [
        ...
        r(5183);
        const $ = ({ attributes: e, reviews: t }) => {
          const r = (0, i.getSetting)("showAvatars", !0),
            s = (0, i.getSetting)("reviewRatingsEnabled", !0),
            o = (r || "product" === e.imageType) && e.showReviewImage,
            n = s && e.showReviewRating,
            a = { ...e, showReviewImage: o, showReviewRating: n };
          return (0, w.jsx)("ul", {
            className: "wc-block-review-list wc-block-components-review-list",
            children:
              0 === t.length
                ? (0, w.jsx)(U, { attributes: a })
                : t.map((e, t) =>
                    (0, w.jsx)(U, { attributes: a, review: e }, e.id || t),
                  ),
          });
        };
        var W = r(923),
        ...
        const z = ((e) => {
          ...
          ({
            ...
            const c = (0, i.getSetting)("reviewRatingsEnabled", !0);
            return (0, w.jsxs)(w.Fragment, {
              children: [
                e.showOrderby && c && (0, w.jsx)(E, { value: n, onChange: r }),
                (0, w.jsx)($, { attributes: e, reviews: s }),
                e.showLoadMore &&
                  a > s.length &&
                  (0, w.jsx)(j, {
                    onClick: t,
                    screenReaderLabel: (0, o.__)(
                      "Load more reviews",
                      "woocommerce",
                    ),
                  }),
        ...
        class J extends s.Component {
          ...
          onAppendReviews() {
            ...
            this.setState({
              reviewsToDisplay: e + this.getReviewsOnLoadMore(),
            });
          }
          onChangeOrderby(e) {
            this.setState({
          ...
          onReviewsAppended({ newReviews: e }) {
            (0, _.speak)(
              (0, o.sprintf)(
                /* translators: %d is the count of reviews loaded. */ /* translators: %d is the count of reviews loaded. */
                (0, o._n)(
                  "%d review loaded.",
                  "%d reviews loaded.",
                  e.length,
          ...
          onReviewsReplaced() {
            (0, _.speak)((0, o.__)("Reviews list updated.", "woocommerce"));
          }
          onReviewsLoadError() {
            (0, _.speak)(
              (0, o.__)(
        ...
        ((e) => {
          const t = Array.from(document.body.querySelectorAll(v.join(","))),
            {
              Block: r,
              getProps: s,
            ...
            a = (({
              ...
              let n = Array.from(document.body.querySelectorAll(s));
              return (
                o &&
                  o.length > 0 &&
                  (n = n.filter(
          ...
          t.forEach((t) => {
            t.addEventListener("wc-blocks_render_blocks_frontend", () => {
              (({
                ...
                let n = Array.from(o.querySelectorAll(s));
                (!1 === i?.multiple && (n = n.slice(0, 1)),
                  b({
                    Block: e,
                    containers: n,
