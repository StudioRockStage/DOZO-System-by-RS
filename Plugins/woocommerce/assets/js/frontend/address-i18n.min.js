jQuery(function (e) {
  ...
  function d(e, a) {
    a
      ? (e.find("label .optional").remove(),
        ...
        0 === e.find('label .required[aria-hidden="true"]').length &&
          e
            .find("label")
  ...
  e(document.body)
    .on("country_to_state_changing", function (a, r, t) {
      ...
      var c = JSON.parse(wc_address_i18n_params.locale_fields);
      (e.each(c, function (a, r) {
        var t = n.find(r),
        ...
        ("undefined" != typeof o.label && t.find("label").html(o.label),
          "undefined" != typeof o.placeholder &&
            ...
            t.find(":input").attr("data-placeholder", o.placeholder),
            t.find(".select2-selection__placeholder").text(o.placeholder)),
          "undefined" != typeof o.placeholder ||
            "undefined" == typeof o.label ||
            t.find("label:not(.screen-reader-text)").length ||
            (t.find(":input").attr("placeholder", o.label),
            t.find(":input").attr("data-placeholder", o.label),
            t.find(".select2-selection__placeholder").text(o.label)),
          "undefined" != typeof o.required ? d(t, o.required) : d(t, !1),
          "undefined" != typeof o.priority && t.data("priority", o.priority),
          "state" !== a &&
            ("undefined" != typeof o.hidden && !0 === o.hidden
              ? t.hide().find(":input").val("")
              : t.show()),
          Array.isArray(o["class"]) &&
            (t.removeClass("form-row-first form-row-last form-row-wide"),
