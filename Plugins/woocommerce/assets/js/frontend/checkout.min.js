jQuery(function (e) {
  ...
  var t = {
      ...
      payment_method_selected: function (o) {
        ...
        (c !== t.selectedPaymentMethod &&
          e(document.body).trigger("payment_method_selected"),
          (t.selectedPaymentMethod = c));
      },
      ...
      should_skip_address_update: function (e) {
        ...
        if (
          t &&
          ("billing_address_1" === t.id || "shipping_address_1" === t.id)
        ) {
          if ("true" === t.getAttribute("data-autocomplete-manipulating"))
            return !0;
          var o = t.id.replace("_address_1", "");
          if (
            window.wc &&
            window.wc.addressAutocomplete &&
            window.wc.addressAutocomplete.activeProvider &&
            window.wc.addressAutocomplete.activeProvider[o]
          )
            return !0;
        }
        return !1;
      ...
      maybe_input_changed: function (e) {
        t.should_skip_address_update(e) || (t.dirtyInput && t.input_changed(e));
      },
      input_changed: function (e) {
        t.should_skip_address_update(e) ||
          ((t.dirtyInput = e.target), t.maybe_update_checkout());
      },
      address_field_blur: function (e) {
        t.should_trigger_address_blur_update(e) &&
          ((t.dirtyInput = e.target), t.maybe_update_checkout());
      },
      queue_update_checkout: function (e) {
        ...
        if (
          o &&
          ("billing_address_1" === o.id || "shipping_address_1" === o.id)
        ) {
          var r = o.id.replace("_address_1", "");
          if (
            window.wc &&
            window.wc.addressAutocomplete &&
            window.wc.addressAutocomplete.activeProvider &&
            window.wc.addressAutocomplete.activeProvider[r]
          )
            return !0;
        }
        ((t.dirtyInput = this),
      ...
      validate_field: function (t) {
        ...
        ("input" === s &&
          ...
          ("validate" !== s && "change" !== s && "focusout" !== s) ||
            (c &&
      ...
      update_checkout_action: function (o) {
        if ((t.xhr && t.xhr.abort(), 0 !== e("form.checkout").length)) {
          ...
          var r = e("#billing_country").val(),
            ...
            c = e(":input#billing_postcode").val(),
          ...
          (h.length &&
            ...
            e("#ship-to-different-address").find("input").is(":checked") &&
              ((s = e("#shipping_country").val()),
              (u = e("#shipping_state").val()),
              (l = e(":input#shipping_postcode").val()),
              (m = e("#shipping_city").val()),
              (p = e(":input#shipping_address_1").val()),
              (_ = e(":input#shipping_address_2").val())));
          var g = {
                    ...
                    e.isEmptyObject(c) ||
                      e(".payment_box :input").each(function () {
                        ...
                        t &&
                          (-1 !==
                          e.inArray(e(this).attr("type"), ["checkbox", "radio"])
                            ? e(this).prop("checked", c[t]).trigger("change")
                            : -1 !== e.inArray(e(this).attr("type"), ["select"])
                              ? e(this).val(c[t]).trigger("change")
                              : null !== e(this).val() &&
                                0 === e(this).val().length &&
                                e(this).val(c[t]).trigger("change"));
                      }),
            ...
            e.ajax({
                ...
                try {
                  ...
                  if (
                    ...
                    var i = e(r.messages)
                        .removeAttr("role")
                        .attr("tabindex", "-1"),
                      c = t.wrapMessagesInsideLink(i),
                      n = e('<div role="alert"></div>').append(c);
                    (t.submit_error(n.prop("outerHTML")),
                      t.show_inline_errors(i));
                  } else
                    t.submit_error(
              ...
              error: function (e, o, r) {
                ...
                ("object" == typeof wc_checkout_params &&
                  ...
                  (i = wc_checkout_params.i18n_checkout_error),
                  t.submit_error(
                    '<div class="woocommerce-error">' + i + "</div>",
                  ));
              },
            })),
          !1)
        ...
        t.find("li[data-id]").each(function () {
          ...
          if (1 === r.length) {
            const e = o + "_description",
              i = t.text().trim(),
              c = r.closest(".form-row"),
              n = document.createElement("p");
            ((n.id = e),
              (n.className = "checkout-inline-error-message"),
              (n.textContent = i),
              c && n.textContent.length > 0 && c.append(n),
    ...
    o = {
      ...
      submit: function (o) {
        var r = e(o.currentTarget),
          i = r.find("#coupon_code"),
          c = this;
        if ((c.remove_coupon_error(), r.is(".processing"))) return !1;
                ...
                t &&
                  ...
                  -1 === t.indexOf("is-error")
                    ? (r.slideUp(400, function () {
                      ...
                      c.clear_coupon_input())
                    : c.show_coupon_error(t, i.parent()),
      ...
      remove_coupon: function (t) {
        t.preventDefault();
        var r = e(this).parents(".woocommerce-checkout-review-order"),
          i = e(this).data("coupon");
        r.addClass("processing").block({
          message: null,
          overlayCSS: { background: "#fff", opacity: 0.6 },
        });
        var c = { security: wc_checkout_params.remove_coupon_nonce, coupon: i };
        e.ajax({
          type: "POST",
          url: wc_checkout_params.wc_ajax_url
            .toString()
      ...
      on_keydown_remove_coupon: function (t) {
        " " === t.key && (t.preventDefault(), e(this).trigger("click"));
      },
    },
    r = {
      init: function () {
      ...
      show_login_form: function () {
        var t = e("form.login, form.woocommerce-form--login");
        return (
          t.is(":visible")
            ? t.slideToggle({ duration: 400 })
            : t.slideToggle({
                duration: 400,
                complete: function () {
                  t.is(":visible") &&
