  ...
  var e = function (t) {
    ...
    i = function (e, o) {
      ...
      if (0 !== t(".woocommerce-cart-form").length) {
        if (
          ...
          var m = t(".wc-empty-cart-message", c).closest(".woocommerce");
          ...
          if (
            ...
            var l = t(".woocommerce-cart-form").find("#coupon_code"),
              _ = l.closest(".coupon");
            (l.val(p), l.focus(), s(d, _, !0));
          }
          (u.length > 0 && a(u), n(i));
        }
    ...
    s = function (e, o, c) {
      if (0 !== o.length) {
        var r = e;
        if ("string" == typeof e) {
          var i = t(t.parseHTML(e)).text().trim();
          if ("" === i) return;
          r = t("<p>", {
    ...
    u = {
      ...
      toggle_shipping: function (e) {
        var o = t(e.currentTarget);
        return (
          t(".shipping-calculator-form").slideToggle("slow", function () {
            var e = this;
            setTimeout(function () {
              var c = t(e);
              o.attr("aria-expanded", c.is(":visible") ? "true" : "false");
            }, 0);
          }),
          t("select.country_to_state, input.country_to_state").trigger(
            "change",
          ),
      ...
      shipping_method_selected: function (o) {
        ...
        (t(
          ...
          i[t(this).data("index")] = t(this).val();
        }),
          c(t("div.cart_totals")));
        var a = {
        ...
        t.ajax({
          ...
          success: function (t) {
            n(t);
            var e = document.getElementById(o.currentTarget.id);
            e && e.focus();
          },
          complete: function () {
            (r(t("div.cart_totals")),
    ...
    m = {
      init: function () {
        ((this.update_cart_totals = this.update_cart_totals.bind(this)),
          ...
          t(document).on("wc_update_cart added_to_cart", function () {
            m.update_cart.apply(m, [].slice.call(arguments, 1));
          }),
          t(document).on(
            "click",
      ...
      input_keypress: function (e) {
        if (13 === e.keyCode) {
          ...
          try {
            o[0].checkValidity() && (e.preventDefault(), this.cart_submit(e));
          } catch (c) {
      ...
      cart_submit: function (e) {
        var c = t(document.activeElement),
          ...
          i = t(e.currentTarget);
        if (
          (i.is("form") || (i = t(e.currentTarget).parents("form")),
          0 !== i.find(".woocommerce-cart-form__contents").length)
        )
          return (
            !o(i) &&
            void (r.is(':input[name="update_cart"]') || c.is("input.qty")
              ? (e.preventDefault(), this.quantity_update(i))
              : (r.is(':input[name="apply_coupon"]') || c.is("#coupon_code")) &&
                (e.preventDefault(), this.apply_coupon(i)))
          );
      },
      ...
      apply_coupon: function (o) {
        ...
        var i = this,
          n = t("#coupon_code"),
          u = n.val(),
          m = { security: wc_cart_params.apply_coupon_nonce, coupon_code: u };
        t.ajax({
          type: "POST",
          url: e("apply_coupon"),
          data: m,
          ...
          success: function (e) {
            if (
              ...
              -1 === e.indexOf("woocommerce-error") &&
                -1 === e.indexOf("is-error"))
            )
              a(e);
            else {
              var o = n.closest(".coupon");
              o.length > 0 && s(e, o, !1);
            }
            t(document.body).trigger("applied_coupon", [u]);
          },
          complete: function () {
            (r(o), i.update_cart(!0));
          },
      ...
      remove_coupon_clicked: function (o) {
        ...
        c(n);
        var u = { security: wc_cart_params.remove_coupon_nonce, coupon: s };
        t.ajax({
          type: "POST",
          url: e("remove_coupon"),
          data: u,
      ...
      on_keydown_remove_coupon: function (e) {
        " " === e.key &&
          (e.preventDefault(), t(e.currentTarget).trigger("click"));
      },
      remove_coupon_error: function (e) {
        t(e.currentTarget)
          .removeClass("has-error")
          .removeAttr("aria-invalid")
          .removeAttr("aria-describedby")
          ...
          t.ajax({
            ...
            complete: function () {
              (r(n),
                r(t("div.cart_totals")),
                t.scroll_to_notices(t('[role="alert"]')),
                t(document.body).trigger("item_removed_from_classic_cart"));
            },
          }));
      },
      on_keydown_remove_item: function (e) {
        " " === e.key &&
          (e.preventDefault(), t(e.currentTarget).trigger("click"));
      },
      item_restore_clicked: function (e) {
        e.preventDefault();
        var o = t(e.currentTarget),
          n = t("form.woocommerce-cart-form");
        (c(n),
          c(t("div.cart_totals")),
          t.ajax({
            type: "GET",
