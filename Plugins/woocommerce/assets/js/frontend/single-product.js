...
jQuery(function ($) {
  ...
  $("body")
    ...
    .on("keydown", ".wc-tabs li a, ul.tabs li a", function (e) {
      ...
      var targetIndex =
        direction === prev || direction === up ? tabIndex - 1 : tabIndex + 1;
  ...
  var ProductGallery = function ($target, args) {
    ...
    this.zoom_enabled =
      "function" === typeof $.fn.zoom && wc_single_product_params.zoom_enabled;
  ...
  ProductGallery.prototype.openPhotoswipe = function (e) {
    ...
    if (
      0 < eventTarget.closest(".woocommerce-product-gallery__trigger").length
    ) {
