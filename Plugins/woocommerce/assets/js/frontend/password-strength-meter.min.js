  ...
  var r = {
    ...
    strengthMeter: function () {
      var e,
        ...
        a = s('button[type="submit"]', t),
        o = s("#reg_password, #account_password, #password_1", t),
        d = o.val(),
        n = !t.is("form.checkout");
      (r.includeMeter(t, o),
        (e = r.checkPasswordStrength(t, o)),
    ...
    includeMeter: function (r, e) {
      ...
      if ("" === e.val())
        ...
        ((r = e.parent()).is(".password-input") ? r.after(t) : e.after(t),
          e.attr("aria-describedby", "password_strength"),
          s(document.body).trigger("wc-password-strength-added"));
      } else (t.show(), s(document.body).trigger("wc-password-strength-show"));
    },
