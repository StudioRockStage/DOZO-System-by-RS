...
((QR8bitByte.prototype = {
  ...
  (QRCode.createBytes = function (t, e) {
    ...
    var R = 0;
    for (l = 0; l < e.length; l++) R += e[l].totalCount;
    var c = new Array(R),
      Q = 0;
    for (l = 0; l < o; l++)
...
((QRPolynomial.prototype = {
  ...
  (QRRSBlock.getRSBlocks = function (t, e) {
    ...
    for (var o = r.length / 3, n = [], i = 0; i < o; i++)
      for (
        var a = r[3 * i + 0], s = r[3 * i + 1], u = r[3 * i + 2], h = 0;
        h < a;
        h++
      )
            ...
            ? (function () {
                ...
                for (
                  ...
                  for (var s = 0; s < t.getModuleCount(); s++) {
                    o.fillStyle = t.isDark(a, s) ? e.foreground : e.background;
                    var u = Math.ceil((s + 1) * n) - Math.floor(s * n),
                      h = Math.ceil((a + 1) * n) - Math.floor(a * n);
                    o.fillRect(Math.round(s * n), Math.round(a * i), u, h);
                  }
                return r;
              })()
            : (function () {
                var r = new QRCode(e.typeNumber, e.correctLevel);
                (r.addData(e.text), r.make());
                for (
                  var o = t("<table></table>")
                    ...
                    n = e.width / r.getModuleCount(),
                    i = e.height / r.getModuleCount(),
                    a = 0;
                  a < r.getModuleCount();
                  a++
                )
                  for (
                    ...
                    t("<td></td>")
                      ...
                      .css(
                        "background-color",
                        r.isDark(a, u) ? e.foreground : e.background,
                      )
                      .appendTo(s);
                return o;
              })();
