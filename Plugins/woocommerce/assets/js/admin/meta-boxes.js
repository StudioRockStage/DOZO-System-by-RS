jQuery(function ($) {
  ...
  jQuery.maybe_disable_save_button = function () {
    var $tab;
    var $save_button;
    if ($(".woocommerce_variation_new_attribute_data").is(":visible")) {
    ...
    var attributes_and_variations_data = $tab.find("input, select, textarea");
    if (
      jQuery.is_attribute_or_variation_empty(attributes_and_variations_data)
    ) {
