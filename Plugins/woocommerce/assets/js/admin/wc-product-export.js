...
(function ($, window) {
  ...
  var productExportForm = function ($form) {
    ...
    $form
      .find(".woocommerce-exporter-types")
  ...
  productExportForm.prototype.onSubmit = function (event) {
    ...
    event.data.productExportForm.$form.addClass(
      "woocommerce-exporter__exporting",
    );
    event.data.productExportForm.$form
      .find(".woocommerce-exporter-progress")
      .val(0);
    event.data.productExportForm.$form
      .find(".woocommerce-exporter-button")
      .prop("disabled", true);
  ...
  productExportForm.prototype.processStep = function (
    ...
    var $this = this,
      ...
      export_product_ids =
        $this.$form.find('input[name="product_ids"]').val() || "";
