      ...
      ShippingZone = Backbone.Model.extend({
        ...
        discardChanges: function (id) {
          ...
          if (
            set_position !== null &&
            zones[id] &&
            zones[id].zone_order !== set_position
          ) {
            changes[id] = _.extend(changes[id] || {}, {
              zone_id: id,
              zone_order: set_position,
            });
          }
        ...
        onDeleteRow: function (event) {
          ...
          if (window.confirm(data.strings.delete_confirmation_msg)) {
            if (zones[zone_id]) {
              ...
              changes[zone_id] = _.extend(changes[zone_id] || {}, {
                deleted: "deleted",
              });
