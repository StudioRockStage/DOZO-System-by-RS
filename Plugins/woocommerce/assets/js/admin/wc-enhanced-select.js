              ...
              ajax: {
                ...
                data: function (params) {
                  return {
                    term: params.term,
                    action:
                      $(this).data("action") || "woocommerce_json_search_pages",
            ...
            var select2_args = $.extend(
              {
                ...
                placeholder: $(this).data("placeholder"),
                minimumInputLength:
                  $(this).data("minimum_input_length") !== null &&
                  $(this).data("minimum_input_length") !== undefined
                    ? $(this).data("minimum_input_length")
                    : "3",
                escapeMarkup: function (m) {
                  return m;
            ...
            var select2_args = $.extend(
              {
                ...
                ajax: {
                  ...
                  processResults: function (data) {
                    var disabledItems =
                      $(select2Element).data("disabled-items") || [];
                    var terms = [];
                    if (data) {
                      $.each(data, function (id, term) {
                        terms.push({
