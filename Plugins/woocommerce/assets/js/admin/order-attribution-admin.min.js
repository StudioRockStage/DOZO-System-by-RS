jQuery(document).ready((e) => {
  ...
  ((window.wcTracks = window.wcTracks || {}),
    ...
    e(".woocommerce-order-attribution-details-toggle").on("click", (o) => {
      const t = e(o.target).closest(
      ...
      (o.preventDefault(),
        r.fadeToggle(250),
        t.find(".toggle-text").toggle(),
        r.hasClass("closed")
          ? (t.attr("aria-expanded", "true"), (d = "opened"))
          : (t.attr("aria-expanded", "false"), (d = "closed")),
