...
(function ($, marketplace_suggestions, ajaxurl) {
  $(function () {
    ...
    function dismissSuggestion(
      ...
      if (_.contains(highUseSuggestionContexts, context)) {
        ...
        var previousDismissalsInThisContext =
          parseInt(Cookies.get(contextDismissalCountCookie), 10) || 0;
        Cookies.set(
    ...
    function renderListItem(
      ...
      container.appendChild(renderSuggestionContent(slug, title, copy));
      container.appendChild(
        renderSuggestionCTA(
          context,
          product,
    ...
    function displaySuggestions(marketplaceSuggestionsApiData) {
      ...
      $(".marketplace-suggestions-container").each(function () {
        ...
        $("ul.product_data_tabs li.marketplace-suggestions_options a").on(
          "click",
          function (e) {
            e.preventDefault();
