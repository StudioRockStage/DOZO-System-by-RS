            ...
            ((o = function (e, t) {
              ...
              (n =
                ...
                s =
                  function (n, i, r, l, c) {
                    if ("string" == typeof n)
                      return a[n] ? a[n](i) : _(o(n, i).f);
                    if (!n.splice) {
                      if (((u = n).deps && s(u.deps, u.callback), !i)) return;
