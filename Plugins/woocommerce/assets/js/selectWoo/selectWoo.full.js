  ...
  var S2 = (function () {
    ...
    S2.define("select2/data/tags", ["jquery"], function ($) {
      ...
      Tags.prototype.createTag = function (decorated, params) {
        var term =
          params.term || 0 == params.term ? params.term.toString().trim() : "";
    ...
    S2.define("select2/compat/utils", ["jquery"], function ($) {
      function syncCssClasses($dest, $src, adapter) {
        ...
        classes =
          $dest.attr("class") || 0 == $dest.attr("class")
            ? $dest.attr("class").toString().trim()
            : "";
        ...
        classes =
          $src.attr("class") || 0 == $src.attr("class")
            ? $src.attr("class").toString().trim()
            : "";
