            ...
            ((s = function (e, t) {
              ...
              (t = function (t, n, i, r) {
                var o,
                  ...
                  A = typeof i;
                if (
                  ((m = w((r = r || t))), "undefined" === A || "function" === A)
                ) {
                  for (
                    n =
                      !n.length && i.length
              ...
              (r.prototype.update = function (e) {
                if (0 !== e.length) {
                  var t = e[0],
                    ...
                    r = n.entityDecode(this.display(t, i));
                  (i.empty().text(r), i.prop("title", t.title || t.text));
                } else this.clear();
              }),
              r
            );
          ...
          function (e, t, n) {
            ...
            return (
              ...
              (i.prototype.bind = function (e, t, i) {
                ...
                (e.call(this, t, i),
                  t.on("open", function () {
                    (r.$search.attr("aria-owns", o),
                      r.$search.trigger("focus"));
                  }),
                  t.on("close", function () {
                    (r.$search.val(""),
                      r.$search.removeAttr("aria-activedescendant"),
                      r.$search.removeAttr("aria-owns"),
                      r.$search.trigger("focus"));
                  }),
            ...
            return (
              ...
              (n.prototype._positionDropdown = function () {
                ...
                ((p.left -= f.left),
                  ...
                  ("above" == r || (n && "below" !== r)) && (p.top = s.top - a),
                  null != r &&
                    (this.$dropdown
                      .removeClass(
        ...
        t.define(
          ...
          function (e, t, n, i) {
            ...
            return (
                          ...
                          : n === i.SPACE && e.ctrlKey
                            ...
                            : n === i.UP
                              ...
                              : n === i.DOWN &&
                                ...
                                e.preventDefault());
                      var r = t.$dropdown.find(".select2-search__field");
                      (r.length ||
                        (r = t.$container.find(".select2-search__field")),
                        n === i.DOWN || n === i.UP
                          ? t.focusOnActiveElement()
                          : (r.trigger("focus"),
                            setTimeout(function () {
              ...
              (r.prototype.focusOnActiveElement = function () {
                this.isOpen() &&
                  !n.isTouchscreen() &&
                  this.$results
