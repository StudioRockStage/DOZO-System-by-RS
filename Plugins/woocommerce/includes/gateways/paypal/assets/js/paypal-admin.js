  ...
  var wc_paypal_admin = {
    ...
    init: function () {
      $(document.body).on(
        ...
        function () {
          var test_api_username = $("#woocommerce_paypal_sandbox_api_username")
              .parents("tr")
              .eq(0),
            test_api_password = $("#woocommerce_paypal_sandbox_api_password")
              .parents("tr")
              .eq(0),
            test_api_signature = $("#woocommerce_paypal_sandbox_api_signature")
              .parents("tr")
              .eq(0),
            live_api_username = $("#woocommerce_paypal_api_username")
              .parents("tr")
              .eq(0),
            live_api_password = $("#woocommerce_paypal_api_password")
              .parents("tr")
              .eq(0),
            live_api_signature = $("#woocommerce_paypal_api_signature")
              .parents("tr")
              .eq(0);
