 ...
 * ═══════════════════════════════════════════════════════════════
 */
define('RS_WARRANTY_VERSION', '7.0.4');
define('RS_DOZO_VERSION', '7.0.4'); // DOZO Deep Audit version - Recursive Class Repair & Module Integrity Fix
...
/**
 * ═══════════════════════════════════════════════════════════════
 * DOZO v7.0.4: SYNTAX SHIELD, RECURSIVE CHECK & REPAIR ENGINE
 * ═══════════════════════════════════════════════════════════════
 */
