  ...
  const ClaudeDeveloper = {
    ...
    testApiKey() {
      ...
      this.sendTestMessage(
        'Hola Claude, esto es una prueba de conexión. Responde solo con "Conexión exitosa ✅"',
      );
    },
    ...
    sendTestMessage(message) {
      $.ajax({
        ...
        success: (response) => {
          ...
          $btn.html(
            '<span class="dashicons dashicons-yes"></span> Probar Conexión',
          );
    ...
    previewCode(button) {
      ...
      alert(
        "Función de preview - Por implementar\n\nCódigo:\n" +
    ...
    clearChat() {
      if (
        !confirm("¿Estás seguro de que quieres limpiar toda la conversación?")
      ) {
        return;
      }
