 ...
 * ═══════════════════════════════════════════════════════════════
 */
define('RS_WARRANTY_VERSION', '7.2.2');
define('RS_DOZO_VERSION', '7.2.2'); // DOZO Deep Audit version - Design Panel Structure Fix & Asset Integration
...
/**
 * ═══════════════════════════════════════════════════════════════
 * DOZO v7.2: DESIGN PANEL INTEGRATION + VALIDATION + SYNC
 * ═══════════════════════════════════════════════════════════════
 */
