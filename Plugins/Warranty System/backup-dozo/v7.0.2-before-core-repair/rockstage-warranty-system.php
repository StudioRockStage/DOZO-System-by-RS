 ...
 * ═══════════════════════════════════════════════════════════════
 */
define('RS_WARRANTY_VERSION', '7.0.2');
define('RS_DOZO_VERSION', '7.0.2'); // DOZO Deep Audit version - Syntax Shield & Load Timing Fix
...
/**
 * ═══════════════════════════════════════════════════════════════
 * DOZO v7.0.2: SYNTAX SHIELD & TRANSLATION LOADING
 * ═══════════════════════════════════════════════════════════════
 */
