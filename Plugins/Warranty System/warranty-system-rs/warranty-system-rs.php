 ...
 * ═══════════════════════════════════════════════════════════════
 */
define('RS_WARRANTY_VERSION', '7.5.5');
define('RS_DOZO_VERSION', '7.5.5'); // DOZO Full Self-Healing Engine + Smart Integration Sync v2 + FileMap Verification Layer
...
/**
 * ═══════════════════════════════════════════════════════════════
 * DOZO v7.4.1: FULL SELF-HEALING ENGINE + VISUAL FEEDBACK LAYER
 * ═══════════════════════════════════════════════════════════════
 */
...
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-repair-engine.php';

// Knowledge and memory
require_once RS_WARRANTY_PLUGIN_DIR . 'includes/class-dozo-knowledge-base.php';
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-self-healing.php';

// Sync and integration
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-sync-engine.php';
require_once RS_WARRANTY_PLUGIN_DIR . 'includes/class-design-panel-integration.php';

// v7.4.1 Modules
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-smart-inspector.php';
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-preinit-guard.php';
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-visual-feedback.php';

// v7.5.0 New Module
require_once RS_WARRANTY_PLUGIN_DIR . 'tools/dozo-smartsync-layout.php';
