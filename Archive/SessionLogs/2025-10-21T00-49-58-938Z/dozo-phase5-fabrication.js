...
const globalReport = path.join(baseDir, 'to chat gpt/Global/DOZO-Fabrication-Report.json');
...
function fabricateDemoPrompts() {
  const demoPrompts = [
    { ia: 'claude', name: 'Prompt Maestro – Layout Panels', desc: 'Diseño de paneles y layouts DOZO' },
    { ia: 'cursor', name: 'Prompt Maestro – Deploy Manager', desc: 'Gestión de compilación y despliegue' },
    { ia: 'chatgpt', name: 'Prompt Maestro – Workflow Sync', desc: 'Gestor de sincronización y comunicación DOZO' },
    { ia: 'shared', name: 'Prompt Maestro – CrossSync', desc: 'Interfaz compartida entre IA y módulos' }
  ];
