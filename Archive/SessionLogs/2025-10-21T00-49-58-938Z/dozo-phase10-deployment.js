...
function buildChangelog() {
  const changelog = `# Warranty System RS v${VERSION}\n` +
...
(async () => {
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('⚠️  Modo: Preparación local (FTP deployment requiere permisos de red)');
  console.log('');
  ...
  try {
    ...
    fs.writeFileSync(HEAL, JSON.stringify({ 
      status: 'ready', 
      healed: false, 
