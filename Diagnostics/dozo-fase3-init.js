...
console.log(
  `   ✅ AutoRepair: ${config.autoRepair ? "Habilitado" : "Deshabilitado"}`,
);
console.log(
  `   ✅ Deep Scan: ${config.deepScan ? "Habilitado" : "Deshabilitado"}`,
);
console.log(
  `   ✅ Backup Before Fix: ${config.backupBeforeFix ? "Habilitado" : "Deshabilitado"}\n`,
);
